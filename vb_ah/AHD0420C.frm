...
Begin VB.Form AHD0420C 
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      ProcessTab      =   -1  'True
      Protect         =   0   'False
      SpreadDesigner  =   "AHD0420C.frx":0000
   End
...
'   Call Gp_Sp_Collection(ss1, 25, " ", " ", " ", " ", " ", " ", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
   ...
   ' sc1.Add Item:="ABX1090C.P_MODIFY", Key:="P-M"
    sc1.Add Item:="AHD0420C.P_REFER", Key:="P-R"
...
On Error GoTo Refer_Err
    ...
    sQuery = "{ CALL " + "AHD0420C.P_REFER" + "("
    sQuery = sQuery + " '" + dtp_yy_mm.RawData + "','" + txt_plt.Text + "','" + Text1.Text + "'"
    sQuery = sQuery + ")"
    sQuery = sQuery + "}"
...
'    Dim sMesg As String
'    Dim sQuery As String
'    sQuery = "{ CALL " + "AHD0120C.P_REFER" + "("
'    sQuery = sQuery + " '" + dtp_yy_mm + "'"
'    sQuery = sQuery + ")"
'    sQuery = sQuery + "}"
'
'    If Gf_Sp_ProceExist(Proc_Sc("Sc").Item("Spread")) Then Exit Sub
