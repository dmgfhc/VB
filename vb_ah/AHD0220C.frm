...
Begin VB.Form AHD0220C 
   Caption         =   "仓库库存报表（订/余）AHD0220C"
   ClientHeight    =   3195
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   4680
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      ProcessTab      =   -1  'True
      Protect         =   0   'False
      SpreadDesigner  =   "AHD0220C.frx":0000
   End
...
Private Sub Form_Define()
   ...
   Call Gp_Sp_Collection(ss1, 15, " ", " ", " ", " ", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    sc1.Add Item:="AHD0220C.P_REFER", Key:="P-R"
...
Public Sub Form_Ref()
    ...
    sQuery = "{call AHD0220C.P_REFER ('" + dtp_yy_mm.RawData + "','" + txt_plt.Text + "')}"
...
Private Sub ExcelPrn()
    ...
    xlApp.Workbooks.Open (App.Path & "\AHD0220C.xls")
    
    Set xlSheet = xlApp.Worksheets("Sheet1")
    xlApp.Sheets("Sheet1").Select
            
    
    xlApp.Range("L3").Value = Format(Now, "YYYY-MM-DD HH:MM:SS")
    xlApp.Range("A3").Value = Mid(dtp_yy_mm.RawData, 1, 4) + "年" + _
                              Mid(dtp_yy_mm.RawData, 5, 2) + "月" + _
                              Mid(dtp_yy_mm.RawData, 7, 2) + "日"
          
    Clipboard.Clear
    ss1.Row = 1: ss1.Col = 2: ss1.Row2 = ss1.MaxRows: ss1.Col2 = 15
    ...
    sRow = "A" & ss1.MaxRows + 5 & ":B" & ss1.MaxRows + 5
    xlApp.Range(sRow).MERGECELLS = True
    sRow = "A" & ss1.MaxRows + 5
