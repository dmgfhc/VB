...
Begin VB.Form AHD0530C 
   Caption         =   "营销部板材对应工序10/30/60天以上未作处理进程情况_AHD0530C"
   ClientHeight    =   3090
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   4680
...
On Error GoTo Refer_Err
 ...
 txt_pri_date.Caption = Gf_CodeFind(M_CN1, "select substr(report_date,1,12) from CP_PLATE_DEL  where rownum =1   ")
    ...
    If Gf_Sp_ProceExist(Proc_Sc("Sc").Item("Spread")) Then Exit Sub
        ...
        ss1.Row = 1:   ss1.Col = 0:      ss1.Text = "板卷10天以上"
        ss1.Row = 2:   ss1.Col = 0:      ss1.Text = "中板10天以上"
        ss1.Row = 3:   ss1.Col = 0:      ss1.Text = "10天以上小计"
        ss1.Row = 4:   ss1.Col = 0:      ss1.Text = "板卷30天以上"
        ss1.Row = 5:   ss1.Col = 0:      ss1.Text = "中板30天以上"
        ss1.Row = 6:   ss1.Col = 0:      ss1.Text = "30天以上小计"
        ss1.Row = 7:   ss1.Col = 0:      ss1.Text = "板卷60天以上"
        ss1.Row = 8:   ss1.Col = 0:      ss1.Text = "中板60天以上"
        ss1.Row = 9:   ss1.Col = 0:      ss1.Text = "60天以上小计"
    Exit Sub
...
On Error GoTo Excel_Error
   ...
   xlSheet.Range("A2").Value = "板卷10天以上"
   xlSheet.Range("A3").Value = "中板10天以上"
   xlSheet.Range("A4").Value = "10天以上小计"
   xlSheet.Range("A5").Value = "板卷30天以上"
   xlSheet.Range("A6").Value = "中板30天以上"
   xlSheet.Range("A7").Value = "30天以上小计"
   xlSheet.Range("A8").Value = "板卷60天以上"
   xlSheet.Range("A9").Value = "中板60天以上"
  xlSheet.Range("A10").Value = "60天以上小计"
  
 xlSheet.Range("A1:I10 ").Borders.LineStyle = 1 '   增加边框
