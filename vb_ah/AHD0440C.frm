...
Begin VB.Form AHD0440C 
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      ProcessTab      =   -1  'True
      Protect         =   0   'False
      SpreadDesigner  =   "AHD0440C.frx":0000
   End
...
'   Call Gp_Sp_Collection(ss1, 25, " ", " ", " ", " ", " ", " ", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    sc1.Add Item:="AHD0440C.P_REFER", Key:="P-R"
...
On Error GoTo Refer_Err
    ...
    Dim sMesg As String
    Dim sQuery As String
    sQuery = "{ CALL " + "AHD0440C.P_REFER" + "("
    sQuery = sQuery + "'" + dtp_yy_mm.RawData + "',"
    sQuery = sQuery + " '" + text_cur_inv_code + "','" + txt_plt.Text + "','" + Text1.Text + "'"
    sQuery = sQuery + ")"
    sQuery = sQuery + "}"
