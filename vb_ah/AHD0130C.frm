...
Begin VB.Form AHD0130C 
   Caption         =   "单库出入库月平衡报表（综判）_AHD0130C"
   ClientHeight    =   3090
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   4680
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      ProcessTab      =   -1  'True
      Protect         =   0   'False
      SpreadDesigner  =   "AHD0130C.frx":0000
   End
...
Call Gp_Ms_Collection(text_cur_inv_code, "p", "n", " ", " ", "r", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
   ...
   Call Gp_Sp_Collection(ss1, 18, " ", " ", " ", " ", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    sc1.Add Item:="AHD0130C.P_REFER", Key:="P-R"
...
Public Sub Form_Ref()
    ...
    sQuery = "{call AHD0130C.P_REFER ('" + dtp_yy_mm.RawData + "','" + text_cur_inv_code + "','" + txt_plt.Text + "')}"
...
Private Sub ExcelPrn()
    ...
    xlApp.Range("C1").Value = text_cur_inv.Text + "出入库月平衡报表"
