...
Begin VB.Form AHD0100C 
   Caption         =   "经销处出入库月平衡报表（综判）_AHD0100C"
   ClientHeight    =   3090
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   4680
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      ProcessTab      =   -1  'True
      Protect         =   0   'False
      SpreadDesigner  =   "AHD0100C.frx":0000
   End
...
Private Sub Form_Define()
   ...
   Call Gp_Sp_Collection(ss1, 18, " ", " ", " ", " ", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    Sc1.Add Item:="AHD0100C.P_REFER", Key:="P-R"
...
Public Sub Form_Ref()
    ...
    sQuery = "{call AHD0100C.P_REFER ('" + dtp_yy_mm.RawData + "','" + txt_plt.Text + "')}"
