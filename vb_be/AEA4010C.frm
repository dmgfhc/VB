...
Begin VB.Form AEA4010C 
   Caption         =   "录入轧钢工序计划T/H标准_AEA4010C"
   ClientHeight    =   7620
   ClientLeft      =   270
   ClientTop       =   2130
   ClientWidth     =   15225
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "AEA4010C.frx":0000
   End
...
Private Sub Form_Define()
    ...
    Call Gp_Sp_Collection(ss1, 4, " ", "n", " ", " ", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    Call Gp_Sp_Collection(ss1, 8, "p", "n", " ", "i", " ", " ", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    Call Gp_Sp_Collection(ss1, 9, "p", "n", " ", "i", " ", " ", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
   Call Gp_Sp_Collection(ss1, 10, "p", "n", " ", "i", " ", " ", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
   Call Gp_Sp_Collection(ss1, 11, "p", "n", " ", "i", " ", " ", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
   ...
   Call Gp_Sp_Collection(ss1, 19, " ", " ", " ", " ", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    Sc1.Add Item:="AEA4010C.P_MODIFY", Key:="P-M"
    Sc1.Add Item:="AEA4010C.P_REFER", Key:="P-R"
    Sc1.Add Item:="AEA4010C.P_ONEROW", Key:="P-O"
