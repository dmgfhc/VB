...
Begin VB.Form AED2010C 
   Caption         =   "变更轧钢计划厂_AED2010C"
   ClientHeight    =   9225
   ClientLeft      =   300
   ClientTop       =   2175
   ClientWidth     =   14820
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "AED2010C.frx":003C
   End
...
'-- Coder             Kim Sung Ho
'-- Date              2007.12.10
'-- Description       MILL_PLT  C3-->C1, C1-->C3 CHANGE
'-------------------------------------------------------------------------------
'-- UPDATE HISTORY  ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
'-------------------------------------------------------------------------------
...
Private Sub Form_Define()
    ...
    'Call Master_Collection("Control_Name", "p(primary)", "n(Necessary)", "m(maxlength)", "i(insert)", "r(refer)", "a(append)", "l(lock)")
       Call Gp_Ms_Collection(txt_mill_plt, "p", "n", "m", " ", "r", " ", "l", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
   ...
   Call Gp_Sp_Collection(ss1, 15, " ", " ", " ", "i", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    sc1.Add Item:="AED2010C.P_MODIFY", Key:="P-M"
    sc1.Add Item:="AED2010C.P_REFER", Key:="P-R"
    sc1.Add Item:="AED2010C.P_ONEROW", Key:="P-O"
