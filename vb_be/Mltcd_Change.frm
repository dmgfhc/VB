...
Begin VB.Form Mltcd_Change 
   ...
   Begin Threed.SSPanel pnl_first 
      ...
      Begin VB.ComboBox cob_MLT_PROC_CD_2 
         ...
         EndProperty
         Height          =   300
         ItemData        =   "Mltcd_Change.frx":0023
         Left            =   2355
         List            =   "Mltcd_Change.frx":0030
         Style           =   2  'Dropdown List
         TabIndex        =   6
         Top             =   660
         Width           =   1005
      ...
      Begin VB.ComboBox cob_MLT_PROC_CD_1 
         ...
         EndProperty
         Height          =   300
         ItemData        =   "Mltcd_Change.frx":0040
         Left            =   1350
         List            =   "Mltcd_Change.frx":0056
         Style           =   2  'Dropdown List
         TabIndex        =   5
         Top             =   660
         Width           =   1005
...
Private Sub Cmd_Ok_Click()
    ...
    Dim iRow As Integer
    strPrc_CD = Trim(txt_MLT_PROC_CD.Text) + Trim(txt_MLT_PROC_CD2.Text) + Trim(txt_MLT_PROC_CD3.Text)
