...
Begin VB.Form AEA1060C 
   Caption         =   "录入板坯长度设计标准_AEA1060C"
   ClientHeight    =   9225
   ClientLeft      =   345
   ClientTop       =   2295
   ClientWidth     =   15315
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "AEA1060C.frx":0000
   End
End
Attribute VB_Name = "AEA1060C"
...
'---------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    Sc1.Add Item:="AEA1060C.P_MODIFY", Key:="P-M"
    Sc1.Add Item:="AEA1060C.P_REFER", Key:="P-R"
    Sc1.Add Item:="AEA1060C.P_ONEROW", Key:="P-O"
...
Public Sub Form_Ins()
    ...
    Call Gp_Sp_InAuthority(Proc_Sc("Sc"), 18)       '输入人员在 Spread 中第几列就写几！
...
Private Sub txt_plt_KeyUp(KeyCode As Integer, Shift As Integer)
    ...
    Else
        ...
        If Len(Trim(txt_PLT)) = txt_PLT.MaxLength Then
            txt_PLT.Text = UCase(txt_PLT.Text)
