...
Begin VB.Form AEC1000C 
   Caption         =   "标准板坯设计_AEC1000C"
   ClientHeight    =   7545
   ClientLeft      =   735
   ClientTop       =   2235
   ClientWidth     =   17220
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      ProcessTab      =   -1  'True
      Protect         =   0   'False
      SpreadDesigner  =   "AEC1000C.frx":0000
   End
...
Private Sub Form_Define()
    ...
    'Call Master_Collection("Control_Name", "p(primary)", "n(Necessary)", "m(maxlength)", "i(insert)", "r(refer)", "a(append)", "l(lock)")
           ...
           Call Gp_Ms_Collection(txt_ccm_line, " ", "n", " ", " ", "r", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
    ...
    sc1.Add Item:="AEC1000C.P_REFER", Key:="P-R"
    sc1.Add Item:="AEC1000C.P_MODIFY", Key:="P-M"
    sc1.Add Item:="AEC1000C.P_ONEROW", Key:="P-O"
...
On Error GoTo Process_Exec_ERROR
    ...
    sQuery = "{call AEC1110P ('" + txt_plt.Text + "','" + txt_prc_line.Text + "','" + txt_ccm_line.Text + "','" & _
                                   Trim(txt_ord_no.Text) + "','" + Trim(cbo_ord_item.Text) + "','" & _
                                   ...
                                   sdb_prod_thk_fr.Value & "," & sdb_prod_thk_to.Value & "," & sdb_prod_wid_fr.Value & "," & _
                                   sdb_prod_wid_to.Value & "," & sdb_prod_len_fr.Value & "," & sdb_prod_len_to.Value & ",'" & _
                                   sUserID + "',?)}"
...
On Error GoTo Process_Exec_ERROR
    ...
    sQuery = "{call AEC1113P ('" + txt_plt.Text + "','" + txt_prc_line.Text + "','R','" + sUserID + "',?)}"
