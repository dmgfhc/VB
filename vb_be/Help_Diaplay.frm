...
Private Sub tre_view_Click()
    ...
    If cmd_Image.Caption = "Close Image" Then
        Call cmd_Image_Click
    End If
...
Private Sub Image_Display(iImageNo As Integer)
    ...
    With MDIMain.Inet
        ...
        .Execute , "GET " & Left(sServerPATH, iLoc) & "Help/" & UCase(sFileName) & " " & Chr(34) & UCase(sFilePath) & Chr(34)
