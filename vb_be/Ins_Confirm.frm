...
Private Sub Cmd_Ok_Click()
    ...
    If cbo_first.Text = "" And Trim(cbo_Second.Text) = "" Then
...
Public Sub Gp_Combo_Add2(sPname As Variant)
...
On Error GoTo Process_Exec_ERROR
    ...
    If P_MODE = "C" Then 'CAST   SLAB_EDT_FL = '1'  HCR
        sQuery = "{call AEE1000P ('" + P_PLT + "','" + Trim(cbo_first.Text) + "','" + Trim(cbo_Second.Text) + "','','" + sUserID + "',?)}"
    Else                 'ROLL   SLAB_EDT_FL = '2'  CCR
        sQuery = "{call AED1100P ('" + P_PLT + "','" + P_LINE + "','','','" + Trim(cbo_first.Text) + "','" + sUserID + "',?)}"
    End If
