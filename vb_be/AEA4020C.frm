...
Begin VB.Form AEA4020C 
   Caption         =   "录入加热炉装炉长度标准_AEA4020C"
   ClientHeight    =   7620
   ClientLeft      =   270
   ClientTop       =   2130
   ClientWidth     =   15225
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "AEA4020C.frx":0000
   End
End
Attribute VB_Name = "AEA4020C"
...
'-------------------------------------------------------------------------------
'-- System Name
'-- Sub_System Name   DAILY SCHEDULE
'-- Program Name
'-- Program ID        AEA4020C
...
Private Sub Form_Define()
   ...
   Call Gp_Sp_Collection(ss1, 17, " ", " ", " ", " ", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    Sc1.Add Item:="AEA4020C.P_MODIFY", Key:="P-M"
    Sc1.Add Item:="AEA4020C.P_REFER", Key:="P-R"
    Sc1.Add Item:="AEA4020C.P_ONEROW", Key:="P-O"
