...
Begin VB.Form AZB1040C 
   Caption         =   "错误列表_AZB1040C"
   ClientHeight    =   7035
   ClientLeft      =   360
   ClientTop       =   2655
   ClientWidth     =   14550
   ...
   Begin InDate.UDate dtp_occ_time 
      Height          =   315
      Left            =   11385
      TabIndex        =   4
      Tag             =   "录入日期"
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "AZB1040C.frx":0000
   End
...
Private Sub Form_Define()
    ...
    Call Gp_Ms_Collection(txt_biz_area_name, " ", " ", " ", " ", "r", " ", "l", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
         ...
         Call Gp_Ms_Collection(dtp_occ_time, "p", " ", " ", " ", "r", " ", "l", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
   ...
   Call Gp_Sp_Collection(ss1, 10, " ", " ", " ", "i", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    Sc1.Add Item:="AZB1040C.P_MODIFY", Key:="P-M"
    Sc1.Add Item:="AZB1040C.P_REFER", Key:="P-R"
    Sc1.Add Item:="AZB1040C.P_ONEROW", Key:="P-O"
...
Private Sub Form_Activate()
    ...
    MDIMain.MenuTool.Buttons(11).Enabled = False    'Line
    MDIMain.MenuTool.Buttons(12).Enabled = False    'Copy
    MDIMain.MenuTool.Buttons(13).Enabled = False    'Paste
...
Private Sub txt_biz_area_DblClick()
    ...
    Call txt_biz_area_KeyUp(vbKeyF4, 1)
