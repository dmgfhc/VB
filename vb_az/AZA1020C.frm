...
Begin VB.Form AZA1020C 
   Caption         =   "适用项目_AZA1020C"
   ClientHeight    =   7620
   ClientLeft      =   315
   ClientTop       =   1860
   ClientWidth     =   14760
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "AZA1020C.frx":0000
   End
...
Private Sub Form_Define()
    ...
    'Call Master_Collection("Control_Name", "p(primary)", "n(Necessary)", "m(maxlength)", "i(insert)", "r(refer)", "a(append)", "l(lock)")
     ...
     Call Gp_Ms_Collection(txt_biz_area_name, " ", " ", " ", " ", "r", " ", "l", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
          Call Gp_Ms_Collection(txt_table_id, "p", " ", " ", " ", "r", " ", "l", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
    Call Gp_Ms_Collection(txt_aply_item_name, "p", " ", " ", " ", "r", " ", "l", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
   ...
   Call Gp_Sp_Collection(ss1, 10, " ", " ", " ", " ", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    Sc1.Add Item:="AZA1020C.P_MODIFY", Key:="P-M"
    Sc1.Add Item:="AZA1020C.P_REFER", Key:="P-R"
    Sc1.Add Item:="AZA1020C.P_ONEROW", Key:="P-O"
