...
Begin VB.Form AZC1010C 
   Caption         =   "人员管理_AZC1010C"
   ClientHeight    =   7620
   ClientLeft      =   330
   ClientTop       =   3015
   ClientWidth     =   14460
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "AZC1010C.frx":0000
   End
...
Private Sub Form_Define()
    ...
    'Call Master_Collection("Control_Name", "p(primary)", "n(Necessary)", "m(maxlength)", "i(insert)", "r(refer)", "a(append)", "l(lock)")
       ...
       Call Gp_Ms_Collection(txt_emp_name, "p", " ", " ", " ", "r", " ", "l", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
           Call Gp_Ms_Collection(txt_dept, "p", " ", " ", " ", "r", " ", "l", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
    Call Gp_Ms_Collection(txt_description, "p", " ", " ", " ", "r", " ", "l", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
    ...
    Sc1.Add Item:="AZC1010C.P_MODIFY", Key:="P-M"
    Sc1.Add Item:="AZC1010C.P_REFER", Key:="P-R"
    Sc1.Add Item:="AZC1010C.P_ONEROW", Key:="P-O"
...
Private Sub Form_Load()
    ...
    Call Gp_Sp_HdColColor(Sc1.Item("Spread"), 12)
    Call Gp_Sp_HdColColor(Sc1.Item("Spread"), 14)
        ...
        Case 3
            ...
            Else
                ...
                If Len(Trim(ss1.Text)) = ss1.TypeMaxEditLen Then
                    sTemp_Code = ss1.Text
                    ss1.Col = 4
                    ss1.Text = Gf_ComnNameFind(M_CN1, "Z0002", Trim(sTemp_Code), 2)
                Else
                    ss1.Col = 4
                    ss1.Text = ""
                End If
        ...
        Case 14
            ...
            Else
                ...
                If Len(Trim(ss1.Text)) = ss1.TypeMaxEditLen Then
                    sTemp_Code = ss1.Text
                    ss1.Col = 15
                    ss1.Text = Gf_ComnNameFind(M_CN1, "C0002", Trim(sTemp_Code), 2)
                Else
                    ss1.Col = 15
                    ss1.Text = ""
                End If
