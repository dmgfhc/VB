...
Begin VB.Form AZC1023C 
   Caption         =   "权限管理_AZC1023C"
   ClientHeight    =   9210
   ClientLeft      =   135
   ClientTop       =   1665
   ClientWidth     =   15240
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "AZC1023C.frx":0000
   End
...
Private Sub Form_Define()
   ...
   Call Gp_Sp_Collection(ss1, 12, " ", " ", " ", " ", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    Sc1.Add Item:="AZC1023C.P_MODIFY", Key:="P-M"
    Sc1.Add Item:="AZC1023C.P_REFER", Key:="P-R"
    Sc1.Add Item:="AZC1023C.P_ONEROW", Key:="P-O"
...
Private Sub Form_Load()
    ...
    Call Gp_Sp_HdColColor(Sc1.Item("Spread"), 2)
...
Private Sub txt_emp_id_Change()
  Dim sTemp_Code As String
  sTemp_Code = txt_emp_id.Text
  txt_emp_name.Text = Gf_EmpNameFind(M_CN1, Trim(sTemp_Code))
