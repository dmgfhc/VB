...
Begin VB.Form AZB1020C 
   Caption         =   "程序版本_AZB1020C"
   ClientHeight    =   5940
   ClientLeft      =   195
   ClientTop       =   3465
   ClientWidth     =   14985
   ...
   Begin Threed.SSCommand cmd_server 
      Height          =   420
      Left            =   90
      TabIndex        =   1
      Top             =   60
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "AZB1020C.frx":0000
   End
End
Attribute VB_Name = "AZB1020C"
...
Private Sub Form_Define()
    ...
    Sc1.Add Item:="AZB1020C.P_SREFER", Key:="P-R"
...
Private Sub Form_Load()
    ...
    If sAuthority = "1111" Then
       cmd_server.Enabled = True
    End If
...
On Error GoTo Refer_Err
    ...
    If Gf_Sp_Refer(M_CN1, Proc_Sc("Sc")) Then
...
Private Sub ss1_DblClick(ByVal Col As Long, ByVal Row As Long)
    ...
    With ss1
        ...
        If Row <> 0 Then
            ...
            .Col = 1: AZB1021C.txt_sub_sys.Text = .Text
            .Col = 2: AZB1021C.txt_sys_name.Text = .Text
            .Col = 3: AZB1021C.txt_first_ver.Text = .Text
            .Col = 4: AZB1021C.txt_second_ver.Text = .Text
            .Col = 5: AZB1021C.txt_third_ver.Text = .Text
            .Col = 6: AZB1021C.sdb_sys_size = .Value
