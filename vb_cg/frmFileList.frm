...
Private Sub Form_Activate()
    ...
    If Me.Tag = "PLATE" Then
        oFile1.Pattern = "Plate*.XLS"
    ElseIf Me.Tag = "SMP" Then
        oFile1.Pattern = "S*.XLS"
    Else
        oFile1.Pattern = "Cer*.XLS"
    End If
    oFile1.SetFocus
...
'    If Me.Tag = "PLATE" Then
'        AGZ3010C.lblFileName.Caption = ExcelFilePath & "\" & Trim(otxtFileName)
'    ElseIf Me.Tag = "SMP" Then
'        AGZ3040C.lblFileName.Caption = ExcelFilePath & "\" & Trim(otxtFileName)
'    Else
'        AGZ3020C.lblFileName.Caption = ExcelFilePath & "\" & Trim(otxtFileName)
'    End If
'    Me.Tag = ""
End Sub
