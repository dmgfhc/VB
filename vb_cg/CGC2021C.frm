...
Const SS2_ERPORT = 23
Const SS2_ORD_CNT = 24 '一批多订单
Const SS2_OVER_FL = 25 '异常坯
Const SS2_TRIM_FL = 26 '是否切边
Const SS2_FLAB_NO = 1
...
Private Sub Form_Define()
   ...
   Call Gp_Sp_Collection(ss2, 20, " ", " ", " ", " ", " ", " ", pColumn2, nColumn2, mColumn2, iColumn2, aColumn2, lColumn2) ' Add by liqian at 2012-07-30 紧急订单
   ...
   Call Gp_Sp_Collection(ss2, 24, " ", " ", " ", " ", " ", " ", pColumn2, nColumn2, mColumn2, iColumn2, aColumn2, lColumn2) '一批多订单
   Call Gp_Sp_Collection(ss2, 25, " ", " ", " ", " ", " ", " ", pColumn2, nColumn2, mColumn2, iColumn2, aColumn2, lColumn2) '异常坯
   Call Gp_Sp_Collection(ss2, 26, " ", " ", " ", " ", " ", " ", pColumn2, nColumn2, mColumn2, iColumn2, aColumn2, lColumn2) '是否切边
   Call Gp_Sp_Collection(ss2, 27, " ", " ", " ", " ", " ", " ", pColumn2, nColumn2, mColumn2, iColumn2, aColumn2, lColumn2) '是否切边
   Call Gp_Sp_Collection(ss2, 28, " ", " ", " ", " ", " ", " ", pColumn2, nColumn2, mColumn2, iColumn2, aColumn2, lColumn2) '是否切边
   Call Gp_Sp_Collection(ss2, 29, " ", " ", " ", " ", " ", " ", pColumn2, nColumn2, mColumn2, iColumn2, aColumn2, lColumn2) '是否切边
   Call Gp_Sp_Collection(ss2, 30, " ", " ", " ", " ", " ", " ", pColumn2, nColumn2, mColumn2, iColumn2, aColumn2, lColumn2) '是否切边
...
Private Sub chk_Cond_Click(Index As Integer)
    ...
    If Index = 3 Then
       ...
       Else
          ...
          tcpMsg2.Caption = "表面检测状态 : " & strState2
       End If
    End If
End Sub
...
'
    ...
    TXT_COM.Text = "5"
    TXT_TOP.Text = "1"
    TXT_BOT.Text = "0"    'LiQian 2012-08-23 底部选择默认不选,界面上TXT_BOT默认也设为0和不选择
'
...
Private Sub ss1_ButtonClicked(ByVal Col As Long, ByVal ROW As Long, ByVal ButtonDown As Integer)
    ...
    Dim sAdd_D       As String  '定制配送订单，末尾加字母D  add by lichao 20140709
    Dim sAdd_E       As String  '一批多订单，末尾加字母P  add by lichao 20150317
    Dim sAdd_F       As String  '异常坯，末尾加字母X  add by lichao 20150317
    Dim sAdd_G       As String  '是否切边加M
