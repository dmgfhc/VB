   ...
   Begin Threed.SSFrame SSFrame2 
      ...
      Begin VB.Frame Frame3 
         ...
         Begin InDate.ULabel ULabel28 
            ...
            EndProperty
         End
         Begin CSTextLibCtl.sidbEdit cal_thk 
            Height          =   315
            Left            =   9630
            TabIndex        =   53
            Tag             =   "理论调头厚度1"
         ...
         Begin InDate.ULabel ULabel10 
            ...
            EndProperty
         End
         Begin CSTextLibCtl.sidbEdit cal_thk2 
            Height          =   315
            Left            =   9630
            TabIndex        =   63
            Tag             =   "理论调头厚度2"
      ...
      Begin FPSpread.vaSpread ss1 
         ...
         SpreadDesigner  =   "CGC2000C.frx":0000
      End
      ...
      Begin TabDlg.SSTab tab1 
         ...
         BackColor       =   14737632
         TabCaption(0)   =   "粗轧制等待"
         TabPicture(0)   =   "CGC2000C.frx":19BE
         ...
         Begin SSSplitter.SSSplitter SSSplitter1 
            ...
            Begin FPSpread.vaSpread ss2 
               ...
               MaxRows         =   1
               RetainSelBlock  =   0   'False
               SpreadDesigner  =   "CGC2000C.frx":1A48
            End
            Begin FPSpread.vaSpread ss4 
               ...
               MaxRows         =   9
               RetainSelBlock  =   0   'False
               SpreadDesigner  =   "CGC2000C.frx":275A
            End
         End
         Begin FPSpread.vaSpread vaSpread1 
            ...
            MaxCols         =   10
            RetainSelBlock  =   0   'False
            SpreadDesigner  =   "CGC2000C.frx":2B72
         End
         Begin FPSpread.vaSpread vaSpread2 
            ...
            MaxCols         =   10
            RetainSelBlock  =   0   'False
            SpreadDesigner  =   "CGC2000C.frx":4661
         End
         Begin FPSpread.vaSpread ss3 
            ...
            MaxRows         =   1
            RetainSelBlock  =   0   'False
            SpreadDesigner  =   "CGC2000C.frx":6150
         End
      ...
      Begin InDate.ULabel ULabel11 
         ...
         EndProperty
      End
      Begin CSTextLibCtl.sidbEdit txt_ORD_LEN_MIN 
         Height          =   315
         Left            =   12900
         TabIndex        =   69
         Tag             =   "平均宽度"
         ...
         Data            =   0
      End
      Begin CSTextLibCtl.sidbEdit txt_ORD_LEN_MAX 
         Height          =   315
         Left            =   14250
         TabIndex        =   70
         Tag             =   "平均厚度"
...
Const SS2_SLAB_NO = 1
Const SS2_UST_FL = 14       '是否探伤  add by liqian 2013-04-08
Const SS2_DEL_TO_DATE = 25  '超交货期用红色显示 add by liqian 2012-06-11
Const SS2_URGNT_FL = 26     '紧急订单绿色显示 add by liqian 2012-08-15
Const SS2_FLAG = 27
Const SS2_EXPORT = 28
Const SS2_ORD_CNT = 29
...
Private Sub Form_Define()
    ...
    Call Gp_Ms_Collection(SDB_CR_STAGE3_TEMP, " ", " ", " ", "i", "r", " ", " ", pControl1, nControl1, mControl1, iControl1, rControl1, aControl1, lControl1)
     ...
     Call Gp_Ms_Collection(TXT_MILL_END_TIME, " ", "n", " ", "i", "r", " ", " ", pControl1, nControl1, mControl1, iControl1, rControl1, aControl1, lControl1)
       ...
       Call Gp_Ms_Collection(txt_Roll_Stlgrd, " ", " ", " ", " ", "r", " ", " ", pControl1, nControl1, mControl1, iControl1, rControl1, aControl1, lControl1)
               Call Gp_Ms_Collection(cal_thk, " ", " ", " ", " ", "r", " ", "l", pControl1, nControl1, mControl1, iControl1, rControl1, aControl1, lControl1)
              Call Gp_Ms_Collection(cal_thk2, " ", " ", " ", " ", "r", " ", "l", pControl1, nControl1, mControl1, iControl1, rControl1, aControl1, lControl1)
       Call Gp_Ms_Collection(txt_ORD_LEN_MIN, " ", " ", " ", " ", "r", " ", "l", pControl1, nControl1, mControl1, iControl1, rControl1, aControl1, lControl1)
       Call Gp_Ms_Collection(txt_ORD_LEN_MAX, " ", " ", " ", " ", "r", " ", "l", pControl1, nControl1, mControl1, iControl1, rControl1, aControl1, lControl1)
    
    'MASTER Collection
     Mc1.Add Item:="CGC2000C.P_MODIFY1", Key:="P-M"
     Mc1.Add Item:="CGC2000C.P_SEFER1", Key:="P-R"
   ...
   'Spread_Collection
    ...
    sc1.Add Item:="CGC2000C.P_REFER1", Key:="P-R"
   ...
   Call Gp_Sp_Collection(ss2, 12, " ", " ", " ", " ", " ", "l", pColumn2, nColumn2, mColumn2, iColumn2, aColumn2, lColumn2) '定尺类别 add by liqian 2012-06-11
   Call Gp_Sp_Collection(ss2, 13, " ", " ", " ", " ", " ", "l", pColumn2, nColumn2, mColumn2, iColumn2, aColumn2, lColumn2) '是否探伤 add by liqian 2013-04-08
   ...
   Call Gp_Sp_Collection(ss2, 18, " ", " ", " ", " ", " ", "l", pColumn2, nColumn2, mColumn2, iColumn2, aColumn2, lColumn2) '订单号 add by liqian 2012-06-11
   Call Gp_Sp_Collection(ss2, 19, " ", " ", " ", " ", " ", "l", pColumn2, nColumn2, mColumn2, iColumn2, aColumn2, lColumn2) '序列号 add by liqian 2012-06-11
   ...
   Call Gp_Sp_Collection(ss2, 28, " ", " ", " ", " ", " ", "l", pColumn2, nColumn2, mColumn2, iColumn2, aColumn2, lColumn2) '订单数量 20150119
   Call Gp_Sp_Collection(ss2, 29, " ", " ", " ", " ", " ", "l", pColumn2, nColumn2, mColumn2, iColumn2, aColumn2, lColumn2) '订单数量 20150119
   Call Gp_Sp_Collection(ss2, 30, " ", " ", " ", " ", " ", "l", pColumn2, nColumn2, mColumn2, iColumn2, aColumn2, lColumn2) '订单数量 20150119
   ...
   'Spread_Collection
    ...
    sc2.Add Item:="CGC2000C.P_REFER2", Key:="P-R"
   ...
   'Spread_Collection
    ...
    sc4.Add Item:="CGC2000C.P_REFER4", Key:="P-R"
    ...
    Proc_Sc.Add Item:=sc1, Key:="Sc"
       ...
       Call Gp_Ms_Collection(txt_RollingSize, " ", " ", " ", " ", "r", " ", "l", pControl4, nControl4, mControl4, iControl4, rControl4, aControl4, lControl4)
            ...
            Call Gp_Ms_Collection(txt_TrimFl, " ", " ", " ", " ", "r", " ", " ", pControl4, nControl4, mControl4, iControl4, rControl4, aControl4, lControl4)
    ...
    Call Gp_Ms_Collection(SDB_CR_STAGE3_TEMP, " ", " ", " ", " ", "r", " ", " ", pControl4, nControl4, mControl4, iControl4, rControl4, aControl4, lControl4)
     ...
     Call Gp_Ms_Collection(TXT_MILL_END_TIME, " ", "n", " ", " ", "r", " ", " ", pControl4, nControl4, mControl4, iControl4, rControl4, aControl4, lControl4)
       ...
       Call Gp_Ms_Collection(txt_Roll_Stlgrd, " ", " ", " ", " ", "r", " ", "l", pControl4, nControl4, mControl4, iControl4, rControl4, aControl4, lControl4)
               Call Gp_Ms_Collection(cal_thk, " ", " ", " ", " ", "r", " ", "l", pControl4, nControl4, mControl4, iControl4, rControl4, aControl4, lControl4)
              Call Gp_Ms_Collection(cal_thk2, " ", " ", " ", " ", "r", " ", "l", pControl4, nControl4, mControl4, iControl4, rControl4, aControl4, lControl4)
       Call Gp_Ms_Collection(txt_ORD_LEN_MIN, " ", " ", " ", " ", "r", " ", "l", pControl4, nControl4, mControl4, iControl4, rControl4, aControl4, lControl4)
       Call Gp_Ms_Collection(txt_ORD_LEN_MAX, " ", " ", " ", " ", "r", " ", "l", pControl4, nControl4, mControl4, iControl4, rControl4, aControl4, lControl4)
   
   'MASTER Collection
    Mc4.Add Item:="CGC2000C.P_SEFER2", Key:="P-R"
...
If Not Gf_MessConfirm("您确定板坯号 " & txt_SlabNo.Text & " 仅通过粗轧机吗？", "W", "") Then
   Exit Sub
End If
...
'    End If
    ...
    sQuery = "{call CGc2000C.P_PASS('" & Trim(txt_SlabNo.Text) & "','" & TXT_CB & "',?,?)}"
...
Public Sub Form_Ref()
    ...
    ElseIf Tab1.Tab = 1 Then
        ...
        If ss3.Text <> "" Then
            ...
            If Gf_Ms_Refer(M_CN1, Mc4, , , False) And Gf_Sp_Refer(M_CN1, sc1, Mc2, Mc2("nControl"), Mc2("mControl"), False) Then
            End If
