...
Const SS1_URGNT_FL = 25  'Add by LiQian at 2012-08-30 是否紧急订单
...
Private Sub Form_Define()
    ...
    Call Gp_Sp_Collection(ss1, 2, " ", " ", " ", " ", " ", " ", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)   '坯料类别
   ...
   Call Gp_Sp_Collection(ss1, 25, " ", " ", " ", " ", " ", " ", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1) 'Add by LiQian at 2012-08-30 是否紧急订单
...
Public Sub Form_Pro()
    ...
    'ADD BY YIDUJUN AT 2010-12-21 检查子板坯号，为负则提示错误
        For i = 1 To ss2.MaxRows
            ...
            If ss2.Value < 0 Then
                ss2.Col = 1
                MsgBox "请确认子板坯号 " + ss2.Text + " 的重量", vbCritical, "错误提示"
                Exit Sub
            End If
...
Public Sub Form_Ref()
    ...
    ElseIf SSTab1.Tab = 1 Then
        ...
        If txt_Status.Text = "2" Then
             Call Gp_MsgBoxDisplay("请正确选择处理分类", "I")
        Exit Sub
        End If
