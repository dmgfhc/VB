...
'-- Program Name      HOT SHEAR 作业实绩查询及修改界面
'-- Program ID        CGC2060C
...
Const SS1_URGNT_FL = 20  '紧急订单绿色标记显示 add by liqian 2012-08-16
...
Private Sub Form_Define()
 ...
 Call Gp_Ms_Collection(SDB_MOTHER_PLATE_LEN6, " ", " ", " ", "i", "r", " ", " ", pControl1, nControl1, mControl1, iControl1, rControl1, aControl1, lControl1)
   ...
   Call Gp_Sp_Collection(ss1, 17, " ", " ", " ", " ", " ", "", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)   '紧急订单绿色标记显示 add by liqian 2012-08-16
   ...
   Call Gp_Sp_Collection(ss1, 23, " ", " ", " ", " ", " ", "", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1) '坯料类别
   Call Gp_Sp_Collection(ss1, 24, " ", " ", " ", " ", " ", "", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1) '坯料类别
   Call Gp_Sp_Collection(ss1, 25, " ", " ", " ", " ", " ", "", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1) '坯料类别
   Call Gp_Sp_Collection(ss1, 26, " ", " ", " ", " ", " ", "", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1) '坯料类别
   Call Gp_Sp_Collection(ss1, 27, " ", " ", " ", " ", " ", "", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1) '坯料类别
...
If Not Gf_MessConfirm("您确定要对母板号 " & txt_RollingNo.Text & " 做废钢处理吗？", "W", "") Then
   Exit Sub
End If
    ...
    Else
        Call Gp_MsgBoxDisplay("废钢处理成功=> " & Trim(txt_RollingNo.Text), "I", "系统提示信息")
    End If
...
If Not Gf_MessConfirm("您确定要初始化当前分段号吗？", "W", "") Then
