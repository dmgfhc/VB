...
Const SS3_REMARK = 16  'Add by liqian at 2012-03-05
Const SS3_INS_EMP = 17 'Add by liqian at 2012-03-05
...
Private Sub Cmd_Ok_Click()
    ...
    If TXT_SS.Text = "ss2" Then
        
        iDR = 0
        iXCnt = 0
        iXrow = 4
        
        If CStr(xlSheet.Cells(iXrow, 2)) = "" Then
            Call Gp_MsgBoxDisplay("上传的计划单没有内容，请确认", "I")
            Set xlSheet = Nothing
    ...
    For iRow = 1 To iXCnt
        ...
        Else
            With CGG2040C.ss3
                ...
                Next iCol
                'modify by liqian at 2012-03-05
                .Col = SS3_INS_EMP:     .Text = sUserID   'INS_EMP
            End With
        End If
