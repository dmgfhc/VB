...
Begin VB.Form CGA3000C 
   Caption         =   "板坯检验录入界面_CGA3000C"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   13155
   ...
   Begin Threed.SSFrame Frame1 
      ...
      Begin VB.ComboBox CBO_SHIFT 
         Height          =   300
         ItemData        =   "CGA3000C.frx":0000
         Left            =   12510
         List            =   "CGA3000C.frx":0002
         TabIndex        =   11
         Tag             =   "班次"
         Top             =   120
         Width           =   645
      ...
      Begin InDate.ULabel ULabel13 
         ...
         EndProperty
      End
      Begin InDate.UDate txt_CUT_TS2 
         Height          =   315
         Left            =   10140
         TabIndex        =   12
         Tag             =   "起始日期"
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "CGA3000C.frx":0004
      VisibleCols     =   1
   End
End
Attribute VB_Name = "CGA3000C"
...
Private Sub Form_Define()
    ...
    'Call Master_Collection("Control_Name", "p(primary)", "n(Necessary)", "m(maxlength)", "i(insert)", "r(refer)", "a(append)", "l(lock)")
      ...
      Call Gp_Ms_Collection(txt_OCCR_TS2, "p", " ", " ", " ", "r", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
        Call Gp_Ms_Collection(txt_CUT_TS, "p", " ", " ", " ", "r", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
       Call Gp_Ms_Collection(txt_CUT_TS2, "p", " ", " ", " ", "r", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
          Call Gp_Ms_Collection(TXT_FLAG, "p", " ", " ", " ", " ", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
...
'---------------------------------------------------------------------------------------------------------------------------------------------------------------
   ...
   Call Gp_Sp_Collection(ss1, 21, " ", " ", " ", " ", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    sc1.Add Item:="CGA3000C.P_SMODIFY", Key:="P-M"
    sc1.Add Item:="CGA3000C.P_SREFER", Key:="P-R"
    sc1.Add Item:="CGA3000C.P_SONEROW", Key:="P-O"
...
Dim sMesg As String
   ...
   If (txt_OCCR_TS.RawData <> "" Or txt_OCCR_TS2.RawData <> "") And (txt_CUT_TS.RawData <> "" Or txt_CUT_TS2.RawData <> "") Then

       sMesg = " 转库日期和切割日期不能同时输入 ！！！"
   ...
   If (txt_OCCR_TS.RawData = "" Or txt_OCCR_TS2.RawData = "") And (txt_CUT_TS.RawData = "" Or txt_CUT_TS2.RawData = "") And txt_slab_no.Text = "" And CBO_SHIFT.Text = "" Then
   ...
   End If
    ...
    If Gf_Sp_Refer(M_CN1, Proc_Sc("Sc"), Mc1, Mc1("nControl"), Mc1("mControl")) Then
        ...
        ElseIf TXT_FLAG = "2" Then
           ...
           MDIMain.MenuTool.Buttons(3).Enabled = False
           MDIMain.MenuTool.Buttons(7).Enabled = False
        End If
...
Private Sub OPT_SCRAP_WAIT_Click(Value As Integer)
    ...
    txt_CUT_TS.Enabled = True
    txt_CUT_TS2.Enabled = True
...
Private Sub OPT_SCRAP_Click(Value As Integer)
    ...
    txt_CUT_TS.RawData = ""
    txt_CUT_TS2.RawData = ""
    txt_CUT_TS.Enabled = False
    txt_CUT_TS2.Enabled = False
    
    OPT_SCRAP_WAIT.ForeColor = &H808080
    OPT_SCRAP.ForeColor = &HFF&
    TXT_FLAG.Text = "2"
    ss1.MaxRows = 0
    ULabel3.Caption = "检验日期"
End Sub
