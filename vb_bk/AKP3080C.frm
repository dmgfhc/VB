   ...
   Begin SSSplitter.SSSplitter SSP 
      ...
      Begin Threed.SSFrame Single 
         ...
         Begin VB.ComboBox CBO_SHIFT 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "AKP3080C.frx":0112
            Left            =   6345
            List            =   "AKP3080C.frx":011F
            TabIndex        =   8
            Tag             =   "班次"
            Top             =   120
            Width           =   735
      ...
      Begin FPSpread.vaSpread ss1 
         ...
         SpreadDesigner  =   "AKP3080C.frx":012F
      End
      Begin FPSpread.vaSpread ss2 
         ...
         Protect         =   0   'False
         RetainSelBlock  =   0   'False
         SpreadDesigner  =   "AKP3080C.frx":114F
      End
   End
End
Attribute VB_Name = "AKP3080C"
...
Private Sub Form_Define()
   ...
   Call Gp_Ms_Collection(txt_commect(4), " ", " ", " ", "i", "r", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
    ...
    'MASTER Collection
    Mc1.Add Item:="AKP3080C.P_MODIFY", Key:="P-M"
    Mc1.Add Item:="AKP3080C.P_REFER", Key:="P-R"
   ...
   Call Gp_Sp_Collection(ss1, 25, " ", " ", " ", "i", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    Sc1.Add Item:="AKP3080C.P_SREFER", Key:="P-R"
    Sc1.Add Item:="AKP3080C.P_SMODIFY", Key:="P-M"
...
Private Sub Cmd_Edit_Click()
    ...
    sQuery = "{call AKP3080P ('" + Trim(Format(txt_DATE.Text, "YYYYMMDD")) + "','" + Trim(CBO_SHIFT.Text) + "',?)}"
