...
Begin VB.Form CEA1160C 
   Caption         =   "头尾放尺长度标准_CEA1160C"
   ClientHeight    =   9180
   ClientLeft      =   855
   ClientTop       =   3180
   ClientWidth     =   13965
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "CEA1160C.frx":0000
   End
End
Attribute VB_Name = "CEA1160C"
...
Private Sub Form_Define()
    ...
    Call Gp_Sp_Collection(ss1, 11, "p", " ", " ", "i", " ", " ", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    sc1.Add Item:="CEA1160C.P_MODIFY", Key:="P-M"
    sc1.Add Item:="CEA1160C.P_REFER", Key:="P-R"
    sc1.Add Item:="CEA1160C.P_ONEROW", Key:="P-O"
    ...
    Call Gp_Sp_ColHidden(ss1, SS1_USER, True)
...
Public Sub Form_Ins()
    ...
    Call Gp_Sp_InAuthority(Proc_Sc("Sc"), SS1_USER)
...
Private Sub ss1_LeaveCell(ByVal Col As Long, ByVal Row As Long, ByVal NewCol As Long, ByVal NewRow As Long, Cancel As Boolean)
    ...
    Dim i, j As Integer
    Dim size(1 To 5) As Long
    Dim ins_size(1 To 5) As Long
