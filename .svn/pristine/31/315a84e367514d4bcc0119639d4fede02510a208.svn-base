...
Begin VB.Form AEA2012C 
   Caption         =   "录入轧辊单位编制量标准_AEA2012C"
   ClientHeight    =   8415
   ClientLeft      =   315
   ClientTop       =   1815
   ClientWidth     =   15225
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "AEA2012C.frx":0000
   End
End
Attribute VB_Name = "AEA2012C"
...
Private Sub Form_Define()
    ...
    Sc1.Add Item:="AEA2012C.P_MODIFY", Key:="P-M"
    Sc1.Add Item:="AEA2012C.P_REFER", Key:="P-R"
    Sc1.Add Item:="AEA2012C.P_ONEROW", Key:="P-O"
