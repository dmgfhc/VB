...
Begin VB.Form AAA1160C 
   ...
   Begin VB.ComboBox txt_prod_cd 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "AAA1160C.frx":0000
      Left            =   4200
      List            =   "AAA1160C.frx":0002
      TabIndex        =   2
      Tag             =   "产品代码"
      Top             =   135
      Width           =   870
   ...
   Begin VB.ComboBox cbo_plt 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "AAA1160C.frx":0004
      Left            =   1470
      List            =   "AAA1160C.frx":0006
      TabIndex        =   1
      Tag             =   "工厂"
      Top             =   135
      Width           =   870
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "AAA1160C.frx":0008
   End
...
'-- Program Name      CCM LINE STANDARD
'-- Program ID        AAA1160C
'-- Designer          GUOLI
'-- Coder             GUOLI
'-- Date              2009.6.9
...
'---------------------------------------------------------------------------------------------------------------------------------------------------------------
   ...
   Call Gp_Sp_Collection(ss1, 11, " ", " ", " ", "i", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    Sc1.Add Item:="AAA1160C.P_SMODIFY", Key:="P-M"
    Sc1.Add Item:="AAA1160C.P_SREFER", Key:="P-R"
    Sc1.Add Item:="AAA1160C.P_SONEROW", Key:="P-O"
...
Dim sThkGrp As String
    ss1.Row = Row

If Col = 3 Then
    ss1.Col = Col
    sThkGrp = ss1.Text
    sQuery = "SELECT FR_THK || '~' || TO_THK FROM BP_THICK_GRP WHERE PROD_CD = 'SL' and THK_CD = '" + sThkGrp + "'  "
    ...
    If ss1.ActiveCol = 3 Or ss1.ActiveCol = 5 Or ss1.ActiveCol = 7 Then
        ...
        If KeyCode = vbKeyF4 Then
           ...
           If ss1.ActiveCol = 3 Then
              Call Pf_Common_DD(M_CN1, KeyCode, "SL", "T")
           End If
