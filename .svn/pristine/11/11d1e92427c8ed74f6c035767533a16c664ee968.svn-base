...
Begin VB.Form AFL2102C 
   Caption         =   "余坯消化报表_AFL2102C"
   ClientHeight    =   3030
   ClientLeft      =   120
   ClientTop       =   450
   ClientWidth     =   4560
   ...
   Begin SSSplitter.SSSplitter SSSplitter1 
      ...
      Begin Threed.SSPanel SSPanel1 
         ...
         Begin VB.ComboBox txt_proc_cd 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "AFL2102C.frx":0052
            Left            =   10470
            List            =   "AFL2102C.frx":0054
      ...
      Begin FPSpread.vaSpread ss1 
         ...
         ProcessTab      =   -1  'True
         Protect         =   0   'False
         SpreadDesigner  =   "AFL2102C.frx":0056
      End
   End
End
Attribute VB_Name = "AFL2102C"
...
'---------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    sc1.Add Item:="AFL2102C.P_SREFER", Key:="P-R"
    sc1.Add Item:="AFL2102C.P_SMODIFY", Key:="P-M"
    sc1.Add Item:="AFL2102C.P_ONEROW", Key:="P-O"
...
Private Sub Form_Load()
    ...
    Call Form_Define
    txt_proc_cd.AddItem " "
    txt_proc_cd.AddItem "CAA"
    txt_proc_cd.AddItem "CAB"
    txt_proc_cd.AddItem "CAC"
    txt_proc_cd.AddItem "CAD"
...
Private Sub txt_stlgrd_Change()
    ...
    If Len(Trim(txt_stlgrd.Text)) = 0 Then txt_act_stlgrd_dec.Text = ""
