...
Begin VB.Form AKN2080C 
   Caption         =   "高炉铁水实绩界面_AKN2080C"
   ClientHeight    =   3030
   ClientLeft      =   120
   ClientTop       =   450
   ClientWidth     =   4560
   ...
   Begin VB.ComboBox cbo_group 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "AKN2080C.frx":0000
      Left            =   7250
      List            =   "AKN2080C.frx":0002
      TabIndex        =   2
      Tag             =   "班别"
      Top             =   120
      Width           =   780
   ...
   Begin VB.ComboBox cbo_shift 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "AKN2080C.frx":0004
      Left            =   4455
      List            =   "AKN2080C.frx":0006
      TabIndex        =   1
      Tag             =   "班次"
      Top             =   120
      Width           =   840
   ...
   Begin VB.ComboBox cbo_bf_plant 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "AKN2080C.frx":0008
      Left            =   1590
      List            =   "AKN2080C.frx":0021
      TabIndex        =   0
      Tag             =   "高炉代码"
      Top             =   120
      Width           =   855
   ...
   Begin FPSpread.vaSpread SS1 
      ...
      SpreadDesigner  =   "AKN2080C.frx":003A
   End
...
Private Sub Form_Define()
   ...
   Call Gp_Sp_Collection(ss1, 15, " ", "n", " ", " ", "a", " ", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    sc1.Add Item:="AKN2080C.P_REFER", Key:="P-R"
    sc1.Add Item:="AKN2080C.P_ONEROW", Key:="P-O"
