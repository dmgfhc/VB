...
Begin VB.Form AKP4010C 
   ...
   Begin VB.TextBox TXT_STLGRD 
      ...
      Width           =   2505
   End
   Begin VB.ComboBox CBO_STL_GROUP 
      Height          =   300
      ItemData        =   "AKP4010C.frx":0000
      Left            =   3510
      List            =   "AKP4010C.frx":002B
      TabIndex        =   2
      Top             =   60
      Width           =   1095
   End
   Begin VB.ComboBox CBO_PLT 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "AKP4010C.frx":0063
      Left            =   1245
      List            =   "AKP4010C.frx":006A
      TabIndex        =   0
      Text            =   "C1"
      Top             =   60
      Width           =   690
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "AKP4010C.frx":0072
   End
...
Private Sub Form_Define()
    ...
    'Call Master_Collection("Control_Name", "p(primary)", "n(Necessary)", "m(maxlength)", "i(insert)", "r(refer)", "a(append)", "l(lock)")
     ...
     Call Gp_Ms_Collection(CBO_STL_GROUP, "p", " ", " ", " ", " ", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
   ...
   Call Gp_Sp_Collection(ss1, 10, " ", " ", " ", "i", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    sc1.Add Item:="AKP4010C.P_MODIFY", Key:="P-M"
    sc1.Add Item:="AKP4010C.P_SREFER", Key:="P-R"
    sc1.Add Item:="AKP4010C.P_ONEROW", Key:="P-O"
