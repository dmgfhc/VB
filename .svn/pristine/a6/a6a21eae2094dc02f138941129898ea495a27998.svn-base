...
Begin VB.Form AKH1030C 
   ...
   Begin VB.ComboBox CBO_ALL_NO1 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "AKH1030C.frx":0000
      Left            =   6270
      List            =   "AKH1030C.frx":0002
      TabIndex        =   15
      Tag             =   "ROLL_NO"
      Top             =   4800
      Width           =   1965
   ...
   Begin VB.ComboBox CBO_ALL_NO 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "AKH1030C.frx":0004
      Left            =   5670
      List            =   "AKH1030C.frx":0006
      TabIndex        =   2
      Tag             =   "ROLL_NO"
      Top             =   120
      Width           =   1965
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "AKH1030C.frx":0008
   End
   ...
   Begin FPSpread.vaSpread ss2 
      ...
      MaxRows         =   31
      RetainSelBlock  =   0   'False
      SpreadDesigner  =   "AKH1030C.frx":0AE8
   End
...
'Dim Sc3 As New Collection           'Spread Collection
  ...
  Private Sub Form_Define()
   ...
   Call Gp_Sp_Collection(ss1, 15, " ", " ", " ", " ", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    sc1.Add Item:="AKH1030C.P_MODIFY", Key:="P-M"
    sc1.Add Item:="AKH1030C.P_REFER", Key:="P-R"
'    sc1.Add Item:="AKH1020C.P_ONEROW", Key:="P-O"
   ...
   Call Gp_Sp_Collection(ss2, 10, " ", " ", " ", "i", " ", " ", pColumn2, nColumn2, mColumn2, iColumn2, aColumn2, lColumn2)
    ...
    sc2.Add Item:="AKH1030C.P_REFER1", Key:="P-R"
    sc2.Add Item:="AKH1030C.P_MODIFY1", Key:="P-M"
                                ...
                                Else
                                    ...
                                    ss1.Col = ss1.ActiveCol
                                     ...
                                     If Len(Trim(ss1.Text)) = 4 Then
                                            ...
                                            sTemp_Code = ss1.Text
                                            ss1.Col = 2
                                            ss1.Text = Gf_ComnNameFind(M_CN1, "F0048", Trim(sTemp_Code), 2)
                                     Else
                                            ss1.Col = 2
                                            ss1.Text = ""
                                     End If
...
Private Sub txt_all_cd_KeyUp(KeyCode As Integer, Shift As Integer)
    ...
    Else
        ...
        If Len(Trim(txt_all_cd.Text)) = txt_all_cd.MaxLength Then
            txt_all_name.Text = Gf_ComnNameFind(M_CN1, "F0048", txt_all_cd.Text, 2)
        Else
            txt_all_name.Text = ""
        End If
    End If
...
Private Sub test_all_cd_KeyUp(KeyCode As Integer, Shift As Integer)
    ...
    Else
        ...
        If Len(Trim(test_all_cd.Text)) = test_all_cd.MaxLength Then
            test_all_name.Text = Gf_ComnNameFind(M_CN1, "F0048", test_all_cd.Text, 2)
        Else
            test_all_name.Text = ""
        End If
    End If
            ...
            Else
                ...
                ss2.Col = ss2.ActiveCol
                 ...
                 If Len(Trim(ss2.Text)) = 4 Then
                   ...
                   sTemp_Code = ss2.Text
                   ss2.Col = 2
                   ss2.Text = Gf_ComnNameFind(M_CN1, "F0048", Trim(sTemp_Code), 2)
                Else
                       ss2.Col = 2
                       ss2.Text = ""
                End If
