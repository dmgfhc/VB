...
Begin VB.Form AZC1020C 
   Caption         =   "权限管理_AZC1020C"
   ClientHeight    =   7620
   ClientLeft      =   195
   ClientTop       =   2490
   ClientWidth     =   13605
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "AZC1020C.frx":0000
   End
...
Private Sub Form_Define()
    ...
    'Call Master_Collection("Control_Name", "p(primary)", "n(Necessary)", "m(maxlength)", "i(insert)", "r(refer)", "a(append)", "l(lock)")
      Call Gp_Ms_Collection(txt_emp_id, "p", " ", " ", " ", "r", " ", "l", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
    Call Gp_Ms_Collection(txt_emp_name, "p", " ", " ", " ", "r", " ", "l", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
    ...
    Call Gp_Sp_Collection(ss1, 4, "p", "n", "m", "i", " ", " ", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    Call Gp_Sp_Collection(ss1, 5, "p", "n", " ", " ", " ", " ", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
   ...
   Call Gp_Sp_Collection(ss1, 13, " ", " ", " ", " ", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    Sc1.Add Item:="AZC1020C.P_MODIFY", Key:="P-M"
    Sc1.Add Item:="AZC1020C.P_REFER", Key:="P-R"
    Sc1.Add Item:="AZC1020C.P_ONEROW", Key:="P-O"
...
Private Sub Form_Load()
    ...
    Call Gp_Sp_HdColColor(Sc1.Item("Spread"), 4)
    ...
    Select Case ss1.ActiveCol
        ...
        Case 4
            ...
            If KeyCode = vbKeyF4 Then
                ...
                Call Gf_PgmID_DD(M_CN1, KeyCode)
            ...
            Else
                ...
                If Len(Trim(ss1.Text)) = ss1.TypeMaxEditLen Then
                    sTemp_Code = ss1.Text
                    ss1.Col = 5
                    ss1.Text = Gf_PgmNameFind(M_CN1, Trim(sTemp_Code))
                Else
                    ss1.Col = 5
                    ss1.Text = ""
                End If
