...
Begin VB.Form AHD0540C 
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      ProcessTab      =   -1  'True
      Protect         =   0   'False
      SpreadDesigner  =   "AHD0540C.frx":0000
   End
...
'-------------------------------------------------------------------------------
'-- System Name       发货管理
'-- Sub_System Name   统计报表
'-- Program Name      热处理订单进度跟踪表
'-- Program ID        AHD0540C
...
Private Sub Form_Define()
    ...
    'Call Master_Collection("Control_Name", "p(primary)", "n(Necessary)", "m(maxlength)", "i(insert)", "r(refer)", "a(append)", "l(lock)")
        Call Gp_Ms_Collection(DTP_DATE_FR, "p", " ", " ", " ", " ", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
      Call Gp_Ms_Collection(DTP_DATE, "p", " ", " ", " ", " ", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
    ...
    sc1.Add Item:="AHD0540C.P_REFER", Key:="P-R"
