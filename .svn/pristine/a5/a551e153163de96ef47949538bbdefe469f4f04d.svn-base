...
Begin VB.Form ABA1030C 
   Caption         =   "定单修改查询 - ABA1030C"
   ClientHeight    =   6330
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   18345
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin FPSpread.vaSpread ss1 
         ...
         SpreadDesigner  =   "ABA1030.frx":0000
      End
   End
End
Attribute VB_Name = "ABA1030C"
...
Private Sub Form_Define()
    ...
    'sc1.Add Item:="ABA1030C.P_MODIFY", Key:="P-M"
    sc1.Add Item:="ABA1030C.P_REFER", Key:="P-R"
    'sc1.Add Item:="ABA1030C.P_ONEROW", Key:="P-O"
