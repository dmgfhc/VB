...
Begin VB.Form EGA1070C 
   BackColor       =   &H00E0E0E0&
   Caption         =   "钢板取样信息查询及修改界面_EGA1070C"
   ClientHeight    =   9420
   ClientLeft      =   225
   ClientTop       =   1185
   ClientWidth     =   15240
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.ComboBox CBO_SHIFT 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "EGA1070C.frx":0000
         Left            =   3990
         List            =   "EGA1070C.frx":000D
         TabIndex        =   4
         Top             =   210
         Width           =   705
      End
      ...
      Begin VB.ComboBox CBO_GROUP 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "EGA1070C.frx":001A
         Left            =   3990
         List            =   "EGA1070C.frx":002A
         TabIndex        =   2
         Top             =   600
         Width           =   705
      End
   ...
   Begin SSSplitter.SSSplitter SSSplitter1 
      ...
      Begin FPSpread.vaSpread ss1 
         ...
         SpreadDesigner  =   "EGA1070C.frx":008C
      End
      Begin FPSpread.vaSpread ss2 
         ...
         Protect         =   0   'False
         RetainSelBlock  =   0   'False
         SpreadDesigner  =   "EGA1070C.frx":0904
      End
   End
   Begin VB.Line Line2 
...
Const SS2_CHG_SMP_NO = 31               '改判时试样号
Const SS2_CHG_STDSPEC = 32              '改判时适用标准
...
Private Sub Form_Define()
    ...
    sc1.Add Item:="EGA1070C.P_REFER1", Key:="P-R"
    ...
    sc2.Add Item:="EGA1070C.P_MODIFY", Key:="P-M"
    sc2.Add Item:="EGA1070C.P_REFER2", Key:="P-R"
...
Private Sub Cmd_Set_Save_Click()
    ...
    strQuery = strQuery & "         ,CUR_INV                                                    " & vbCrLf
    strQuery = strQuery & "         ,LOC                                                        " & vbCrLf
    ...
    strQuery = strQuery & "         ,A.CUR_INV                                 CUR_INV          " & vbCrLf
    strQuery = strQuery & "         ,A.LOC                                     LOC              " & vbCrLf
    strQuery = strQuery & "   FROM  GP_PLATE A                                                  " & vbCrLf
