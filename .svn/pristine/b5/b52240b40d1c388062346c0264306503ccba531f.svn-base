...
Begin VB.Form Sheet000 
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "Sheet.frx":0000
   End
End
Attribute VB_Name = "Sheet000"
...
Private Sub Form_Define()
   ...
   Call Gp_Sp_Collection(ss1, 13, " ", " ", " ", "i", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    Sc1.Add Item:="PKG_SHEET.P_MODIFY", Key:="P-M"
    Sc1.Add Item:="PKG_SHEET.P_REFER", Key:="P-R"
    Sc1.Add Item:="PKG_SHEET.P_ONEROW", Key:="P-O"
