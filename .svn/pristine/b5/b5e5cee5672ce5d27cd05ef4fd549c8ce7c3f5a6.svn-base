...
Begin VB.Form AEA1070C 
   Caption         =   "录入母板长度余量标准_AEA1070C"
   ClientHeight    =   7620
   ClientLeft      =   345
   ClientTop       =   2205
   ClientWidth     =   15225
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "AEA1070C.frx":0000
   End
End
Attribute VB_Name = "AEA1070C"
...
Private Sub Form_Define()
    ...
    'Call Master_Collection("Control_Name", "p(primary)", "n(Necessary)", "m(maxlength)", "i(insert)", "r(refer)", "a(append)", "l(lock)")
     ...
     Call Gp_Ms_Collection(txt_APLY_ITEM, "p", "n", " ", " ", "r", "a", "l", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
...
'---------------------------------------------------------------------------------------------------------------------------------------------------------------
   ...
   Call Gp_Sp_Collection(ss1, 11, " ", " ", " ", " ", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    Sc1.Add Item:="AEA1070C.P_MODIFY", Key:="P-M"
    Sc1.Add Item:="AEA1070C.P_REFER", Key:="P-R"
    Sc1.Add Item:="AEA1070C.P_ONEROW", Key:="P-O"
...
Private Sub TXT_APLY_ITEM_KeyUp(KeyCode As Integer, Shift As Integer)
    ...
    End If
        ...
        txt_APLY_ITEM_NAME.Text = Gf_ApplyNameFind(M_CN1, "EP_PLATELEN_M", Trim(txt_APLY_ITEM.Text))
    Else
