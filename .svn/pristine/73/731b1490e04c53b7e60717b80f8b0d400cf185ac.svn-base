...
Begin VB.Form AKB2030C 
   ...
   Begin SSSplitter.SSSplitter Sp1 
      ...
      Begin FPSpread.vaSpread ss4 
         ...
         ProcessTab      =   -1  'True
         Protect         =   0   'False
         SpreadDesigner  =   "AKB2030C.frx":374C
      End
      Begin FPSpread.vaSpread ss3 
         ...
         ProcessTab      =   -1  'True
         Protect         =   0   'False
         SpreadDesigner  =   "AKB2030C.frx":3BB2
      End
      Begin FPSpread.vaSpread ss1 
         ...
         ProcessTab      =   -1  'True
         Protect         =   0   'False
         SpreadDesigner  =   "AKB2030C.frx":4006
      End
   End
   ...
   Begin VB.Image Image1 
      Height          =   585
      Left            =   100
      Picture         =   "AKB2030C.frx":4BA6
      Top             =   135
      Width           =   915
   End
End
Attribute VB_Name = "AKB2030C"
