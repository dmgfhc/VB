...
Begin VB.Form AHD0450C 
   BackColor       =   &H00E0E0E0&
   Caption         =   "厂库别库存收发存报表_AHD0450C"
   ClientHeight    =   3030
   ClientLeft      =   120
   ClientTop       =   450
   ClientWidth     =   4560
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      ProcessTab      =   -1  'True
      Protect         =   0   'False
      SpreadDesigner  =   "AHD0450C.frx":0000
   End
...
Const SPD_BASE_WGT = 6               ' 月初库存
'Const SPD_HOUSING_WGT_D = 7         ' 当日入库重量
Const SPD_HOUSING_WGT = 7            ' 入库重量
'Const SPD_SHIPPING_WGT_D = 9        ' 当日发货重量
Const SPD_SHIPPING_WGT = 8           ' 发货重量
'Const SPD_MOVE_IN_WGT_D = 11        ' 当日转入库重量
Const SPD_MOVE_IN_WGT = 9            ' 转入库重量
'Const SPD_MOVE_OUT_WGT_D = 13       ' 当日转出库重量
Const SPD_MOVE_OUT_WGT = 10          ' 转出库重量
Const SPD_TERM_END_WGT = 11          ' 月末库存
'Const SPD_TERM_END_CNT = 16         ' 月末块数
Const SPD_MOVING_DANG_WGT = 12       ' 转库在途
'Const SPD_MOVING_QIAN_WGT = 18      ' 前月在途
Const SPD_MOVING_GOUMA_WGT = 13      ' 异储在途
'Const SPD_CLAIM_HOUSING_WGT = 20    ' 退货重量
'Const SPD_CLAIM_SHIPPING_WGT = 21   ' 退货发货量
'Const SPD_CLAIM_RTN_WGT = 22        ' 隔月退货退入库
...
Call Gp_Ms_Collection(text_cur_inv_code, "p", "n", " ", " ", "r", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
   ...
   Call Gp_Sp_Collection(ss1, 14, " ", " ", " ", " ", " ", " ", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    sc1.Add Item:="AHD0450C.P_REFER", Key:="P-R"
...
'    Call Gp_Sp_ColHidden(ss1, SPD_HOUSING_WGT_D, True)
'    Call Gp_Sp_ColHidden(ss1, SPD_SHIPPING_WGT_D, True)
'    Call Gp_Sp_ColHidden(ss1, SPD_MOVE_IN_WGT_D, True)
'    Call Gp_Sp_ColHidden(ss1, SPD_MOVE_OUT_WGT_D, True)
'    Call Gp_Sp_ColHidden(ss1, SPD_CLAIM_HOUSING_WGT, True)
'    Call Gp_Sp_ColHidden(ss1, SPD_CLAIM_SHIPPING_WGT, True)
'    Call Gp_Sp_ColHidden(ss1, SPD_CLAIM_RTN_WGT, True)
'    Call Gp_Sp_ColHidden(ss1, SPD_MOVING_QIAN_WGT, True)
...
'    iSumCol.Add Item:=SPD_HOUSING_WGT_D
    iSumCol.Add Item:=SPD_HOUSING_WGT
'    iSumCol.Add Item:=SPD_SHIPPING_WGT_D
    iSumCol.Add Item:=SPD_SHIPPING_WGT
'    iSumCol.Add Item:=SPD_MOVE_IN_WGT_D
    iSumCol.Add Item:=SPD_MOVE_IN_WGT
'    iSumCol.Add Item:=SPD_MOVE_OUT_WGT_D
    iSumCol.Add Item:=SPD_MOVE_OUT_WGT
    iSumCol.Add Item:=SPD_TERM_END_WGT
'    iSumCol.Add Item:=SPD_TERM_END_CNT
    iSumCol.Add Item:=SPD_MOVING_DANG_WGT
'    iSumCol.Add Item:=SPD_MOVING_QIAN_WGT
    iSumCol.Add Item:=SPD_MOVING_GOUMA_WGT
'    iSumCol.Add Item:=SPD_CLAIM_HOUSING_WGT
'    iSumCol.Add Item:=SPD_CLAIM_SHIPPING_WGT
'    iSumCol.Add Item:=SPD_CLAIM_RTN_WGT
