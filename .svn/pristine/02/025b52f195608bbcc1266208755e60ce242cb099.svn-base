...
'    If sForm_Fl = "1" Then
'        txt_cur_inv.Text = "00"
'        Me.Caption = "1号热处理作业对象指示_DED1010C"
'    Else
'        txt_cur_inv.Text = "WD"
'        Me.Caption = "2号热处理作业对象指示_DED1010C"
'    End If
...
Public Sub Form_Ref()
    ...
    If txt_cur_inv.Text <> "00" And txt_cur_inv.Text <> "HB" Then
        Call Gp_MsgBoxDisplay("只堆放仓库 --> '00' / 'HB' ", "I")
        Exit Sub
    End If
