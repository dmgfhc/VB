...
Begin VB.Form AEA2015C 
   Caption         =   "录入轧辊单位调整编制对象除外标准_AEA2015C"
   ClientHeight    =   8415
   ClientLeft      =   420
   ClientTop       =   2340
   ClientWidth     =   15225
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "AEA2015C.frx":0000
   End
End
Attribute VB_Name = "AEA2015C"
...
Private Sub Form_Define()
   ...
   Call Gp_Sp_Collection(ss1, 12, " ", " ", " ", " ", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    Sc1.Add Item:="AEA2015C.P_MODIFY", Key:="P-M"
    Sc1.Add Item:="AEA2015C.P_REFER", Key:="P-R"
    Sc1.Add Item:="AEA2015C.P_ONEROW", Key:="P-O"
    ...
    Select Case ss1.ActiveCol
        ...
        Case 3
            ...
            Else
                ...
                If Trim(ss1.Text) = "" Then
                    ...
                    ss1.Text = ""
                Else
                    sTemp_Code = Gf_ComnNameFind(M_CN1, "B0005", Trim(ss1.Text), 2)
                    ss1.Col = 4
                    ss1.Text = sTemp_Code
                End If
        ...
        Case 7
            ...
            Else
                ...
                Else
                    ss1.Col = 3
                    sTemp_Code = Left(Trim(ss1.Text), 1)
                    ss1.Col = 7
                    sTemp_Code = Gf_UsageNameFind(M_CN1, sTemp_Code, Trim(ss1.Text))
                    ss1.Col = 8
                    ss1.Text = sTemp_Code
                End If
