...
Begin VB.Form AZB1010C 
   Caption         =   "程序列表_AZB1010C"
   ClientHeight    =   5940
   ClientLeft      =   150
   ClientTop       =   3270
   ClientWidth     =   14985
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "AZB1010C.frx":0000
   End
   Begin VB.TextBox txt_pgmname 
      BeginProperty Font 
         Name            =   "宋体"
         Size            =   9.75
         Charset         =   0
...
Private Sub Form_Define()
    ...
    Call Gp_Ms_Collection(txt_biz_area_name, " ", "", "", "", "r", "", "l", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
          Call Gp_Ms_Collection(txt_pgmname, "p", "", "", "", "r", "", "l", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
          Call Gp_Ms_Collection(cbo_pgm_knd, "p", "", "", "", "r", "", "l", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
   ...
   Call Gp_Sp_Collection(ss1, 11, " ", " ", " ", " ", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    Sc1.Add Item:="AZB1010C.P_MODIFY", Key:="P-M"
    Sc1.Add Item:="AZB1010C.P_REFER", Key:="P-R"
    Sc1.Add Item:="AZB1010C.P_ONEROW", Key:="P-O"
    ...
    cbo_pgm_knd.AddItem "Type"
    cbo_pgm_knd.AddItem "Server"
    cbo_pgm_knd.AddItem "Client"
    
    cbo_pgm_knd.ListIndex = 0
...
Private Sub ss1_DblClick(ByVal Col As Long, ByVal Row As Long)
    ...
    If Row < 1 Or Col = 2 Or Col = 4 Or Col = 5 Or Col = 6 Or Col = 7 Then Exit Sub
    ...
    With ss1
        ...
        .Col = 1: AZB1011C.txt_pgm_id.Text = .Text
        .Col = 4: AZB1011C.txt_pgm_name.Text = .Text
