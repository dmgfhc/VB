...
Begin VB.Form CEA1170C 
   Caption         =   "板坯堆冷信息标准_CEA1170C"
   ClientHeight    =   3030
   ClientLeft      =   120
   ClientTop       =   450
   ClientWidth     =   4560
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "CEA1170C.frx":0000
   End
End
Attribute VB_Name = "CEA1170C"
...
Private Sub Form_Define()
    ...
    sc1.Add Item:="CEA1170C.P_MODIFY", Key:="P-M"
    sc1.Add Item:="CEA1170C.P_REFER", Key:="P-R"
    sc1.Add Item:="CEA1170C.P_ONEROW", Key:="P-O"
