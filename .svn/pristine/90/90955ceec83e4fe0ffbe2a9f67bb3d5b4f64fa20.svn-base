   ...
   Begin SSSplitter.SSSplitter SSSplitter2 
      ...
      Begin SSSplitter.SSSplitter SSSplitter3 
         ...
         Begin FPSpread.vaSpread ss2 
            ...
            MaxRows         =   2
            RetainSelBlock  =   0   'False
            SpreadDesigner  =   "EGD1010C.frx":048D
         End
      End
   End
...
Const SS2_HTM_METH = 26               '热处理方法
Const SS2_EMP_CD = 27                 '插入人员
...
Private Sub Form_Define()
    ...
    Call Gp_Ms_Collection(txt_cur_inv_name, " ", "n", " ", " ", " ", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
     ...
     Call Gp_Ms_Collection(sdb_prod_len_to, "p", " ", " ", " ", "r", " ", "l", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
        ...
        Call Gp_Ms_Collection(TXT_PLATE_NO, "p", " ", " ", " ", "r", " ", "l", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
    ...
    Call Gp_Ms_Collection(sdb_prod_len_to, "p", " ", " ", " ", " ", " ", " ", pControl2, nControl2, mControl2, iControl2, rControl2, aControl2, lControl2)
       ...
       Call Gp_Ms_Collection(TXT_PLATE_NO, "p", " ", " ", " ", " ", " ", " ", pControl2, nControl2, mControl2, iControl2, rControl2, aControl2, lControl2)
    ...
    Call Gp_Sp_ColHidden(ss2, SS2_HTM_METH, True)
    Call Gp_Sp_ColHidden(ss2, SS2_EMP_CD, True)
        ...
        For iRow = 1 To ss2.MaxRows
            ...
            If ss2.Text = "" Then
                ...
                Else
                    ss2.Text = "2"
                End If
                ss2.Col = SS2_HTM_METH   'ss2.MaxCols - 1
                ss2.Text = txt_meth.Text
                ss2.Col = SS2_EMP_CD     'ss2.MaxCols
                ss2.Text = sUserID
