...
Begin VB.Form ACB5025C 
   BackColor       =   &H00E0E0E0&
   Caption         =   "半产品装车实绩录入_ACB5025C"
   ClientHeight    =   9225
   ClientLeft      =   315
   ClientTop       =   1800
   ClientWidth     =   15225
   ...
   Begin SSSplitter.SSSplitter SSSplitter1 
      ...
      Begin FPSpread.vaSpread ss1 
         ...
         SpreadDesigner  =   "ACB5025C.frx":0052
      End
   End
...
Private Sub Form_Define()
   ...
   Call Gp_Sp_Collection(ss1, 37, " ", " ", " ", " ", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    sc1.Add Item:="ACB5025C.P_MODIFY", Key:="P-M"
    sc1.Add Item:="ACB5025C.P_SREFER1", Key:="P-R"
    sc1.Add Item:="ACB5025C.P_MODIFY1", Key:="P-L"
