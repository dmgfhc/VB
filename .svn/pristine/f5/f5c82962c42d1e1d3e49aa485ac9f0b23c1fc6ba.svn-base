...
Begin VB.Form ACE6020C 
   Caption         =   "在制品替代处理(订单标准)_ACE6020C"
   ClientHeight    =   9225
   ClientLeft      =   330
   ClientTop       =   2235
   ClientWidth     =   15225
...
Const SS1_FORCE_CD = 26             ' 是否强制替代    24->26
Const SS1_REMARK = 27               ' 替代备注        25->27
Const SS1_ORDER_NO = 28             ' 替代订单        26->28
Const SS1_ORDER_ITEM = 29           ' 替代序列        27->29
Const SS1_USER_ID = 30              ' 替代人          28->30
Const SS1_REASON = 31               ' 备注原因
