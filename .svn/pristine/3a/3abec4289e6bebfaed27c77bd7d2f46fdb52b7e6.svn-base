...
Begin VB.Form CEE1040C 
   Caption         =   "坯料分段切割指示查询_CEE1040C"
   ClientHeight    =   7620
   ClientLeft      =   195
   ClientTop       =   2565
   ClientWidth     =   15135
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "CEE1040C.frx":0000
   End
...
Private Sub Form_Define()
    ...
    Call Gp_Ms_Collection(txt_plt_name, " ", "n", " ", " ", "r", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
     Call Gp_Ms_Collection(dtp_date_fr, "p", "n", "m", " ", "r", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
     Call Gp_Ms_Collection(dtp_date_to, "p", "n", "m", " ", "r", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
    ...
    sc1.Add Item:="CEE1040C.P_REFER", Key:="P-R"
    'Sc1.Add Item:="CEE1040C.P_MODIFY", Key:="P-M"
    'Sc1.Add Item:="CEE1040C.P_ONEROW", Key:="P-O"
