...
Begin VB.Form DED1010C 
   Caption         =   "热处理作业对象指示_DED1010C"
   ClientHeight    =   7620
   ClientLeft      =   225
   ClientTop       =   2580
   ClientWidth     =   14820
   ...
   Begin SSSplitter.SSSplitter SSSplitter2 
      ...
      Begin FPSpread.vaSpread ss1 
         ...
         RowHeaderDisplay=   0
         SpreadDesigner  =   "DED1010C.frx":0052
      End
      Begin SSSplitter.SSSplitter SSSplitter3 
         ...
         Begin FPSpread.vaSpread ss2 
            ...
            MaxRows         =   20
            RetainSelBlock  =   0   'False
            SpreadDesigner  =   "DED1010C.frx":046C
         End
      End
   End
...
Private Sub Form_Define()
    ...
    'Call Master_Collection("Control_Name", "p(primary)", "n(Necessary)", "m(maxlength)", "i(insert)", "r(refer)", "a(append)", "l(lock)")
         Call Gp_Ms_Collection(txt_cur_inv, "p", "n", "m", " ", "r", " ", "l", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
    Call Gp_Ms_Collection(txt_cur_inv_name, " ", "n", " ", " ", "r", " ", "l", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
...
Public Sub Form_Ref()
    ...
    If txt_cur_inv.Text <> "00" And txt_cur_inv.Text <> "WD" Then
        Call Gp_MsgBoxDisplay("只堆放仓库 --> '00' / 'WD'", "I")
        Exit Sub
    End If
