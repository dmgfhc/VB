...
Begin VB.Form AHA0010C 
   Caption         =   "发货能力管理_AHA0010C"
   ClientHeight    =   7650
   ClientLeft      =   1200
   ClientTop       =   2310
   ClientWidth     =   12885
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "AHA0010C.frx":0000
   End
End
Attribute VB_Name = "AHA0010C"
...
Private Sub Form_Define()
    ...
    'Call Master_Collection("Control_Name", "p(primary)", "n(Necessary)", "m(maxlength)", "i(insert)", "r(refer)", "a(append)", "l(lock)")
        Call Gp_Ms_Collection(txt_fac_cd, "p", " ", " ", " ", "r", " ", "l", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
      Call Gp_Ms_Collection(txt_fac_name, " ", " ", " ", " ", "r", " ", "l", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
    ...
    Sc1.Add Item:="AHA0010C.P_MODIFY", Key:="P-M"
    Sc1.Add Item:="AHA0010C.P_REFER", Key:="P-R"
    Sc1.Add Item:="AHA0010C.P_ONEROW", Key:="P-O"
...
'                            sCurr = .Value
'
'                            If sCurr = sfac_cd Then
'
'                                    .Col = Col
'                                    .Row = Row
'                                    .CellTag = "False"
'
'                                    Call Gp_MsgBoxDisplay("代码重复...")
'
'                                    .Col = Col
'                                    .Row = Row
'                                    .CellTag = ""
...
Private Sub txt_fac_cd_KeyUp(KeyCode As Integer, Shift As Integer)
    ...
    If Len(Trim(txt_fac_cd.Text)) = txt_fac_cd.MaxLength Then
        txt_fac_name.Text = Gf_ComnNameFind(M_CN1, "H0001", Trim(txt_fac_cd.Text), 2)
