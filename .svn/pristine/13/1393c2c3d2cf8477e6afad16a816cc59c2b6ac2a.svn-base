...
Begin VB.Form CGF2090C 
   Caption         =   "轧辊堆焊实绩查询及修改界面_CGF2090C"
   ClientHeight    =   3090
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   4680
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "CGF2090C.frx":0000
   End
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin VB.ComboBox CBO_PLT 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "CGF2090C.frx":1B6B
         Left            =   5550
         List            =   "CGF2090C.frx":1B72
         TabIndex        =   5
         Top             =   165
         Width           =   825
      End
      Begin VB.ComboBox CBO_GROUP 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "CGF2090C.frx":1B7A
         Left            =   10080
         List            =   "CGF2090C.frx":1B8A
         TabIndex        =   4
         Top             =   150
         Width           =   735
      End
      Begin VB.ComboBox CBO_SHIFT 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "CGF2090C.frx":1B9A
         Left            =   7860
         List            =   "CGF2090C.frx":1BA7
         TabIndex        =   3
         Top             =   165
         Width           =   735
      End
...
Private Sub Form_Define()
  ...
  Call Gp_Ms_Collection(SDB_AFT_GRID_DIA, " ", " ", " ", "i", "r", " ", "l", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
    ...
    '
    'MASTER Collection
     Mc1.Add Item:="CGF2090C.P_MODIFY", Key:="P-M"
     Mc1.Add Item:="CGF2090C.P_REFER", Key:="P-R"
    ...
    sc1.Add Item:="CGF2090C.P_SREFER", Key:="P-R"
...
'    BEF_GRID = Gf_CodeFind(M_CN1, sQuery2)
    ...
    sQuery1 = "SELECT ROLL_DIA FROM GP_ROLL3 WHERE ROLL_NO = '" & Trim(CBO_ROLL_ID) & "' "
