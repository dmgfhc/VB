...
Begin VB.Form AFP2010C 
   Caption         =   "铁水预处理实绩导出_AFP2010C"
   ClientHeight    =   9225
   ClientLeft      =   375
   ClientTop       =   1980
   ClientWidth     =   15225
   ...
   Begin VB.ComboBox cbo_shift 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "AFP2010C.frx":0000
      Left            =   6015
      List            =   "AFP2010C.frx":0002
   ...
   Begin VB.ComboBox cbo_group 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "AFP2010C.frx":0004
      Left            =   8355
      List            =   "AFP2010C.frx":0006
      Style           =   2  'Dropdown List
      TabIndex        =   3
      Top             =   90
      Width           =   885
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "AFP2010C.frx":0008
   End
...
'---------------------------------------------------------------------------------------------------------------------------------------------------------------
   ...
   Call Gp_Sp_Collection(ss1, 49, " ", " ", " ", " ", " ", " ", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    sc1.Add Item:="AFP2010C.P_SREFER", Key:="P-R"
...
Dim iArrWgt As Double
Dim iDepWgt As Double
...
End If
    ...
    sQuery = "{call AFP2010C.P_SREFER ('" + txt_from_DATE.RawData + "','" + txt_to_DATE.RawData + "','" + Trim(cbo_shift.Text) + "','" + Trim(cbo_group.Text) + "','" + Trim(txt_from_heat.Text) + "','" + Trim(txt_to_heat.Text) + "')}"
