...
Begin VB.Form AGF2020C 
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin VB.ComboBox CBO_SHIFT 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "AGF2020C.frx":0000
         Left            =   7230
         List            =   "AGF2020C.frx":000D
         TabIndex        =   2
         Top             =   240
         Width           =   735
      End
      Begin VB.ComboBox CBO_GROUP 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "AGF2020C.frx":001A
         Left            =   9180
         List            =   "AGF2020C.frx":002A
         TabIndex        =   3
         Top             =   240
         Width           =   735
      End
      Begin VB.ComboBox CBO_PLT 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "AGF2020C.frx":003A
         Left            =   4815
         List            =   "AGF2020C.frx":0044
         TabIndex        =   1
         Top             =   240
         Width           =   735
      End
...
Private Sub Form_Define()
  ...
  Call Gp_Ms_Collection(TXT_UTP_ROLL_DISUSE_TIME, " ", " ", " ", "i", "r", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
       Call Gp_Ms_Collection(SDB_ROLL_DISUSE_DIA, " ", " ", " ", "i", "r", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
...
Call Gp_Ms_Collection(TXT_UTP_P_ROLL_DISUSE_TIME, " ", "n", " ", "i", "r", " ", " ", pControl4, nControl4, mControl4, iControl4, rControl4, aControl4, lControl4)
    ...
    'MASTER Collection
     Mc1.Add Item:="AGF2020C.P_MODIFY1", Key:="P-M"
     Mc1.Add Item:="AGF2020C.P_REFER1", Key:="P-R"
     ...
     Mc2.Add Item:="AGF2020C.P_MODIFY2", Key:="P-M"
     Mc2.Add Item:="AGF2020C.P_REFER2", Key:="P-R"
     ...
     Mc3.Add Item:="AGF2020C.P_MODIFY3", Key:="P-M"
     Mc3.Add Item:="AGF2020C.P_REFER3", Key:="P-R"
     ...
     Mc4.Add Item:="AGF2020C.P_MODIFY4", Key:="P-M"
     Mc4.Add Item:="AGF2020C.P_REFER4", Key:="P-R"
...
Public Sub Form_Pro()
    ...
    Select Case Mid(Trim(CB0_ROLL_ID.Text), 1, 1)
       ...
       Case "R"
          ...
          sMsg = "您确定要报废轧辊" + CB0_ROLL_ID.Text + "吗？"
          If Not Gf_MessConfirm(sMsg, "Q") Then Exit Sub
...
'              Call Gp_Ms_ControlLock(Mc1("pControl"), True)
       ...
       Case "B"
          ...
          sMsg = "您确定要报废轴承" + CB0_ROLL_ID.Text + "吗？"
          If Not Gf_MessConfirm(sMsg, "Q") Then Exit Sub
...
'              Call Gp_Ms_ControlLock(Mc1("pControl"), True)
       ...
       Case "C"
          ...
          sMsg = "您确定要报废轴承座" + CB0_ROLL_ID.Text + "吗？"
          If Not Gf_MessConfirm(sMsg, "Q") Then Exit Sub
          
          If Not Gp_DateCheck(TXT_UTP_B_ROLL_DISUSE_TIME) Then
              sMesg = " 请正确输入轴承座报废时间 ！"
              Call Gp_MsgBoxDisplay(sMesg)
              Exit Sub
          End If
...
'              Call Gp_Ms_ControlLock(Mc1("pControl"), True)
       ...
       Case "P"
          ...
          sMsg = "您确定要报废护板" + CB0_ROLL_ID.Text + "吗？"
          If Not Gf_MessConfirm(sMsg, "Q") Then Exit Sub
