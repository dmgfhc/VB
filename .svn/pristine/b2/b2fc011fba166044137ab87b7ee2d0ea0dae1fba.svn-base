...
Begin VB.Form CEE3010C 
   Caption         =   "精整作业指示查询_CEE3010C"
   ClientHeight    =   7350
   ClientLeft      =   180
   ClientTop       =   2925
   ClientWidth     =   14595
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "CEE3010C.frx":0000
   End
...
Public Sub Form_Ref()
    ...
    sQuery = "{call CEE3010C.P_REFER ('" + txt_plt.Text + "','" + txt_PRC_LINE.Text + "','" + dtp_date.RawData + "')}" '
