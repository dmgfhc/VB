...
Begin VB.Form AGB3011C 
   ...
   Begin SSSplitter.SSSplitter SSSplitter1 
      ...
      Begin SSSplitter.SSSplitter SSSplitter2 
         ...
         Begin FPSpread.vaSpread ss1 
            ...
            SpreadDesigner  =   "AGB3011C.frx":0084
         End
      End
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin VB.ComboBox cbo_plt 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "AGB3011C.frx":08BE
         Left            =   14160
         List            =   "AGB3011C.frx":08C8
         TabIndex        =   6
         Text            =   "C1"
         Top             =   180
         Visible         =   0   'False
...
Private Sub Form_Define()
    ...
    sc1.Add Item:="AGB3010C.P_SREFER2", Key:="P-R"
