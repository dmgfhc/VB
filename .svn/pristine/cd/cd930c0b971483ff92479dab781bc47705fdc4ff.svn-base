...
Begin VB.Form AKE1010C 
   Caption         =   "转炉工艺参数查询界面_AKE1010C"
   ClientHeight    =   3030
   ClientLeft      =   120
   ClientTop       =   450
   ClientWidth     =   4560
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "AKE1010C.frx":0000
   End
   Begin FPSpread.vaSpread ss2 
      ...
      MaxRows         =   3
      RetainSelBlock  =   0   'False
      SpreadDesigner  =   "AKE1010C.frx":046A
   End
   Begin FPSpread.vaSpread ss3 
      ...
      MaxRows         =   3
      RetainSelBlock  =   0   'False
      SpreadDesigner  =   "AKE1010C.frx":090F
   End
...
Private Sub Form_Define()
    ...
    sc1.Add Item:="AKE1010C.P_SREFER1", Key:="P-R"
    ...
    sc2.Add Item:="AKE1010C.P_SREFER2", Key:="P-R"
   ...
   'Spread_Collection
    ...
    Sc3.Add Item:="AKE1010C.P_SREFER3", Key:="P-R"
