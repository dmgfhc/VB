...
Begin VB.Form AGF3040C 
   ...
   Begin VB.ComboBox CBO_ROLL_NO 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "AGF3040C.frx":0000
      Left            =   1200
      List            =   "AGF3040C.frx":0002
      TabIndex        =   0
      Tag             =   "ROLL_NO"
      Top             =   120
      Width           =   1365
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "AGF3040C.frx":0004
   End
...
Dim sc1 As New Collection           'Spread Collection
  ...
  Private Sub Form_Define()
   ...
   Call Gp_Sp_Collection(ss1, 11, " ", " ", " ", "i", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    sc1.Add Item:="AGF3040C.P_MODIFY", Key:="P-M"
    sc1.Add Item:="AGF3040C.P_REFER", Key:="P-R"
    sc1.Add Item:="AGF3040C.P_ONEROW", Key:="P-O"
