...
Begin VB.Form ACB5060C 
   BackColor       =   &H00E0E0E0&
   Caption         =   "产品装火车对象查询及确定装车_ACB5060C"
   ClientHeight    =   7230
   ClientLeft      =   135
   ClientTop       =   2325
   ClientWidth     =   15240
   ...
   Begin VB.TextBox txt_plt 
      ...
      Width           =   375
   End
   Begin VB.TextBox txt_str_plt_name 
      BeginProperty Font 
         Name            =   "宋体"
         Size            =   9.75
         Charset         =   134
   ...
   Begin SSSplitter.SSSplitter SSSplitter1 
      ...
      Begin SSSplitter.SSSplitter SSSplitter2 
         ...
         Begin FPSpread.vaSpread ss1 
            ...
            SpreadDesigner  =   "ACB5060C.frx":00A4
         End
      End
      Begin FPSpread.vaSpread ss2 
         ...
         ProcessTab      =   -1  'True
         RetainSelBlock  =   0   'False
         SpreadDesigner  =   "ACB5060C.frx":0D00
      End
   End
...
Private Sub Form_Define()
    ...
    Call Gp_Ms_Collection(text_size_knd_name_in, " ", " ", " ", " ", "r", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
         ...
         Call Gp_Ms_Collection(txt_htm_ord_name, " ", " ", " ", " ", "r", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
               Call Gp_Ms_Collection(txt_lot_no, "p", " ", " ", " ", "r", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
                  
              Call Gp_Ms_Collection(txt_str_plt, " ", " ", " ", " ", "r", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
         Call Gp_Ms_Collection(txt_str_plt_name, " ", " ", " ", " ", "r", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
    ...
    Call Gp_Ms_Collection(txt_car_no, "p", " ", " ", " ", "r", " ", " ", pControl2, nControl2, mControl2, iControl2, rControl2, aControl2, lControl2)
    ...
    Call Gp_Sp_Collection(ss1, 6, " ", " ", " ", " ", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1, False)
    Call Gp_Sp_Collection(ss1, 7, " ", " ", " ", " ", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1, False)
   ...
   Call Gp_Sp_Collection(ss1, 32, " ", " ", " ", " ", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    sc1.Add Item:="ACB5060C.P_MODIFY1", Key:="P-M"
    sc1.Add Item:="ACB5060C.P_SREFER1", Key:="P-R"
    ...
    Call Gp_Sp_Collection(ss2, 6, " ", " ", " ", " ", " ", "l", pColumn2, nColumn2, mColumn2, iColumn2, aColumn2, lColumn2, False)
    Call Gp_Sp_Collection(ss2, 7, " ", " ", " ", "i", " ", "l", pColumn2, nColumn2, mColumn2, iColumn2, aColumn2, lColumn2, False)
    Call Gp_Sp_Collection(ss2, 8, " ", " ", " ", "i", " ", "l", pColumn2, nColumn2, mColumn2, iColumn2, aColumn2, lColumn2, False)
   ...
   Call Gp_Sp_Collection(ss2, 29, " ", " ", " ", "i", " ", "l", pColumn2, nColumn2, mColumn2, iColumn2, aColumn2, lColumn2, False)
   Call Gp_Sp_Collection(ss2, 30, " ", " ", " ", "i", " ", "l", pColumn2, nColumn2, mColumn2, iColumn2, aColumn2, lColumn2, False)
   Call Gp_Sp_Collection(ss2, 31, " ", " ", " ", "i", " ", "l", pColumn2, nColumn2, mColumn2, iColumn2, aColumn2, lColumn2, False)
   Call Gp_Sp_Collection(ss2, 32, " ", " ", " ", " ", " ", "l", pColumn2, nColumn2, mColumn2, iColumn2, aColumn2, lColumn2)

    'Spread_Collection
    Sc2.Add Item:=ss2, Key:="Spread"
    Sc2.Add Item:="ACB5060C.P_MODIFY2", Key:="P-M"
    Sc2.Add Item:="ACB5060C.P_SREFER2", Key:="P-R"
...
Private Sub cmd_confirm_Click()
    ...
    If Trim(txt_str_plt.Text) = "" Or Trim(txt_str_plt_name.Text) = "" Then
        Call Gp_MsgBoxDisplay("输入起始库...")
        Exit Sub
    End If
    ...
    If Trim(txt_str_plt.Text) = Trim(txt_plt.Text) Then
        Call Gp_MsgBoxDisplay("起始库 = 目标库")
        Exit Sub
    End If
    
    If UCase(Trim(txt_str_plt.Text)) = "ZZ" Then
        Call Gp_MsgBoxDisplay("错误起始库")
        Exit Sub
    End If
...
'    If Trim(txt_sale_dept.Text) = "" Then
'        Call Gp_MsgBoxDisplay("输入部门代码...")
'        Exit Sub
'    End If
    ...
    MvNo = "C" & UCase(txt_str_plt.Text) & UCase(txt_plt.Text)
    ...
    For iRow = 1 To ss2.MaxRows
        ...
        If ss2.Text = txt_car_no.Text Then
    ...
    If iCount > 0 Then
        ...
        If Gf_Sp_Refer(M_CN1, Sc2, , , , False) Then
            ss1.OperationMode = OperationModeNormal
            Call MDIMain.FormMenuSetting(Me, FormType, "RE", sAuthority)
            Call MenuTool_ReSet
        End If
        txt_str_plt.Text = ""
        txt_str_plt_name.Text = ""
        txt_plt.Text = ""
        txt_plt_name.Text = ""
        txt_car_no.Text = ""
        stx_move_time.RawData = ""
        sdb_slab_num.Value = ss2.MaxRows
        sdb_slab_wgt.Value = Gf_Sp_ColSum(ss2, 12, 1, ss2.MaxRows)
    End If
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
    ...
    If Gf_Sp_ProceExist(sc1.Item("Spread")) Or Gf_Sp_ProceExist(Sc2.Item("Spread")) Then
        Cancel = 1
        Exit Sub
    End If
...
Public Sub Form_Cls()
    ...
    If Gf_Sp_Cls(sc1) Or Gf_Sp_Cls(Sc2) Then
...
Public Sub Form_Ref()
    ...
    If Gf_Sp_ProceExist(sc1.Item("Spread")) Or Gf_Sp_ProceExist(sc1.Item("Spread")) Then
        Exit Sub
    End If
    ...
    If Gf_Sp_Refer(M_CN1, Sc2, Mc2, , , False) Then
...
Public Sub Form_Pro()
    ...
    For iRow = 1 To ss1.MaxRows
        ...
        If ss1.Text = "Update" Then
            ss1.Col = 29
            ss1.Text = txt_train_no.Text
            bRow = True
        End If
    
    Next iRow
    
    If bRow And Trim(txt_train_no.Text) = "" Then
        Call Gp_MsgBoxDisplay("输入车厢号...")
        Exit Sub
    End If
    
    If Gf_Sp_Process(M_CN1, sc1, Mc1, True) Or Gf_Sp_Process(M_CN1, Sc2, , True) Then
        Call MDIMain.FormMenuSetting(Me, FormType, "RE", sAuthority)
        Call MenuTool_ReSet
...
Private Sub txt_str_plt_DblClick()

    Call txt_str_plt_KeyUp(vbKeyF4, 0)
    
End Sub

Private Sub txt_str_plt_KeyUp(KeyCode As Integer, Shift As Integer)

    If KeyCode = vbKeyF4 Then
    
        DD.sWitch = "MS"
        DD.sKey = "C0013"
        DD.rControl.Add Item:=txt_str_plt
        DD.rControl.Add Item:=txt_str_plt_name
    ...
    Else
        ...
        If Len(Trim(txt_str_plt.Text)) = txt_str_plt.MaxLength Then
            txt_str_plt_name.Text = Gf_ComnNameFind(M_CN1, "C0013", txt_str_plt.Text, 2)
        Else
              txt_str_plt_name.Text = ""
        End If
...
Private Sub txt_train_no_DblClick()

    Call txt_train_no_KeyUp(vbKeyF4, 0)

End Sub

Private Sub txt_train_no_KeyUp(KeyCode As Integer, Shift As Integer)

    If KeyCode = vbKeyF4 Then

        DD.sWitch = "MS"
        DD.rControl.Add Item:=txt_train_no
