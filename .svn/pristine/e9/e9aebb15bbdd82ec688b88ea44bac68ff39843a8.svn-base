...
Begin VB.Form AKL2050C 
   Caption         =   "°åÅ÷ÇÐ¸îÏÖ×´½çÃæ_AKL2050C"
   ClientHeight    =   8895
   ClientLeft      =   435
   ClientTop       =   1950
   ClientWidth     =   13680
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "AKL2050C.frx":0000
   End
End
Attribute VB_Name = "AKL2050C"
...
Public Sub Form_Ref()
    ...
    sQuery = "Select SLAB_NO,HCR_KND,LEN,WID,THK,WGT,ORD_NO"
    sQuery = sQuery + " From FP_SLAB "
    sQuery = sQuery + " Where LOC LIKE 'S0A0101%' AND REC_STS IN ('1','2') AND SLAB_RHF_IN_DATE IS NULL"
