...
Begin VB.Form AKP1211C 
   Caption         =   "中厚板卷厂生产简报_AKP1211C"
   ClientHeight    =   9435
   ClientLeft      =   525
   ClientTop       =   1815
   ClientWidth     =   15105
   ...
   Begin SSSplitter.SSSplitter SSSplitter1 
      ...
      Begin FPSpread.vaSpread ss1 
         ...
         SpreadDesigner  =   "AKP1211C.frx":0092
      End
      Begin FPSpread.vaSpread ss3 
         ...
         Protect         =   0   'False
         RetainSelBlock  =   0   'False
         SpreadDesigner  =   "AKP1211C.frx":17A1
         UnitType        =   0
      End
      Begin FPSpread.vaSpread ss4 
         ...
         Protect         =   0   'False
         RetainSelBlock  =   0   'False
         SpreadDesigner  =   "AKP1211C.frx":3E2B
      End
      Begin FPSpread.vaSpread ss2 
         ...
         Protect         =   0   'False
         RetainSelBlock  =   0   'False
         SpreadDesigner  =   "AKP1211C.frx":8098
      End
   End
...
Private Sub Form_Define()
   ...
   Call Gp_Sp_Collection(ss1, 29, " ", " ", " ", " ", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    sc1.Add Item:="AKP1211C.P_SREFER12", Key:="P-R"
   ...
   Call Gp_Sp_Collection(ss2, 21, " ", " ", " ", " ", " ", "l", pColumn2, nColumn2, mColumn2, iColumn2, aColumn2, lColumn2)
    ...
    sc2.Add Item:="AKP1111C.P_SREFER2", Key:="P-R"
   ...
   Call Gp_Sp_Collection(ss3, 12, " ", " ", " ", " ", " ", " ", pColumn3, nColumn3, mColumn3, iColumn3, aColumn3, lColumn3)
    ...
    Sc3.Add Item:="AKP1211C.P_MODIFY", Key:="P-M"
...
Public Sub Form_Ref()
    ...
    If txt_DATE.RawData >= "20101010" Then
        MsgBox "2010年10月10日以后的报表请到 '中厚板卷厂生产简报_V1010_AKP1213C' 画面查询", vbCritical, "错误提示"
       Exit Sub
    End If
...
'    sQuery = sQuery & "         SCRAP_REM_WGT,      DAY_SCRAP_WGT,      " & vbCrLf
'    sQuery = sQuery & "         SCRAP_WGT,          STL_MAT_CONSP,      " & vbCrLf
'    sQuery = sQuery & "         STL_MAT_MON_CONSP,  YEAR_S_PLN_PROD,    " & vbCrLf
...
'    sQuery = sQuery & "         TAP_AVE_WGT_2                           " & vbCrLf
...
'    sQuery = sQuery & "  WHERE  PROD_DATE  =  '" & txt_DATE.RawData & "'" & vbCrLf
    ...
    sQuery = sQuery & "         DAY_SCRAP_WGT8                          " & vbCrLf
    sQuery = sQuery & "   FROM  FP_PROD_DAY_REPORT_2                    " & vbCrLf
    sQuery = sQuery & "  WHERE  PROD_DATE  =  '" & txt_DATE.RawData & "'" & vbCrLf
...
'    Next iCol
    ...
    ''''''ADD BY GUOLI 200706041102''''''''''''''''''''''
    With ss4
'        .ROW = 11: .ROW2 = 11
'        .Col = 1:  .Col2 = TEMP_CNT - 6
'
'        .BlockMode = True
...
'
'        .ROW = 11: .ROW2 = 11
'        .Col = TEMP_CNT - 4: .Col2 = TEMP_CNT - 3
'
'        .BlockMode = True
'        .RowMerge = MergeAlways
'        .ColMerge = MergeAlways
...
Private Sub ExcelPrn()
    ...
    xlApp.Workbooks.Open (App.Path & "\AKP1211C.xls")
    ...
    xlApp.Range("D55").Value = Format(Now, "YYYY-MM-DD HH:MM:SS")
    xlApp.Range("V55").Value = "制表人： " & sUserID
   ...
   '-----------------Peocess ss3-----------------------------------------
    With ss3
        .Col = 2
            .Row = 2:    xlApp.Range("Y17").Value = .Text
            .Row = 3:    xlApp.Range("Y18").Value = .Text
            .Row = 4:    xlApp.Range("Y19").Value = .Text
            .Row = 5:    xlApp.Range("Y20").Value = .Text
            .Row = 6:    xlApp.Range("Y21").Value = .Text
            .Row = 7:    xlApp.Range("Y22").Value = .Text
            .Row = 8:    xlApp.Range("Y23").Value = .Text
            
            .Row = 10:   xlApp.Range("Y25").Value = .Text
            .Row = 11:   xlApp.Range("Y26").Value = .Text
            .Row = 12:   xlApp.Range("Y27").Value = .Text
        
        .Col = 4
            .Row = 2:    xlApp.Range("AA17").Value = .Text
            .Row = 3:    xlApp.Range("AA18").Value = .Text
            .Row = 4:    xlApp.Range("AA19").Value = .Text
            .Row = 5:    xlApp.Range("AA20").Value = .Text
            .Row = 6:    xlApp.Range("AA21").Value = .Text
            .Row = 7:    xlApp.Range("AA22").Value = .Text
            .Row = 8:    xlApp.Range("AA23").Value = .Text
            
            .Row = 10:   xlApp.Range("AA25").Value = .Text
            .Row = 11:   xlApp.Range("AA26").Value = .Text
            .Row = 12:   xlApp.Range("AA27").Value = .Text
         
        .Col = 5
            .Row = 6:    xlApp.Range("AB21").Value = "至  " & .Text

        .Col = 6
            .Row = 2:    xlApp.Range("AC17").Value = .Text
            .Row = 3:    xlApp.Range("AC18").Value = .Text
            .Row = 4:    xlApp.Range("AC19").Value = .Text
            .Row = 5:    xlApp.Range("AC20").Value = .Text
            .Row = 7:    xlApp.Range("AC22").Value = .Text
            .Row = 8:    xlApp.Range("AC23").Value = .Text
            .Row = 9:    xlApp.Range("AC24").Value = .Text
            .Row = 10:   xlApp.Range("AC25").Value = .Text
            .Row = 11:   xlApp.Range("AC26").Value = .Text
            .Row = 12:   xlApp.Range("AC27").Value = .Text
        
        .Col = 8
            .Row = 3:    xlApp.Range("AE18").Value = .Text
            .Row = 4:    xlApp.Range("AE19").Value = .Text
            .Row = 5:    xlApp.Range("AE20").Value = .Text
            .Row = 6:    xlApp.Range("AE21").Value = .Text
            .Row = 7:    xlApp.Range("AE22").Value = .Text
            .Row = 8:    xlApp.Range("AE23").Value = .Text
            .Row = 9:    xlApp.Range("AE24").Value = .Text
            .Row = 10:   xlApp.Range("AE25").Value = .Text
            .Row = 11:   xlApp.Range("AE26").Value = .Text
            .Row = 12:   xlApp.Range("AE27").Value = .Text

    End With

    If ss4.MaxCols > 29 Then
        IDc = 29
    Else
        IDc = ss4.MaxCols
    End If
    ...
    If ss4.MaxCols > 29 Then
        ...
        Clipboard.Clear
        ss4.SetSelection 30, 1, ss4.MaxCols, 10
        ss4.ClipboardCopy
