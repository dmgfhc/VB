...
Begin VB.Form AFL2103C 
   Caption         =   "板坯CAD统计情况综合查询_AFL2103C"
   ClientHeight    =   3030
   ClientLeft      =   120
   ClientTop       =   450
   ClientWidth     =   4560
   ...
   Begin VB.ComboBox cbo_proc_cd 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "AFL2103C.frx":0000
      Left            =   1440
      List            =   "AFL2103C.frx":0007
      TabIndex        =   2
      Tag             =   "炉座号"
      Text            =   "CAD"
      Top             =   120
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      ProcessTab      =   -1  'True
      Protect         =   0   'False
      SpreadDesigner  =   "AFL2103C.frx":0010
   End
...
Private Sub Form_Define()
    ...
    'Call Master_Collection("Control_Name", "p(primary)", "n(Necessary)", "m(maxlength)", "i(insert)", "r(refer)", "a(append)", "l(lock)")
         Call Gp_Ms_Collection(cbo_proc_cd, "p", " ", " ", " ", "r", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
...
'---------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    sc1.Add Item:="AFL2103C.P_REFER", Key:="P-R"
...
Dim sQuery As String
   ...
   QueryYN = False
    ...
    sQuery = "SELECT COUNT(*)  FROM FP_SLAB  WHERE REC_STS = '2' AND PROC_CD = 'CAD'"
