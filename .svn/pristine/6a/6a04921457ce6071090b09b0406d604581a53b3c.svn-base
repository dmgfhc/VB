...
Begin VB.Form ABX1080C 
   Caption         =   "BP_MODIFY_ITEM_ABX1080C"
   ClientHeight    =   7620
   ClientLeft      =   270
   ClientTop       =   4890
   ClientWidth     =   15135
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "ABX108OC.frx":0000
   End
   Begin VB.TextBox txt_ORD_ATTR 
      BeginProperty Font 
         Name            =   "宋体"
         Size            =   9.75
         Charset         =   0
...
Private Sub Form_Define()
    ...
    'Call Master_Collection("Control_Name", "p(primary)", "n(Necessary)", "m(maxlength)", "i(insert)", "r(refer)", "a(append)", "l(lock)")
      Call Gp_Ms_Collection(txt_ORD_ATTR, "p", " ", " ", "i", "r", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
    ...
    Sc1.Add Item:="ABX1080C.P_MODIFY", Key:="P-M"
    Sc1.Add Item:="ABX1080C.P_REFER", Key:="P-R"
    Sc1.Add Item:="ABX1080C.P_ONEROW", Key:="P-O"
