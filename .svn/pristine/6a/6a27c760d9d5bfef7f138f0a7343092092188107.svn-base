...
Private Sub Form_Define()
  ...
  Call Gp_Ms_Collection(dtp_ins_date_prod_date2, "p", " ", " ", " ", "r", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
    ...
    Call Gp_Sp_Collection(ss2, 27, " ", " ", " ", " ", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)    '重点合同
    ...
    Call Gp_Sp_ColHidden(ss2, 22, True)   'caolei priority 转库优先级  20130305
...
Private Sub Form_Load()
    ...
    txt_mill_plt_name.Text = "中板厂"
'    txt_priority.Text = "2"
'    txt_priority_name.Text = "未指示"
'
...
Public Sub Form_Ref()
 ...
 Dim ForCnt As Integer
    ...
    If txt_mill_plt.Text <> "" And txt_mill_plt.Text <> "C1" And txt_mill_plt.Text <> "C2" And txt_mill_plt.Text <> "C3" Then
        Call Gp_MsgBoxDisplay("使用工厂必须为'C1'或者'C2'或者'C3'")
        Exit Sub
    End If
