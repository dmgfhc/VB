...
Begin VB.Form CGH2030C 
   ...
   Begin VB.ComboBox CBO_GROUP 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "CGH2030C.frx":0000
      Left            =   12825
      List            =   "CGH2030C.frx":0010
      TabIndex        =   5
      Top             =   120
      Width           =   735
   End
   Begin VB.ComboBox CBO_SHIFT 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "CGH2030C.frx":0020
      Left            =   9945
      List            =   "CGH2030C.frx":002D
      TabIndex        =   4
      Top             =   120
      Width           =   735
   End
   Begin VB.ComboBox CBO_PLT 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "CGH2030C.frx":003A
      Left            =   1185
      List            =   "CGH2030C.frx":003C
      Locked          =   -1  'True
      TabIndex        =   0
      Top             =   120
      Width           =   735
   ...
   Begin VB.ComboBox CBO_PRC 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "CGH2030C.frx":003E
      Left            =   3510
      List            =   "CGH2030C.frx":006C
      TabIndex        =   1
      Top             =   120
      Width           =   735
   End
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "CGH2030C.frx":00A8
   End
...
Private Sub Form_Define()
   ...
   Call Gp_Ms_Collection(txt_Occr_Time, "p", " ", " ", " ", " ", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
    ...
    sc1.Add Item:="CGH2030C.P_MODIFY", Key:="P-M"
    sc1.Add Item:="CGH2030C.P_REFER", Key:="P-R"
    sc1.Add Item:="CGH2030C.P_ONEROW", Key:="P-O"
        ...
        Case 5
            ...
            Else
                ...
                If Len(Trim(ss1.Text)) = ss1.TypeMaxEditLen Then
                    sTemp_Code = ss1.Text
                    ss1.Col = 6
                    ss1.Text = Gf_ComnNameFind(M_CN1, "F0014", Trim(sTemp_Code), 2)
                Else
                    ss1.Col = 6
                    ss1.Text = ""
                End If
