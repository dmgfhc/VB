...
Begin VB.Form CEH2010C 
   Caption         =   "坯料紧急分段作业指示_CEH2010C"
   ClientHeight    =   8250
   ClientLeft      =   255
   ClientTop       =   2280
   ClientWidth     =   14940
   ...
   Begin SSSplitter.SSSplitter SSSplitter1 
      ...
      Begin SSSplitter.SSSplitter SSSplitter2 
         ...
         Begin Threed.SSPanel SSPanel1 
            ...
            Begin VB.ComboBox cbo_slab_cut 
               ...
               EndProperty
               Height          =   315
               ItemData        =   "CEH2010C.frx":00A4
               Left            =   4230
               List            =   "CEH2010C.frx":00A6
         ...
         Begin FPSpread.vaSpread ss2 
            ...
            ProcessTab      =   -1  'True
            Protect         =   0   'False
            SpreadDesigner  =   "CEH2010C.frx":00A8
         End
      End
      Begin FPSpread.vaSpread ss1 
         ...
         SpreadDesigner  =   "CEH2010C.frx":068D
      End
   End
...
Private Sub Form_Define()
    ...
    sc1.Add Item:="CEH2010C.P_REFER1", Key:="P-R"
    sc1.Add Item:="CEH2010C.P_ONEROW1", Key:="P-O"
    sc1.Add Item:="CEH2010C.P_MODIFY1", Key:="P-M"
    ...
    sc2.Add Item:="CEH2010C.P_REFER2", Key:="P-R"
    sc2.Add Item:="CEH2010C.P_MODIFY2", Key:="P-M"
    ...
    cbo_slab_cut.AddItem "11"
    cbo_slab_cut.AddItem "12"
    cbo_slab_cut.AddItem "13"
    cbo_slab_cut.AddItem "14"
    cbo_slab_cut.AddItem "15"
...
Public Sub Form_Pro()
    ...
    If sdb_slab_len.Value < sdb_cut_len.Value Then
        Call Gp_MsgBoxDisplay("母板坯长度 < 切割长度.....", "I")
        Exit Sub
    End If
    
    If sdb_slab_len.Value <> sdb_cut_len.Value Then
        If Not Gf_MessConfirm("母板坯长度 <> 切割长度.....", "I") Then
            Exit Sub
        End If
    End If
    ...
    If udt_ins_date.RawData = "" Then
        Call Gp_MsgBoxDisplay(udt_ins_date.Tag + "必须输入", "I")
        Exit Sub
    End If

    If Len(udt_ins_date.RawData) <> 8 Then
        Call Gp_MsgBoxDisplay(udt_ins_date.Tag + "长度不正确", "I")
        Exit Sub
    End If
    
    If udt_ins_date.RawData < Mid(sDateTime, 1, 8) Then
        Call Gp_MsgBoxDisplay("指示日期 < 现在日期", "I")
        Exit Sub
    End If
