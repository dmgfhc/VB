...
Begin VB.Form ACB6080C 
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "ACB6080C.frx":0000
   End
End
Attribute VB_Name = "ACB6080C"
...
'---------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    sc1.Add Item:="ACB6080C.P_SREFER", Key:="P-R"
...
Public Sub Form_Ref()
      Dim wgt3, wgt4, wgt5, wgt6, i As Double
