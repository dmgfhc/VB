...
Begin VB.Form AGF2032C 
   ...
   Begin VB.ComboBox CBO_ROLL_TYPE 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "AGF2032C.frx":0000
      Left            =   10620
      List            =   "AGF2032C.frx":0002
      TabIndex        =   3
      Top             =   285
      Width           =   1485
   End
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "AGF2032C.frx":0004
   End
   ...
   Begin InDate.ULabel ULabel4 
      ...
      EndProperty
   End
   Begin CSTextLibCtl.sitxEdit SDT_GRIND_DATE_FROM 
      Height          =   315
      Left            =   1395
      TabIndex        =   4
      Top             =   285
   ...
   End
   Begin CSTextLibCtl.sitxEdit SDT_GRIND_DATE_TO 
      Height          =   315
      Left            =   2865
      TabIndex        =   5
      Top             =   285
...
Private Sub Form_Define()
  ...
  Call Gp_Ms_Collection(SDT_GRIND_DATE_FROM, "p", " ", " ", " ", " ", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
   ...
   Call Gp_Sp_Collection(ss1, 19, " ", " ", " ", " ", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    sc1.Add Item:="AGF2032C.P_SREFER", Key:="P-R"
...
Private Sub Form_Load()
    ...
    sQuery_Rt = "SELECT ROLL_NO FROM GP_ROLL WHERE ROLL_STATUS<>'DL' ORDER BY SUBSTR(ROLL_NO,1,1) DESC, SUBSTR(ROLL_NO,2,1), SUBSTR(ROLL_NO,6,2) "
...
On Error GoTo Refer_Err
    ...
    If Gf_Sp_Refer(M_CN1, Proc_Sc("Sc"), Mc1, Mc1("nControl"), Mc1("mControl")) Then
        ...
        For I = 1 To ss1.MaxRows
            ss1.Row = I
            ss1.Col = 9
            TOT_GHT = TOT_GHT + Val(ss1.Text)
            ss1.Col = 11
            TOT_WGT = TOT_WGT + Val(ss1.Text)
            ss1.Col = 13
            TOT_RMB = TOT_RMB + Val(ss1.Text)
        Next I
...
Private Sub SDT_GRIND_DATE_FROM_DblClick()
    SDT_GRIND_DATE_FROM.RawData = Gf_DTSet(M_CN1, "D")
End Sub

Private Sub SDT_GRIND_DATE_TO_DblClick()
