...
Begin VB.Form AFP7010C 
   Caption         =   "返送钢水实绩导出_AFP7010C"
   ClientHeight    =   9225
   ClientLeft      =   150
   ClientTop       =   1740
   ClientWidth     =   15225
   ...
   Begin VB.ComboBox cbo_group 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "AFP7010C.frx":0000
      Left            =   8640
      List            =   "AFP7010C.frx":0002
   ...
   Begin VB.ComboBox cbo_shift 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "AFP7010C.frx":0004
      Left            =   6270
      List            =   "AFP7010C.frx":0006
      Style           =   2  'Dropdown List
      TabIndex        =   2
      Top             =   120
      Width           =   735
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "AFP7010C.frx":0008
   End
...
'-- Program Name      RET STEEL Download
'-- Program ID        AFP7010C
'-- Designer          YANGSHU
'-- Coder             YANGSHU
'-- Date              2004.9.21
...
'---------------------------------------------------------------------------------------------------------------------------------------------------------------
   ...
   Call Gp_Sp_Collection(ss1, 13, " ", " ", " ", " ", " ", " ", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    sc1.Add Item:="AFP7010C.P_SREFER", Key:="P-R"
