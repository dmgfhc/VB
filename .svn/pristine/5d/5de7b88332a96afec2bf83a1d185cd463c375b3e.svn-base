...
'    Else
'
'        Active_YN = GetSetting("NISCO", "EXE-FILE", "BE.exe")
'
'        If Active_YN = "1" Then
...
Private Sub MDIForm_QueryUnload(Cancel As Integer, UnloadMode As Integer)
    ...
    If Cancel = False Then SaveSetting "NISCO", "EXE-FILE", "BE.exe", ""
...
Private Sub Mnu_AED2010C_Click()
    AED2010C.Show
    AED2010C.SetFocus
End Sub

Private Sub Mnu_AED4010C_Click()
    AED4010C.Show
    AED4010C.SetFocus
End Sub
