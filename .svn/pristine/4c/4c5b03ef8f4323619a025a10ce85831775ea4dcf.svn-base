...
Begin VB.Form AEA2020C 
   Caption         =   "录入轧辊单位编制量标准_AEA2020C"
   ClientHeight    =   7500
   ClientLeft      =   600
   ClientTop       =   2100
   ClientWidth     =   12585
   ...
   Begin VB.ComboBox Cbo_thkwid_fl 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "AEA2020C.frx":0000
      Left            =   7425
      List            =   "AEA2020C.frx":0002
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "AEA2020C.frx":0004
   End
...
Call Gp_Ms_Collection(txt_prod_cd_name, " ", "n", " ", " ", "r", " ", "l", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
   ...
   Call Gp_Sp_Collection(ss1, 12, " ", " ", "", " ", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    Sc1.Add Item:="AEA2020C.P_MODIFY", Key:="P-M"
    Sc1.Add Item:="AEA2020C.P_REFER", Key:="P-R"
    Sc1.Add Item:="AEA2020C.P_ONEROW", Key:="P-O"
    ...
    Cbo_thkwid_fl.AddItem "Type"
    Cbo_thkwid_fl.AddItem "Wid"
    Cbo_thkwid_fl.AddItem "Thk"
...
Private Sub TXT_APLY_ITEM_Change()
