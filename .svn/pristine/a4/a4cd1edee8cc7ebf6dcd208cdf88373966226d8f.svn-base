...
Begin VB.Form AFT3999C 
   Caption         =   "供中板厂板坯磅差录入界面(计量)_AFT3999C"
   ClientHeight    =   9225
   ClientLeft      =   195
   ClientTop       =   1950
   ClientWidth     =   15225
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "AFT3999C.frx":0000
   End
End
Attribute VB_Name = "AFT3999C"
...
Private Sub Form_Define()
    ...
    'Call Master_Collection("Control_Name", "p(primary)", "n(Necessary)", "m(maxlength)", "i(insert)", "r(refer)", "a(append)", "l(lock)")
       Call Gp_Ms_Collection(dtp_yy_mm, "p", " ", " ", " ", " ", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
...
'---------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    sc1.Add Item:="AFT3999C.P_SMODIFY", Key:="P-M"
    sc1.Add Item:="AFT3999C.P_SREFER", Key:="P-R"
    sc1.Add Item:="AFT3999C.P_SONEROW", Key:="P-O"
...
Private Sub Form_Load()
    ...
    dtp_yy_mm.RawData = Format(Now, "YYYYMM")
