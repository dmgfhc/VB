...
Begin VB.Form AGB2015C 
   Caption         =   "轧制作业实绩/母板实绩查询及修改界面_AGB2015C"
   ClientHeight    =   9240
   ClientLeft      =   270
   ClientTop       =   3300
   ClientWidth     =   15090
   ...
   Begin SSSplitter.SSSplitter SSSplitter1 
      ...
      Begin Threed.SSPanel SSPanel2 
         ...
         Begin TabDlg.SSTab SSTab1 
            ...
            EndProperty
            TabCaption(0)   =   "轧制实绩"
            TabPicture(0)   =   "AGB2015C.frx":0092
            ...
            Tab(0).Control(26)=   "Label43"
            Tab(0).Control(26).Enabled=   0   'False
            Tab(0).Control(27)=   "Label49"
            Tab(0).Control(27).Enabled=   0   'False
            Tab(0).Control(28)=   "Label59"
            Tab(0).Control(28).Enabled=   0   'False
            Tab(0).Control(29)=   "Label61"
            ...
            Tab(0).Control(34)=   "ULabel46"
            Tab(0).Control(34).Enabled=   0   'False
            Tab(0).Control(35)=   "ULabel18"
            Tab(0).Control(35).Enabled=   0   'False
            Tab(0).Control(36)=   "ULabel90"
            Tab(0).Control(36).Enabled=   0   'False
            Tab(0).Control(37)=   "SDB_MPLATE_CNT"
            Tab(0).Control(37).Enabled=   0   'False
            Tab(0).Control(38)=   "ULabel4"
            Tab(0).Control(38).Enabled=   0   'False
            Tab(0).Control(39)=   "ULabel3"
            Tab(0).Control(39).Enabled=   0   'False
            Tab(0).Control(40)=   "ULabel13"
            Tab(0).Control(40).Enabled=   0   'False
            Tab(0).Control(41)=   "ULabel12"
            Tab(0).Control(41).Enabled=   0   'False
            Tab(0).Control(42)=   "SDB_COOL_WGT"
            Tab(0).Control(42).Enabled=   0   'False
            Tab(0).Control(43)=   "SDB_COOL_ENT_TEMP"
            Tab(0).Control(43).Enabled=   0   'False
            Tab(0).Control(44)=   "SDB_COOL_EXT_TEMP"
            Tab(0).Control(44).Enabled=   0   'False
            Tab(0).Control(45)=   "SDB_COOL_AVE_TEMP"
            Tab(0).Control(45).Enabled=   0   'False
            Tab(0).Control(46)=   "SDB_STAGE2_DEL_DUR"
            Tab(0).Control(46).Enabled=   0   'False
            Tab(0).Control(47)=   "ULabel105"
            Tab(0).Control(47).Enabled=   0   'False
            Tab(0).Control(48)=   "ULabel100"
            Tab(0).Control(48).Enabled=   0   'False
            Tab(0).Control(49)=   "ULabel97"
            Tab(0).Control(49).Enabled=   0   'False
            Tab(0).Control(50)=   "ULabel94"
            Tab(0).Control(50).Enabled=   0   'False
            Tab(0).Control(51)=   "ULabel91"
            Tab(0).Control(51).Enabled=   0   'False
            Tab(0).Control(52)=   "SDB_CR_STAGE1_TIME"
            Tab(0).Control(52).Enabled=   0   'False
            Tab(0).Control(53)=   "SDB_CR_STAGE1_TEMP"
            Tab(0).Control(53).Enabled=   0   'False
            Tab(0).Control(54)=   "SDB_CR_STAGE1_THK"
            Tab(0).Control(54).Enabled=   0   'False
            Tab(0).Control(55)=   "ULabel80"
            Tab(0).Control(55).Enabled=   0   'False
            Tab(0).Control(56)=   "TXT_MILL_END_TIME"
            Tab(0).Control(56).Enabled=   0   'False
            Tab(0).Control(57)=   "TXT_MILL_STA_TIME"
            Tab(0).Control(57).Enabled=   0   'False
            Tab(0).Control(58)=   "ULabel38"
            Tab(0).Control(58).Enabled=   0   'False
            Tab(0).Control(59)=   "ULabel37"
            Tab(0).Control(59).Enabled=   0   'False
            Tab(0).Control(60)=   "ULabel36"
            Tab(0).Control(60).Enabled=   0   'False
            Tab(0).Control(61)=   "ULabel35"
            Tab(0).Control(61).Enabled=   0   'False
            Tab(0).Control(62)=   "ULabel34"
            Tab(0).Control(62).Enabled=   0   'False
            Tab(0).Control(63)=   "ULabel33"
            Tab(0).Control(63).Enabled=   0   'False
            Tab(0).Control(64)=   "ULabel32"
            Tab(0).Control(64).Enabled=   0   'False
            Tab(0).Control(65)=   "ULabel31"
            Tab(0).Control(65).Enabled=   0   'False
            Tab(0).Control(66)=   "ULabel29"
            Tab(0).Control(66).Enabled=   0   'False
            Tab(0).Control(67)=   "ULabel28"
            Tab(0).Control(67).Enabled=   0   'False
            Tab(0).Control(68)=   "ULabel27"
            Tab(0).Control(68).Enabled=   0   'False
            Tab(0).Control(69)=   "ULabel26"
            Tab(0).Control(69).Enabled=   0   'False
            Tab(0).Control(70)=   "ULabel25"
            Tab(0).Control(70).Enabled=   0   'False
            Tab(0).Control(71)=   "ULabel24"
            Tab(0).Control(71).Enabled=   0   'False
            Tab(0).Control(72)=   "ULabel23"
            Tab(0).Control(72).Enabled=   0   'False
            Tab(0).Control(73)=   "ULabel22"
            Tab(0).Control(73).Enabled=   0   'False
            Tab(0).Control(74)=   "ULabel21"
            Tab(0).Control(74).Enabled=   0   'False
            Tab(0).Control(75)=   "ULabel17"
            Tab(0).Control(75).Enabled=   0   'False
            Tab(0).Control(76)=   "ULabel16"
            Tab(0).Control(76).Enabled=   0   'False
            Tab(0).Control(77)=   "ULabel15"
            Tab(0).Control(77).Enabled=   0   'False
            Tab(0).Control(78)=   "ULabel14"
            Tab(0).Control(78).Enabled=   0   'False
            Tab(0).Control(79)=   "ULabel11"
            Tab(0).Control(79).Enabled=   0   'False
            Tab(0).Control(80)=   "ULabel6"
            Tab(0).Control(80).Enabled=   0   'False
            Tab(0).Control(81)=   "ULabel5"
            Tab(0).Control(81).Enabled=   0   'False
            Tab(0).Control(82)=   "ULabel2"
            Tab(0).Control(82).Enabled=   0   'False
            Tab(0).Control(83)=   "ULabel1"
            Tab(0).Control(83).Enabled=   0   'False
            Tab(0).Control(84)=   "ULabel10"
            Tab(0).Control(84).Enabled=   0   'False
            Tab(0).Control(85)=   "ULabel9"
            Tab(0).Control(85).Enabled=   0   'False
            Tab(0).Control(86)=   "ULabel8"
            Tab(0).Control(86).Enabled=   0   'False
            Tab(0).Control(87)=   "ULabel7"
            Tab(0).Control(87).Enabled=   0   'False
            Tab(0).Control(88)=   "SDB_ROLLING_PASS"
            Tab(0).Control(88).Enabled=   0   'False
            Tab(0).Control(89)=   "SDB_SLAB_MILL_LEN"
            Tab(0).Control(89).Enabled=   0   'False
            Tab(0).Control(90)=   "SDB_TAIL_CROP_WID"
            Tab(0).Control(90).Enabled=   0   'False
            Tab(0).Control(91)=   "SDB_TAIL_CROP_LEN"
            Tab(0).Control(91).Enabled=   0   'False
            Tab(0).Control(92)=   "SDB_CROWN_VAL"
            Tab(0).Control(92).Enabled=   0   'False
            Tab(0).Control(93)=   "SDB_MILL_END_MIN_TEMP"
            Tab(0).Control(93).Enabled=   0   'False
            Tab(0).Control(94)=   "SDB_MILL_END_MAX_TEMP"
            Tab(0).Control(94).Enabled=   0   'False
            Tab(0).Control(95)=   "SDB_END_AVE_TEMP"
            Tab(0).Control(95).Enabled=   0   'False
            Tab(0).Control(96)=   "SDB_MILL_END_AIM_TEMP"
            Tab(0).Control(96).Enabled=   0   'False
            Tab(0).Control(97)=   "SDB_HEAD_CROP_WID"
            Tab(0).Control(97).Enabled=   0   'False
            Tab(0).Control(98)=   "SDB_HEAD_CROP_LEN"
            Tab(0).Control(98).Enabled=   0   'False
            Tab(0).Control(99)=   "SDB_TAIL_WID"
            Tab(0).Control(99).Enabled=   0   'False
            Tab(0).Control(100)=   "SDB_MID_WID"
            Tab(0).Control(100).Enabled=   0   'False
            Tab(0).Control(101)=   "SDB_HEAD_WID"
            Tab(0).Control(101).Enabled=   0   'False
            Tab(0).Control(102)=   "SDB_AVE_THK"
            Tab(0).Control(102).Enabled=   0   'False
            Tab(0).Control(103)=   "SDB_AIM_THK"
            Tab(0).Control(103).Enabled=   0   'False
            Tab(0).Control(104)=   "SDB_COILING_OUT_TEMP"
            Tab(0).Control(104).Enabled=   0   'False
            Tab(0).Control(105)=   "SDB_COILING_IN_TEMP"
            Tab(0).Control(105).Enabled=   0   'False
            Tab(0).Control(106)=   "SDB_TRIM_WGT"
            Tab(0).Control(106).Enabled=   0   'False
            Tab(0).Control(107)=   "SDB_MAX_WID"
            Tab(0).Control(107).Enabled=   0   'False
            Tab(0).Control(108)=   "SDB_MIN_WID"
            Tab(0).Control(108).Enabled=   0   'False
            Tab(0).Control(109)=   "SDB_AVE_WID"
            Tab(0).Control(109).Enabled=   0   'False
            Tab(0).Control(110)=   "SDB_AIM_WID"
            Tab(0).Control(110).Enabled=   0   'False
            Tab(0).Control(111)=   "SDB_DELAY_DUR"
            Tab(0).Control(111).Enabled=   0   'False
            Tab(0).Control(112)=   "SDB_MILL_DUR"
            Tab(0).Control(112).Enabled=   0   'False
            Tab(0).Control(113)=   "ULabel81"
            Tab(0).Control(113).Enabled=   0   'False
            Tab(0).Control(114)=   "ULabel89"
            Tab(0).Control(114).Enabled=   0   'False
            Tab(0).Control(115)=   "SDB_STD_WID"
            Tab(0).Control(115).Enabled=   0   'False
            Tab(0).Control(116)=   "SDB_HD_CUT_THK"
            Tab(0).Control(116).Enabled=   0   'False
            Tab(0).Control(117)=   "ULabel41"
            Tab(0).Control(117).Enabled=   0   'False
            Tab(0).Control(118)=   "ROLL_SHIFT"
            Tab(0).Control(118).Enabled=   0   'False
            Tab(0).Control(119)=   "ROLL_GROUP"
            Tab(0).Control(119).Enabled=   0   'False
            Tab(0).Control(120)=   "ROLL_EMP"
            Tab(0).Control(120).Enabled=   0   'False
            Tab(0).Control(121)=   "CHK_PROD_C_COIL"
            Tab(0).Control(121).Enabled=   0   'False
            Tab(0).Control(122)=   "CHK_PROD_C_PLATE"
            Tab(0).Control(122).Enabled=   0   'False
            Tab(0).Control(123)=   "TXT_PROD_STATUS"
            Tab(0).Control(123).Enabled=   0   'False
            Tab(0).Control(124)=   "TXT_COOLING_METHOD"
            Tab(0).Control(124).Enabled=   0   'False
            Tab(0).Control(125)=   "CHK_PROD_PLATE"
            Tab(0).Control(125).Enabled=   0   'False
            Tab(0).Control(126)=   "CHK_PROD_COIL"
            Tab(0).Control(126).Enabled=   0   'False
            Tab(0).Control(127)=   "CHK_COOL_METHOD_AIR"
            Tab(0).Control(127).Enabled=   0   'False
            Tab(0).Control(128)=   "CHK_COOL_METHOD_WATER"
            Tab(0).Control(128).Enabled=   0   'False
            Tab(0).Control(129)=   "TXT_COOL_PRTY"
            Tab(0).Control(129).Enabled=   0   'False
            Tab(0).Control(130)=   "CHK_COOL_PRTY_FIN"
            Tab(0).Control(130).Enabled=   0   'False
            Tab(0).Control(131)=   "CHK_COOL_PRTY_COIL"
            Tab(0).Control(131).Enabled=   0   'False
            Tab(0).Control(132)=   "CHK_ROLLING_OP"
            Tab(0).Control(132).Enabled=   0   'False
            Tab(0).Control(133)=   "CHK_ROLLING_AUTO"
            Tab(0).Control(133).Enabled=   0   'False
            Tab(0).Control(134)=   "TXT_ROLLING_METHOD"
            Tab(0).Control(134).Enabled=   0   'False
            Tab(0).Control(135)=   "TXT_CR_CD"
            Tab(0).Control(135).Enabled=   0   'False
            Tab(0).Control(136)=   "CHK_CR_CD"
            Tab(0).Control(136).Enabled=   0   'False
            Tab(0).Control(137)=   "CHK_NON_CR_CD"
            Tab(0).Control(137).Enabled=   0   'False
            Tab(0).Control(138)=   "TXT_MILL_BG"
            Tab(0).Control(138).Enabled=   0   'False
            Tab(0).ControlCount=   139
            TabCaption(1)   =   "母板实绩"
            TabPicture(1)   =   "AGB2015C.frx":00AE
            Tab(1).ControlEnabled=   0   'False
            Tab(1).Control(0)=   "Label96"
            Tab(1).Control(1)=   "Label114"
            Tab(1).Control(2)=   "SDB_CR_STAGE3_THK"
            Tab(1).Control(3)=   "ULabel102"
            Tab(1).Control(4)=   "ULabel101"
            Tab(1).Control(5)=   "ULabel99"
            Tab(1).Control(6)=   "ULabel98"
            Tab(1).Control(7)=   "ULabel96"
            Tab(1).Control(8)=   "ULabel95"
            Tab(1).Control(9)=   "ULabel93"
            Tab(1).Control(10)=   "ULabel92"
            Tab(1).Control(11)=   "SDB_CR_STAGE3_TIME"
            Tab(1).Control(12)=   "SDB_CR_STAGE2_TIME"
            Tab(1).Control(13)=   "SDB_CR_STAGE3_TEMP"
            Tab(1).Control(14)=   "SDB_CR_STAGE2_TEMP"
            Tab(1).Control(15)=   "SDB_CR_STAGE2_THK"
            Tab(1).Control(16)=   "SDB_MOTHER_SCH_LEN12"
            Tab(1).Control(17)=   "SDB_MOTHER_SCH_LEN11"
            Tab(1).Control(18)=   "SDB_MOTHER_SCH_LEN10"
            Tab(1).Control(19)=   "SDB_MOTHER_SCH_LEN9"
            Tab(1).Control(20)=   "SDB_MOTHER_SCH_LEN8"
            Tab(1).Control(21)=   "SDB_MOTHER_SCH_LEN7"
            Tab(1).Control(22)=   "SDB_MOTHER_SCH_LEN6"
            Tab(1).Control(23)=   "SDB_MOTHER_SCH_LEN5"
            Tab(1).Control(24)=   "SDB_MOTHER_SCH_LEN4"
            Tab(1).Control(25)=   "SDB_MOTHER_SCH_LEN3"
            Tab(1).Control(26)=   "SDB_MOTHER_SCH_LEN2"
            Tab(1).Control(27)=   "SDB_MOTHER_SCH_LEN1"
            Tab(1).Control(28)=   "SSCommand2"
            Tab(1).Control(29)=   "SSCommand1"
            Tab(1).Control(30)=   "ULabel74"
            Tab(1).Control(31)=   "ULabel73"
            Tab(1).Control(32)=   "ULabel72"
            Tab(1).Control(33)=   "ULabel71"
            Tab(1).Control(34)=   "ULabel70"
            Tab(1).Control(35)=   "ULabel69"
            Tab(1).Control(36)=   "ULabel68"
            Tab(1).Control(37)=   "ULabel67"
            Tab(1).Control(38)=   "ULabel66"
            Tab(1).Control(39)=   "ULabel65"
            Tab(1).Control(40)=   "ULabel64"
            Tab(1).Control(41)=   "ULabel63"
            Tab(1).Control(42)=   "ULabel62"
            Tab(1).Control(43)=   "ULabel61"
            Tab(1).Control(44)=   "ULabel60"
            Tab(1).Control(45)=   "ULabel59"
            Tab(1).Control(46)=   "ULabel58"
            Tab(1).Control(47)=   "ULabel57"
            Tab(1).Control(48)=   "ULabel56"
            Tab(1).Control(49)=   "ULabel55"
            Tab(1).Control(50)=   "ULabel54"
            Tab(1).Control(51)=   "ULabel53"
            Tab(1).Control(52)=   "ULabel52"
            Tab(1).Control(53)=   "ULabel51"
            Tab(1).Control(54)=   "SDB_MOTHER_PLATE_LEN12"
            Tab(1).Control(55)=   "SDB_MOTHER_PLATE_LEN11"
            Tab(1).Control(56)=   "SDB_MOTHER_PLATE_LEN10"
            Tab(1).Control(57)=   "SDB_MOTHER_PLATE_LEN9"
            Tab(1).Control(58)=   "SDB_MOTHER_PLATE_LEN8"
            Tab(1).Control(59)=   "SDB_MOTHER_PLATE_LEN7"
            Tab(1).Control(60)=   "SDB_MOTHER_PLATE_LEN6"
            Tab(1).Control(61)=   "SDB_MOTHER_PLATE_LEN5"
            Tab(1).Control(62)=   "SDB_MOTHER_PLATE_LEN4"
            Tab(1).Control(63)=   "SDB_MOTHER_PLATE_LEN3"
            Tab(1).Control(64)=   "SDB_MOTHER_PLATE_LEN2"
            Tab(1).Control(65)=   "SDB_MOTHER_PLATE_LEN1"
            Tab(1).Control(66)=   "TXT_CUTEND_CD"
            Tab(1).Control(67)=   "CHK_NO"
            Tab(1).Control(68)=   "CHK_YES"
            Tab(1).Control(69)=   "TXT_COMFRM"
            Tab(1).Control(70)=   "TXT_MOTHER_PLATE7"
            Tab(1).Control(71)=   "TXT_MOTHER_PLATE11"
            Tab(1).Control(72)=   "TXT_MOTHER_PLATE9"
            Tab(1).Control(73)=   "TXT_MOTHER_PLATE8"
            Tab(1).Control(74)=   "TXT_MOTHER_PLATE12"
            Tab(1).Control(75)=   "TXT_MOTHER_PLATE10"
            Tab(1).Control(76)=   "TXT_MOTHER_PLATE4"
            Tab(1).Control(77)=   "TXT_MOTHER_PLATE6"
            Tab(1).Control(78)=   "TXT_MOTHER_PLATE2"
            Tab(1).Control(79)=   "TXT_MOTHER_PLATE3"
            Tab(1).Control(80)=   "TXT_MOTHER_PLATE5"
            Tab(1).Control(81)=   "TXT_MOTHER_PLATE1"
            Tab(1).ControlCount=   82
            Begin VB.TextBox TXT_MILL_BG 
               Height          =   315
               Left            =   13710
               TabIndex        =   160
               Top             =   4110
      ...
      Begin Threed.SSPanel SSPanel1 
         ...
         Begin VB.ComboBox CBO_PLT 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "AGB2015C.frx":00CA
            Left            =   7200
            List            =   "AGB2015C.frx":00D4
            TabIndex        =   139
            Tag             =   "工厂代码"
            Top             =   120
            Width           =   705
         ...
         Begin VB.ComboBox CBO_SHIFT 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "AGB2015C.frx":00E0
            Left            =   9330
            List            =   "AGB2015C.frx":00ED
            TabIndex        =   138
            Tag             =   "班次"
            Top             =   120
            Width           =   645
         ...
         Begin VB.ComboBox CBO_GROUP 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "AGB2015C.frx":00FA
            Left            =   11355
            List            =   "AGB2015C.frx":010A
            TabIndex        =   137
            Tag             =   "班别"
            Top             =   120
            Width           =   645
      ...
      Begin FPSpread.vaSpread ss1 
         ...
         SpreadDesigner  =   "AGB2015C.frx":011A
      End
      Begin Threed.SSPanel SSPanel3 
         ...
         Begin Threed.SSCheck chk_fl 
            ...
            Caption         =   "无轧制信息"
         End
         Begin CSTextLibCtl.sidbEdit sdb_rht_time 
            Height          =   315
            Left            =   10
            TabIndex        =   156
            Tag             =   "终轧平均温度"
         ...
         Begin InDate.ULabel ULabel43 
            ...
            ForeColor       =   0
         End
         Begin CSTextLibCtl.sidbEdit SDB_TIME 
            Height          =   315
            Left            =   0
            TabIndex        =   159
            Tag             =   "终轧平均温度"
...
Dim iCur_Row As Integer
Dim iTime_num As Integer
 ...
 Call Gp_Ms_Collection(SDB_MILL_END_MIN_TEMP, " ", " ", " ", "i", "r", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
    ...
    Call Gp_Ms_Collection(SDB_CR_STAGE2_TIME, " ", " ", " ", "i", "r", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
        ...
        Call Gp_Ms_Collection(SDB_MPLATE_CNT, " ", " ", " ", "i", "r", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
           ...
           Call Gp_Ms_Collection(TXT_MILL_BG, " ", " ", " ", "i", " ", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
...
Call Gp_Ms_Collection(SDB_MOTHER_PLATE_LEN12, " ", " ", " ", "i", "r", " ", " ", pControl1, nControl1, mControl1, iControl1, rControl1, aControl1, lControl1)
  Call Gp_Ms_Collection(SDB_MOTHER_SCH_LEN12, " ", " ", " ", " ", "r", " ", " ", pControl1, nControl1, mControl1, iControl1, rControl1, aControl1, lControl1)
         ...
         Call Gp_Ms_Collection(TXT_CUTEND_CD, " ", " ", " ", "i", " ", " ", " ", pControl1, nControl1, mControl1, iControl1, rControl1, aControl1, lControl1)
           ...
           Call Gp_Ms_Collection(chk_fl, "p", " ", " ", " ", "r", " ", " ", pControl2, nControl2, mControl2, iControl2, rControl2, aControl2, lControl2)
     Call Gp_Ms_Collection(sdb_rht_time, "p", " ", " ", " ", "r", " ", " ", pControl2, nControl2, mControl2, iControl2, rControl2, aControl2, lControl2)
    ...
    'MASTER Collection
     Mc1.Add Item:="AGB2015C.P_MODIFY1", Key:="P-M"
     Mc1.Add Item:="AGB2015C.P_REFER1", Key:="P-R"
     ...
     Mc2.Add Item:="AGB2015C.P_MODIFY2", Key:="P-M"
     Mc2.Add Item:="AGB2015C.P_REFER2", Key:="P-R"
    ...
    Call Gp_Sp_Collection(ss1, 1, "p", " ", " ", " ", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1, True)
    
    For iRow = 2 To ss1.MaxCols
        Call Gp_Sp_Collection(ss1, iRow, " ", " ", " ", " ", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1, True)
    Next iRow
    
    'Spread_Collection
    sc1.Add Item:=ss1, Key:="Spread"
    sc1.Add Item:="AGB2015C.P_SREFER", Key:="P-R"
    sc1.Add Item:="AGB2015C.P_ONEROW", Key:="P-O"
...
Public Sub Form_Ref()
    ...
    If CBO_SLAB_NO.Text = "" Or ss1.MaxRows > 0 Then
    

         If Gf_Sp_Refer(M_CN1, sc1, Mc3) Then
...
'                       CBO_SLAB_NO.Enabled = True
   ...
   End Select
    ...
    Call Gp_Sp_OneRowDisplay(M_CN1, Gf_Sp_MakeQuery(ss1, sc1.Item("P-O"), "O", sc1.Item("pColumn"), iCur_Row), ss1, iCur_Row)
...
Private Sub ss1_Click(ByVal Col As Long, ByVal Row As Long)
    ...
    If iCur_Row <> 0 Then
        Call Gp_Sp_BlockColor(ss1, 1, ss1.MaxCols, iCur_Row, iCur_Row)
    End If
    
    iCur_Row = Row
    Call Gp_Sp_BlockColor(ss1, 1, ss1.MaxCols, iCur_Row, iCur_Row, , &HFFFF80)
...
Private Sub Timer1_Timer()
    ...
    iTime_num = iTime_num + 1
    
    If iTime_num = SDB_TIME.Value Then
        Call Form_Ref
        iTime_num = 0
    End If
...
Private Sub TXT_MILL_BG_DblClick()
    Call txt_mill_bg_KeyUp(vbKeyF4, 0)
End Sub

Private Sub txt_mill_bg_KeyUp(KeyCode As Integer, Shift As Integer)

    If KeyCode = vbKeyF4 Then
    
        DD.sWitch = "MS"
        DD.sKey = "BG008"
        DD.rControl.Add Item:=TXT_MILL_BG
