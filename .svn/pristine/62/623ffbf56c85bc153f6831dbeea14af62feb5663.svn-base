...
Dim Report_KND As String        '说明书：T
    ...
    With ss1
        ...
        For i = 1 To .MaxRows
            ...
            If .Text = "1" Then
                ...
                .Col = 15:    sEMP_ID = Trim(.Text)         '打印人
                 Call SEND_ERP("U", 1, sCertNo, sEMP_ID)    '记录打印履历
...
'Name "c:\cert.pdf" As "c:\ELE_CERT\" & sCertNo & ".pdf"
'Kill "c:\ELE_CERT\" & sCertNo & ".pdf"
'Name "c:\ele_cert\cert.pdf" As "c:\ELE_CERT\" & sCertNo & ".pdf"
