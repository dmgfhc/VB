...
'HYS INSERT END
        ...
        Case "txt_SHOT_BLAST"            '抛丸代码
            sCode = "Q0074"
            Set oCodeName = txt_SHOT_BLAST_NAME
        
        Case "txt_HTM_METH1"            '热处理方法
            sCode = "Q0073"
        
        Case "txt_HTM_METH2"            '热处理方法
            sCode = "Q0073"
        
        Case "txt_HTM_METH3"            '热处理方法
            sCode = "Q0073"
    
        Case "txt_MTH_COND1"            '热处理条件
            sCode = "HTM_COND_CD"
        
        Case "txt_MTH_COND2"            '热处理条件
            sCode = "HTM_COND_CD"
        
        Case "txt_MTH_COND3"            '热处理条件
            sCode = "HTM_COND_CD"
    End Select
...
Private Sub txt_MTH_COND1_Change()
    ...
    If Change_Mth_COND(1) = False Then
        Call MsgBox("对应热处理条件代码错误!", vbOKOnly, "系统提示")
    End If
End Sub
...
'生产工厂路线
    If GF_Necessary_Value_Check(txt_MILL_PLT, "请选择轧钢厂！") = False Then Exit Function
    Select Case sPLT_CD
           Case "C1"
...
'平均出炉温差
    If GF_Necessary_Value_Check(txt_CHG_TMP_TGT, "平均出炉温差", txt_CHG_TMP_TGT) = False Then Exit Function
    
'板坯表面/中心温差
    If GF_Necessary_Value_Check(txt_CHG_TMP_DEF_SC, "板坯表面/中心温差", txt_CHG_TMP_DEF_SC) = False Then Exit Function
    
'板坯头尾温差
    If GF_Necessary_Value_Check(txt_CHG_TMP_DEF_TAPE, "板坯头尾温差", txt_CHG_TMP_DEF_TAPE) = False Then Exit Function
    
'控轧代码
    If GF_Necessary_Value_Check(txt_CR_CD, "控轧代码", txt_CR_CD) = False Then Exit Function
    
'T1温度/压下率&终轧温度
        If txt_CR_CD.Text = "Y" Or txt_CR_CD.Text = "y" Then
            If GF_Necessary_Value_Check(txt_MILL_TMPT1, "T1温度", txt_MILL_TMPT1) = False Then Exit Function
            If GF_Necessary_Value_Check(txt_MILL_RATET1, "T1温度/压下率", txt_MILL_RATET1) = False Then Exit Function
            If GF_Necessary_Value_Check(txt_MILL_TMP_MIN, "终轧温度误差下限", txt_MILL_TMP_MIN) = False Then Exit Function
            If GF_Necessary_Value_Check(txt_MILL_TMP_MAX, "终轧温度误差上限", txt_MILL_TMP_MAX) = False Then Exit Function
            If GF_Necessary_Value_Check(txt_MILL_TMP_TGT, "终轧温度目标值", txt_MILL_TMP_TGT) = False Then Exit Function
        End If


'冷却方法代码
    If GF_Necessary_Value_Check(txt_COOL_WAY, "冷却方法代码", txt_COOL_WAY) = False Then Exit Function
    
'冷却温度/冷却速率

        If txt_COOL_WAY.Text = "W" Or txt_COOL_WAY.Text = "w" Then
            If GF_Necessary_Value_Check(txt_COOL_TMP_MIN, "冷却温度误差下限", txt_COOL_TMP_MIN) = False Then Exit Function
            If GF_Necessary_Value_Check(txt_COOL_TMP_MAX, "冷却温度误差上限", txt_COOL_TMP_MAX) = False Then Exit Function
            If GF_Necessary_Value_Check(txt_COOL_TMP_TGT, "冷却温度目标值", txt_COOL_TMP_TGT) = False Then Exit Function
            If GF_Necessary_Value_Check(txt_COOL_TMP_RATE, "冷却速率", txt_COOL_TMP_RATE) = False Then Exit Function
        End If
    
'控冷代码
    If GF_Necessary_Value_Check(txt_COOL_CTL_TYP, "控冷代码", txt_COOL_CTL_TYP) = False Then Exit Function
'热矫直代码
    If GF_Necessary_Value_Check(txt_HOT_USE, "热矫直代码", txt_HOT_USE) = False Then Exit Function
...
'平均出炉温差
    If GF_Necessary_Value_Check(txt_CHG_TMP_TGT_Z, "平均出炉温差", txt_CHG_TMP_TGT_Z) = False Then Exit Function
    
'板坯表面/中心温差
    If GF_Necessary_Value_Check(txt_CHG_TMP_DEF_SC_Z, "板坯表面/中心温差", txt_CHG_TMP_DEF_SC_Z) = False Then Exit Function
    
'板坯头尾温差
    If GF_Necessary_Value_Check(txt_CHG_TMP_DEF_TAPE_Z, "板坯头尾温差", txt_CHG_TMP_DEF_TAPE_Z) = False Then Exit Function
    
'控轧代码
    If GF_Necessary_Value_Check(txt_CR_CD_Z, "控轧代码", txt_CR_CD_Z) = False Then Exit Function
    
'T1温度/压下率&终轧温度
 
        If txt_CR_CD_Z.Text = "Y" Or txt_CR_CD_Z.Text = "y" Then
            If GF_Necessary_Value_Check(txt_MILL_TMPT1_Z, "T1温度", txt_MILL_TMPT1_Z) = False Then Exit Function
            If GF_Necessary_Value_Check(txt_MILL_RATET1_Z, "T1温度/压下率", txt_MILL_RATET1_Z) = False Then Exit Function
            If GF_Necessary_Value_Check(txt_MILL_TMP_MIN_Z, "终轧温度误差下限", txt_MILL_TMP_MIN_Z) = False Then Exit Function
            If GF_Necessary_Value_Check(txt_MILL_TMP_MAX_Z, "终轧温度误差上限", txt_MILL_TMP_MAX_Z) = False Then Exit Function
            If GF_Necessary_Value_Check(txt_MILL_TMP_TGT_Z, "终轧温度目标值", txt_MILL_TMP_TGT_Z) = False Then Exit Function
        End If

'冷却方法代码
    If GF_Necessary_Value_Check(txt_COOL_WAY_Z, "冷却方法代码", txt_COOL_WAY_Z) = False Then Exit Function
    
'冷却温度/冷却速率

        If txt_COOL_WAY_Z.Text = "W" Or txt_COOL_WAY_Z.Text = "w" Then
            If GF_Necessary_Value_Check(txt_COOL_TMP_MIN_Z, "冷却温度误差下限", txt_COOL_TMP_MIN_Z) = False Then Exit Function
            If GF_Necessary_Value_Check(txt_COOL_TMP_MAX_Z, "冷却温度误差上限", txt_COOL_TMP_MAX_Z) = False Then Exit Function
            If GF_Necessary_Value_Check(txt_COOL_TMP_TGT_Z, "冷却温度目标值", txt_COOL_TMP_TGT_Z) = False Then Exit Function
            If GF_Necessary_Value_Check(txt_COOL_TMP_RATE_Z, "冷却速率", txt_COOL_TMP_RATE_Z) = False Then Exit Function
        End If

'控冷代码
    If GF_Necessary_Value_Check(txt_COOL_CTL_TYP_Z, "控冷代码", txt_COOL_CTL_TYP_Z) = False Then Exit Function
'热矫直代码
    If GF_Necessary_Value_Check(txt_HOT_USE_Z, "热矫直代码", txt_HOT_USE_Z) = False Then Exit Function
