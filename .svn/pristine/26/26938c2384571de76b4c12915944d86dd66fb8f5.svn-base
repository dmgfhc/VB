...
Begin VB.Form AKH1010C 
   ...
   Begin VB.ComboBox CBO_ALL_NO 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "AKH1010C.frx":0000
      Left            =   5550
      List            =   "AKH1010C.frx":0002
      TabIndex        =   2
      Tag             =   "ROLL_NO"
      Top             =   120
      Width           =   1845
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "AKH1010C.frx":0004
   End
   ...
   Begin FPSpread.vaSpread ss2 
      ...
      Protect         =   0   'False
      RetainSelBlock  =   0   'False
      SpreadDesigner  =   "AKH1010C.frx":0D38
   End
   Begin FPSpread.vaSpread ss3 
      ...
      Protect         =   0   'False
      RetainSelBlock  =   0   'False
      SpreadDesigner  =   "AKH1010C.frx":138C
   End
...
'Dim Sc3 As New Collection           'Spread Collection
  ...
  Private Sub Form_Define()
   ...
   Call Gp_Sp_Collection(ss1, 22, " ", " ", " ", " ", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    sc1.Add Item:="AKH1010C.P_MODIFY", Key:="P-M"
    sc1.Add Item:="AKH1010C.P_REFER", Key:="P-R"
   ...
   Call Gp_Sp_Collection(ss2, 11, " ", " ", " ", " ", " ", "l", pColumn2, nColumn2, mColumn2, iColumn2, aColumn2, lColumn2)
    ...
    sc2.Add Item:="AKH1010C.P_REFER1", Key:="P-R"
   ...
   'Spread_Collection
    ...
    Sc3.Add Item:="AKH1010C.P_REFER2", Key:="P-R"
                                            ...
                                            Else
                                                ...
                                                ss1.Col = ss1.ActiveCol
                                                 ...
                                                 If Len(Trim(ss1.Text)) = 4 Then
                                                        ...
                                                        sTemp_Code = ss1.Text
                                                        ss1.Col = 2
                                                        ss1.Text = Gf_ComnNameFind(M_CN1, "F0018", Trim(sTemp_Code), 2)
                                                 Else
                                                        ss1.Col = 2
                                                        ss1.Text = ""
                                                 End If
...
Private Sub txt_all_cd_KeyUp(KeyCode As Integer, Shift As Integer)
    ...
    Else
        ...
        If Len(Trim(txt_all_cd.Text)) = txt_all_cd.MaxLength Then
            txt_all_name.Text = Gf_ComnNameFind(M_CN1, "F0018", txt_all_cd.Text, 2)
        Else
            txt_all_name.Text = ""
        End If
    End If
...
On Error GoTo Process_Exec_ERROR
    ...
    sQuery = "{CALL AKH1010C.P_REFER1('" & Trim(txt_all_cd1.Text) & "')}"
...
'    sQuery = "{CALL AKH1020C.P_REFER2('" & Trim(txt_all.Text) + Trim(txt_all1.Text) & "')}"
    ...
    sQuery = "{call AKH1010C.P_REFER2 ('" + txt_all + "', '" + txt_all1 + "')}"
