...
Begin VB.Form AEZ1010C 
   Caption         =   "顺序调整（pop_up)_AEZ1010C"
   ClientHeight    =   7620
   ClientLeft      =   -255
   ClientTop       =   2550
   ClientWidth     =   15135
...
On Error GoTo Refer_Err
    ...
    If sMesg = "OK" Then
        ...
        If sMesg = "OK" Then
            ...
            If Gf_Sp_Refer(M_CN1, Proc_Sc("Sc"), Mc1) = True Then
...
Public Sub Form_Pro()
    ...
    If Gf_Sp_Process(M_CN1, Proc_Sc("SC"), Mc1) Then Call MDIMain.FormMenuSetting("", "RE")
