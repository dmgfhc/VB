...
Begin VB.Form AKN2020C 
   Caption         =   "板坯切割作业指示查询界面_AKN2020C"
   ClientHeight    =   9165
   ClientLeft      =   360
   ClientTop       =   1785
   ClientWidth     =   15285
   ...
   Begin VB.ComboBox cbo_CAST_ID 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "AKN2020C.frx":0000
      Left            =   5175
      List            =   "AKN2020C.frx":000D
      TabIndex        =   1
      Tag             =   "连铸机号"
      Top             =   135
      Width           =   720
   End
   Begin VB.ComboBox cbo_HEAT_ID 
      BeginProperty Font 
         Name            =   "宋体"
         Size            =   9.75
         Charset         =   134
      ...
      Width           =   1575
   End
   Begin VB.TextBox txt_CAST_NUMBER 
      BeginProperty Font 
         Name            =   "宋体"
         Size            =   9.75
         Charset         =   134
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "AKN2020C.frx":001A
   End
...
'-- Program Name      Slabcut Schedule Query
'-- Program ID        AFN2020C
'-- Designer          GUOLI
'-- Coder             GUOLI
'-- Date              2003.8.14
...
Private Sub Form_Define()
    ...
    'Call Master_Collection("Control_Name", "p(primary)", "n(Necessary)", "m(maxlength)", "i(insert)", "r(refer)", "a(append)", "l(lock)")
      Call Gp_Ms_Collection(cbo_HEAT_ID, "p", "n", " ", " ", " ", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
      Call Gp_Ms_Collection(cbo_CAST_ID, "p", " ", " ", " ", "r", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
  Call Gp_Ms_Collection(txt_CAST_NUMBER, " ", " ", " ", " ", "r", " ", "l", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
     Call Gp_Ms_Collection(txt_HEAT_CNT, " ", " ", " ", " ", "r", " ", "l", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
     Call Gp_Ms_Collection(txt_HEAT_SEQ, " ", " ", " ", " ", "r", " ", "l", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
    
    'MASTER Collection
    Mc1.Add Item:="AFN2020C.P_REFER", Key:="P-R"
   ...
   Call Gp_Sp_Collection(ss1, 14, " ", " ", " ", " ", " ", " ", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    sc1.Add Item:="AFN2020C.P_SREFER", Key:="P-R"
...
'    Call Gf_ComboAdd(M_CN1, cbo_HEAT_ID, "select distinct a.heat_mana_no from ep_slab_ins a")
...
On Error GoTo Refer_Err
    ...
    If cbo_HEAT_ID.Text = "" And cbo_CAST_ID.Text = "" Then
    ...
    If Gf_Ms_Refer(M_CN1, Mc1, , Mc1("mControl")) Then
