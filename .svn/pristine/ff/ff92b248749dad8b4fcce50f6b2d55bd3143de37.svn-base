...
Begin VB.Form ACB4031C 
   BackColor       =   &H00E0E0E0&
   Caption         =   "转库作业实绩查询_ACB4031C"
   ClientHeight    =   10410
   ClientLeft      =   150
   ClientTop       =   1170
   ClientWidth     =   15960
   ...
   Begin VB.ComboBox CBO_PLT 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "ACB4031C.frx":0000
      Left            =   3865
      List            =   "ACB4031C.frx":000D
      TabIndex        =   39
      Top             =   1220
      Width           =   720
   End
   ...
   Begin VB.ComboBox CBO_SIZE_KND 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "ACB4031C.frx":001D
      Left            =   3865
      List            =   "ACB4031C.frx":002D
      TabIndex        =   25
      Top             =   465
      Width           =   720
   End
   Begin VB.ComboBox CBO_TRIM_FL 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "ACB4031C.frx":0041
      Left            =   3865
      List            =   "ACB4031C.frx":0051
      TabIndex        =   24
      Top             =   855
      Width           =   720
   End
   ...
   Begin VB.ComboBox CBO_PROD_CD 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "ACB4031C.frx":0061
      Left            =   3865
      List            =   "ACB4031C.frx":006E
      TabIndex        =   20
      Text            =   "PP"
      Top             =   75
      Width           =   720
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "ACB4031C.frx":007E
   End
...
Const SS1_CNT = 14
Const SS1_WGT = 15
Const SS1_PROD_GRD = 16
Const SS1_SIZE_KND = 17
Const SS1_TRIM_FL = 18
Const SS1_CUST_CD = 19
Const SS1_CUST_NAME = 20
Const SS1_FR_INV = 21
Const SS1_FR_INV_LOC = 22
Const SS1_TO_INV = 23
Const SS1_TO_INV_LOC = 24
Const SS1_MOVE_DATE = 25
Const SS1_MOVE_TIME = 26
Const SS1_MOVE_CAR_NO = 27
Const SS1_MOVE_EMP = 28
Const SS1_RCV_DATE = 29
Const SS1_RCV_TIME = 30
Const SS1_RCV_EMP = 31
Const SS1_ORD = 32
...
Private Sub Form_Define()
   ...
   Call Gp_Ms_Collection(text_cur_inv_code, "p", " ", " ", " ", "r", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
    Call Gp_Ms_Collection(txt_dst_inv_code, "p", " ", " ", " ", "r", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
         Call Gp_Ms_Collection(MOV_DATE_FR, "p", " ", " ", " ", "r", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
         Call Gp_Ms_Collection(MOV_DATE_TO, "p", " ", " ", " ", "r", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
   ...
   'Spread_Collection
    ...
    sc1.Add Item:="ACB4031C.P_SREFER", Key:="P-R"
