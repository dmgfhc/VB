...
Begin VB.Form AEA2011C 
   Caption         =   "录入轧辊单位编制厚/宽度组标准_AEA2011C"
   ClientHeight    =   8415
   ClientLeft      =   540
   ClientTop       =   2625
   ClientWidth     =   15225
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "AEA2011C.frx":0000
   End
...
Private Sub Form_Define()
   ...
   Call Gp_Sp_Collection(ss1, 10, " ", " ", " ", " ", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    Sc1.Add Item:="AEA2011C.P_MODIFY", Key:="P-M"
    Sc1.Add Item:="AEA2011C.P_REFER", Key:="P-R"
    Sc1.Add Item:="AEA2011C.P_ONEROW", Key:="P-O"
