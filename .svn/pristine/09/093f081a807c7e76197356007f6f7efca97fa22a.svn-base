...
Begin VB.Form AKH1011C 
   ...
   Begin FPSpread.vaSpread SS1 
      ...
      SpreadDesigner  =   "AKH1011C.frx":0000
   End
End
Attribute VB_Name = "AKH1011C"
...
'---------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    sc1.Add Item:="AKH1011C.P_MODIFY", Key:="P-M"
    sc1.Add Item:="AKH1011C.P_REFER", Key:="P-R"
