...
Begin VB.Form CEH1010C 
   Caption         =   "坯料分段作业指示对象选定/查询_CEH1010C"
   ClientHeight    =   8250
   ClientLeft      =   120
   ClientTop       =   1695
   ClientWidth     =   14940
   ...
   Begin SSSplitter.SSSplitter SSSplitter1 
      ...
      Begin FPSpread.vaSpread ss2 
         ...
         ProcessTab      =   -1  'True
         Protect         =   0   'False
         SpreadDesigner  =   "CEH1010C.frx":0052
      End
      Begin FPSpread.vaSpread ss1 
         ...
         SpreadDesigner  =   "CEH1010C.frx":08E0
      End
   End
...
Private Sub Form_Define()
    ...
    sc1.Add Item:="CEH1010C.P_REFER1", Key:="P-R"
    sc1.Add Item:="CEH1010C.P_ONEROW1", Key:="P-O"
    sc1.Add Item:="CEH1010C.P_MODIFY1", Key:="P-M"
    ...
    sc2.Add Item:="CEH1010C.P_REFER2", Key:="P-R"
...
Private Sub cmd_slab_confirm_Click()
    ...
    sQuery = "{call CEH1010P ('C3','" & txt_del_to.RawData & "','" & txt_ord_no.Text & "','" _
