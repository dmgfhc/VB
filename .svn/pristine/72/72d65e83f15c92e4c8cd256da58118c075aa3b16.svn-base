...
Begin VB.Form ARZ0030C 
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "ARZ0030C.frx":0000
   End
End
Attribute VB_Name = "ARZ0030C"
...
Private Sub Form_Define()
   ...
   Call Gp_Sp_Collection(ss1, 24, " ", " ", " ", " ", " ", " ", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    sc1.Add Item:="ARZ0030C.P_MODIFY", Key:="P-M"
    sc1.Add Item:="ARZ0030C.P_REFER", Key:="P-R"
    sc1.Add Item:="ARZ0030C.P_ONEROW", Key:="P-O"
...
Private Sub txt_if_cd_KeyUp(KeyCode As Integer, Shift As Integer)
    ...
    If KeyCode = vbKeyF4 Then
        ...
        Load ARX0010C
        ARX0010C.txt_form_nm.Text = "ARZ0030C"
        ARX0010C.Show 1
