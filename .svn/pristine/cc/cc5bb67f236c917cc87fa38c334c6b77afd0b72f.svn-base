...
Begin VB.Form AFT3010C 
   Caption         =   "运行日志查询_AFT3010C"
   ClientHeight    =   9225
   ClientLeft      =   480
   ClientTop       =   2175
   ClientWidth     =   15225
   ...
   Begin VB.ComboBox cbo_LOG_TYPE 
      BeginProperty Font 
         Name            =   "宋体"
         Size            =   9.75
         Charset         =   134
      ...
      EndProperty
      Height          =   315
      ItemData        =   "AFT3010C.frx":0000
      Left            =   5100
      List            =   "AFT3010C.frx":000D
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "AFT3010C.frx":001B
   End
   Begin InDate.UDate txt_OCCUR_DATE 
      Height          =   315
      Left            =   1530
      TabIndex        =   2
      Tag             =   "起始日期"
...
Private Sub Form_Define()
    ...
    'Call Master_Collection("Control_Name", "p(primary)", "n(Necessary)", "m(maxlength)", "i(insert)", "r(refer)", "a(append)", "l(lock)")
       Call Gp_Ms_Collection(txt_OCCUR_DATE, "p", " ", " ", " ", "", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
         Call Gp_Ms_Collection(cbo_LOG_TYPE, "p", " ", " ", " ", "", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
...
'---------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    sc1.Add Item:="AFT3010C.P_SREFER", Key:="P-R"
