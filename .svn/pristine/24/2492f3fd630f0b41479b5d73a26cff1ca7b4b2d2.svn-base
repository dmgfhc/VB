...
Begin VB.Form DGC1030C 
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "DGC1030C.frx":0000
   End
...
Private Sub Form_Define()
    ...
    'Call Spread_Collection("Column_Num", "p(primary)", "n(Necessary)", "m(maxlength)", "i(insert)", "a(append_down), "l(lock)")
     ...
     Call Gp_Sp_Collection(ss1, 9, " ", " ", " ", "i", " ", "l", pColumn, nColumn, mColumn, iColumn, aColumn, lColumn)
    Call Gp_Sp_Collection(ss1, 10, " ", " ", " ", " ", " ", "l", pColumn, nColumn, mColumn, iColumn, aColumn, lColumn)
    Call Gp_Sp_Collection(ss1, 11, " ", " ", " ", "i", " ", "l", pColumn, nColumn, mColumn, iColumn, aColumn, lColumn)
    
    sc1.Add Item:=ss1, Key:="Spread"
    sc1.Add Item:="DGC1030C.P_SREFER", Key:="P-R"
    sc1.Add Item:="DGC1030C.P_SONEROW", Key:="P-O"
    sc1.Add Item:="DGC1030C.P_SMODIFY", Key:="P-M"
