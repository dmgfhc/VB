...
Begin VB.Form CEC4030C 
   Caption         =   "强制长坯料设计_CEC4030C"
   ClientHeight    =   8625
   ClientLeft      =   1245
   ClientTop       =   2595
   ClientWidth     =   15360
   ...
   Begin SSSplitter.SSSplitter SSSplitter1 
      ...
      Begin SSSplitter.SSSplitter SSSplitter2 
         ...
         Begin FPSpread.vaSpread ss2 
            ...
            SpreadDesigner  =   "CEC4030C.frx":00A4
         End
      End
      Begin FPSpread.vaSpread ss1 
         ...
         MaxRows         =   2
         RetainSelBlock  =   0   'False
         SpreadDesigner  =   "CEC4030C.frx":0DB9
      End
   End
...
Private Sub Form_Define()
    ...
    sc1.Add Item:="CEC4030C.P_REFER1", Key:="P-R"
    ...
    Call Gp_Ms_Collection(sdb_long_slab_wgt, " ", " ", " ", " ", "r", " ", " ", pControl2, nControl2, mControl2, iControl2, rControl2, aControl2, lControl2)
          Call Gp_Ms_Collection(txt_sms_plt, "p", "n", " ", " ", " ", " ", " ", pControl2, nControl2, mControl2, iControl2, rControl2, aControl2, lControl2)
    ...
    Call Gp_Sp_Collection(ss2, 24, " ", " ", " ", " ", " ", "l", pColumn2, nColumn2, mColumn2, iColumn2, aColumn2, lColumn2, False)
    Call Gp_Sp_Collection(ss2, 25, " ", " ", " ", "i", " ", "l", pColumn2, nColumn2, mColumn2, iColumn2, aColumn2, lColumn2, False)
    
    'Spread_Collection
    sc2.Add Item:=ss2, Key:="Spread"
    sc2.Add Item:="CEC4030C.P_REFER2", Key:="P-R"
    sc2.Add Item:="CEC4030C.P_ONEROW2", Key:="P-O"
    sc2.Add Item:="CEC4030C.P_MODIFY2", Key:="P-M"
...
Public Sub Form_Pro()
    ...
    dLong_Slab_Edt_Seq = Gf_FloatFind(M_CN1, "SELECT NVL(MAX(SLAB_EDT_SEQ),0) FROM EP_C3_REQ_SLAB_EDT ")
...
Private Sub ss1_Click(ByVal Col As Long, ByVal Row As Long)
    ...
    If cRow <> 0 Then
        ...
        If ss1.Text = "" Then
            ...
            ss1.Col = 23:   txt_sms_plt.Text = ss1.Text
        Else
            If Not Gf_Sp_Cls(sc2) Then Exit Sub
            ss1.Col = 0:    ss1.Text = ""
