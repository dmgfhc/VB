...
Begin VB.Form ACE6040C 
   Caption         =   "在制品替代分板处理(单订单)_ACE6040C"
   ClientHeight    =   3030
   ClientLeft      =   120
   ClientTop       =   450
   ClientWidth     =   4560
   ...
   Begin SSSplitter.SSSplitter SSSplitter1 
      ...
      Begin FPSpread.vaSpread ss2 
         ...
         SpreadDesigner  =   "ACE6040C.frx":0072
      End
      Begin Threed.SSPanel SSPanel1 
         ...
         Begin VB.ComboBox CBO_REP_NUM 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "ACE6040C.frx":0D4B
            Left            =   14370
            List            =   "ACE6040C.frx":0D67
            TabIndex        =   25
            Text            =   "1"
            Top             =   855
            Width           =   750
      ...
      Begin FPSpread.vaSpread ss1 
         ...
         MaxRows         =   1
         RetainSelBlock  =   0   'False
         SpreadDesigner  =   "ACE6040C.frx":0D8B
      End
   End
End
Attribute VB_Name = "ACE6040C"
...
Const SS1_REP_NUM = 28              ' 替代数量
Const SS1_USER_ID = 29              ' 替代人

Const SS2_ORDER_NO = 1              ' 替代订单
Const SS2_ORDER_ITEM = 2            ' 替代序列
...
Private Sub Form_Define()
  ...
  Call Gp_Sp_Collection(ss1, SS1_ORDER_ITEM, " ", " ", " ", "i", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
     Call Gp_Sp_Collection(ss1, SS1_REP_NUM, " ", " ", " ", "i", " ", " ", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
     Call Gp_Sp_Collection(ss1, SS1_USER_ID, " ", " ", " ", "i", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    
    'Spread_Collection
    sc1.Add Item:=ss1, Key:="Spread"
    sc1.Add Item:="ACE6040C.P_REFER1", Key:="P-R"
    sc1.Add Item:="ACE6040C.P_MODIFY1", Key:="P-M"
    ...
    sc2.Add Item:="ACE6040C.P_REFER2", Key:="P-R"
...
Public Sub Form_Pro()
    ...
    For iCount = 1 To ss1.MaxRows
        ...
        Select Case ss1.Text
               Case "Update"
                ss1.Col = SS1_REP_NUM
                ss1.Value = Trim(CBO_REP_NUM.Text)
        End Select
...
Private Sub ss2_Click(ByVal Col As Long, ByVal Row As Long)
    ...
    ss2.Row = Row
    ss2.Col = SS2_ORDER_NO
    sOrd_No = ss2.Text
    ss2.Col = SS2_ORDER_ITEM
    sOrd_Item = ss2.Text
