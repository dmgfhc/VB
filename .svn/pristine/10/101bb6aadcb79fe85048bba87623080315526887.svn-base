...
Begin VB.Form AKH1090C 
   ...
   Begin Threed.SSFrame Frame1 
      ...
      Begin VB.ComboBox cbo_caster_id 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "AKH1090C.frx":0000
         Left            =   11205
         List            =   "AKH1090C.frx":0002
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "AKH1090C.frx":0004
   End
End
Attribute VB_Name = "AKH1090C"
...
Private Sub Form_Define()
    ...
    Call Gp_Ms_Collection(SDT_FROM_DATE, "p", " ", " ", " ", " ", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
      Call Gp_Ms_Collection(SDT_TO_DATE, "p", " ", " ", " ", " ", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
    ...
    Call Gp_Ms_Collection(cbo_caster_id, "p", " ", " ", " ", " ", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
...
'---------------------------------------------------------------------------------------------------------------------------------------------------------------
   ...
   Call Gp_Sp_Collection(ss1, 14, " ", " ", " ", " ", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    sc1.Add Item:="AKH1090C.P_SREFER", Key:="P-R"
...
Private Sub Form_Load()
    ...
    SDT_FROM_DATE.Text = Format(Now, "YYYY-MM-DD")
'    + "-01"
