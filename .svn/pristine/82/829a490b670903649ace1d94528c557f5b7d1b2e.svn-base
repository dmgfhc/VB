...
'        Else
'            Call Gp_MsgBoxDisplay("只能从主画面登陆订单管理系统...", "W")
'            Unload Me
'        End If
'
''            sUserID = "1JS1005"
