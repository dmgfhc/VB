...
Begin VB.Form DGA1052C 
   Caption         =   "中板热处理矫直实绩查询及修改_DGA1052C"
   ClientHeight    =   11010
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   15240
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      ProcessTab      =   -1  'True
      Protect         =   0   'False
      SpreadDesigner  =   "DGA1052C.frx":0000
   End
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin VB.ComboBox cbo_PrcLine 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "DGA1052C.frx":0DB3
         Left            =   4005
         List            =   "DGA1052C.frx":0DB5
         Locked          =   -1  'True
         TabIndex        =   4
         Tag             =   "炉座号"
         Top             =   180
