...
Begin VB.Form AQD0101C 
   Caption         =   "被清空试样号查询_AQD0101C"
   ClientHeight    =   9090
   ClientLeft      =   165
   ClientTop       =   1605
   ClientWidth     =   15240
   ...
   Begin VB.ComboBox CBO_SHIFT 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "AQD0101C.frx":0000
      Left            =   10560
      List            =   "AQD0101C.frx":000D
      TabIndex        =   7
      Top             =   120
      Width           =   735
   End
   Begin VB.ComboBox CBO_GROUP 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "AQD0101C.frx":001A
      Left            =   10560
      List            =   "AQD0101C.frx":002A
      TabIndex        =   6
      Top             =   600
      Width           =   735
   End
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "AQD0101C.frx":003A
   End
   ...
   Begin InDate.ULabel ULabel1 
      ...
      EndProperty
   End
   Begin InDate.UDate dtp_SEND_DATE_1 
      Height          =   315
      Left            =   6120
      TabIndex        =   4
      Tag             =   "质量设计日期"
      ...
      BackColor       =   16777215
   End
   Begin InDate.UDate dtp_SEND_DATE_2 
      Height          =   315
      Left            =   7630
      TabIndex        =   5
      Tag             =   "质量设计日期"
...
Private Sub Form_Define()
    ...
    Call Gp_Ms_Collection(dtp_SEND_DATE_1, "p", " ", " ", " ", "r", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
    Call Gp_Ms_Collection(dtp_SEND_DATE_2, "p", " ", " ", " ", "r", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
    ...
    Sc1.Add Item:="AQD0101C.P_REFER", Key:="P-R"
...
Private Sub Form_Activate()
    ...
    dtp_INS_DATE_1 = Date - Day(Now) + 1
    dtp_INS_DATE_2 = Date
    dtp_SEND_DATE_1 = Date - Day(Now) + 1
    dtp_SEND_DATE_2 = Date
    txt_PLT.SetFocus
