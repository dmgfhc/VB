...
Begin VB.Form AHD0180C 
   Caption         =   "经营部 出入库月平衡报表（入库）_AHD0180C"
   ClientHeight    =   3195
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   4680
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      ProcessTab      =   -1  'True
      Protect         =   0   'False
      SpreadDesigner  =   "AHD0180C.frx":0000
   End
...
Private Sub Form_Define()
   ...
   Call Gp_Sp_Collection(ss1, 18, " ", " ", " ", " ", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    sc1.Add Item:="AHD0180C.P_REFER", Key:="P-R"
...
Public Sub Form_Ref()
    ...
    sQuery = "{call AHD0180C.P_REFER ('" + dtp_yy_mm2.RawData + "','" + txt_plt.Text + "')}"
