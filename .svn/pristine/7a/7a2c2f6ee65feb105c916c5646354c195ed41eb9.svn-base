...
Begin VB.Form ACE7000C 
   Caption         =   "录入自动替代标准_ACE7000C"
   ClientHeight    =   3030
   ClientLeft      =   120
   ClientTop       =   450
   ClientWidth     =   4560
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.TextBox txt_prod_cd_name 
         ...
         Width           =   1590
      End
      Begin Threed.SSCommand cmd_auto_rep 
         Height          =   420
         Left            =   9330
         TabIndex        =   6
         TabStop         =   0   'False
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "ACE7000C.frx":0000
   End
End
Attribute VB_Name = "ACE7000C"
...
Private Sub Form_Define()
 ...
 Call Gp_Ms_Collection(txt_prod_cd_name, " ", " ", " ", " ", "r", " ", "l", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
   ...
   Call Gp_Sp_Collection(ss1, 11, " ", " ", " ", " ", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    sc1.Add Item:="ACE7000C.P_MODIFY", Key:="P-M"
    sc1.Add Item:="ACE7000C.P_REFER", Key:="P-R"
    sc1.Add Item:="ACE7000C.P_ONEROW", Key:="P-O"
...
Private Sub cmd_auto_rep_Click()
...
On Error GoTo Process_Exec_ERROR
    ...
    sQuery = "{call ACE7010P ('" + txt_ord_no.Text + "', '" + cbo_ord_item.Text + "','" + TXT_ORD_KND.Text + "',?)}"
    ...
    Else
        ...
        Call MsgBox("自动替代结束！", vbInformation, "系统提示信息")
...
Private Sub Form_Load()
    ...
    txt_plt.Text = "**"
    txt_plt_name.Text = "中厚板卷厂"
    txt_prod_cd.Text = "PP"
    txt_prod_cd_name.Text = "热轧钢板"
    
    Call txt_plt_KeyUp(0, 0)
    
    If Mid(sAuthority, 4, 1) <> "1" Then
       cmd_auto_rep.Enabled = False
    End If
        ...
        Case 4
            ...
            Else
                ...
                If Len(Trim(ss1.Text)) = ss1.TypeMaxEditLen Then
                    sTemp_Code = ss1.Text
                    ss1.Col = 4
                    ss1.Text = Gf_ComnNameFind(M_CN1, "C0025", Trim(sTemp_Code), 3)    '3，显示中文简称，2，显示中文全称
                Else
                    ss1.Col = 4
                    ss1.Text = ""
                End If
