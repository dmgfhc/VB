...
Begin VB.Form DGC1020C 
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "DGC1020C.frx":0000
   End
   Begin VB.ComboBox CBO_DELAY_CD 
      BeginProperty Font 
         Name            =   "宋体"
         Size            =   9.75
         Charset         =   134
      ...
      EndProperty
      Height          =   315
      ItemData        =   "DGC1020C.frx":1BB9
      Left            =   10710
      List            =   "DGC1020C.frx":1BD2
      TabIndex        =   3
      Tag             =   "延迟原因"
      Top             =   120
      Width           =   2640
...
Private Sub Form_Define()
    ...
    Call Gp_Ms_Collection(SDT_PROD_DATE_TO, "p", "n", " ", " ", " ", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
        Call Gp_Ms_Collection(CBO_DELAY_CD, "p", " ", " ", " ", " ", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
    ...
    'Call Spread_Collection("Column_Num", "p(primary)", "n(Necessary)", "m(maxlength)", "i(insert)", "a(append_down), "l(lock)")
     Call Gp_Sp_Collection(ss1, 1, "p", " ", " ", " ", " ", " ", pColumn, nColumn, mColumn, iColumn, aColumn, lColumn)
    ...
    sc1.Add Item:="DGC1020C.P_SREFER", Key:="P-R"
    sc1.Add Item:="DGC1020C.P_SONEROW", Key:="P-O"
    sc1.Add Item:="DGC1020C.P_SMODIFY", Key:="P-M"
...
Private Sub Form_Load()
    ...
    SDT_PROD_DATE_TO.RawData = Format(Now, "YYYYMMDD") & "2359"
    
    Call Gp_Sp_ColGet(Proc_Sc("Sc")("Spread"), "DG-System.INI", Me.Name)
    
    Call Gf_ComboAdd(M_CN1, CBO_DELAY_CD, "SELECT CD || '  ' || CD_SHORT_NAME  FROM ZP_CD WHERE CD_MANA_NO='G0041'")
    ...
    Select Case ss1.ActiveCol
        ...
        Case 5
            ...
            Else
                    ...
                    If Len(Trim(ss1.Text)) < 3 Then
                        ss1.Col = 6
                        ss1.Text = ""
                    ElseIf Len(Trim(ss1.Text)) = 3 Then
                        sTemp_Code = ss1.Text
                        ss1.Col = 6
                        ss1.Text = Gf_ComnNameFind(M_CN1, "G0041", Trim(sTemp_Code), 1)
                    End If
            End If
