...
Begin VB.Form AFT3016C 
   Caption         =   "炼钢非计划统计报表_AFT3016C"
   ClientHeight    =   3030
   ClientLeft      =   120
   ClientTop       =   450
   ClientWidth     =   4560
   ...
   Begin SSSplitter.SSSplitter SSSplitter1 
      ...
      Begin FPSpread.vaSpread ss1 
         ...
         SpreadDesigner  =   "AFT3016C.frx":0052
      End
   End
End
Attribute VB_Name = "AFT3016C"
...
'---------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    sc1.Add Item:="AFT3016C.P_SREFER", Key:="P-R"
