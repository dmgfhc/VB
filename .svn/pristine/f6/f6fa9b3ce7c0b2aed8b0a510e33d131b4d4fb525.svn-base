...
Begin VB.Form AEA1110C 
   Caption         =   "录入作业准备时间_AEA1110C"
   ClientHeight    =   9540
   ClientLeft      =   225
   ClientTop       =   1500
   ClientWidth     =   15240
   ...
   Begin FPSpread.vaSpread SS1 
      ...
      SpreadDesigner  =   "AEA1110C.frx":0000
   End
End
Attribute VB_Name = "AEA1110C"
...
Call Gp_Ms_Collection(txt_prc_line, "p", "n", "m", " ", "r", "a", "l", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
    ...
    Sc1.Add Item:="AEA1110C.P_MODIFY", Key:="P-M"
    Sc1.Add Item:="AEA1110C.P_REFER", Key:="P-R"
    Sc1.Add Item:="AEA1110C.P_ONEROW", Key:="P-O"
