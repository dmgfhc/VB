...
Begin VB.Form AAA1120C 
   Caption         =   "月 公辅材料 计划使用量查询_AAA1120C"
   ClientHeight    =   8250
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   15240
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "AAA1120C.frx":0000
   End
...
Private Sub Form_Define()
    ...
    'Call Master_Collection("Control_Name", "p(primary)", "n(Necessary)", "m(maxlength)", "i(insert)", "r(refer)", "a(append)", "l(lock)")
      Call Gp_Ms_Collection(dtp_YEAR_MONTH, "p", " ", " ", " ", "r", " ", "l", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
        ...
        Call Gp_Ms_Collection(txt_PRC_LINE, "P", " ", " ", " ", "r", " ", "l", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
...
'   Call Gp_Sp_Collection(ss1, 15, " ", " ", " ", " ", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    sc1.Add Item:="AAA1120C.P_REFER", Key:="P-R"
    sc1.Add Item:="AAA1120C.P_ONEROW", Key:="P-O"
...
'    .Buttons(9).Enabled = False                    'Row Cance
