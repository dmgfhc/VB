...
Const SS1_EXTRA_FL = 34   '2011-8-30  add by LiQian 营销部要求以前的目的地(流向)改为针对客户添加的流向(如A,B,C,等等),并打印显示在码单上
