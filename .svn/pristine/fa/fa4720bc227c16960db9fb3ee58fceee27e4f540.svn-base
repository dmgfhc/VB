...
Begin VB.Form ACB4030C 
   Caption         =   "转库实绩查询_ACB4030C"
   ClientHeight    =   7200
   ClientLeft      =   225
   ClientTop       =   1650
   ClientWidth     =   15240
   ...
   Begin SSSplitter.SSSplitter SSSplitter1 
      ...
      Begin FPSpread.vaSpread ss2 
         ...
         SpreadDesigner  =   "ACB4030C.frx":0052
      End
      Begin FPSpread.vaSpread ss1 
         ...
         ScrollBarExtMode=   -1  'True
         SpreadDesigner  =   "ACB4030C.frx":089E
      End
   End
   Begin VB.Line Line1 
...
Private Sub Form_Define()
   ...
   Call Gp_Sp_Collection(ss1, 17, " ", " ", " ", "i", " ", " ", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    sc1.Add Item:="ACB4030C.P_REFER", Key:="P-R"
    sc1.Add Item:="ACB4030C.P_MODIFY", Key:="P-M"
...
Private Sub cmd_input_Click()
    ...
    With ss1
        For iDx = 1 To .MaxRows
            ...
            .Col = 16:     .Text = Trim(txt_input_date.Text)
            .Col = 17:     .Text = sUserID
            .Col = 0:      .Text = "Update"
        Next iDx
    End With
...
Private Sub txt_input_date_Click()
    ...
    txt_input_date.RawData = AdoRs.Fields(0)
...
Private Sub ExcelPrn()
    ...
    Set Wb = xlApp.Workbooks.Open(App.Path & "\ACB4030C.xls")
...
'    Next I
    ...
    Clipboard.Clear
    ss1.SetSelection 9, 1, 13, ss1.MaxRows
    ss1.ClipboardCopy
