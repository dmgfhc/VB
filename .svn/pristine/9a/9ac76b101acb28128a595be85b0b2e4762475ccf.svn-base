...
Begin VB.Form AEA2016C 
   Caption         =   "辊期标准公里数录入_AEA2016C"
   ClientHeight    =   9180
   ClientLeft      =   870
   ClientTop       =   1755
   ClientWidth     =   11010
   ...
   Begin FPSpread.vaSpread SS1 
      ...
      SpreadDesigner  =   "AEA2016C.frx":0000
   End
End
Attribute VB_Name = "AEA2016C"
...
Private Sub Form_Define()
   ...
   Call Gp_Sp_Collection(SS1, 12, " ", " ", " ", " ", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    Sc1.Add Item:="AEA2016C.P_MODIFY", Key:="P-M"
    Sc1.Add Item:="AEA2016C.P_REFER", Key:="P-R"
    Sc1.Add Item:="AEA2016C.P_ONEROW", Key:="P-O"
