...
Begin VB.Form CKP1313C 
   Caption         =   "中板厂生产质量简报_CKP1313C"
   ClientHeight    =   3030
   ClientLeft      =   120
   ClientTop       =   450
   ClientWidth     =   4560
   ...
   Begin SSSplitter.SSSplitter SSSplitter1 
      ...
      Begin FPSpread.vaSpread ss1 
         ...
         SpreadDesigner  =   "CKP1313C.frx":00D2
      End
      Begin FPSpread.vaSpread ss2 
         ...
         MaxRows         =   5
         RetainSelBlock  =   0   'False
         SpreadDesigner  =   "CKP1313C.frx":0EA8
      End
      Begin FPSpread.vaSpread ss3 
         ...
         MaxRows         =   5
         RetainSelBlock  =   0   'False
         SpreadDesigner  =   "CKP1313C.frx":1B53
      End
      Begin FPSpread.vaSpread ss4 
         ...
         MaxRows         =   5
         RetainSelBlock  =   0   'False
         SpreadDesigner  =   "CKP1313C.frx":27E7
      End
      Begin FPSpread.vaSpread ss5 
         ...
         MaxRows         =   5
         RetainSelBlock  =   0   'False
         SpreadDesigner  =   "CKP1313C.frx":346F
      End
      Begin FPSpread.vaSpread ss6 
         ...
         MaxRows         =   5
         RetainSelBlock  =   0   'False
         SpreadDesigner  =   "CKP1313C.frx":40D2
      End
   End
...
Private Sub Form_Define()
   ...
   Call Gp_Sp_Collection(ss1, 28, " ", " ", " ", " ", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    Sc1.Add Item:="CKP1313C.P_SREFER1", Key:="P-R"
   ...
   Call Gp_Sp_Collection(ss2, 31, " ", " ", " ", " ", " ", "l", pColumn2, nColumn2, mColumn2, iColumn2, aColumn2, lColumn2)
    ...
    Sc2.Add Item:="CKP1313C.P_SREFER2", Key:="P-R"
   ...
   Call Gp_Sp_Collection(ss3, 30, " ", " ", " ", " ", " ", "l", pColumn3, nColumn3, mColumn3, iColumn3, aColumn3, lColumn3)
    ...
    Sc3.Add Item:="CKP1313C.P_SREFER3", Key:="P-R"
   ...
   Call Gp_Sp_Collection(ss4, 28, " ", " ", " ", " ", " ", "l", pColumn4, nColumn4, mColumn4, iColumn4, aColumn4, lColumn4)
   ...
   Call Gp_Sp_Collection(ss4, 30, " ", " ", " ", " ", " ", "l", pColumn4, nColumn4, mColumn4, iColumn4, aColumn4, lColumn4)
    ...
    sc4.Add Item:="CKP1313C.P_SREFER4", Key:="P-R"
   ...
   Call Gp_Sp_Collection(ss5, 24, " ", " ", " ", " ", " ", "l", pColumn5, nColumn5, mColumn5, iColumn5, aColumn5, lColumn5)
   Call Gp_Sp_Collection(ss5, 25, " ", " ", " ", " ", " ", "l", pColumn5, nColumn5, mColumn5, iColumn5, aColumn5, lColumn5)
   Call Gp_Sp_Collection(ss5, 26, " ", " ", " ", " ", " ", "l", pColumn5, nColumn5, mColumn5, iColumn5, aColumn5, lColumn5)
   Call Gp_Sp_Collection(ss5, 27, " ", " ", " ", " ", " ", "l", pColumn5, nColumn5, mColumn5, iColumn5, aColumn5, lColumn5)
   Call Gp_Sp_Collection(ss5, 28, " ", " ", " ", " ", " ", "l", pColumn5, nColumn5, mColumn5, iColumn5, aColumn5, lColumn5)
   Call Gp_Sp_Collection(ss5, 29, " ", " ", " ", " ", " ", "l", pColumn5, nColumn5, mColumn5, iColumn5, aColumn5, lColumn5)
   Call Gp_Sp_Collection(ss5, 30, " ", " ", " ", " ", " ", "l", pColumn5, nColumn5, mColumn5, iColumn5, aColumn5, lColumn5)
    
    'Spread_Collection
    sc5.Add Item:=ss5, Key:="Spread"
    sc5.Add Item:="CKP1313C.P_SREFER5", Key:="P-R"
    ...
    sc5.Add Item:=ss5.MaxRows, Key:="Last"
   ...
   Call Gp_Sp_Collection(ss6, 16, " ", " ", " ", " ", " ", "l", pColumn6, nColumn6, mColumn6, iColumn6, aColumn6, lColumn6)
   Call Gp_Sp_Collection(ss6, 17, " ", " ", " ", " ", " ", "l", pColumn6, nColumn6, mColumn6, iColumn6, aColumn6, lColumn6)
   Call Gp_Sp_Collection(ss6, 18, " ", " ", " ", " ", " ", "l", pColumn6, nColumn6, mColumn6, iColumn6, aColumn6, lColumn6)
   Call Gp_Sp_Collection(ss6, 19, " ", " ", " ", " ", " ", "l", pColumn6, nColumn6, mColumn6, iColumn6, aColumn6, lColumn6)
   Call Gp_Sp_Collection(ss6, 20, " ", " ", " ", " ", " ", "l", pColumn6, nColumn6, mColumn6, iColumn6, aColumn6, lColumn6)
   Call Gp_Sp_Collection(ss6, 21, " ", " ", " ", " ", " ", "l", pColumn6, nColumn6, mColumn6, iColumn6, aColumn6, lColumn6)
   Call Gp_Sp_Collection(ss6, 22, " ", " ", " ", " ", " ", "l", pColumn6, nColumn6, mColumn6, iColumn6, aColumn6, lColumn6)
   Call Gp_Sp_Collection(ss6, 23, " ", " ", " ", " ", " ", "l", pColumn6, nColumn6, mColumn6, iColumn6, aColumn6, lColumn6)
   Call Gp_Sp_Collection(ss6, 24, " ", " ", " ", " ", " ", "l", pColumn6, nColumn6, mColumn6, iColumn6, aColumn6, lColumn6)
    
    'Spread_Collection
    sc6.Add Item:=ss6, Key:="Spread"
    sc6.Add Item:="CKP1313C.P_SREFER6", Key:="P-R"
    ...
    sc6.Add Item:=ss6.MaxRows, Key:="Last"
...
Private Sub Form_Load()
    ...
    Call Sp_Setting(sc4.Item("Spread"))
    Call Sp_Setting(sc5.Item("Spread"))
    ...
    Call Gp_Sp_ColGet(Proc_Sc("Sc5")("Spread"), "K-System.INI", Me.Name)
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
    ...
    Call Gp_Sp_ColSet(Proc_Sc("Sc5")("Spread"), "K-System.INI", Me.Name)
...
Public Sub Form_Ref()
    ...
    If Sp_Display(M_CN1, Proc_Sc("Sc1")("Spread"), Gf_Ms_MakeQuery(Proc_Sc("Sc1").Item("P-R"), "R", Mc1("pControl"))) Then
       ...
       Call Sp_Display2(M_CN1, Proc_Sc("Sc3")("Spread"), Gf_Ms_MakeQuery(Proc_Sc("Sc3").Item("P-R"), "R", Mc1("pControl")))
'       Call Sp_Display2(M_CN1, Proc_Sc("Sc4")("Spread"), Gf_Ms_MakeQuery(Proc_Sc("Sc4").Item("P-R"), "R", Mc1("pControl")))
'       Call Sp_Display3(M_CN1, Proc_Sc("Sc5")("Spread"), Gf_Ms_MakeQuery(Proc_Sc("Sc5").Item("P-R"), "R", Mc1("pControl")))
    End If
...
Private Sub Cmd_Edit_Click()
    ...
    sQuery = "{call CKP1312P ('" + Trim(Format(txt_DATE.Text, "YYYYMMDD")) + "',?)}"
...
Private Sub ExcelPrn()
    ...
    xlApp.Workbooks.Open (App.Path & "\CKP1312C.xls")
    ...
    xlApp.Range("B40").Value = "制表日期：" + Format(Now, "YYYY-MM-DD HH:MM:SS")
    xlApp.Range("Q40").Value = "制表人：" + sUserID
    ...
    Clipboard.Clear
    ss4.SetSelection 1, 1, ss4.MaxCols, ss4.MaxRows
    ss4.ClipboardCopy
    xlApp.Range("B32").Select
    xlApp.ActiveSheet.Paste
    
    Clipboard.Clear
    ss5.SetSelection 1, 1, ss5.MaxCols, ss5.MaxRows
    ss5.ClipboardCopy
    xlApp.Range("B39").Select
    xlApp.ActiveSheet.Paste
...
'        .ClearRange 1, 1, .MaxCols, .MaxRows, True
        ...
        If UBound(ArrayRecords, 2) <> 0 Then
            ...
            For iRowCount = 0 To UBound(ArrayRecords, 2)
                ...
                Select Case Mid(Trim(ArrayRecords(0, iRowCount)), 1, 1)
                    Case "A"
                        .ROW = 1
                    Case "B"
                        .ROW = 2
                ...
                For iColcount = 1 To .MaxCols / 2
                    
                    Select Case Mid(Trim(ArrayRecords(0, iRowCount)), 2, 1)
                        Case "0"
                            .Col = iColcount * 2 - 1
                        Case "1"
                            .Col = iColcount * 2
