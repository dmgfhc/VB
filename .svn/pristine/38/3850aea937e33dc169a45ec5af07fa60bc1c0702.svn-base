...
Const SS1_SLAB_NO = 1
Const SS1_URGNT_FL = 22          '紧急订单绿色标记  2012-11-07 by CaoLei
Const SS1_ORD_NO = 12
...
Private Sub Form_Define()
    ...
    Call Gp_Sp_Collection(ss1, 22, " ", " ", " ", "i", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)  '紧急订单绿色标记  2012-11-07 by CaoLei
...
Public Sub Form_Pro()
    ...
    If Val(str(sdb_slab_wgt.VALUE)) < Val(str(sdb_cut_wgt.VALUE)) Then
        Call Gp_MsgBoxDisplay("母板坯重量 < 切割重量.....", "I")
        Exit Sub
    End If
    
    If Val(str(sdb_slab_wgt.VALUE)) <> Val(str(sdb_cut_wgt.VALUE)) Then
        If Not Gf_MessConfirm("母板坯重量 <> 切割重量.....", "I") Then
            Exit Sub
        End If
    End If
