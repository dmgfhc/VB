...
Begin VB.Form ABB1049C 
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "板坯设计结果查询_ABB1049C"
   ClientHeight    =   5835
   ClientLeft      =   120
   ClientTop       =   450
   ClientWidth     =   12045
   ...
   Begin SSSplitter.SSSplitter SSSplitter1 
      ...
      Begin FPSpread.vaSpread ss1 
         ...
         SpreadDesigner  =   "ABB1049C.frx":0052
      End
      Begin FPSpread.vaSpread ss2 
         ...
         MaxRows         =   2
         RetainSelBlock  =   0   'False
         SpreadDesigner  =   "ABB1049C.frx":0DF9
      End
   End
...
Private Sub Form_Define()
   ...
   Call Gp_Sp_Collection(ss1, 24, " ", " ", " ", " ", " ", " ", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    sc1.Add Item:="ABB1049C.P_REFER", Key:="P-R"
    ...
    sc2.Add Item:="ABB1049C.P_REFER2", Key:="P-R"
