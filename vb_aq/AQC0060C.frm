...
Begin VB.Form AQC0060C 
   BackColor       =   &H00E0E0E0&
   Caption         =   "钢板取样信息查询及修改界面_AQC0060C"
   ClientHeight    =   8505
   ClientLeft      =   360
   ClientTop       =   1890
   ClientWidth     =   11400
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.ComboBox CBO_GROUP 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "AQC0060C.frx":0000
         Left            =   3780
         List            =   "AQC0060C.frx":0010
         TabIndex        =   20
         Top             =   600
         Width           =   735
      End
      ...
      Begin VB.ComboBox CBO_SHIFT 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "AQC0060C.frx":0020
         Left            =   3780
         List            =   "AQC0060C.frx":002D
         TabIndex        =   11
         Top             =   210
         Width           =   735
      End
   ...
   Begin SSSplitter.SSSplitter SSSplitter1 
      ...
      Begin FPSpread.vaSpread ss1 
         ...
         SpreadDesigner  =   "AQC0060C.frx":008C
      End
      Begin FPSpread.vaSpread ss2 
         ...
         Protect         =   0   'False
         RetainSelBlock  =   0   'False
         SpreadDesigner  =   "AQC0060C.frx":0865
      End
   End
   Begin VB.Line Line1 
      X1              =   60
...
'                    End If
    ...
    strQuery = strQuery & "   FROM  GP_COIL B                                                   " & vbCrLf
        ...
        For intRow = 1 To .MaxRows
            ...
            Else
                ...
                If txt_SMP_NO.Text = "" Then
                    If sSmpFl <> "" And Right(sSmpNo, 2) <> "00" Then
                        txt_SMP_NO.Text = sSmpNo
                    Else
                        If Len(Trim(txt_SMP_NO.Text)) <> 14 Then txt_SMP_NO.Text = sPlateNo
                    End If
                End If
...
'                .Row = iDr
                ...
                If Left(.Text, 1) <> "X" Then
                    ...
                    If sBefStdspec <> "" And sSTDSPEC <> sBefStdspec And (ExpoCheck(sBefStdspec) And Not ExpoCheck(sSTDSPEC)) Then
                        If Len(Trim(txt_CHG_SMP_NO.Text)) = 14 Then .Col = SS2_SMP_NO: .Text = txt_CHG_SMP_NO.Text
                    Else
                        If Len(Trim(txt_SMP_NO.Text)) = 14 Then .Col = SS2_SMP_NO: .Text = txt_SMP_NO.Text
                    End If
...
'                    .Row = iDr
                    ...
                    If strSmpNO = .Text Then
                        ...
                        .ForeColor = RED
                    Else
                        If sSmpFl = "P" And strSmpNO <> txt_SMP_NO.Text And Right(Trim(.Text), 2) <> "00" Then
...
'                            .Row = iDr:             .Row2 = iDr
                    ...
                    .Col = SS2_SMP_NO
                    If strSmpNO = txt_SMP_NO.Text And Right(Trim(.Text), 2) = "00" Then
                        sSmpFl = "P"
                    End If
                End If
'            Next iDr
    ...
    If Row > 0 Then
        ...
        If Col = SS2_SMP_FLAG Then
         ...
         ElseIf Col = SS2_SMP_NO Then
            ...
            strSmpNO = ss2.Text
            ss2.Col = Col
            If Len(ss2.Text) <> Len(strSmpNO) Or Left(ss2.Text, 8) <> Left(strSmpNO, 8) Then
