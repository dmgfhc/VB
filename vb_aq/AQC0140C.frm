...
Begin VB.Form AQC0140C 
   Caption         =   "性能未完成试样号查询及终结界面_AQC0140C"
   ClientHeight    =   8415
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   10605
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "AQC0140C.frx":0000
   End
   Begin InDate.UDate dtp_TEST_INS_DATE_TO 
      Height          =   315
      Left            =   2880
      TabIndex        =   5
      Tag             =   "指示日期"
      ...
      BackColor       =   16777215
   End
   Begin InDate.UDate dtp_TEST_INS_DATE_FR 
      Height          =   315
      Left            =   1350
      TabIndex        =   4
      Tag             =   "指示日期"
...
Private Sub Form_Define()
   ...
   Call Gp_Ms_Collection(dtp_TEST_INS_DATE_FR, "p", "n", " ", " ", " ", " ", "l", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
   Call Gp_Ms_Collection(dtp_TEST_INS_DATE_TO, "p", "n", " ", " ", " ", " ", "l", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
   ...
   Call Gp_Sp_Collection(ss1, 27, " ", " ", " ", " ", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    Sc1.Add Item:="AQC0140C.P_REFER", Key:="P-R"
...
Private Sub Form_Load()
   ...
   dtp_TEST_INS_DATE_FR.Text = DateAdd("d", -1, Date)
   dtp_TEST_INS_DATE_TO.Text = Date
