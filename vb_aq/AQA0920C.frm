...
Begin VB.Form AQA0920C 
   ...
   Begin Threed.SSFrame Frame1 
      ...
      Begin VB.ComboBox cbo_prc_line 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "AQA0920C.frx":0000
         Left            =   1530
         List            =   "AQA0920C.frx":0002
         TabIndex        =   2
         Tag             =   "连铸机号"
         Top             =   120
         Width           =   870
      ...
      Begin VB.ComboBox CBO_STLGRD 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "AQA0920C.frx":0004
         Left            =   4470
         List            =   "AQA0920C.frx":002C
         TabIndex        =   1
         Top             =   120
         Width           =   2175
      End
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "AQA0920C.frx":00BC
   End
End
Attribute VB_Name = "AQA0920C"
...
'---------------------------------------------------------------------------------------------------------------------------------------------------------------
   ...
   Call Gp_Sp_Collection(ss1, 15, " ", " ", " ", " ", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    Sc1.Add Item:="AQA0920C.P_MODIFY", Key:="P-M"
    Sc1.Add Item:="AQA0920C.P_REFER", Key:="P-R"
