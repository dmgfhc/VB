...
Begin VB.Form AQA0800C 
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "AQA0800.frx":0000
   End
   Begin InDate.ULabel ULabel1 
      Height          =   315
      Index           =   1
...
Private Sub Form_Define()
  ...
  Call Gp_Ms_Collection(txt_STDSPEC, "p", " ", " ", " ", "r", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
    ...
    Sc1.Add Item:="AQA0800C.P_MODIFY", Key:="P-M"
    Sc1.Add Item:="AQA0800C.P_REFER", Key:="P-R"
    Sc1.Add Item:="AQA0800C.P_ONEROW", Key:="P-O"
