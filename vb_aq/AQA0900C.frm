...
Begin VB.Form AQA0900C 
   ...
   Begin Threed.SSFrame Frame1 
      ...
      Begin VB.ComboBox cbo_prc_line 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "AQA0900C.frx":0000
         Left            =   1530
         List            =   "AQA0900C.frx":0002
         TabIndex        =   2
         Tag             =   "连铸机号"
         Top             =   120
         Width           =   870
      End
      Begin VB.ComboBox CBO_STLGRD 
         BeginProperty Font 
            Name            =   "宋体"
            Size            =   9.75
            Charset         =   134
         ...
         EndProperty
         Height          =   315
         ItemData        =   "AQA0900C.frx":0004
         Left            =   4470
         List            =   "AQA0900C.frx":0017
         TabIndex        =   1
         Top             =   120
         Width           =   2175
      End
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "AQA0900C.frx":0062
   End
End
Attribute VB_Name = "AQA0900C"
...
Private Sub Form_Define()
    ...
    'Call Master_Collection("Control_Name", "p(primary)", "n(Necessary)", "m(maxlength)", "i(insert)", "r(refer)", "a(append)", "l(lock)")
          Call Gp_Ms_Collection(cbo_prc_line, "p", " ", " ", " ", "r", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
            Call Gp_Ms_Collection(CBO_STLGRD, "p", " ", " ", " ", "r", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
           Call Gp_Ms_Collection(txt_all_thk, "p", " ", " ", " ", "r", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
...
'---------------------------------------------------------------------------------------------------------------------------------------------------------------
   ...
   Call Gp_Sp_Collection(ss1, 16, " ", " ", " ", " ", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    Sc1.Add Item:="AQA0900C.P_MODIFY", Key:="P-M"
    Sc1.Add Item:="AQA0900C.P_REFER", Key:="P-R"
