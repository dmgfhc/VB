...
Begin VB.Form AQA0272C 
   Caption         =   "ERP下抛生产许可信息 - AQA0272C"
   ClientHeight    =   9090
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   15240
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "AQA0272.frx":0000
   End
End
Attribute VB_Name = "AQA0272C"
...
Private Sub Form_Define()
    ...
    Sc1.Add Item:="AQA0272C.P_MODIFY", Key:="P-M"
    Sc1.Add Item:="AQA0272C.P_REFER", Key:="P-R"
    Sc1.Add Item:="AQA0272C.P_ONEROW", Key:="P-O"
