...
Begin VB.Form AQA0271C 
   Caption         =   "船板交货状态维护界面-AQA0271C"
   ClientHeight    =   7245
   ClientLeft      =   60
   ClientTop       =   375
   ClientWidth     =   12945
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "AQA0271C.frx":0000
   End
...
'-- Program Name      船板交货状态维护界面
'-- Program ID        AQA0271C
'-- Document No       Q-00-0010(Specification)
'-- Designer          SUN BIN
'-- Coder             SUN BIN
'-- Date              2010.8.5
'-- Description       船板交货状态维护界面入
'-------------------------------------------------------------------------------
'-- UPDATE HISTORY  ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
'-------------------------------------------------------------------------------
...
'    Call Gp_Sp_Collection(ss1, 18, "p", "n", " ", "i", " ", " ", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    Sc1.Add Item:="AQA0271C.P_MODIFY", Key:="P-M"
    Sc1.Add Item:="AQA0271C.P_REFER", Key:="P-R"
    Sc1.Add Item:="AQA0271C.P_ONEROW", Key:="P-O"
...
On Error GoTo Err_Track:
    ...
    Select Case Me.ActiveControl.Name
        ...
        Case "txt_INSP_CD"                   '检查机关
            sCode = "Q0052"
            Set oCodeName = txt_INSP_NAME
