...
Begin VB.Form AQA0260C 
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "AQA0260C.frx":0000
   End
   Begin VB.ComboBox Cob_SMP_CLASS_CD 
      BeginProperty Font 
         Name            =   "宋体"
         Size            =   9.75
         Charset         =   134
      ...
      EndProperty
      Height          =   315
      ItemData        =   "AQA0260C.frx":1D5F
      Left            =   1365
      List            =   "AQA0260C.frx":1D61
      TabIndex        =   0
      Top             =   120
      Width           =   1845
   End
End
Attribute VB_Name = "AQA0260C"
...
Private Sub Form_Define()
    ...
    'Call Master_Collection("Control_Name", "p(primary)", "n(Necessary)", "m(maxlength)", "i(insert)", "r(refer)", "a(append)", "l(lock)")
      Call Gp_Ms_Collection(Cob_SMP_CLASS_CD, "p", " ", " ", " ", "r", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
    ...
    Sc1.Add Item:="AQA0260C.P_MODIFY", Key:="P-M"
    Sc1.Add Item:="AQA0260C.P_REFER", Key:="P-R"
    Sc1.Add Item:="AQA0260C.P_ONEROW", Key:="P-O"
    ...
    For i = 1 To 16
        ...
        Cob_SMP_CLASS_CD.AddItem Choose(i, "A-拉伸", "B-弯曲", "C-冲击", "E-时效", "F-脱碳层", "G-淬透性", "H-断口", "J-非金属夹杂", "K-酸浸", "L-反复弯曲", "M-锻平", "N-焊接", "P-SSCC", "Q-DWTT", "R-晶粒度", "S-抗氢裂能力")
    
    Next i
        Cob_SMP_CLASS_CD.ListIndex = 1
...
Public Sub Form_Ins()
    ...
    Else
        ...
        'Gp_Sp_InAuthority( project's name, useid cloumn no, 'insert' or 'update'or others)
        Call Gp_Sp_InAuthority(Proc_Sc("Sc"), 9)
        
        With ss1
            .Row = .ActiveRow
            .Col = 1: .Text = Left(Cob_SMP_CLASS_CD.Text, 1)
