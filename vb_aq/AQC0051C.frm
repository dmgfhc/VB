...
Begin VB.Form AQC0051C 
   Caption         =   "PWHT复样指示及下达界面_AQC0051C"
   ClientHeight    =   3120
   ClientLeft      =   60
   ClientTop       =   420
   ClientWidth     =   4680
   ...
   Begin SSSplitter.SSSplitter SSSplitter1 
      ...
      Begin FPSpread.vaSpread ss1 
         ...
         ProcessTab      =   -1  'True
         Protect         =   0   'False
         SpreadDesigner  =   "AQC0051C.frx":0032
      End
   End
   ...
   Begin InDate.ULabel ULabel1 
      ...
      ForeColor       =   16711680
   End
   Begin Threed.SSCommand cmd_AQC0051C 
      Height          =   390
      Left            =   11640
      TabIndex        =   11
      Top             =   480
...
Private Sub Form_Define()
    ...
    'Call Master_Collection("Control_Name", "p(primary)", "n(Necessary)", "m(maxlength)", "i(insert)", "r(refer)", "a(append)", "l(lock)")
        ...
        Call Gp_Ms_Collection(txt_STDSPEC, "p", " ", " ", " ", " ", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
         ...
         Call Gp_Ms_Collection(dtp_date_f, "p", "n", " ", " ", " ", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
         Call Gp_Ms_Collection(dtp_date_t, "p", "n", " ", " ", " ", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
...
'     Call Gp_Sp_Collection(ss1, 1, " ", " ", " ", "i", " ", " ", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
     ...
     Call Gp_Sp_Collection(ss1, 3, " ", " ", " ", " ", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)    '块数
     Call Gp_Sp_Collection(ss1, 4, " ", " ", " ", " ", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)    '重量
    ...
    Sc1.Add Item:="AQC0051C.P_REFER", Key:="P-R"
    'Sc1.Add Item:="AQC0051C.P_ONEROW", Key:="P-O"
    Sc1.Add Item:="AQC0051C.P_MODIFY", Key:="P-M"
...
Private Sub cmd_AQC0051C_Click()
    Dim SMP_NO As String
    Dim SMP_CUT_LOC As String
     With ss1
     .Col = 1:
            .Row = ss1.ActiveRow
            SMP_NO = .Text
    ...
    With ss1
     .Col = 47:
            ...
            SMP_CUT_LOC = .Text
    End With
    AQC0052C.txt_smp_cut_loc = SMP_CUT_LOC
    AQC0052C.txt_smp_no = SMP_NO
    AQC0052C.Form_Ref
End Sub
