...
Begin VB.Form AQA0500C 
   Caption         =   "厚度附加值维护界面_AQA0500C"
   ClientHeight    =   3165
   ClientLeft      =   60
   ClientTop       =   375
   ClientWidth     =   11310
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "AQA0500C.frx":0000
   End
...
'-- Program Name      厚度附加值维护界面_AQA0500C
'-- Program ID        AQA0500C
'-- Document No       Q-00-0010(Specification)
'-- Designer          Sun Bin
'-- Coder             Sun Bin
'-- Date              2010.03.04
'-- Description       厚度附加值维护界面_AQA0500C
'-------------------------------------------------------------------------------
'-- UPDATE HISTORY  ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
'-------------------------------------------------------------------------------
...
Private Sub Form_Define()
    ...
    'Call Master_Collection("Control_Name", "p(primary)", "n(Necessary)", "m(maxlength)", "i(insert)", "r(refer)", "a(append)", "l(lock)")
       ...
       Call Gp_Ms_Collection(txt_ENDUSE_NAME, " ", " ", " ", " ", " ", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
    ...
    Sc1.Add Item:="AQA0500C.P_MODIFY", Key:="P-M"
    Sc1.Add Item:="AQA0500C.P_REFER", Key:="P-R"
    Sc1.Add Item:="AQA0500C.P_ONEROW", Key:="P-O"
