...
Begin VB.Form AQC0100C 
   ...
   Begin VB.ComboBox COB_SHIFT 
      Height          =   300
      ItemData        =   "AQC0100C.frx":0000
      Left            =   3720
      List            =   "AQC0100C.frx":000D
      TabIndex        =   5
      Top             =   570
      Width           =   810
   End
   ...
   Begin VB.ComboBox COB_GROUP 
      Height          =   300
      ItemData        =   "AQC0100C.frx":001A
      Left            =   1350
      List            =   "AQC0100C.frx":002A
      TabIndex        =   2
      Top             =   570
      Width           =   960
   End
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      ProcessTab      =   -1  'True
      Protect         =   0   'False
      SpreadDesigner  =   "AQC0100C.frx":003A
   End
...
Private Sub Form_Define()
    ...
    'Call Master_Collection("Control_Name", "p(primary)", "n(Necessary)", "m(maxlength)", "i(insert)", "r(refer)", "a(append)", "l(lock)")
     ...
     Call Gp_Ms_Collection(txt_Slab_NO, "p", " ", " ", " ", "r", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
       Call Gp_Ms_Collection(COB_GROUP, "p", " ", " ", " ", "r", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
       Call Gp_Ms_Collection(COB_SHIFT, "p", " ", " ", " ", "r", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
   ...
   Call Gp_Sp_Collection(ss1, 25, "p", " ", " ", " ", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    Sc1.Add Item:="AQC0100C.P_ONEROW", Key:="P-O"
    Sc1.Add Item:="AQC0100C.P_REFER", Key:="P-R"
    Sc1.Add Item:="AQC0100C.P_MODIFY", Key:="P-M"
...
'    End If
    ...
    Clipboard.Clear
    ss1.Row = 1: ss1.Col = 2: ss1.Row2 = ss1.MaxRows: ss1.Col2 = 20
