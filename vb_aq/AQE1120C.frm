...
Begin VB.Form AQE1120C 
   Caption         =   "板材产品技质部周简报_AQE1120C"
   ClientHeight    =   3090
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   4680
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "AQE1120C.frx":0000
   End
...
'
    ...
    Sc1.Add Item:="AQE1120C.P_REFER", Key:="P-R"
...
On Error GoTo Refer_Err
    ...
    sQuery = "{call AQE1120C.P_REFER ('" + DTP_DATE_FR.RawData + "','" + DTP_DATE_TO.RawData + "','" + txt_PLT.Text + "','" + txt_PROD_CD.Text + "')}"
    
    If Gf_Sp_ProceExist(Proc_Sc("Sc").Item("Spread")) Then Exit Sub
    
    If Gf_Multi_Stotal_Display(M_CN1, Proc_Sc("Sc"), sQuery, 1, 1, iSumCnt, iSumCol, False) Then
