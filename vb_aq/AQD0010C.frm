...
Begin VB.Form AQD0010C 
   Caption         =   "查询质量证明书_AQD0010C"
   ClientHeight    =   9090
   ClientLeft      =   -435
   ClientTop       =   2490
   ClientWidth     =   15795
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "AQD0010C.frx":0000
   End
...
Private Sub Form_Define()
    ...
    Sc1.Add Item:="AQD0010C.P_MODIFY_SEND", Key:="P-M"
    Sc1.Add Item:="AQD0010C.P_REFER", Key:="P-R"
    Sc1.Add Item:="AQD0010C.P_ONEROW", Key:="P-O"
...
Dim v_text As String
  ...
  If cmd_All.Caption = "全选" Then
    v_text = "1"
    cmd_All.Caption = "取消全选"
  Else
    v_text = "0"
    cmd_All.Caption = "全选"
  End If
...
Private Sub cmdReport_Click()
    ...
    Save_State = 0
        ...
        If ssp_PRN.Value = True Or ssp_ELE.Value = True Then
            Save_State = 0
        End If
    ...
    With ss1
       ...
       For i = 1 To .MaxRows
            ...
            If .Text = "1" Then
                ...
                Call SEND_ERP("U", 1, sCertNo, sEMP_ID)
...
Private Function SEND_ERP(iType As String, iCheck As String, Cert_No As String, EMP_ID As String) As Boolean
    ...
    sQuery = "{call AQD0010C.P_MODIFY ('" + iType + "', '" + iCheck + "','" + Cert_No + "','" + EMP_ID + "',?,?)}"
...
Private Function Electronic_certificate(sCertNo As String) As String
        ...
        Name "c:\ele_cert\cert.pdf" As "c:\" & sCertNo & ".pdf"
