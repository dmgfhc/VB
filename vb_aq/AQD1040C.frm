...
Begin VB.Form AQD1040C 
   Caption         =   "镍系钢钢板统计_AQD1040C"
   ClientHeight    =   9300
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   15360
   ...
   Begin SSSplitter.SSSplitter SSSplitter1 
      ...
      Begin FPSpread.vaSpread ss1 
         ...
         SpreadDesigner  =   "AQD1040C.frx":0052
      End
...
'-------------------------------------------------------------------------------
'-- System Name       质量管理
'-- Sub_System Name   质量证明书管理
'-- Program Name      镍系钢钢板统计界面
'-- Program ID        AQD1040C
...
Private Sub Form_Define()
   ...
   FormType = "Refer"
     ...
     Call Gp_Ms_Collection(txt_CONTROL_NO, "p", " ", " ", " ", "r", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
       ...
       Call Gp_Ms_Collection(udt_DATE_MIN, "p", "n", " ", " ", "r", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
       Call Gp_Ms_Collection(udt_DATE_MAX, "p", "n", " ", " ", "r", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
    ...
    Sc1.Add Item:="AQD1040C.P_SREFER", Key:="P-R"
