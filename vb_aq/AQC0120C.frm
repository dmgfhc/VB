...
Begin VB.Form AQC0120C 
   Caption         =   "委托单信息查询界面_AQC0120C"
   ClientHeight    =   8115
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   15240
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      ProcessTab      =   -1  'True
      Protect         =   0   'False
      SpreadDesigner  =   "AQC0120C.frx":0000
   End
...
Private Sub Form_Define()
  ...
  Call Gp_Ms_Collection(txt_OUT_SHEET_NO, "p", " ", " ", " ", "r", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
      ...
      Call Gp_Ms_Collection(txt_STD_SPEC, "p", " ", " ", " ", "r", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
    ...
    Sc1.Add Item:="AQC0120C.P_REFER", Key:="P-R"
