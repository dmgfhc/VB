...
Begin VB.Form AQA0400C 
   Caption         =   "做普标准管理_AQA0400C"
   ClientHeight    =   3195
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   4680
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "AQA0400C.frx":0000
   End
...
'-- Program Name      做普标准管理_AQA0400C
'-- Program ID        AQA0400C
'-- Document No       Q-00-0010(Specification)
'-- Designer          Lee Qing Yu
'-- Coder             Lee Qing Yu
'-- Date              2003.5.19
'-- Description       做普标准管理_AQA0400C
'-------------------------------------------------------------------------------
'-- UPDATE HISTORY  ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
'-------------------------------------------------------------------------------
...
Private Sub Form_Define()
    ...
    Sc1.Add Item:="AQA0400C.P_MODIFY", Key:="P-M"
    Sc1.Add Item:="AQA0400C.P_REFER", Key:="P-R"
    Sc1.Add Item:="AQA0400C.P_ONEROW", Key:="P-O"
