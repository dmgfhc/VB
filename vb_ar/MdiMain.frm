...
Begin VB.MDIForm MDIMain 
   ...
   Begin VB.Menu PopUp_Spread 
      ...
      End
   End
   Begin VB.Menu ARZ0000C 
      Caption         =   "接口现状"
      Begin VB.Menu Mnu_ARZ0040C 
         Caption         =   "ERP/MES接口状况汇总_ARZ0040C"
      End
      Begin VB.Menu Mnu_ARZ0010C 
         Caption         =   "接口现状查询及实绩再发送_ARZ0010C"
      End
   End
   Begin VB.Menu ARZ0001C 
      Caption         =   "接口项目管理"
      Begin VB.Menu Mnu_ARZ0020C 
         Caption         =   "基本接口项目管理_ARZ0020C"
      End
      Begin VB.Menu Mnu_ARZ0030C 
         Caption         =   "接口项目管理_ARZ0030C"
      End
   End
...
Private Sub MDIForm_Load()
    ...
    If GF_DbConnect = False Then
        Unload Me
    Else
'        Active_YN = GetSetting("NISCO", "EXE-FILE", "AR.exe")
'
'        If Active_YN = "1" Then
...
Private Sub MDIForm_QueryUnload(Cancel As Integer, UnloadMode As Integer)
    ...
    If FormLD Then
        ...
        If MsgBox("界面上有未处理的数据，" + vbCrLf + "仍然要退出当前系统吗？", MB_YESNO _
    ...
    If Cancel = False Then SaveSetting "NISCO", "EXE-FILE", "AR.exe", ""
...
On Error Resume Next
    ...
    If Screen.ActiveForm.Name = "MDIMain" Then
        ...
        If Button.Key = "Exit" Then
            If vbYes = MsgBox("退出" + Me.Caption + "吗？", vbQuestion + vbYesNo, Me.Caption) Then
                Unload Me
            End If
        End If
...
Private Sub Mnu_ARZ0010C_Click()
    ARZ0010C.Show
    ARZ0010C.SetFocus
End Sub

Private Sub Mnu_ARZ0020C_Click()
    ARZ0020C.Show
    ARZ0020C.SetFocus
End Sub

Private Sub Mnu_ARZ0030C_Click()
    ARZ0030C.Show
    ARZ0030C.SetFocus
End Sub

Private Sub Mnu_ARZ0040C_Click()
    ARZ0040C.Show
    ARZ0040C.SetFocus
End Sub
