...
Begin VB.Form ARZ0020C 
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "ARZ0020C.frx":0000
   End
End
Attribute VB_Name = "ARZ0020C"
...
Private Sub Form_Define()
    ...
    'Call Master_Collection("Control_Name", "p(primary)", "n(Necessary)", "m(maxlength)", "i(insert)", "r(refer)", "a(append)", "l(lock)")
      Call Gp_Ms_Collection(txt_if_cd, "p", " ", " ", " ", "r", " ", "l", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
    Call Gp_Ms_Collection(txt_if_name, " ", " ", " ", " ", "r", " ", "l", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
    ...
    sc1.Add Item:="ARZ0020C.P_MODIFY", Key:="P-M"
    sc1.Add Item:="ARZ0020C.P_REFER", Key:="P-R"
    sc1.Add Item:="ARZ0020C.P_ONEROW", Key:="P-O"
...
Private Sub ss1_EditMode(ByVal Col As Long, ByVal Row As Long, ByVal Mode As Integer, ByVal ChangeMade As Boolean)
    ...
    If Gf_Sc_Authority(sAuthority, "U") Then
        ...
        Call Gp_Sp_InAuthority(Proc_Sc("Sc"), 20)
    End If
...
Private Sub txt_if_cd_KeyUp(KeyCode As Integer, Shift As Integer)
    ...
    If KeyCode = vbKeyF4 Then
        ...
        Load ARX0010C
        ARX0010C.txt_form_nm.Text = "ARZ0020C"
        ARX0010C.Show 1
