...
Begin VB.Form DED1012C 
   Caption         =   "宽厚板热处理作业对象指示_DED1012C"
   ClientHeight    =   3030
   ClientLeft      =   120
   ClientTop       =   450
   ClientWidth     =   4560
   ...
   Begin SSSplitter.SSSplitter SSSplitter2 
      ...
      Begin FPSpread.vaSpread ss1 
         ...
         RowHeaderDisplay=   0
         SpreadDesigner  =   "DED1012C.frx":0052
      End
      Begin SSSplitter.SSSplitter SSSplitter3 
         ...
         Begin FPSpread.vaSpread ss2 
            ...
            MaxRows         =   20
            RetainSelBlock  =   0   'False
            SpreadDesigner  =   "DED1012C.frx":048D
         End
      End
   End
...
Private Sub Form_Define()
    ...
    sc2.Add Item:="DED1012C.P_REFER2", Key:="P-R"
    sc2.Add Item:="DED1012C.P_ONEROW2", Key:="P-O"
    sc2.Add Item:="DED1012C.P_MODIFY2", Key:="P-M"
...
Public Sub Form_Ref()
    ...
    If txt_cur_inv.Text <> "HB" Then
        Call Gp_MsgBoxDisplay("只堆放仓库 -->  'HB' ")
        Exit Sub
    End If
