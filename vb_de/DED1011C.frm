...
Begin VB.Form DED1011C 
   Caption         =   "2号热处理作业对象指示_DED1011C"
   ClientHeight    =   7620
   ClientLeft      =   210
   ClientTop       =   2190
   ClientWidth     =   14820
   ...
   Begin SSSplitter.SSSplitter SSSplitter2 
      ...
      Begin FPSpread.vaSpread ss1 
         ...
         RowHeaderDisplay=   0
         SpreadDesigner  =   "DED1011C.frx":0052
      End
      Begin SSSplitter.SSSplitter SSSplitter3 
         ...
         Begin FPSpread.vaSpread ss2 
            ...
            MaxRows         =   2
            RetainSelBlock  =   0   'False
            SpreadDesigner  =   "DED1011C.frx":046C
         End
      End
   End
...
Private Sub Form_Define()
    ...
    sc1.Add Item:="DED1010C.P_REFER1", Key:="P-R"
    ...
    sc2.Add Item:="DED1010C.P_REFER2", Key:="P-R"
    sc2.Add Item:="DED1010C.P_ONEROW2", Key:="P-O"
    sc2.Add Item:="DED1010C.P_MODIFY2", Key:="P-M"
        ...
        For iRow = 1 To ss2.MaxRows
            ...
            If ss2.Text = "" Then
                ...
                If opt_htn_plt1 Then
                    ss2.Text = "1"
                ElseIf opt_htn_plt2 Then
                    ss2.Text = "2"
                ElseIf opt_htn_plt3 Then
                    ss2.Text = "3"
...
Private Sub Form_Load()
    ...
    Call Gp_Spl_SizeGet(SSSplitter2, "D-System.INI", Me.Name, "H")
    
    Call Gp_Sp_ColGet(sc1.Item("Spread"), "D-System.INI", Me.Name)
    Call Gp_Sp_ColGet(sc2.Item("Spread"), "D-System.INI", Me.Name)
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
    ...
    Call Gp_Spl_SizeSet(SSSplitter2, "D-System.INI", Me.Name)
    
    Call Gp_Sp_ColSet(sc1.Item("Spread"), "D-System.INI", Me.Name)
    Call Gp_Sp_ColSet(sc2.Item("Spread"), "D-System.INI", Me.Name)
...
Public Sub Form_Ref()
    ...
    If txt_cur_inv.Text <> "00" And txt_cur_inv.Text <> "SG" And txt_cur_inv.Text <> "EG" Then
        Call Gp_MsgBoxDisplay("只堆放仓库 --> '00' / 'SG'/ 'EG'", "I")
        Exit Sub
    End If
    ...
    If Sp_Display(M_CN1, sc1.Item("Spread"), Gf_Ms_MakeQuery(sc1.Item("P-R"), "R", Mc1("pControl")), _
        ...
        If txt_cur_inv.Text = "00" Then
            ...
            opt_htn_plt3.Enabled = False
            
        ElseIf txt_cur_inv.Text = "SG" Then
         ...
         ElseIf txt_cur_inv.Text = "EG" Then
            opt_htn_plt1.Value = False
            opt_htn_plt2.Value = False
            opt_htn_plt3.Value = True
