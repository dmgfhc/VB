...
Begin VB.MDIForm MDIMain 
   ...
   Begin VB.Menu Mnu_AEA 
      ...
      Begin VB.Menu Mnu_AEA3 
         Caption         =   "输入连浇炉数标准"
         Begin VB.Menu Mnu_AEA1010C 
            Caption         =   "连铸厚度损耗标准录入"
         End
         Begin VB.Menu Mnu_AEA1000C 
            Caption         =   "头尾坯切割标准录入"
         End
         Begin VB.Menu Mnu_AEA1101C 
            Caption         =   "录入一炉多钢种标准"
         End
   ...
   Begin VB.Menu Mnu_AEB 
      ...
      Begin VB.Menu Mnu_AEB1070C 
         Caption         =   "HMI 板坯设计"
      End
      Begin VB.Menu Mnu_AEB1090C 
         Caption         =   "HMI板坯长度计算"
      End
      Begin VB.Menu Mnu_AEB4010C 
         Caption         =   "长坯料设计"
      End
      Begin VB.Menu Mnu_AEB4030C 
         Caption         =   "强制长坯料设计"
      End
      Begin VB.Menu Line6 
         Caption         =   "-"
      ...
      End
   End
   Begin VB.Menu Mnu_AEC1 
      Caption         =   "炼钢计划"
      Begin VB.Menu Mnu_AEC1060C 
         Caption         =   "查询日计划需求量 "
      End
      Begin VB.Menu Mnu_AEB3050C 
         Caption         =   "炉次编制结果修改"
      End
      Begin VB.Menu Mnu_AEC1070C 
         Caption         =   "连浇炉数编制结果修改"
      End
      Begin VB.Menu Mnu_AEC2010C 
         Caption         =   "确定炼钢作业生产管制指示"
      End
      Begin VB.Menu Mnu_AEC1080C 
         Caption         =   "坯料申报汇总明细查询"
      End
   End
   Begin VB.Menu Mnu_AEC2 
      Caption         =   "轧钢计划"
      ...
      End
   End
   Begin VB.Menu Mnu_AED 
      Caption         =   "CCR作业管理"
      Visible         =   0   'False
      Begin VB.Menu Mnu_AED1010C 
         Caption         =   "CCR材查询/选定"
      End
   End
   Begin VB.Menu Mnu_AEE 
      Caption         =   "作业指示"
      Begin VB.Menu Mnu_AEE1010C 
         Caption         =   "炉次作业指示查询"
      End
      Begin VB.Menu Mnu_AEE1020C 
         Caption         =   "板坯作业指示查询"
      End
      Begin VB.Menu Mnu_AEE1 
         Caption         =   "相关炼钢作业指示  "
         Visible         =   0   'False
      End
      Begin VB.Menu Mnu_AEE2010C 
         Caption         =   "轧钢作业指示查询"
         Visible         =   0   'False
      End
      Begin VB.Menu Mnu_AEE3010C 
         Caption         =   "精整作业指示查询"
         Visible         =   0   'False
      End
   End
   Begin VB.Menu Mnu_AEH 
      Caption         =   "坯料分段作业计划"
      Begin VB.Menu Mnu_AEH2010C 
         Caption         =   "坯料分段作业指示"
      End
   End
   Begin VB.Menu Mnu_AEZ 
      ...
      Begin VB.Menu Mnu_AEZ2010C 
         Caption         =   "查询相关工作管理信息"
      End
      Begin VB.Menu Mnu_AEC1090C 
         Caption         =   "炼钢二切情况统计_AEC1090C"
      End
   End
...
'    Else
'
'        Active_YN = GetSetting("NISCO", "EXE-FILE", "AE.exe")
''
'        If Active_YN = "1" Then
...
Private Sub MDIForm_QueryUnload(Cancel As Integer, UnloadMode As Integer)
    ...
    If Cancel = False Then SaveSetting "NISCO", "EXE-FILE", "AE.exe", ""
...
Private Sub Mnu_AEA1000C_Click()
    AEA1000C.Show
    AEA1000C.SetFocus
End Sub

Private Sub Mnu_AEA1010C_Click()
    AEA1010C.Show
    AEA1010C.SetFocus
End Sub
...
Private Sub Mnu_AEA1101C_Click()
    AEA1101C.Show
    AEA1101C.SetFocus
End Sub
...
Private Sub Mnu_AEB1080C_Click()
    AEB1080C.Show
    AEB1080C.SetFocus
End Sub

Private Sub Mnu_AEB1090C_Click()
    AEB1090C.Show
    AEB1090C.SetFocus

' Call Gp_MsgBoxDisplay("年后再用.!!")
    Exit Sub
End Sub
...
Private Sub Mnu_AEB4010C_Click()
    AEB4010C.Show
    AEB4010C.SetFocus
End Sub

Private Sub Mnu_AEB4030C_Click()
    AEB4030C.Show
    AEB4030C.SetFocus
End Sub

Private Sub Mnu_AEC1000C_Click()
    AEC1000C.Show
    AEC1000C.SetFocus
End Sub

Private Sub Mnu_AEC1060C_Click()
    AEC1060C.Show
    AEC1060C.SetFocus
End Sub

Private Sub Mnu_AEC1070C_Click()
    AEC1070C.Show
    AEC1070C.SetFocus
End Sub

Private Sub Mnu_AEC1080C_Click()
    AEC1080C.Show
    AEC1080C.SetFocus
End Sub

Private Sub Mnu_AEC1090C_Click()
    AEC1090C.Show
    AEC1090C.SetFocus
End Sub

Private Sub Mnu_AEC2010C_Click()
    AEC2010C.Show
    AEC2010C.SetFocus
End Sub
...
Private Sub Mnu_AED1010C_Click()
    AED1010C.Show
    AED1010C.SetFocus
End Sub

Private Sub Mnu_AEE1010C_Click()
    AEE1010C.Show
    AEE1010C.SetFocus
End Sub

Private Sub Mnu_AEE1020C_Click()
    AEE1020C.Show
    AEE1020C.SetFocus
End Sub

Private Sub Mnu_AEE2010C_Click()
    AEE2010C.Show
    AEE2010C.SetFocus
End Sub

Private Sub Mnu_AEE3010C_Click()
    AEE3010C.Show
    AEE3010C.SetFocus
End Sub

Private Sub Mnu_AEH2010C_Click()
    AEH2010C.Show
    AEH2010C.SetFocus
End Sub
