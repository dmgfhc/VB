...
Begin VB.Form AEA1130C 
   Caption         =   "录入浇铸作业时间_AEA1130C"
   ClientHeight    =   6030
   ClientLeft      =   660
   ClientTop       =   3855
   ClientWidth     =   13215
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "AEA1130C.frx":0000
   End
...
'         07.11.09 Kim Sung Ho  SLAB_THK ADD
'-------------------------------------------------------------------------------
'-- DECLARATION     ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
'-------------------------------------------------------------------------------
...
'---------------------------------------------------------------------------------------------------------------------------------------------------------------
   ...
   Call Gp_Sp_Collection(ss1, 11, " ", " ", " ", " ", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    Sc1.Add Item:="AEA1130C.P_MODIFY", Key:="P-M"
    Sc1.Add Item:="AEA1130C.P_REFER", Key:="P-R"
    Sc1.Add Item:="AEA1130C.P_ONEROW", Key:="P-O"
...
Private Sub txt_plt_KeyUp(KeyCode As Integer, Shift As Integer)
    ...
    If Len(Trim(txt_plt)) = txt_plt.MaxLength Then
        txt_plt_name.Text = Gf_ComnNameFind(M_CN1, "C0001", Trim(txt_plt.Text), 4)
    Else
        txt_plt_name.Text = ""
    End If
