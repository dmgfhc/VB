...
Begin VB.Form AEA1010C 
   Caption         =   "连铸厚度损耗标准录入_AEA1010C"
   ClientHeight    =   9195
   ClientLeft      =   450
   ClientTop       =   2325
   ClientWidth     =   15225
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "AEA1010C.frx":0000
   End
...
'---------------------------------------------------------------------------------------------------------------------------------------------------------------
   ...
   Call Gp_Sp_Collection(ss1, 10, " ", " ", " ", " ", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    Sc1.Add Item:="AEA1010C.P_MODIFY", Key:="P-M"
    Sc1.Add Item:="AEA1010C.P_REFER", Key:="P-R"
    Sc1.Add Item:="AEA1010C.P_ONEROW", Key:="P-O"
...
Public Sub Form_Ins()
    ...
    Call Gp_Sp_InAuthority(Proc_Sc("Sc"), 9)       '输入人员在 Spread 中第几列就写几！
