...
Begin VB.Form AEA2017C 
   Caption         =   "轧辊钢种系数录入_AEA2017C"
   ClientHeight    =   8940
   ClientLeft      =   165
   ClientTop       =   1305
   ClientWidth     =   10665
   ...
   Begin FPSpread.vaSpread SS1 
      ...
      SpreadDesigner  =   "AEA2017C.frx":0000
   End
End
Attribute VB_Name = "AEA2017C"
...
Private Sub Form_Define()
    ...
    Sc1.Add Item:="AEA2017C.P_MODIFY", Key:="P-M"
    Sc1.Add Item:="AEA2017C.P_REFER", Key:="P-R"
    Sc1.Add Item:="AEA2017C.P_ONEROW", Key:="P-O"
...
Private Sub ss1_EditMode(ByVal Col As Long, ByVal Row As Long, ByVal Mode As Integer, ByVal ChangeMade As Boolean)
    ...
    If check_f4.Text <> "" Then
       If check_f4.Text = 115 Then
          check_f4.Text = ""
          Exit Sub
       End If
    End If
...
Private Sub txt_plt_Change()
    ...
    If Len(txt_plt.Text) = 2 Then
        txt_plt.Text = UCase(Trim(txt_plt.Text))
        If Not txt_plt.Text Like "C#" Then Call Gp_MsgBoxDisplay("工厂代码错误！"): txt_plt.Text = "C1"
...
Private Sub StdSPEC_check(stdspec As String)
    ...
    iCheck = Gf_CodeFind(M_CN1, "SELECT count(*) FROM QP_STD_HEAD WHERE STDSPEC = '" & stdspec & "' ")
    
    If iCheck < 1 Then
       Call MsgBox("您输入的标准代号有误，请查实后重新输入", vbOKOnly + vbQuestion, "操作提示")
    End If
