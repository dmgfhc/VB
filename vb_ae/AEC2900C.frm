...
Begin VB.Form AEC2900C 
   Caption         =   "轧辊单位编制结果修改_AEC2900C"
   ClientHeight    =   7650
   ClientLeft      =   435
   ClientTop       =   2130
   ClientWidth     =   14175
   ...
   Begin FPSpread.vaSpread ss3 
      ...
      SpreadDesigner  =   "AEC2900C.frx":0000
   End
   ...
   Begin SSSplitter.SSSplitter spl_splitter 
      ...
      Begin FPSpread.vaSpread ss1 
         ...
         MaxRows         =   2
         RetainSelBlock  =   0   'False
         SpreadDesigner  =   "AEC2900C.frx":0333
      End
      Begin FPSpread.vaSpread ss2 
         ...
         MaxRows         =   2
         RetainSelBlock  =   0   'False
         SpreadDesigner  =   "AEC2900C.frx":0C8C
      End
   End
...
'   2.01  07.10.24 KIM SUNG HO  SMS SEQUENCE CONTROL DELETE
'-------------------------------------------------------------------------------
'-- DECLARATION     ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
'-------------------------------------------------------------------------------
...
Private Sub Form_Define()
   ...
   Call Gp_Sp_Collection(ss1, 16, " ", " ", " ", " ", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    sc1.Add Item:="AEC2900C.P_REFER3", Key:="P-R"
    ...
    sc2.Add Item:="AEC2900C.P_REFER2", Key:="P-R"
...
On Error GoTo Chart_Refer_Error
    ...
    sQuery = "SELECT COUNT(*) FROM (SELECT COUNT(*) FROM EP_SLAB_EDT WHERE SMS_PLT = '" & txt_plt.Text & "' "
    ...
    sQuery = sQuery + " FROM EP_SLAB_EDT WHERE SMS_PLT = '" & txt_plt.Text & "' "
...
On Error GoTo Process_Exec_ERROR
    ...
    sQuery = "{call AEZ5000P ('" + P_PLT + "','" + Trim(str(P_LINE)) + "','" + P_STATUS + "','" + P_MODE + "','" + P_UNIT + "','"
