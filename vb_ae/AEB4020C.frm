...
Begin VB.Form AEB4020C 
   Caption         =   "强制订单板坯设计_AEB4020C"
   ClientHeight    =   8625
   ClientLeft      =   180
   ClientTop       =   2925
   ClientWidth     =   15315
   ...
   Begin SSSplitter.SSSplitter SSSplitter1 
      ...
      Begin SSSplitter.SSSplitter SSSplitter2 
         ...
         Begin FPSpread.vaSpread ss2 
            ...
            SpreadDesigner  =   "AEB4020C.frx":00A4
         End
      End
      Begin FPSpread.vaSpread ss1 
         ...
         MaxRows         =   2
         RetainSelBlock  =   0   'False
         SpreadDesigner  =   "AEB4020C.frx":13E5
      End
   End
...
Public Sub Form_Pro()
    ...
    dLong_Slab_Edt_Seq = Gf_FloatFind(M_CN1, "SELECT MAX(SLAB_EDT_SEQ) FROM EP_SLAB_EDT WHERE CCM_PRC_LINE = '" & txt_prc_line.Text & "'")
