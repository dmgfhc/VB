...
Begin VB.Form AEB0020C 
   Caption         =   "非运转设备查询/修改_AEB0020C"
   ClientHeight    =   7980
   ClientLeft      =   480
   ClientTop       =   1755
   ClientWidth     =   15225
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "AEB0020C.frx":0000
   End
...
Private Sub Form_Define()
   ...
   Call Gp_Sp_Collection(ss1, 13, " ", " ", " ", " ", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    Sc1.Add Item:="AEB0020C.P_MODIFY", Key:="P-M"
    Sc1.Add Item:="AEB0020C.P_REFER", Key:="P-R"
    Sc1.Add Item:="AEB0020C.P_ONEROW", Key:="P-O"
...
Private Sub Form_Load()
    ...
    Call Gp_Sp_HdColColor(Proc_Sc("Sc")("Spread"), 9)
            ...
            Else
                ...
                ss1.Col = ss1.ActiveCol
                 ...
                 If Len(Trim(ss1.Text)) = ss1.TypeMaxEditLen Then
                        sTemp_Code = ss1.Text
                        ss1.Col = 9
                        ss1.Text = Gf_ComnNameFind(M_CN1, "C0001", Trim(sTemp_Code), 2)
                    Else
                        ss1.Col = 9
                        ss1.Text = ""
                 End If
