...
Begin VB.Form AEA2013C 
   Caption         =   "录入轧辊单位编制量厚/宽度标准_AEA2013C"
   ClientHeight    =   8415
   ClientLeft      =   135
   ClientTop       =   1755
   ClientWidth     =   14010
   ...
   Begin VB.ComboBox Cbo_thkwid_fl 
      BeginProperty Font 
         Name            =   "宋体"
         Size            =   9.75
         Charset         =   134
      ...
      EndProperty
      Height          =   315
      ItemData        =   "AEA2013C.frx":0000
      Left            =   10170
      List            =   "AEA2013C.frx":0002
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "AEA2013C.frx":0004
   End
...
Private Sub Form_Define()
    ...
    'Call Master_Collection("Control_Name", "p(primary)", "n(Necessary)", "m(maxlength)", "i(insert)", "r(refer)", "a(append)", "l(lock)")
          ...
          Call Gp_Ms_Collection(Cbo_thkwid_fl, "p", "n", " ", " ", "r", "a", "l", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
    ...
    Call Gp_Sp_Collection(ss1, 5, "p", "n", "m", "i", "a", " ", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    Call Gp_Sp_Collection(ss1, 6, "p", "n", "m", "i", " ", " ", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
   ...
   Call Gp_Sp_Collection(ss1, 14, " ", " ", " ", " ", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    Sc1.Add Item:="AEA2013C.P_MODIFY", Key:="P-M"
    Sc1.Add Item:="AEA2013C.P_REFER", Key:="P-R"
    Sc1.Add Item:="AEA2013C.P_ONEROW", Key:="P-O"
    ...
    Cbo_thkwid_fl.AddItem "分类"
    Cbo_thkwid_fl.AddItem "厚度"
    Cbo_thkwid_fl.AddItem "宽度"
    
    Cbo_thkwid_fl.ListIndex = 0
...
Private Sub ss1_KeyUp(KeyCode As Integer, Shift As Integer)
    ...
    Select Case ss1.ActiveCol
        ...
        Case 6
            ...
            'SS1.Col = 5
            iTw = Cbo_thkwid_fl.ListIndex
        
            If KeyCode = vbKeyF4 Then
            
                If iTw = 0 Then Exit Sub
