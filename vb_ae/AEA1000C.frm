...
Begin VB.Form AEA1000C 
   Caption         =   "头尾坯切割标准录入_AEA1000C"
   ClientHeight    =   9225
   ClientLeft      =   585
   ClientTop       =   2475
   ClientWidth     =   15315
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "AEA1000C.frx":0380
   End
   Begin VB.TextBox txt_PRC_line 
      ...
      Width           =   420
   End
   Begin VB.TextBox txt_STLGRD_CD 
      BeginProperty Font 
         Name            =   "宋体"
         Size            =   9.75
         Charset         =   134
...
'-- PROGRAM HEADER  ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
'-------------------------------------------------------------------------------
'-- System Name       Slab's Top&Bottom Cut standard
'-- Sub_System Name
'-- Program Name
'-- Program ID
...
Private Sub Form_Define()
    ...
    'Call Master_Collection("Control_Name", "p(primary)", "n(Necessary)", "m(maxlength)", "i(insert)", "r(refer)", "a(append)", "l(lock)")
          Call Gp_Ms_Collection(txt_PLT, "p", "n", "m", " ", "r", "a", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
     Call Gp_Ms_Collection(txt_PRC_line, "p", " ", " ", " ", "r", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
    Call Gp_Ms_Collection(txt_STLGRD_CD, "p", " ", " ", " ", "r", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
...
'---------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    Call Gp_Sp_Collection(ss1, 3, "p", "n", "m", "i", " ", " ", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
   ...
   Call Gp_Sp_Collection(ss1, 11, " ", " ", " ", " ", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    Sc1.Add Item:="AEA1000C.P_MODIFY", Key:="P-M"
    Sc1.Add Item:="AEA1000C.P_REFER", Key:="P-R"
    Sc1.Add Item:="AEA1000C.P_ONEROW", Key:="P-O"
...
Public Sub Form_Ins()
    ...
    Call Gp_Sp_InAuthority(Proc_Sc("Sc"), 10)       '输入人员在 Spread 中第几列就写几！
        ...
        Case 3
            ...
            Else
                ...
                ss1.Col = ss1.ActiveCol
                 ...
                 If Len(Trim(ss1.Text)) >= 10 Then
                        sTemp_Code = ss1.Text
                        ss1.Col = 4
                        ss1.Text = Gf_CodeFind(M_CN1, "SELECT STEEL_GRD_DETAIL FROM QP_NISCO_CHMC WHERE STLGRD = '" + sTemp_Code + "'")
                    Else
                        ss1.Col = 4
                        ss1.Text = ""
                 End If
...
Private Sub txt_stlgrd_cd_DblClick()

    Call TxT_stlgrd_cd_KeyUp(vbKeyF4, 0)
    
End Sub

Private Sub TxT_stlgrd_cd_KeyUp(KeyCode As Integer, Shift As Integer)

    If KeyCode = vbKeyF4 Then
    
        DD.sWitch = "MS"
        DD.rControl.Add Item:=txt_STLGRD_CD
    ...
    Else
        ...
        If Len(Trim(txt_STLGRD_CD)) >= 10 Then
            txt_STLGRD_NAME.Text = Gf_CodeFind(M_CN1, "SELECT STEEL_GRD_DETAIL FROM QP_NISCO_CHMC WHERE STLGRD = '" + Trim(txt_STLGRD_CD.Text) + "'")
         Else
