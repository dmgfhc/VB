...
Begin VB.Form AEA1080C 
   Caption         =   "录入炉次编制标准_AEA1080C"
   ClientHeight    =   7290
   ClientLeft      =   240
   ClientTop       =   2130
   ClientWidth     =   15135
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "AEA1080C.frx":0000
   End
...
Private Sub Form_Define()
   ...
   Call Gp_Sp_Collection(ss1, 12, " ", " ", " ", " ", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    Sc1.Add Item:="AEA1080C.P_MODIFY", Key:="P-M"
    Sc1.Add Item:="AEA1080C.P_REFER", Key:="P-R"
    Sc1.Add Item:="AEA1080C.P_ONEROW", Key:="P-O"
        ...
        Case 5
            ...
            Else
                ...
                If Len(Trim(ss1.Text)) = ss1.TypeMaxEditLen Then
                    sTemp_Code = ss1.Text
                    ss1.Col = 6
                    ss1.Text = Gf_ComnNameFind(M_CN1, "Z0003", Trim(sTemp_Code), 2)
                Else
                    ss1.Col = 6
                    ss1.Text = ""
                End If
