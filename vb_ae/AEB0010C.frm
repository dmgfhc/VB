...
Begin VB.Form AEB0010C 
   Caption         =   "连铸断面查询/修改_AEB0010C"
   ClientHeight    =   6885
   ClientLeft      =   465
   ClientTop       =   2355
   ClientWidth     =   15270
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "AEB0010C.frx":0000
   End
End
Attribute VB_Name = "AEB0010C"
...
Private Sub Form_Define()
    ...
    Sc1.Add Item:="AEB0010C.P_MODIFY", Key:="P-M"
    Sc1.Add Item:="AEB0010C.P_REFER", Key:="P-R"
    Sc1.Add Item:="AEB0010C.P_ONEROW", Key:="P-O"
...
Private Sub ss1_EditMode(ByVal Col As Long, ByVal Row As Long, ByVal Mode As Integer, ByVal ChangeMade As Boolean)
    ...
    If Mode = 1 And Col = 16 Then
        ...
        ss1.Col = 16
        If ss1.Text = "0" Or ss1.Text = "" Then
            ...
            For I = 1 To ss1.MaxRows
                ...
                If ss1.Text = sFl And I <> Row Then
    ...
    If Row > 0 And Col = 2 Then
        ...
        With ss1
            ...
            strSQL = "SELECT B.PLT,                 " & vbCrLf & _
                     ...
                     "       '',                    " & vbCrLf & _
                     "       ''                     " & vbCrLf & _
                     " FROM  EP_SLAB_SIZE B         " & vbCrLf & _
                     " WHERE B.PLT =                " & vbCrLf & _
                     " '" + Trim(txt_plt.Text) + "' " & vbCrLf & _
                     "   AND B.PRC_LINE =           " & vbCrLf & _
                     "'" + Trim(.Text) + "' "
                     Call Sp_INS_Set(M_CN1, Proc_Sc("SC"), strSQL, Row)
                     Call Gp_Sp_InAuthority(Proc_Sc("Sc"), 18)
                     .Col = 0: .Text = "Input"
...
Private Sub Sp_INS_Set(Conn As ADODB.Connection, Sc As Collection, sQuery As String, irow As Long)

On Error GoTo Spread_INS_Error
...
Spread_INS_Error:
    ...
    Screen.MousePointer = vbDefault
    Call Gp_MsgBoxDisplay("Sp_INS_INIT_Error : " & Error)
