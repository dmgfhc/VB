...
Begin VB.Form AEA1100C 
   Caption         =   "录入炉次间钢种混浇标准_AEA1100C"
   ClientHeight    =   5940
   ClientLeft      =   195
   ClientTop       =   3405
   ClientWidth     =   15225
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "AEA1100C.frx":0000
   End
...
Private Sub Form_Define()
    ...
    Sc1.Add Item:="AEA1100C.P_MODIFY", Key:="P-M"
    Sc1.Add Item:="AEA1100C.P_REFER", Key:="P-R"
    Sc1.Add Item:="AEA1100C.P_ONEROW", Key:="P-O"
