...
Begin VB.Form AEA1090C 
   Caption         =   "录入连浇炉数编制标准_AEA1090C"
   ClientHeight    =   7620
   ClientLeft      =   135
   ClientTop       =   2040
   ClientWidth     =   15120
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "AEA1090C.frx":0000
   End
...
Private Sub Form_Define()
   ...
   Call Gp_Sp_Collection(ss1, 12, " ", " ", " ", " ", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    Sc1.Add Item:="AEA1090C.P_MODIFY", Key:="P-M"
    Sc1.Add Item:="AEA1090C.P_REFER", Key:="P-R"
    Sc1.Add Item:="AEA1090C.P_ONEROW", Key:="P-O"
