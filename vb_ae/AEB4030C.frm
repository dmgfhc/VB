...
Begin VB.Form AEB4030C 
   Caption         =   "强制长坯料设计_AEB4030C"
   ClientHeight    =   8625
   ClientLeft      =   360
   ClientTop       =   2565
   ClientWidth     =   15360
   ...
   Begin SSSplitter.SSSplitter SSSplitter1 
      ...
      Begin SSSplitter.SSSplitter SSSplitter2 
         ...
         Begin FPSpread.vaSpread ss2 
            ...
            SpreadDesigner  =   "AEB4030C.frx":00A4
         End
      End
      Begin FPSpread.vaSpread ss1 
         ...
         MaxRows         =   2
         RetainSelBlock  =   0   'False
         SpreadDesigner  =   "AEB4030C.frx":0DB9
      End
   End
...
'-- Sub_System Name
'-- Program Name      COMPULSORY LONG SLAB DESIGN
'-- Program ID        AEB4030C
...
Private Sub Form_Define()
    ...
    Call Gp_Ms_Collection(txt_ccm_prc_line, "p", "n", " ", " ", "r", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
    ...
    Sc1.Add Item:="AEB4030C.P_REFER1", Key:="P-R"
    ...
    'Call Master_Collection("Control_Name", "p(primary)", "n(Necessary)", "m(maxlength)", "i(insert)", "r(refer)", "a(append)", "l(lock)")
           Call Gp_Ms_Collection(txt_stlgrd, "p", "n", " ", " ", "r", " ", " ", pControl2, nControl2, mControl2, iControl2, rControl2, aControl2, lControl2)
         Call Gp_Ms_Collection(sdb_slab_thk, "p", "n", " ", " ", "r", " ", " ", pControl2, nControl2, mControl2, iControl2, rControl2, aControl2, lControl2)
         Call Gp_Ms_Collection(sdb_slab_wid, "p", "n", " ", " ", "r", " ", " ", pControl2, nControl2, mControl2, iControl2, rControl2, aControl2, lControl2)
          Call Gp_Ms_Collection(sdb_cut_len, " ", " ", " ", " ", " ", " ", " ", pControl2, nControl2, mControl2, iControl2, rControl2, aControl2, lControl2)
    Call Gp_Ms_Collection(sdb_long_slab_len, " ", " ", " ", " ", "r", " ", " ", pControl2, nControl2, mControl2, iControl2, rControl2, aControl2, lControl2)
    Call Gp_Ms_Collection(sdb_long_slab_wgt, " ", " ", " ", " ", "r", " ", " ", pControl2, nControl2, mControl2, iControl2, rControl2, aControl2, lControl2)
     Call Gp_Ms_Collection(txt_ccm_prc_line, "p", "n", " ", " ", " ", " ", " ", pControl2, nControl2, mControl2, iControl2, rControl2, aControl2, lControl2)
    ...
    Call Gp_Sp_Collection(SS2, 25, " ", " ", " ", "i", " ", "l", pColumn2, nColumn2, mColumn2, iColumn2, aColumn2, lColumn2, False)
    
    'Spread_Collection
    sc2.Add Item:=SS2, Key:="Spread"
    sc2.Add Item:="AEB4030C.P_REFER2", Key:="P-R"
    sc2.Add Item:="AEB4030C.P_ONEROW2", Key:="P-O"
    sc2.Add Item:="AEB4030C.P_MODIFY2", Key:="P-M"
...
Public Sub Form_Pro()
    ...
    dLong_Slab_Edt_Seq = Gf_FloatFind(M_CN1, "SELECT NVL(MAX(SLAB_EDT_SEQ),0) FROM EP_SLAB_EDT WHERE CCM_PRC_LINE = '" & txt_ccm_prc_line.Text & "'")
    ...
    For iRow = 1 To SS2.MaxRows
        ...
        SS2.Col = 24
        SS2.VALUE = sdb_cut_len.VALUE
        SS2.Col = 25
        SS2.VALUE = txt_ccm_prc_line.Text
        
    Next iRow
    
    'Not Exist Process Data
    If iSelCnt <= 1 Then Exit Sub
...
Private Sub ss1_Click(ByVal Col As Long, ByVal Row As Long)
    ...
    If cRow <> 0 Then
        ...
        If ss1.Text = "" Then
            ...
            ss1.Row = cRow
            ss1.Col = 0:    ss1.Text = ""
            Call Gp_Sp_BlockColor(ss1, 1, ss1.MaxCols, cRow, cRow)
            ss1.Row = Row
