...
Begin VB.Form RH_MODIF 
   ...
   Begin VB.ComboBox cbo_m_bb_yn 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "RH_MODIFY.frx":0000
      Left            =   1065
      List            =   "RH_MODIFY.frx":000D
      TabIndex        =   6
      Text            =   " "
      Top             =   1350
      Width           =   870
   ...
   Begin VB.ComboBox P_GROUP 
      Height          =   315
      ItemData        =   "RH_MODIFY.frx":0024
      Left            =   9240
      List            =   "RH_MODIFY.frx":0026
      TabIndex        =   3
      Text            =   " "
      Top             =   1380
      Visible         =   0   'False
   ...
   Begin VB.ComboBox P_SHIFT 
      Height          =   315
      ItemData        =   "RH_MODIFY.frx":0028
      Left            =   9270
      List            =   "RH_MODIFY.frx":002A
      TabIndex        =   2
      Text            =   " "
      Top             =   1020
      Visible         =   0   'False
...
'-- Program Name      RH RESLT MODIFICATION
'-- Program ID        AFE5014C
'-- Document No
'-- Designer          KIM.S.H
'-- Coder             KIM.S.H
    ...
    'Form Type : Start , Master, Sheet, Msheet, PopSheet, Refer
     ...
     Call Gp_Ms_Collection(txt_m_arrv_temp, " ", " ", " ", "i", "r", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
      ...
      Call Gp_Ms_Collection(txt_m_dep_temp, " ", " ", " ", "i", "r", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
         Call Gp_Ms_Collection(cbo_m_bb_yn, " ", " ", " ", "i", "r", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
     ...
     Mc1.Add Item:="AFE5014C.P_SREFER", Key:="P-R"
     Mc1.Add Item:="AFE5014C.P_MODIFY", Key:="P-M"
...
'    Call MDIMain.FormMenuSetting(Me, FormType, "FS", sAuthority)
    ...
    With AFE5010C.ss3
        ...
        .Col = 19:    cbo_m_bb_yn.Text = .Text
        .Col = 26:    txt_m_elect.Text = .Text
        .Col = 27:    txt_m_commt.Text = .Text
    End With
