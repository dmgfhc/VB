...
Private Sub Cmd_Ok_Click()
    ...
    sDATE = Format(xlSheet.Cells(2, 1), "YYYY-MM-DD")
    ...
    For iRow = 1 To iXCnt
        ...
        If iRow <= 3 Then
            ...
            With AFT4070C.ss1
                ...
                For iCol = 2 To .MaxCols - 3
                    .Col = iCol
'                    If iCol = 10 Then
'                    .Text = Format(xlSheet.Cells(iRow + 4, 10 - 1), "YYYY-MM-DD HH:MM:SS")
'                    Else
                    .Text = CStr(xlSheet.Cells(iRow + 4, iCol - 1))
'                    End If
                    ...
                    End If
                Next iCol
                .Col = .MaxCols - 3:     .Text = sDATE
                .Col = .MaxCols - 2:     .Text = sUserID   'INS_EMP
                .Col = .MaxCols - 1:     .Text = Format(Now, "YYYY-MM-DD HH:MM:SS")
            End With
            ...
            With AFT4070C.ss2
                ...
                For iCol = 2 To .MaxCols - 3
                    .Col = iCol
'                    If iCol = 10 Then
'                    .Text = Format(xlSheet.Cells(iRow + 9, 10 - 1), "YYYY-MM-DD HH:MM:SS")
'                    Else
                    .Text = CStr(xlSheet.Cells(iRow + 9, iCol - 1))
'                    End If
            ...
            With AFT4070C.ss3
                ...
                For iCol = 2 To .MaxCols - 3
                    .Col = iCol
'                    If iCol = 10 Then
'                    .Text = Format(xlSheet.Cells(iRow + 14, 10 - 1), "YYYY-MM-DD HH:MM:SS")
'                    Else
                    .Text = CStr(xlSheet.Cells(iRow + 14, iCol - 1))
'                    End If
