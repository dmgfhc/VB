...
Begin VB.Form AFF2010C 
   Caption         =   "VD实绩修改及查询界面_AFF2010C"
   ClientHeight    =   9225
   ClientLeft      =   240
   ClientTop       =   2130
   ClientWidth     =   15225
   ...
   Begin Threed.SSFrame Frame2 
      ...
      Begin VB.ComboBox cbo_group_cd 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "AFF2010C.frx":0000
         Left            =   10035
         List            =   "AFF2010C.frx":0002
         TabIndex        =   21
         Tag             =   "班别"
         Top             =   180
         Width           =   630
      ...
      Begin VB.ComboBox cbo_shift 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "AFF2010C.frx":0004
         Left            =   7815
         List            =   "AFF2010C.frx":0006
         TabIndex        =   20
         Tag             =   "班次"
         Top             =   180
         Width           =   630
   ...
   Begin Threed.SSFrame Frame1 
      ...
      Begin VB.ComboBox cbo_heat_no 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "AFF2010C.frx":0008
         Left            =   1455
         List            =   "AFF2010C.frx":0012
         TabIndex        =   13
         Tag             =   "炉号"
         Top             =   300
         Width           =   1425
      ...
      Begin VB.ComboBox cbo_re_cd 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "AFF2010C.frx":0044
         Left            =   5400
         List            =   "AFF2010C.frx":0046
         TabIndex        =   12
         Tag             =   "再处理"
         Top             =   300
         Width           =   675
      ...
      Begin VB.ComboBox cbo_prc_line 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "AFF2010C.frx":0048
         Left            =   7830
         List            =   "AFF2010C.frx":004A
         TabIndex        =   11
         Tag             =   "VD"
         Top             =   300
         Width           =   615
   ...
   Begin Threed.SSFrame Frame4 
      ...
      Begin CSTextLibCtl.sidbEdit txt_sta_slag_wgt 
         ...
         Data            =   0
      End
      Begin CSTextLibCtl.sidbEdit txt_ld_emp_wgt 
         Height          =   315
         Left            =   5155
         TabIndex        =   44
         Top             =   720
      ...
      Begin CSTextLibCtl.sidbEdit txt_vacuum_dur 
         ...
         Data            =   0
      End
      Begin CSTextLibCtl.sidbEdit txt_steam_usage 
         Height          =   315
         Left            =   8275
         TabIndex        =   49
         Top             =   1110
...
Private Sub Form_Define()
    ...
    'Call Master_Collection("Control_Name", "p(primary)", "n(Necessary)", "m(maxlength)", "i(insert)", "r(refer)", "a(append)", "l(lock)")
     ...
     Call Gp_Ms_Collection(txt_act_steel_grd, " ", " ", " ", "i", "r", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
       ...
       Call Gp_Ms_Collection(txt_ld_sta_date, " ", " ", " ", "i", " ", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
        Call Gp_Ms_Collection(txt_start_date, " ", " ", " ", "i", " ", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
          Call Gp_Ms_Collection(txt_end_date, " ", " ", " ", "i", " ", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
       Call Gp_Ms_Collection(txt_ld_end_date, " ", " ", " ", "i", " ", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
    ...
    Call Gp_Ms_Collection(txt_arrv_steel_wgt, " ", " ", " ", "i", "r", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
     Call Gp_Ms_Collection(txt_dep_steel_wgt, " ", " ", " ", "i", "r", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
      ...
      Call Gp_Ms_Collection(txt_end_slag_wgt, " ", " ", " ", "i", "r", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
        Call Gp_Ms_Collection(txt_ld_emp_wgt, " ", " ", " ", "i", "r", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
       ...
       Call Gp_Ms_Collection(txt_steam_usage, " ", " ", " ", "i", "r", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
...
Call Gp_Ms_Collection(txt_element_content_al, " ", " ", " ", " ", "r", " ", "l", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
 ...
 Call Gp_Ms_Collection(txt_element_content_o, " ", " ", " ", " ", "r", " ", "l", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
    ...
    'MASTER Collection
     Mc1.Add Item:="AFF2010C.P_MODIFY", Key:="P-M"
     Mc1.Add Item:="AFF2010C.P_REFER", Key:="P-R"
     ...
     Call Gp_Ms_Collection(txt_act_steel_grd, " ", " ", " ", " ", "r", " ", " ", pControl1, nControl1, mControl1, iControl1, rControl1, aControl1, lControl1)
       ...
       Call Gp_Ms_Collection(txt_ld_sta_date, " ", " ", " ", " ", "r", " ", " ", pControl1, nControl1, mControl1, iControl1, rControl1, aControl1, lControl1)
       ...
       Call Gp_Ms_Collection(txt_ld_end_date, " ", " ", " ", " ", "r", " ", " ", pControl1, nControl1, mControl1, iControl1, rControl1, aControl1, lControl1)
              Call Gp_Ms_Collection(txt_proc, "p", " ", " ", " ", " ", " ", " ", pControl1, nControl1, mControl1, iControl1, rControl1, aControl1, lControl1)
             Call Gp_Ms_Collection(cbo_re_cd, "p", "n", " ", " ", " ", " ", " ", pControl1, nControl1, mControl1, iControl1, rControl1, aControl1, lControl1)
     
     Mc2.Add Item:="AFF2010C.P_REFER1", Key:="P-R"
...
Private Sub cbo_HEAT_NO_Change()
   If Len(cbo_heat_no.Text) = 8 Then
      ...
      AFF2010C.cbo_re_cd.Clear
      Call Gf_ComboAdd(M_CN1, cbo_re_cd, "SELECT RE_CD  FROM FP_VDRSLT WHERE HEAT_NO = '" + cbo_heat_no.Text + "'")
      cbo_re_cd.ListIndex = cbo_re_cd.ListCount - 1
   Else
      cbo_ld_id.Text = ""
   End If
...
'    sQuery = sQuery & " WHERE MLT_PROC_CD LIKE '%BD%' "
...
'
'
'    'Call Gf_HeatNo_ComboAdd(M_CN1, cbo_heat_no, "FP_VDRSLT", "DEP_STEEL_WGT", Trim(cbo_prc_line.Text))
...
'  If Mid(cbo_heat_no, 3, 1) = "2" Then
'     cbo_prc_line.Text = "2"
'  ElseIf Mid(cbo_heat_no, 3, 1) = "1" Then
'     cbo_prc_line.Text = "1"
'  End If
  cbo_heat_no = V_HEAT_NO
  cbo_re_cd.Text = "1"
...
Private Sub Form_Load()
    ...
    sQuery_Rt = Gf_CodeFind(M_CN1, "SELECT SHIFT  FROM GP_SHIFTSTD WHERE TRANCD = 'BE21' ")
    If sQuery_Rt = "" Then
    ...
    sQuery_Rt = Gf_CodeFind(M_CN1, "SELECT GROUP_CD  FROM GP_SHIFTSTD WHERE TRANCD = 'BE21' ")
...
Public Sub Form_Pro()
    ...
    cbo_heat_no.Text = Mid(cbo_heat_no.Text, 1, 8)
    If cbo_prc_line.Text <> "1" And cbo_prc_line.Text <> "2" Then
       MsgBox "   VD station ！Please Input  ", vbCritical, "错误提示"
       Exit Sub
    End If
    If cbo_shift = "" Then
...
Private Sub txt_dir_steel_grd_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
    ...
    txt_dir_steel_grd.ToolTipText = Gf_FloatFind(M_CN1, sQuery)
End Sub
