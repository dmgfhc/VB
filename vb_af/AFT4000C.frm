...
Begin VB.Form AFT4000C 
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "AFT4000C.frx":0000
   End
...
'---------------------------------------------------------------------------------------------------------------------------------------------------------------
   ...
   Call Gp_Sp_Collection(ss1, 16, " ", " ", " ", " ", " ", "l ", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    sc1.Add Item:="AFT4000C.P_SREFER", Key:="P-R"
    sc1.Add Item:="AFT4000C.P_SMODIFY", Key:="P-M"
'    sc1.Add Item:="AFT4000C.P_SONEROW", Key:="P-O"
