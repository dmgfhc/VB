...
Begin VB.Form AFL2060C 
   Caption         =   "标准垛位管理界面_AFL2060C"
   ClientHeight    =   9225
   ClientLeft      =   240
   ClientTop       =   2325
   ClientWidth     =   15225
   ...
   Begin VB.ComboBox cbo_YARD_TYPE 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "AFL2060C.frx":0000
      Left            =   8175
      List            =   "AFL2060C.frx":0002
   ...
   Begin VB.ComboBox cbo_PROD_TYPE 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "AFL2060C.frx":0004
      Left            =   1395
      List            =   "AFL2060C.frx":0006
      Style           =   2  'Dropdown List
      TabIndex        =   0
      Tag             =   "库种类"
      Top             =   120
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "AFL2060C.frx":0008
   End
...
Private Sub cbo_PROD_TYPE_Click()
    ...
    Call Gf_ComboAdd(M_CN1, cbo_YARD_TYPE, "SELECT DISTINCT YARD_TYPE FROM FP_STDYARD WHERE PROD_TYPE = '" + cbo_PROD_TYPE + "' AND YARD_KND = '00'")
End Sub
