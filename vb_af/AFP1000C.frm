...
Begin VB.Form AFP1000C 
   Caption         =   "高炉铁水实绩导出及删除_AFP1000C"
   ClientHeight    =   9225
   ClientLeft      =   735
   ClientTop       =   2445
   ClientWidth     =   15225
   ...
   Begin VB.ComboBox cbo_bf_line 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "AFP1000C.frx":0000
      Left            =   6615
      List            =   "AFP1000C.frx":0019
      TabIndex        =   6
      Tag             =   "高炉代码"
      Top             =   120
      Width           =   855
   ...
   Begin VB.ComboBox cbo_shift 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "AFP1000C.frx":0032
      Left            =   9015
      List            =   "AFP1000C.frx":0034
   ...
   Begin VB.ComboBox cbo_group 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "AFP1000C.frx":0036
      Left            =   11430
      List            =   "AFP1000C.frx":0038
      Style           =   2  'Dropdown List
      TabIndex        =   3
      Top             =   120
      Width           =   885
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "AFP1000C.frx":003A
   End
...
Private Sub Form_Define()
    ...
    Call Gp_Ms_Collection(txt_from_DATE, "p", " ", " ", " ", "", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
      ...
      Call Gp_Ms_Collection(cbo_bf_line, "p", " ", " ", " ", "", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
...
'---------------------------------------------------------------------------------------------------------------------------------------------------------------
   ...
   Call Gp_Sp_Collection(SS1, 18, " ", " ", " ", " ", " ", " ", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    sc1.Add Item:="AFP1000C.P_SREFER", Key:="P-R"
    sc1.Add Item:="AFP1000C.P_SMODIFY", Key:="P-M"
    sc1.Add Item:="AFP1000C.P_SONEROW", Key:="P-O"
...
Dim Iron_Rec, Iron_Use, Iron_Use_ACT, Back_Wgt As Double

On Error GoTo Refer_Err

If Trim(txt_from_DATE) = "____-__-__" Then
   txt_from_DATE.Text = Format(Now, "YYYY-MM") + "-01"
End If
If Trim(txt_to_DATE) = "____-__-__" Then
    ...
    If Gf_Sp_Refer(M_CN1, Proc_Sc("Sc"), Mc1, Mc1("nControl")) Then
        ...
        With SS1
             For i = 1 To .MaxRows
                ...
                .Col = 4
                 Iron_Use = Iron_Use + Val(.Text)
                .Col = 5
                 Iron_Use_ACT = Iron_Use_ACT + Val(.Text)
