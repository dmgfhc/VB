...
Begin VB.Form AFT3030C 
   ...
   Begin VB.ComboBox cbo_PLT 
      ...
      Height          =   315
      IMEMode         =   1  'ON
      ItemData        =   "AFT3030C.frx":0000
      Left            =   6075
      List            =   "AFT3030C.frx":000D
      TabIndex        =   1
      Tag             =   "工厂"
      Top             =   120
      Width           =   735
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "AFT3030C.frx":001D
   End
   Begin InDate.ULabel ULabel5 
      Height          =   315
      Index           =   2
...
'-------------------------------------------------------------------------------
'-- System Name       炼钢作业管理
'-- Sub_System Name   炼钢作业管理
'-- Program Name      铸坯质量跟踪查询
'-- Program ID        AFT3030C
'-- Designer          袁登科
'-- Coder             袁登科
'-- Date              2012.3.09
...
'---------------------------------------------------------------------------------------------------------------------------------------------------------------
   ...
   Call Gp_Sp_Collection(ss1, 74, " ", " ", " ", " ", " ", " ", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    sc1.Add Item:="AFT3030C.P_SREFER1", Key:="P-R"
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
    ...
    Call Gp_Sp_ColSet(Proc_Sc("Sc")("Spread"), "AF-System.INI", Me.Name)
...
'    If Trim(txt_from_DATE.RawData) <> Trim(txt_to_DATE.RawData) Then
'               MsgBox "只能查询一天内信息!", vbCritical, "系统提示信息"
'               Exit Sub
'    End If
   If Trim(txt_to_DATE.RawData) - Trim(txt_from_DATE.RawData) > 6 Then
               MsgBox "只能查询七天内信息!", vbCritical, "系统提示信息"
               Exit Sub
    End If
