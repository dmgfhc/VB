...
Begin VB.Form AFT4030C 
   Caption         =   "钢包盛钢时间跟踪报表_AFT4030C"
   ClientHeight    =   3030
   ClientLeft      =   120
   ClientTop       =   450
   ClientWidth     =   4560
   ...
   Begin SSSplitter.SSSplitter SSSplitter1 
      ...
      Begin Threed.SSPanel SSPanel1 
         ...
         Begin VB.ComboBox cbo_shift 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "AFT4030C.frx":0052
            Left            =   5910
            List            =   "AFT4030C.frx":0054
         ...
         Begin VB.ComboBox cbo_group 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "AFT4030C.frx":0056
            Left            =   8220
            List            =   "AFT4030C.frx":0058
            Style           =   2  'Dropdown List
            TabIndex        =   2
            Top             =   120
            Width           =   735
      ...
      Begin FPSpread.vaSpread ss1 
         ...
         SpreadDesigner  =   "AFT4030C.frx":005A
      End
   End
End
Attribute VB_Name = "AFT4030C"
...
'---------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    sc1.Add Item:="AFT4030C.P_SREFER", Key:="P-R"
