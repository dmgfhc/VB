...
Begin VB.Form AFT4040C 
   Caption         =   "板坯库存报表_AFT4040C"
   ClientHeight    =   3030
   ClientLeft      =   120
   ClientTop       =   450
   ClientWidth     =   4560
   ...
   Begin SSSplitter.SSSplitter SSSplitter1 
      ...
      Begin Threed.SSPanel SSPanel1 
         ...
         Begin VB.ComboBox cbo_plt 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "AFT4040C.frx":0052
            Left            =   5910
            List            =   "AFT4040C.frx":0054
         ...
         Begin VB.ComboBox cbo_gov 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "AFT4040C.frx":0056
            Left            =   8220
            List            =   "AFT4040C.frx":0058
            Style           =   2  'Dropdown List
            TabIndex        =   2
            Top             =   120
            Width           =   1500
      ...
      Begin FPSpread.vaSpread ss1 
         ...
         SpreadDesigner  =   "AFT4040C.frx":005A
      End
   End
End
Attribute VB_Name = "AFT4040C"
...
'---------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    sc1.Add Item:="AFT4040C.P_SREFER", Key:="P-R"
...
Private Sub Form_Load()
    ...
    cbo_gov.AddItem ""
    cbo_gov.AddItem "研发中心"
    cbo_gov.AddItem "研究院"
    cbo_gov.AddItem "销售总公司"
    cbo_gov.AddItem "其他"
