...
Begin VB.Form AFP5010C 
   Caption         =   "VD实绩导出_AFP5010C"
   ClientHeight    =   9225
   ClientLeft      =   255
   ClientTop       =   1665
   ClientWidth     =   15225
   ...
   Begin VB.ComboBox cbo_shift 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "AFP5010C.frx":0000
      Left            =   6255
      List            =   "AFP5010C.frx":0002
   ...
   Begin VB.ComboBox cbo_group 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "AFP5010C.frx":0004
      Left            =   8595
      List            =   "AFP5010C.frx":0006
      Style           =   2  'Dropdown List
      TabIndex        =   3
      Top             =   120
      Width           =   735
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "AFP5010C.frx":0008
   End
...
'---------------------------------------------------------------------------------------------------------------------------------------------------------------
   ...
   Call Gp_Sp_Collection(ss1, 37, " ", " ", " ", " ", " ", " ", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    sc1.Add Item:="AFP5010C.P_SREFER", Key:="P-R"
