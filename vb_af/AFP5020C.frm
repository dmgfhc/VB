...
Begin VB.Form AFP5020C 
   Caption         =   "RH实绩导出_AFP5020C"
   ClientHeight    =   9225
   ClientLeft      =   225
   ClientTop       =   2055
   ClientWidth     =   15930
   ...
   Begin VB.ComboBox cbo_prc_line 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "AFP5020C.frx":0000
      Left            =   14445
      List            =   "AFP5020C.frx":000D
      TabIndex        =   9
      Tag             =   "LF"
      Top             =   120
      Width           =   735
   ...
   Begin VB.ComboBox cbo_shift 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "AFP5020C.frx":001A
      Left            =   6015
      List            =   "AFP5020C.frx":001C
   ...
   Begin VB.ComboBox cbo_group 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "AFP5020C.frx":001E
      Left            =   8175
      List            =   "AFP5020C.frx":0020
      Style           =   2  'Dropdown List
      TabIndex        =   3
      Top             =   120
      Width           =   735
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "AFP5020C.frx":0022
   End
...
'---------------------------------------------------------------------------------------------------------------------------------------------------------------
   ...
   Call Gp_Sp_Collection(ss1, 81, " ", " ", " ", " ", " ", " ", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    sc1.Add Item:="AFP5020C.P_SREFER1", Key:="P-R"
