...
Begin VB.Form AFO2080C 
   Caption         =   "原料出库输入界面_AFO2080C"
   ClientHeight    =   9225
   ClientLeft      =   240
   ClientTop       =   2565
   ClientWidth     =   15225
   ...
   Begin VB.ComboBox cbo_prc_line 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "AFO2080C.frx":0000
      Left            =   10335
      List            =   "AFO2080C.frx":0002
      TabIndex        =   6
      Tag             =   "机号"
      Top             =   135
      Width           =   735
   ...
   Begin VB.TextBox txt_PRC 
      ...
      Width           =   825
   End
   Begin VB.ComboBox cbo_MAT_OUT_KIND 
      BeginProperty Font 
         Name            =   "宋体"
         Size            =   9.75
         Charset         =   134
      ...
      EndProperty
      Height          =   315
      ItemData        =   "AFO2080C.frx":0004
      Left            =   13635
      List            =   "AFO2080C.frx":0006
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "AFO2080C.frx":0008
   End
   ...
   Begin InDate.ULabel SSP2 
      ...
      ForeColor       =   255
   End
   Begin InDate.UDate txt_MAT_DAY_TO 
      Height          =   315
      Left            =   3345
      TabIndex        =   3
      Top             =   135
...
'-- Program Name      RAWMATERIAL OUTYARD
'-- Program ID        AFO2080C
'-- Designer          GUOLI
'-- Coder             GUOLI
'-- Date              2003.9.1
...
Private Sub Form_Define()
    ...
    'Call Master_Collection("Control_Name", "p(primary)", "n(Necessary)", "m(maxlength)", "i(insert)", "r(refer)", "a(append)", "l(lock)")
     ...
     Call Gp_Ms_Collection(txt_MAT_DAY_TO, "p", " ", " ", " ", "r", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
   ...
   Call Gp_Ms_Collection(cbo_MAT_OUT_KIND, "p", " ", " ", " ", "r", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
...
'---------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    ''added by guoli at 20100414161100 for 刘汝营''''''''''''''
   ...
   Call Gp_Sp_Collection(ss1, 10, " ", "n", " ", "i", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    
    'Spread_Collection
    sc1.Add Item:=ss1, Key:="Spread"
    sc1.Add Item:="AFO2080C.P_SMODIFY", Key:="P-M"
    sc1.Add Item:="AFO2080C.P_SREFER", Key:="P-R"
    sc1.Add Item:="AFO2080C.P_SONEROW", Key:="P-O"
...
Private Sub Form_Load()
    ...
    cbo_MAT_OUT_KIND.AddItem ""
    cbo_MAT_OUT_KIND.AddItem "0:废钢"
    cbo_MAT_OUT_KIND.AddItem "1:辅原料"
    cbo_MAT_OUT_KIND.AddItem "2:铁合金"
    cbo_MAT_OUT_KIND.AddItem "3:其他原料"
...
'        cbo_MAT_OUT_KIND.Enabled = False
...
Dim Kind, sTemp_kind, sTemp_cd As String
    ...
    ElseIf ss1.ActiveCol = 3 Then
       ...
       ElseIf Trim(Kind) = "3" Then
          sTemp_cd = "F0019"
       Else
          MsgBox "原料种类错误！", vbCritical, "系统提示信息"
          Exit Sub
       End If
