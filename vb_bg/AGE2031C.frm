...
Begin VB.Form AGE2031C 
   Caption         =   "板卷未入库产品垛位变更界面_AGE2021C"
   ClientHeight    =   9660
   ClientLeft      =   195
   ClientTop       =   1500
   ClientWidth     =   14355
   ...
   Begin SSSplitter.SSSplitter SSSplitter1 
      ...
      Begin FPSpread.vaSpread ss1 
         ...
         SpreadDesigner  =   "AGE2031C.frx":0052
      End
      Begin SSSplitter.SSSplitter SSSplitter2 
         ...
         Begin FPSpread.vaSpread ss2 
            ...
            Protect         =   0   'False
            RetainSelBlock  =   0   'False
            SpreadDesigner  =   "AGE2031C.frx":0969
         End
      End
   End
...
Call Gp_Ms_Collection(text_cur_inv_code, "p", " ", " ", " ", "r", " ", " ", pControl2, nControl2, mControl2, iControl2, rControl2, aControl2, lControl2)
   ...
   Call Gp_Sp_Collection(ss2, 16, " ", " ", " ", " ", " ", " ", pColumn2, nColumn2, mColumn2, iColumn2, aColumn2, lColumn2)
    ...
    sc1.Add Item:="AGE2031C.P_MODIFY", Key:="P-M"
    sc1.Add Item:="AGE2031C.P_ONEROW", Key:="P-O"
    sc1.Add Item:="AGE2031C.P_SREFER1", Key:="P-R"
    ...
    sc2.Add Item:="AGE2031C.P_MODIFY", Key:="P-M"
    sc2.Add Item:="AGE2031C.P_ONEROW", Key:="P-O"
    sc2.Add Item:="AGE2031C.P_SREFER2", Key:="P-R"
