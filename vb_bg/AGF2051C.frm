...
Begin VB.Form AGF2051C 
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      RowsFrozen      =   2
      SpreadDesigner  =   "AGF2051C.frx":0000
   End
...
Private Sub Form_Define()
  ...
  Call Gp_Ms_Collection(SDT_IN_DATE_FROM, "p", " ", " ", " ", " ", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
   ...
   Call Gp_Sp_Collection(ss1, 26, " ", " ", " ", " ", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    sc1.Add Item:="AGF2051C.P_SREFER", Key:="P-R"
    sc1.Add Item:="AGF2051C.P_SMODIFY", Key:="P-M"
...
Private Sub Form_Load()
    ...
    sQuery_Rt = "SELECT ROLL_NO FROM GP_ROLL WHERE ROLL_STATUS<>'DL' AND PLT='C1' ORDER BY SUBSTR(ROLL_NO,1,1) DESC, SUBSTR(ROLL_NO,2,1), SUBSTR(ROLL_NO,6,2) "
