   ...
   Begin SSSplitter.SSSplitter SSSplitter1 
      ...
      Begin Threed.SSFrame SSFrame2 
         ...
         Begin VB.ComboBox CBO_SHIFT 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "AGC2045C.frx":0052
            Left            =   6420
            List            =   "AGC2045C.frx":005F
            TabIndex        =   5
            Top             =   120
            Width           =   885
         End
         ...
         Begin VB.ComboBox CBO_GROUP 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "AGC2045C.frx":006F
            Left            =   7320
            List            =   "AGC2045C.frx":007F
            TabIndex        =   3
            Tag             =   "班别"
            Top             =   120
            Width           =   885
      ...
      Begin FPSpread.vaSpread ss1 
         ...
         SpreadDesigner  =   "AGC2045C.frx":008F
      End
   End
End
Attribute VB_Name = "AGC2045C"
...
Call Gp_Ms_Collection(SDT_PROD_DATE_FROM, "p", "n", " ", " ", " ", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
  Call Gp_Ms_Collection(SDT_PROD_DATE_TO, "p", "n", " ", " ", " ", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
   ...
   Call Gp_Ms_Collection(txt_stdspec_chg, "p", " ", " ", " ", "r", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
    ...
    sc1.Add Item:="AGC2045C.P_SREFER", Key:="P-R"
    sc1.Add Item:="AGC2045C.P_MODIFY", Key:="P-M"
    sc1.Add Item:="AGC2045C.P_ONEROW", Key:="P-O"
...
Dim OrgColor As Variant
    ...
    ss1.Row = Row:    ss1.Col = SS1_SCH_STS:    OrgColor = ss1.BackColor
    ss1.Row = Row:    ss1.Col = 0:
