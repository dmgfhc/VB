...
Begin VB.Form AGC2430C 
   ...
   Begin VB.ComboBox txt_HTM_METH 
      Height          =   300
      ItemData        =   "AGC2430C.frx":0000
      Left            =   13260
      List            =   "AGC2430C.frx":000D
      TabIndex        =   15
      Top             =   90
      Width           =   1065
   End
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      ProcessTab      =   -1  'True
      Protect         =   0   'False
      SpreadDesigner  =   "AGC2430C.frx":001A
   End
...
Const SS1_REQ_END_DATE = 29
Const SS1_SMP_CUT_PLT = 34
Const SS1_SMP_NO = 30
Const SS1_URGNT_FL = 36  '紧急订单绿色标记 2012-11-08  by  LiQian
...
'    Call Gp_Ms_Collection(TXT_SLAB_NO, "p", " ", " ", " ", "r", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
 ...
 Call Gp_Ms_Collection(txt_smp_sent_no, "p", " ", " ", " ", "r", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
   ...
   Call Gp_Sp_Collection(ss1, 22, " ", " ", " ", "i", " ", " ", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1) 'H
...
Private Function SAMPLE_SEND_PRINT(arrRecords1 As Variant) As String
    ...
    Do
        ...
        pAry(LneCnt, 17) = arrRecords1(41, PrtCnt) & ""                  ' H
        pAry(LneCnt, 18) = arrRecords1(16, PrtCnt) & ""                  ' Std_Smp_Fl
        pAry(LneCnt, 19) = arrRecords1(17, PrtCnt) & ""                  ' Photo_Fl
        pAry(LneCnt, 20) = arrRecords1(38, PrtCnt) & ""                  ' HIC_Fl
        pAry(LneCnt, 21) = arrRecords1(42, PrtCnt) & ""                  ' MECH_Fl
        pAry(LneCnt, 22) = arrRecords1(18, PrtCnt) & ""                  ' Text
        
        
        
        '   增加实验条件 2012.5.29 LIUXIANG
        If Not IsNull(arrRecords1(26, PrtCnt)) Then
            pAry(LneCnt, 23) = pAry(LneCnt, 23) + "屈服类型：" + arrRecords1(26, PrtCnt) & " "
        End If
        If Not IsNull(arrRecords1(27, PrtCnt)) Then
            pAry(LneCnt, 23) = pAry(LneCnt, 23) + "追加屈服类型：" + arrRecords1(27, PrtCnt) & " "
        End If
        If Not IsNull(arrRecords1(28, PrtCnt)) Then
            pAry(LneCnt, 23) = pAry(LneCnt, 23) + "高温屈服类型：" + arrRecords1(28, PrtCnt) & " "
        End If
        If Not IsNull(arrRecords1(29, PrtCnt)) Then
            pAry(LneCnt, 23) = pAry(LneCnt, 23) + "追加高温屈服类型：" + arrRecords1(29, PrtCnt) & " "
        End If
        
        If Not IsNull(arrRecords1(30, PrtCnt)) Then
            pAry(LneCnt, 23) = pAry(LneCnt, 23) + "冲击开槽：" + arrRecords1(30, PrtCnt) & " "
        End If
        If Not IsNull(arrRecords1(31, PrtCnt)) Then
            pAry(LneCnt, 23) = pAry(LneCnt, 23) + "追加冲击开槽：" + arrRecords1(31, PrtCnt) & " "
        End If
        If Not IsNull(arrRecords1(32, PrtCnt)) Then
            pAry(LneCnt, 23) = pAry(LneCnt, 23) + "时效冲击开槽：" + arrRecords1(32, PrtCnt) & " "
        End If
        If Not IsNull(arrRecords1(33, PrtCnt)) Then
            pAry(LneCnt, 23) = pAry(LneCnt, 23) + "追加时效冲击开槽：" + arrRecords1(33, PrtCnt) & " "
        End If
         
        
        If Not IsNull(arrRecords1(34, PrtCnt)) Then
            pAry(LneCnt, 23) = pAry(LneCnt, 23) + "冲击尺寸：" + arrRecords1(34, PrtCnt) & " "
        End If
        If Not IsNull(arrRecords1(35, PrtCnt)) Then
            pAry(LneCnt, 23) = pAry(LneCnt, 23) + "追加冲击尺寸：" + arrRecords1(35, PrtCnt) & " "
        End If
        If Not IsNull(arrRecords1(36, PrtCnt)) Then
            pAry(LneCnt, 23) = pAry(LneCnt, 23) + "时效冲击尺寸：" + arrRecords1(36, PrtCnt) & " "
        End If
        If Not IsNull(arrRecords1(37, PrtCnt)) Then
            pAry(LneCnt, 23) = pAry(LneCnt, 23) + "追加时效冲击尺寸：" + arrRecords1(37, PrtCnt) & " "
        End If
        
        If Not IsNull(arrRecords1(39, PrtCnt)) Then
            pAry(LneCnt, 23) = pAry(LneCnt, 23) + "HIC试验标准：" + arrRecords1(39, PrtCnt) & " "
        End If
        If Not IsNull(arrRecords1(40, PrtCnt)) Then
            pAry(LneCnt, 23) = pAry(LneCnt, 23) + "溶液类型：" + arrRecords1(40, PrtCnt) & " "
        End If
