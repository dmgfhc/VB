...
Begin VB.Form AGE2030C 
   ...
   Begin SSSplitter.SSSplitter SSSplitter1 
      ...
      Begin FPSpread.vaSpread ss1 
         ...
         SpreadDesigner  =   "AGE2030C.frx":0052
      End
      Begin SSSplitter.SSSplitter SSSplitter2 
         ...
         Begin Threed.SSFrame SSFrame1 
            ...
            Begin InDate.ULabel ULabel3 
               ...
               EndProperty
            End
            Begin Threed.SSCommand ssc_adjust 
               Height          =   585
               Left            =   90
               TabIndex        =   30
               Top             =   5460
         ...
         Begin FPSpread.vaSpread ss2 
            ...
            Protect         =   0   'False
            RetainSelBlock  =   0   'False
            SpreadDesigner  =   "AGE2030C.frx":0ADF
         End
      End
   End
...
Call Gp_Ms_Collection(text_cur_inv_code, "p", " ", " ", " ", "r", " ", " ", pControl2, nControl2, mControl2, iControl2, rControl2, aControl2, lControl2)
    ...
    'MASTER Collection
    Mc1.Add Item:="AGE2030C.P_REFER", Key:="P-R"
   ...
   Call Gp_Sp_Collection(ss2, 19, " ", " ", " ", " ", " ", " ", pColumn2, nColumn2, mColumn2, iColumn2, aColumn2, lColumn2)
    ...
    sc1.Add Item:="AGE2030C.P_MODIFY", Key:="P-M"
    sc1.Add Item:="AGE2030C.P_ONEROW", Key:="P-O"
    sc1.Add Item:="AGE2030C.P_SREFER1", Key:="P-R"
    ...
    sc2.Add Item:="AGE2030C.P_MODIFY", Key:="P-M"
    sc2.Add Item:="AGE2030C.P_ONEROW", Key:="P-O"
    sc2.Add Item:="AGE2030C.P_SREFER2", Key:="P-R"
...
Private Sub ss2_Click(ByVal Col As Long, ByVal Row As Long)
    ...
    If Col = 1 Then
        ...
        If txt_fr_seq = "" Then
           txt_fr_seq.Text = ss2.Text
        ElseIf txt_to_seq = "" Then
           txt_to_seq.Text = ss2.Text
        ElseIf txt_tg_seq = "" Then
           txt_tg_seq.Text = ss2.Text
        End If
    End If
...
Private Sub ssc_adjust_Click()
    ...
    For iCnt = ss2.MaxRows To 1 Step -1
        ss2.Col = 0
        ss2.Row = iCnt
        If Trim(ss2.Text) = "Delete" Or Trim(ss2.Text) = "Update" Then
           sMsg = " 有未完成的垛位操作，请取消本次操作"
           GoTo MOVE_CLICK_ERROR
        End If
    Next
    ...
    If txt_t_addr.Text <> "" Then
       ...
       If mResult = vbYes Then
           If Gp_Adjust_Exec(text_cur_inv_code.Text, txt_t_addr.Text, txt_fr_seq.Text, txt_to_seq.Text, txt_tg_seq.Text) = "" Then
              MsgBox ("垛位调整完毕")
              Call Form_Ref
           Else
              MsgBox ("垛位调整失败")
...
Private Sub txt_f_addr_KeyUp(KeyCode As Integer, Shift As Integer)
    ...
    If Len(Trim(txt_f_addr)) = txt_f_addr.MaxLength Then
        ...
        If text_cur_inv_code.Text = "00" Then
           txt_o_f_addr_nm.Text = Gf_ComnNameFind(M_CN1, "F0039", Trim(txt_f_addr.Text), 2)
        ElseIf text_cur_inv_code.Text = "WD" Then
           txt_o_f_addr_nm.Text = Gf_ComnNameFind(M_CN1, "F0041", Trim(txt_f_addr.Text), 2)
        ElseIf text_cur_inv_code.Text = "52" Then
           txt_o_f_addr_nm.Text = Gf_ComnNameFind(M_CN1, "F0038", Trim(txt_f_addr.Text), 2)
        End If
        txt_o_f_addr.Text = txt_f_addr.Text
    Else
        txt_o_f_addr_nm.Text = ""
...
End Sub
Private Function Gp_Adjust_Exec(Cur_Inv As String, Loc As String, txt_fr_seq As String, txt_to_seq As String, txt_tg_seq As String) As String
...
On Error GoTo Process_Exec_ERROR
    ...
    sQuery = "{call GP_ADJUST_YARD('" + Cur_Inv + "','" + Loc + "','" + txt_fr_seq + "','" + txt_to_seq + "','" + txt_tg_seq + "',?)}"
...
Process_Exec_ERROR:
    ...
    Set adoCmd = Nothing
    Screen.MousePointer = vbDefault
    Gp_Adjust_Exec = "Process_Exec_ERROR"
    Err.Raise Err.Number, Err.Description & sQuery
