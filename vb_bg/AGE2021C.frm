...
Begin VB.Form AGE2021C 
   ...
   Begin VB.ComboBox CBO_PRC_LINE 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "AGE2021C.frx":0000
      Left            =   11760
      List            =   "AGE2021C.frx":000A
      TabIndex        =   21
      Top             =   60
      Width           =   1185
   End
   Begin VB.ComboBox CBO_UST_SHIFT 
      BeginProperty Font 
         Name            =   "宋体"
         Size            =   9.75
         Charset         =   134
      ...
      EndProperty
      Height          =   315
      ItemData        =   "AGE2021C.frx":0016
      Left            =   9420
      List            =   "AGE2021C.frx":0023
      TabIndex        =   17
      Top             =   450
      Width           =   855
   End
   Begin VB.ComboBox CBO_SURFGRD 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "AGE2021C.frx":0030
      Left            =   11760
      List            =   "AGE2021C.frx":0046
      TabIndex        =   16
      Tag             =   "等级"
      Top             =   450
      Width           =   1185
   ...
   Begin VB.ComboBox CBO_SHIFT 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "AGE2021C.frx":0080
      Left            =   9420
      List            =   "AGE2021C.frx":008D
      TabIndex        =   5
      Top             =   60
      Width           =   855
   End
   ...
   Begin SSSplitter.SSSplitter SSSplitter1 
      ...
      Begin FPSpread.vaSpread ss1 
         ...
         SpreadDesigner  =   "AGE2021C.frx":00EC
      End
      Begin FPSpread.vaSpread ss2 
         ...
         Protect         =   0   'False
         RetainSelBlock  =   0   'False
         SpreadDesigner  =   "AGE2021C.frx":0A51
      End
   End
   ...
   Begin InDate.ULabel ULabel9 
      ...
      EndProperty
   End
   Begin InDate.UDate SDT_UST_PROD_DATE 
      Height          =   315
      Left            =   4710
      TabIndex        =   18
      Tag             =   "起始日期"
      ...
      BackColor       =   16777215
   End
   Begin InDate.UDate SDT_UST_PROD_DATE_TO 
      Height          =   315
      Left            =   6465
      TabIndex        =   19
      Tag             =   "起始日期"
...
Private Sub Form_Define()
    ...
    Call Gp_Ms_Collection(SDT_UST_PROD_DATE, "p", " ", " ", " ", " ", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
 Call Gp_Ms_Collection(SDT_UST_PROD_DATE_TO, "p", " ", " ", " ", " ", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
        Call Gp_Ms_Collection(CBO_UST_SHIFT, "p", " ", " ", " ", " ", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
   ...
   Call Gp_Sp_Collection(ss1, 19, " ", " ", " ", " ", " ", " ", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)  '是否紧急订单 by lichao 20121128
   ...
   Call Gp_Sp_Collection(ss2, 11, " ", " ", " ", "i", " ", " ", pColumn2, nColumn2, mColumn2, iColumn2, aColumn2, lColumn2)
    ...
    sc1.Add Item:="AGE2021C.P_SREFER", Key:="P-R"
    ...
    sc2.Add Item:="AGE2021C.P_MODIFY", Key:="P-M"
    sc2.Add Item:="AGE2021C.P_ONEROW", Key:="P-O"
    sc2.Add Item:="AGE2021C.P_SREFER2", Key:="P-R"
...
On Error GoTo Process_Exec_ERROR
    ...
    sQuery = "{call AGE2020C.P_MODIFY1 ('" + "C1" + "','" + Trim(txt_f_addr.Text) + "',?)}"
