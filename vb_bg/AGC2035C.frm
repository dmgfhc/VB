...
' 2012-02-13  liqian 加订单材/余材代码显示,需要改变左边列,以前左边列和右边列共用列变量,故重新定义左边变量,所有SS1变量地方做更改.
Const SS1_LINE1 = 1
Const SS1_LINE2 = 2
...
Const SS1_URGNT_FL = 25      'Add by LiQian at 2012-11-08 紧急订单标记
Const SS2_sPaint = 15   '喷印
Const SS2_sPunch = 16   '冲印
Const SS2_sEdge = 17    '侧喷
Const SS2_PRODSPECNOA_STD = 37 '多船级社标准一
Const SS2_PRODSPECNOB_STD = 38 '多船级社标准二
Const SS2_PRODSPECNOC_STD = 39 '多船级社标准三
Const SS2_PRODSPECNOA = 40 '多船级社牌号一
Const SS2_PRODSPECNOB = 41 '多船级社牌号二
Const SS2_PRODSPECNOC = 42 '多船级社牌号三
Const SS2_INSP_CD = 43     '见证机关
Const SS2_SIDEMARK = 36 ' 侧喷加喷
Const SS2_SURFACE_REQUESTS = 44 ' 表面客户要求
...
Dim Ship_Emblem As Integer '船级社数量
...
Private Sub Form_Define()
   ...
   Call Gp_Sp_Collection(ss1, 14, " ", " ", " ", "i", " ", " ", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1) '喷印
   Call Gp_Sp_Collection(ss1, 15, " ", " ", " ", "i", " ", " ", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1) '冲印
   Call Gp_Sp_Collection(ss1, 16, " ", " ", " ", "i", " ", " ", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1) '侧喷
   ...
   Call Gp_Sp_Collection(ss1, 25, " ", " ", " ", " ", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    Call Gp_Sp_Collection(ss2, 37, " ", " ", " ", " ", " ", "l", pColumn2, nColumn2, mColumn2, iColumn2, aColumn2, lColumn2) '多船级社标准一 20140101
    Call Gp_Sp_Collection(ss2, 38, " ", " ", " ", " ", " ", "l", pColumn2, nColumn2, mColumn2, iColumn2, aColumn2, lColumn2) '多船级社标准二 20140101
    Call Gp_Sp_Collection(ss2, 39, " ", " ", " ", " ", " ", "l", pColumn2, nColumn2, mColumn2, iColumn2, aColumn2, lColumn2) '多船级社标准三 20140101
    Call Gp_Sp_Collection(ss2, 40, " ", " ", " ", " ", " ", "l", pColumn2, nColumn2, mColumn2, iColumn2, aColumn2, lColumn2) '多船级社牌号一 20140101
    Call Gp_Sp_Collection(ss2, 41, " ", " ", " ", " ", " ", "l", pColumn2, nColumn2, mColumn2, iColumn2, aColumn2, lColumn2) '多船级社牌号二 20140101
    Call Gp_Sp_Collection(ss2, 42, " ", " ", " ", " ", " ", "l", pColumn2, nColumn2, mColumn2, iColumn2, aColumn2, lColumn2) '多船级社牌号三 20140101
    Call Gp_Sp_Collection(ss2, 43, " ", " ", " ", " ", " ", "l", pColumn2, nColumn2, mColumn2, iColumn2, aColumn2, lColumn2) '见证机关 20140227
    ...
    Select Case sSpec_Str
           ...
           Case Else
                ...
                If sTS_YN = "Y" Then
                    TXT_Class_comp = "12"
                End If
                If sTS_YN = "A" Then '管线钢判断 add hanchao
                    TXT_Class_comp = "16"
                End If
                If jIS_YN = "A" Then 'JIS标识判断 add hanchao
                    TXT_Class_comp = "15"
                End If
...
Private Sub Cmd_SEND(iPlate_no As String, iThk As String, iWid As String, iLen As String, iWGT As String, iSpec As String, iStdspec_yy As String, iColorStr As String)
    ...
    Dim sSpec As String           ' 标准号
    Dim sStdspec_yy As String     ' 标准年号
    Dim sSpec1 As String * 34     ' 标准号（带标准年号）
    Dim sSpec2 As String * 40     ' 钢种
    ...
    If TXT_Class_comp <> "" Then
        If Val(TXT_Class_comp) < 1 Or Val(TXT_Class_comp) > 50 Then
            SMESG = "Class_comp(1-50) 数据错误，请确认"
            Call Gp_MsgBoxDisplay(SMESG)
            Exit Sub
        End If
    End If
...
'    sComp = 0
    ...
    If chk_Cond(0) = 1 Then
        ...
        Winsock1.SendData HiByte(sPaint) '(sTopPaint) 使用sPaint定义上喷 20140101
        Winsock1.SendData LoByte(sPaint) '(sTopPaint) 使用sPaint定义上喷 20140101
        Winsock1.SendData HiByte(sBottomPaint) '(sBottomPaint) 使用sPaint定义下喷 20140101
        Winsock1.SendData LoByte(sBottomPaint) '(sBottomPaint) 使用sPaint定义下喷 20140101
