...
Begin VB.Form AGE2040C 
   Caption         =   "钢板库库图现状查询_AGE2040C"
   ClientHeight    =   9090
   ClientLeft      =   360
   ClientTop       =   1725
   ClientWidth     =   14205
   ...
   Begin VB.ComboBox CBO_CUR_INV 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "AGE2040C.frx":0000
      Left            =   1380
      List            =   "AGE2040C.frx":000A
      TabIndex        =   6
      Top             =   120
      Width           =   795
   End
   Begin VB.ComboBox CBO_YARD_COLUMN 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "AGE2040C.frx":0016
      Left            =   8430
      List            =   "AGE2040C.frx":0018
      TabIndex        =   5
      Top             =   9840
      Visible         =   0   'False
      Width           =   795
   ...
   Begin VB.ComboBox CBO_YARD_ROW 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "AGE2040C.frx":001A
      Left            =   7620
      List            =   "AGE2040C.frx":001C
      TabIndex        =   4
      Top             =   9840
      Visible         =   0   'False
      Width           =   795
   ...
   Begin VB.ComboBox CBO_YARD_TYPE 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "AGE2040C.frx":001E
      Left            =   5220
      List            =   "AGE2040C.frx":0020
      TabIndex        =   3
      Top             =   120
      Width           =   795
   End
   Begin VB.ComboBox CBO_ZONE_TYPE 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "AGE2040C.frx":0022
      Left            =   6030
      List            =   "AGE2040C.frx":0024
      TabIndex        =   2
      Top             =   120
      Width           =   795
   End
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "AGE2040C.frx":0026
      UserResize      =   1
   End
...
'    If ss1.TypeButtonText = "" Then Exit Sub
    ...
    If ss1.TypeButtonColor = &HC0C0FF Then
        AGE2030C.txt_t_addr.Text = sAddr
    Else
        AGE2030C.txt_f_addr.Text = sAddr
    End If
    
    AGE2030C.text_cur_inv_code.Text = CBO_CUR_INV.Text
    AGE2030C.sOth = "AGE2040C"
