...
Begin VB.Form CEA1180C 
   Caption         =   "中板头尾坯方尺度维护钢种组_CEA1180C"
   ClientHeight    =   3030
   ClientLeft      =   120
   ClientTop       =   450
   ClientWidth     =   4560
   ...
   Begin SSSplitter.SSSplitter SSSplitter1 
      ...
      Begin FPSpread.vaSpread ss1 
         ...
         SpreadDesigner  =   "CEA1180C.frx":0052
      End
      Begin Threed.SSPanel SSPanel1 
         ...
         FloodShowPct    =   -1  'True
         Begin VB.TextBox txt_STLGRD_DETIAL 
            BeginProperty Font 
               Name            =   "宋体"
               Size            =   9.75
               Charset         =   0
...
Private Sub Form_Define()
    ...
    'Call Master_Collection("Control_Name", "p(primary)", "n(Necessary)", "m(maxlength)", "i(insert)", "r(refer)", "a(append)", "l(lock)")
           ...
           Call Gp_Ms_Collection(txt_STLGRD, " ", " ", " ", " ", " ", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
           Call Gp_Ms_Collection(txt_STLGRD_DETIAL, "p", " ", " ", " ", " ", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
    ...
    sc1.Add Item:="CEA1180C.P_MODIFY", Key:="P-M"
    sc1.Add Item:="CEA1180C.P_REFER", Key:="P-R"
    sc1.Add Item:="CEA1180C.P_ONEROW", Key:="P-O"
...
Private Sub txt_stlgrd_KeyUp(KeyCode As Integer, Shift As Integer)
   ...
   If KeyCode = vbKeyF4 Then
        ...
        DD.rControl.Add Item:=txt_STLGRD_DETIAL
    ...
    Else
        ...
        If Len(Trim(txt_STLGRD.Text)) >= 10 Then
            txt_STLGRD_DETIAL.Text = Gf_StlgrdNameFind(M_CN1, Trim(txt_STLGRD.Text))
        Else
            txt_STLGRD_DETIAL.Text = ""
        End If
