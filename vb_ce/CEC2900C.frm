...
Begin VB.Form CEC2900C 
   Caption         =   "轧辊单位编制结果查询/修改_CEC2900C"
   ClientHeight    =   7650
   ClientLeft      =   270
   ClientTop       =   2925
   ClientWidth     =   15240
   ...
   Begin FPSpread.vaSpread ss3 
      ...
      SpreadDesigner  =   "CEC2900C.frx":0000
   End
   ...
   Begin SSSplitter.SSSplitter spl_splitter 
      ...
      Begin FPSpread.vaSpread ss1 
         ...
         MaxRows         =   1
         RetainSelBlock  =   0   'False
         SpreadDesigner  =   "CEC2900C.frx":03A3
      End
      Begin FPSpread.vaSpread ss2 
         ...
         MaxRows         =   1
         RetainSelBlock  =   0   'False
         SpreadDesigner  =   "CEC2900C.frx":0C58
      End
   End
...
'   2.01  07.10.24 KIM SUNG HO  EP_SLAB_EDT --> EP_SLAB_EDT3, EP_PLATE_EDT --> EP_PLATE_EDT3 TABLE ID CHANGE
'-------------------------------------------------------------------------------
'-- DECLARATION     ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
'-------------------------------------------------------------------------------
...
Private Sub Form_Define()
   ...
   Call Gp_Sp_Collection(ss1, 17, " ", " ", " ", " ", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    sc1.Add Item:="CEC2900C.P_REFER3", Key:="P-R"
    ...
    sc2.Add Item:="CEC2900C.P_REFER2", Key:="P-R"
    ...
    'Call Gp_Sp_ColHidden(Sc1.Item("Spread"), 16, True)  'SLAB_EDT_NO
    Call Gp_Sp_ColHidden(sc1.Item("Spread"), 16, True)  'SLAB_EDT_NO
...
On Error GoTo Process_Exec_ERROR
    ...
    sQuery = "SELECT COUNT(*) FROM EP_SLAB_EDT3  "
...
Private Sub Form_Load()
    ...
    iSlab_MaxLen = Gf_FloatFind(M_CN1, "SELECT SLAB_LEN_MAX FROM EP_FUR_SIZE_STD WHERE PLT = 'C3' AND PRC_LINE = '1' AND FUR_LINE = '2'")
    Label9.Caption = Gf_FloatFind(M_CN1, "SELECT SLAB_LEN_MAX FROM EP_FUR_SIZE_STD WHERE PLT = 'C3' AND PRC_LINE = '1' AND FUR_LINE = '1'")
    Label5.Caption = Gf_FloatFind(M_CN1, "SELECT SLAB_LEN_MIN FROM EP_FUR_SIZE_STD WHERE PLT = 'C3' AND PRC_LINE = '1' AND FUR_LINE = '2'")
    
    Label14.Caption = iSlab_MaxLen
    
    iStatus = Gf_FloatFind(M_CN1, "SELECT COUNT(*) FROM ZP_JOB WHERE PLT = 'C3' AND PRC_STS <> 'C' AND MAIN_PGMID = 'CED1000P' ")
    If iStatus <> 0 Then
    ...
    If SMESG = "OK" Then
        ...
        If SMESG = "OK" Then
            ...
            If Chart_Refer Then
                ...
                'sQuery = "SELECT COUNT(*) FROM EP_SLAB_EDT3 WHERE SLAB_EDT_FL = '1' "
                'iCount = Gf_FloatFind(M_CN1, sQuery)
    ...
    With ss3
        ...
        For iCount = 1 To 135
            ...
            If iCount = 1 And .Text <> "" Then
                ...
                .Col = 7
                lbl_len(iCount).Height = (1020 / iSlab_MaxLen) * .Value
                lbl_len(iCount).Top = 2800 + (960 - lbl_len(iCount).Height)
...
'                    lbl_len(iCount).BorderStyle = 1
                ...
                ElseIf .Text = "" And iCount = 1 Then
                    ...
                    lbl_len(iCount).Top = 2800
                    lbl_len(iCount).Left = lbl_len(iCount - 1).Left + lbl_len(iCount - 1).Width
                    lbl_len(iCount).Height = 1020
...
On Error GoTo Chart_Refer_Error
    ...
    sQuery = "SELECT COUNT(*) FROM (SELECT COUNT(*) FROM EP_SLAB_EDT3 WHERE MILL_PLT = '" & TXT_PLT.Text & "' "
    ...
    'sQuery = "SELECT ROLL_MANA_NO, ASROLL_WID, ASROLL_THK, HCR_FL, SLAB_NO, FUR_LINE, SLAB_LEN  "
    sQuery = "SELECT ROLL_MANA_NO, ASROLL_WID, ASROLL_THK, HCR_FL, SLAB_EDT_SEQ, FUR_LINE, SLAB_LEN  "
    sQuery = sQuery + " FROM EP_SLAB_EDT3 WHERE MILL_PLT = '" & TXT_PLT.Text & "' "
    ...
    If lbl_wid(Index).BackColor = &H80FF80 Or lbl_wid(Index).BackColor = &H80CC00 Or lbl_wid(Index).BackColor = &HFFFF& Then    'green, yellow
        ...
        For iCount = 1 To ss3.MaxRows
            ...
            If lbl_wid(Index).Tag = sRollNo + sSlabNo Then
                ...
                If ss3.Text = "2" Then
                    lbl_len(Index).BackColor = &HFFFFC0
                Else
                    lbl_len(Index).BackColor = &HFFC0FF
                End If
...
On Error GoTo Process_Exec_ERROR
    ...
    sQuery = "{call CEZ5000P ('" + P_PLT + "','" + Trim(Str(P_LINE)) + "','" + P_STATUS + "','" + P_MODE + "','" + P_UNIT + "','"
