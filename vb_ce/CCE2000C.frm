...
Begin VB.Form CCE2000C 
   Caption         =   "余材降级查询/录入_CCE2000C"
   ClientHeight    =   7710
   ClientLeft      =   1245
   ClientTop       =   885
   ClientWidth     =   12060
   ...
   Begin VB.ComboBox cbo_ord_item 
      Height          =   300
      ItemData        =   "CCE2000C.frx":0000
      Left            =   12915
      List            =   "CCE2000C.frx":0002
      TabIndex        =   11
      Top             =   465
      Width           =   660
   End
   ...
   Begin SSSplitter.SSSplitter SSSplitter1 
      ...
      Begin FPSpread.vaSpread ss1 
         ...
         SpreadDesigner  =   "CCE2000C.frx":0056
      End
      Begin FPSpread.vaSpread ss2 
         ...
         MaxCols         =   21
         RetainSelBlock  =   0   'False
         SpreadDesigner  =   "CCE2000C.frx":08F3
      End
   End
...
Private Sub Form_Define()
   ...
   Call Gp_Sp_Collection(ss1, 18, " ", " ", " ", " ", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    sc1.Add Item:="CCE2000C.P_REFER1", Key:="P-R"
   ...
   Call Gp_Sp_Collection1(ss2, 21, " ", " ", " ", " ", " ", "l", pColumn2, nColumn2, mColumn2, iColumn2, aColumn2, lColumn2)
    ...
    sc2.Add Item:="CCE2000C.P_REFER2", Key:="P-R"
    sc2.Add Item:="CCE2000C.P_MODIFY", Key:="P-M"
