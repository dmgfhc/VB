...
Begin VB.Form CEB2060C 
   Caption         =   "板坯设计结果查询/修改_CEB2060C"
   ClientHeight    =   8655
   ClientLeft      =   735
   ClientTop       =   2355
   ClientWidth     =   13260
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "CEB2060C.frx":0000
   End
...
'-- System Name
'-- Sub_System Name
'-- Program Name      SLAB DESIGN RESULT
'-- Program ID        CEB2060C
...
Private Sub Form_Define()
   ...
   Call Gp_Sp_Collection(ss1, 25, " ", " ", " ", " ", " ", " ", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    sc1.Add Item:="CEB2060C.P_REFER", Key:="P-R"
