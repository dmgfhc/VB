...
Begin VB.Form CEB1010C 
   Caption         =   "设计订单查询/选定_CEB1010C"
   ClientHeight    =   7545
   ClientLeft      =   375
   ClientTop       =   2790
   ClientWidth     =   15300
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      ProcessTab      =   -1  'True
      Protect         =   0   'False
      SpreadDesigner  =   "CEB1010C.frx":0000
   End
...
Private Sub Form_Define()
    ...
    sc1.Add Item:="CEB1010C.P_REFER", Key:="P-R"
    sc1.Add Item:="CEB1010C.P_MODIFY", Key:="P-M"
    sc1.Add Item:="CEB1010C.P_ONEROW", Key:="P-O"
    ...
    For iRow = 1 To ss1.MaxRows - 1
        ...
        If Trim(ss1.Text) <> "定尺" Then
            ...
            If dMin <= sdb_prod_len_chg.Value And dMax >= sdb_prod_len_chg.Value Then
                ...
                ss1.Col = SPD_USERID:    ss1.Value = sUserID
...
Private Sub ss1_DblClick(ByVal Col As Long, ByVal Row As Long)
    ...
    If Row <= 0 Then Exit Sub
    If Col < 17 Or Col > 20 Then Exit Sub
    ss1.Row = Row
    ss1.Col = 1
    If ss1.Text = "汇总" Then Exit Sub
    ...
    'If ss1.Value <> 0 Then
        ...
        ss1.Row = Row
        ss1.Col = 1
        CEB2080C.txt_ord_no.Text = Trim(ss1.Text)
        
        ss1.Row = Row
        ss1.Col = 2
        CEB2080C.txt_ord_item.Text = Trim(ss1.Text)
        
        CEB2080C.Active_CForm = "CEB2080C"
...
On Error GoTo SpreadPro_Error
    ...
    For iCount = 1 To Sc.Item("Spread").MaxRows
        ...
        If ss1.Text = "设计" Then
            ...
            adoCmd.Parameters(6).Value = ss1.Text
