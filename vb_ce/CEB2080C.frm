...
Begin VB.Form CEB2080C 
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "板坯设计结果查询/修改_CEB2080C"
   ClientHeight    =   7695
   ClientLeft      =   660
   ClientTop       =   2895
   ClientWidth     =   13530
   ...
   Begin SSSplitter.SSSplitter SSSplitter1 
      ...
      Begin FPSpread.vaSpread ss2 
         ...
         SpreadDesigner  =   "CEB2080C.frx":0052
      End
      Begin FPSpread.vaSpread ss1 
         ...
         MaxRows         =   2
         RetainSelBlock  =   0   'False
         SpreadDesigner  =   "CEB2080C.frx":0734
      End
   End
...
Private Sub Form_Define()
   ...
   Call Gp_Sp_Collection(ss1, 23, " ", " ", " ", " ", " ", " ", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    sc1.Add Item:="CEB2080C.P_REFER", Key:="P-R"
    sc1.Add Item:="CEB2080C.P_MODIFY", Key:="P-M"
    ...
    sc2.Add Item:="CEB2080C.P_REFER2", Key:="P-R"
...
Private Sub cmd_process_Click()
    ...
    sQuery = "{call CEB2080C.P_MODIFY ('U','" & txt_ord_no.Text & "','" & txt_ord_item.Text & "'," & iProd_cnt & "," _
