...
Begin VB.Form CEC4010C 
   Caption         =   "长坯料设计_CEC4010C"
   ClientHeight    =   8250
   ClientLeft      =   300
   ClientTop       =   2640
   ClientWidth     =   15300
   ...
   Begin SSSplitter.SSSplitter SSSplitter1 
      ...
      Begin FPSpread.vaSpread ss1 
         ...
         SpreadDesigner  =   "CEC4010C.frx":0052
      End
      Begin FPSpread.vaSpread ss2 
         ...
         MaxRows         =   2
         RetainSelBlock  =   0   'False
         SpreadDesigner  =   "CEC4010C.frx":08C3
      End
   End
...
Private Sub Form_Define()
    ...
    sc1.Add Item:="CEC4010C.P_REFER1", Key:="P-R"
    sc1.Add Item:="CEC4010C.P_ONEROW1", Key:="P-O"
    sc1.Add Item:="CEC4010C.P_MODIFY1", Key:="P-M"
    ...
    sc2.Add Item:="CEC4010C.P_REFER2", Key:="P-R"
...
Private Sub cmd_single_ord_Click()
    ...
    sQuery = "{call CEC4010P ( " & sdb_b1_len_min.Value & "," _
                                 & sdb_b1_len_max.Value & "," _
                                 & sdb_b3_len_min.Value & "," _
                                 & sdb_b3_len_max.Value & "," _
                                 & sdb_ext_len_min.Value & "," _
                                 & sdb_ext_len_max.Value & "," _
                                 & ",?)}"
...
Public Sub Form_Ref()
    ...
    sdb_slab_cnt1.Value = Gf_FloatFind(M_CN1, " SELECT  COUNT(SLAB_EDT_SEQ) FROM EP_C3_REQ_SLAB_EDT " & _
