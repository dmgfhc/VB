...
Begin VB.Form CEA1140C 
   Caption         =   "录入产品厚度别轧制长度标准_CEA1140C"
   ClientHeight    =   7215
   ClientLeft      =   570
   ClientTop       =   2490
   ClientWidth     =   13590
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "CEA1140C.frx":0000
   End
End
Attribute VB_Name = "CEA1140C"
...
Private Sub Form_Define()
    ...
    Sc1.Add Item:="CEA1140C.P_MODIFY", Key:="P-M"
    Sc1.Add Item:="CEA1140C.P_REFER", Key:="P-R"
    Sc1.Add Item:="CEA1140C.P_ONEROW", Key:="P-O"
