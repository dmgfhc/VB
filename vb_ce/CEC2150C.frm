...
Begin VB.Form CEC2150C 
   Caption         =   "坯料使用计划结果信息查询/确定_CEC2150C"
   ClientHeight    =   8250
   ClientLeft      =   180
   ClientTop       =   2370
   ClientWidth     =   15375
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "CEC2150C.frx":0000
   End
End
Attribute VB_Name = "CEC2150C"
...
Private Sub Form_Define()
    ...
    'MASTER Collection
    Mc2.Add Item:="CEC2150C.P_REFER1", Key:="P-R"
    ...
    sc1.Add Item:="CEC2150C.P_REFER2", Key:="P-R"
    sc1.Add Item:="CEC2150C.P_ONEROW2", Key:="P-O"
    sc1.Add Item:="CEC2150C.P_MODIFY2", Key:="P-M"
...
Private Sub cmd_Confirm_Click()
    ...
    sQuery = "SELECT COUNT(*) FROM EP_C3_REQ_SLAB_EDT WHERE CCM_PRC_LINE = 'Y' "
    ...
    sQuery = "{call CEC2150P ('C3','" & udt_plan_date.RawData & "','" & sUserID & "',?)}"
