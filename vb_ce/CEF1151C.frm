...
Begin VB.Form CEF1151C 
   BackColor       =   &H00E0E0E0&
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "相关母板/产品信息_CEF1151C"
   ClientHeight    =   8955
   ClientLeft      =   645
   ClientTop       =   1875
   ClientWidth     =   14115
   ...
   Begin VB.TextBox txt_slab_cut_seq 
      BeginProperty Font 
         Name            =   "宋体"
         Size            =   9.75
         Charset         =   0
   ...
   Begin VB.PictureBox Picture1 
      ...
      End
   End
   Begin VB.TextBox txt_block_seq 
      BeginProperty Font 
         Name            =   "宋体"
         Size            =   9.75
         Charset         =   0
   ...
   Begin MSComctlLib.ImageList ImageList2 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "CEF1151C.frx":0000
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "CEF1151C.frx":00E0
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "CEF1151C.frx":029A
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "CEF1151C.frx":04DF
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "CEF1151C.frx":0639
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         NumListImages   =   5
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "CEF1151C.frx":094A
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "CEF1151C.frx":0C6A
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "CEF1151C.frx":0DB5
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "CEF1151C.frx":0F42
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "CEF1151C.frx":104E
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin SSSplitter.SSSplitter SSSplitter1 
      ...
      Begin SSSplitter.SSSplitter SSSplitter2 
         ...
         Begin FPSpread.vaSpread ss2 
            ...
            SpreadDesigner  =   "CEF1151C.frx":1584
         End
      End
      Begin FPSpread.vaSpread ss1 
         ...
         MaxRows         =   1
         RetainSelBlock  =   0   'False
         SpreadDesigner  =   "CEF1151C.frx":1EAE
      End
   End
...
Private Sub Form_Define()
    ...
    'Call Master_Collection("Control_Name", "p(primary)", "n(Necessary)", "m(maxlength)", "i(insert)", "r(refer)", "a(append)", "l(lock)")
         Call Gp_Ms_Collection(txt_slab_no, "p", " ", " ", " ", "r", " ", "l", pContro2, nContro2, mContro2, iContro2, rContro2, aContro2, lContro2)
    Call Gp_Ms_Collection(txt_slab_cut_seq, "p", " ", " ", " ", "r", " ", "l", pContro2, nContro2, mContro2, iContro2, rContro2, aContro2, lContro2)
       Call Gp_Ms_Collection(txt_block_seq, "p", " ", " ", " ", "r", " ", "l", pContro2, nContro2, mContro2, iContro2, rContro2, aContro2, lContro2)
   ...
   Call Gp_Sp_Collection(ss1, 18, " ", " ", " ", " ", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    sc1.Add Item:="CEF1151C.P_MODIFY1", Key:="P-M"
    sc1.Add Item:="CEF1151C.P_REFER1", Key:="P-R"
    sc1.Add Item:="CEF1151C.P_ONEROW1", Key:="P-O"
    ...
    Call Gp_Sp_Collection(ss2, 3, "p", " ", " ", "i", " ", "l", pColumn2, nColumn2, mColumn2, iColumn2, aColumn2, lColumn2)
    Call Gp_Sp_Collection(ss2, 4, "p", " ", " ", "i", " ", "l", pColumn2, nColumn2, mColumn2, iColumn2, aColumn2, lColumn2)
   ...
   Call Gp_Sp_Collection(ss2, 18, " ", " ", " ", " ", " ", "l", pColumn2, nColumn2, mColumn2, iColumn2, aColumn2, lColumn2)
    ...
    sc2.Add Item:="CEF1151C.P_MODIFY1", Key:="P-M"
    sc2.Add Item:="CEF1151C.P_ONEROW1", Key:="P-O"
    sc2.Add Item:="CEF1151C.P_REFER2", Key:="P-R"
...
Private Sub Form_Activate()
    ...
    sAuthority = Gf_Pgm_Authority("CEF1151C")
...
Public Sub Form_Pro()
    ...
    If Chk_ss1.Value = -1 Then
        If Gf_Sp_Process(M_CN1, Proc_Sc("Sc"), Mc1) Then
            ...
            Call MDIMain.FormMenuSetting(Me, FormType, "RE", sAuthority)
            Call Form_Ref
            CEF1150C.Complete = True
        End If
    Else
        If Gf_Sp_Process(M_CN1, Proc_Sc("Sc"), Mc2) Then
            Call MDIMain.FormMenuSetting(Me, FormType, "RE", sAuthority)
            If ss2.MaxRows = 0 Then Call Form_Ref
            CEF1150C.Complete = True
        End If
    End If
...
Private Sub ss1_Click(ByVal Col As Long, ByVal Row As Long)
    ...
    ss1.Col = 2
    txt_slab_cut_seq.Text = ss1.Text
    ss1.Col = 3
    txt_block_seq.Text = ss1.Text
...
Private Sub ss1_ColWidthChange(ByVal Col1 As Long, ByVal Col2 As Long)
    ...
    For iCol = 1 To ss1.MaxCols
        ss2.ColWidth(iCol) = ss1.ColWidth(iCol)
    Next iCol
...
Private Sub ss2_ColWidthChange(ByVal Col1 As Long, ByVal Col2 As Long)
    ...
    For iCol = 1 To ss2.MaxCols
        ss1.ColWidth(iCol) = ss2.ColWidth(iCol)
    Next iCol
