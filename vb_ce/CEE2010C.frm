...
Begin VB.Form CEE2010C 
   Caption         =   "轧钢作业指示查询_CEE2010C"
   ClientHeight    =   7620
   ClientLeft      =   195
   ClientTop       =   2070
   ClientWidth     =   15135
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "CEE2010C.frx":0000
   End
...
Private Sub Form_Define()
 ...
 Call Gp_Ms_Collection(txt_PRC_LINE, "p", "n", "m", " ", "r", " ", "l", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
     Call Gp_Ms_Collection(dtp_date, "p", "n", "m", " ", "r", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
...
'---------------------------------------------------------------------------------------------------------------------------------------------------------------
   ...
   Call Gp_Sp_Collection(ss1, 25, " ", " ", " ", " ", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    sc1.Add Item:="CEE2010C.P_MODIFY", Key:="P-M"
    sc1.Add Item:="CEE2010C.P_REFER", Key:="P-R"
    sc1.Add Item:="CEE2010C.P_ONEROW", Key:="P-O"
