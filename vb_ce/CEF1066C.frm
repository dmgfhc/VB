...
Begin VB.Form CEF1066C 
   BackColor       =   &H00E0E0E0&
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "余坯替代/分配余量_CEF1066C"
   ClientHeight    =   4125
   ClientLeft      =   450
   ClientTop       =   2625
   ClientWidth     =   13980
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      ProcessTab      =   -1  'True
      Protect         =   0   'False
      SpreadDesigner  =   "CEF1066C.frx":0000
   End
...
Private Sub cmd_cnf_Click()
    ...
    For iRow = 1 To ss1.MaxRows
        ...
        CEF1065C.Slab_Len.Remove (ss1.MaxRows - iRow + 1)
        CEF1065C.Slab_Wgt.Remove (ss1.MaxRows - iRow + 1)
    ...
    For iRow = 1 To ss1.MaxRows
        ...
        If ss1.Value = 1 Then
            ...
            If IIf(ss1.Text = "", 0, ss1.Value) <> 0 Then
                ...
                CEF1065C.sdb_div_wgt.Value = sdb_slab_rem_wgt1.Value
                CEF1065C.sdb_ord_wgt.Value = CEF1065C.sdb_mat_wgt.Value - sdb_slab_rem_wgt1.Value
        ...
        CEF1065C.Slab_Len.Add Item:=Chg_Slab_Len(iRow)
        CEF1065C.Slab_Wgt.Add Item:=Chg_Slab_Wgt(iRow)
        
        CEF1065C.lbl_slab(iRow).Width = (CEF1065C.Shape1.Width / CEF1065C.sdb_mat_wgt.Value) * (Chg_Slab_Wgt.Item(iRow) + IIf(iRow > 0, CEF1065C.dSlab_Cut_Spare_Wgt, 0))
        
        If iRow = 1 Then
            CEF1065C.lbl_slab(iRow).Left = CEF1065C.Shape1.Left
        Else
            CEF1065C.lbl_slab(iRow).Left = CEF1065C.lbl_slab(iRow - 1).Left + CEF1065C.lbl_slab(iRow - 1).Width
        End If
        
        'ToolTipText Setting
        CEF1065C.lbl_slab(iRow).ToolTipText = CEF1065C.Ord_No.Item(iRow) & "-" & CEF1065C.Ord_Item.Item(iRow) & "(" & CEF1065C.Slab_Len.Item(iRow) & ", " & CEF1065C.Slab_Wgt.Item(iRow) & ")"
