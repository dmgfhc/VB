...
Begin VB.Form AAA1130C 
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "AAA1130C.frx":0000
   End
   Begin VB.ComboBox cbo_plt 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "AAA1130C.frx":1C5E
      Left            =   1455
      List            =   "AAA1130C.frx":1C60
      TabIndex        =   1
      Tag             =   "工厂"
      Top             =   240
      Width           =   870
   ...
   Begin VB.ComboBox txt_prod_cd 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "AAA1130C.frx":1C62
      Left            =   4245
      List            =   "AAA1130C.frx":1C64
      TabIndex        =   0
      Tag             =   "产品代码"
      Top             =   240
      Width           =   870
...
'-- Program Name      SLAB THICK STANDARD
'-- Program ID        AAA1130C
'-- Designer          GUOLI
'-- Coder             GUOLI
'-- Date              2009.6.6
...
'---------------------------------------------------------------------------------------------------------------------------------------------------------------
   ...
   Call Gp_Sp_Collection(ss1, 14, " ", " ", " ", "i", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    Sc1.Add Item:="AAA1130C.P_SMODIFY", Key:="P-M"
    Sc1.Add Item:="AAA1130C.P_SREFER", Key:="P-R"
    Sc1.Add Item:="AAA1130C.P_SONEROW", Key:="P-O"
...
ElseIf Col = 7 Then
    ...
    sQuery = "SELECT FR_THK || '~' || TO_THK FROM BP_THICK_GRP WHERE PROD_CD = 'SL' and THK_CD = '" + sSlabWidGrp + "'  "
End If
