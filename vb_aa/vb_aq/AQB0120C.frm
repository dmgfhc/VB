...
Begin VB.Form AQB0120C 
   ...
   Begin TabDlg.SSTab ssT 
      ...
      Tab(0).Control(3)=   "txt_HTM_CD(0)"
      Tab(0).Control(4)=   "txt_RA_DIR_NAME(0)"
      Tab(0).Control(5)=   "txt_RA_DIR_CD(0)"
      Tab(0).Control(6)=   "txt_YR_DSC_CD(0)"
      Tab(0).Control(7)=   "txt_TS_DSC_CD(0)"
      Tab(0).Control(8)=   "txt_RA_DSC_CD(0)"
      Tab(0).Control(9)=   "txt_EL_DSC_CD(0)"
      Tab(0).Control(10)=   "txt_SNPP_EL_DSC_CD(0)"
      Tab(0).Control(11)=   "txt_SG_EL_DSC_CD(0)"
      Tab(0).Control(12)=   "txt_SP_EL_DSC_CD(0)"
      Tab(0).Control(13)=   "txt_YP_DSC_CD(0)"
      Tab(0).Control(14)=   "txt_TENCIL_SMP_CD(0)"
      Tab(0).Control(15)=   "txt_SP_EL_SMP_CD(0)"
      Tab(0).Control(16)=   "txt_SNPP_EL_CD(1)"
      Tab(0).Control(17)=   "txt_SNPP_EL_CD(0)"
      Tab(0).Control(18)=   "txt_SG_EL_CD(1)"
      Tab(0).Control(19)=   "txt_SG_EL_CD(0)"
      Tab(0).Control(20)=   "txt_SP_EL_CD(1)"
      Tab(0).Control(21)=   "txt_EL_CD(1)"
      Tab(0).Control(22)=   "txt_EL_CD(0)"
      Tab(0).Control(23)=   "txt_SP_EL_CD(0)"
      ...
      Tab(0).Control(40)=   "sdb_YP_MAX(0)"
      Tab(0).Control(41)=   "ULabel4(9)"
      Tab(0).Control(42)=   "sdb_TS_MAX(0)"
      Tab(0).Control(43)=   "ULabel4(10)"
      Tab(0).Control(44)=   "sdb_RA_MAX(0)"
      Tab(0).Control(45)=   "ULabel4(11)"
      Tab(0).Control(46)=   "sdb_EL_MAX(0)"
      Tab(0).Control(47)=   "ULabel4(12)"
      Tab(0).Control(48)=   "sdb_SNPP_EL_MAX(0)"
      Tab(0).Control(49)=   "ULabel4(13)"
      Tab(0).Control(50)=   "sdb_SG_EL_MAX(0)"
      Tab(0).Control(51)=   "ULabel4(14)"
      Tab(0).Control(52)=   "sdb_SP_EL_MAX(0)"
      Tab(0).Control(53)=   "ULabel4(15)"
      Tab(0).Control(54)=   "ULabel4(59)"
      Tab(0).Control(55)=   "sdb_YR_MAX(0)"
      Tab(0).Control(56)=   "ULabel4(60)"
      Tab(0).Control(57)=   "ULabel4(95)"
      Tab(0).Control(58)=   "ULabel4(111)"
      Tab(0).Control(59)=   "ULabel4(138)"
      Tab(0).Control(60)=   "ULabel4(139)"
      Tab(0).Control(61)=   "sdb_DRAW_MIN(1)"
      Tab(0).Control(62)=   "sdb_DRAW_MIN(2)"
      Tab(0).Control(63)=   "sdb_DRAW_MIN(3)"
      Tab(0).Control(64)=   "sdb_DRAW_MIN(6)"
      Tab(0).Control(65)=   "sdb_DRAW_MIN(8)"
      Tab(0).Control(66)=   "sdb_DRAW_MIN(9)"
      Tab(0).Control(67)=   "sdb_DRAW_MIN(10)"
      Tab(0).Control(68)=   "sdb_DRAW_MIN(7)"
      Tab(0).Control(69)=   "sdb_DRAW_MIN(4)"
      Tab(0).Control(70)=   "sdb_DRAW_MIN(5)"
      Tab(0).Control(71)=   "sdb_DRAW_MIN(11)"
      Tab(0).Control(72)=   "sdb_DRAW_MAX(11)"
      Tab(0).Control(73)=   "ULabel4(149)"
      Tab(0).Control(74)=   "ULabel4(150)"
      Tab(0).Control(75)=   "Line3(4)"
      Tab(0).Control(76)=   "Line3(3)"
      Tab(0).Control(77)=   "Line3(2)"
      Tab(0).Control(78)=   "Line3(1)"
      Tab(0).Control(79)=   "Line3(0)"
      Tab(0).Control(80)=   "Line49(2)"
      ...
      Tab(3).Control(0)=   "Line49(7)"
      Tab(3).Control(1)=   "Line3(26)"
      Tab(3).Control(2)=   "Line3(27)"
      Tab(3).Control(3)=   "Line3(28)"
      Tab(3).Control(4)=   "Line3(29)"
      Tab(3).Control(5)=   "Line3(30)"
      Tab(3).Control(6)=   "ULabel4(137)"
      Tab(3).Control(7)=   "ULabel4(98)"
      Tab(3).Control(8)=   "ULabel4(69)"
      Tab(3).Control(9)=   "ULabel4(68)"
      Tab(3).Control(10)=   "ULabel4(67)"
      Tab(3).Control(11)=   "ULabel4(66)"
      Tab(3).Control(12)=   "ULabel4(65)"
      Tab(3).Control(13)=   "ULabel4(64)"
      Tab(3).Control(14)=   "ULabel4(63)"
      Tab(3).Control(15)=   "ULabel4(62)"
      Tab(3).Control(16)=   "ULabel4(61)"
      Tab(3).Control(17)=   "ULabel27(30)"
      Tab(3).Control(18)=   "sdb_HGT_EL_MAX(1)"
      Tab(3).Control(19)=   "sdb_HGT_EL_MIN(1)"
      Tab(3).Control(20)=   "ULabel27(29)"
      Tab(3).Control(21)=   "sdb_HGT_SNPP_EL_MAX(1)"
      Tab(3).Control(22)=   "sdb_HGT_SNPP_EL_MIN(1)"
      Tab(3).Control(23)=   "ULabel27(28)"
      Tab(3).Control(24)=   "sdb_HGT_SP_EL_MAX(1)"
      Tab(3).Control(25)=   "sdb_HGT_SP_EL_MIN(1)"
      Tab(3).Control(26)=   "ULabel27(27)"
      Tab(3).Control(27)=   "sdb_HGT_RA_MAX(1)"
      Tab(3).Control(28)=   "sdb_HGT_RA_MIN(1)"
      Tab(3).Control(29)=   "ULabel27(14)"
      Tab(3).Control(30)=   "sdb_HGT_TS_MAX(1)"
      Tab(3).Control(31)=   "sdb_HGT_TS_MIN(1)"
      Tab(3).Control(32)=   "ULabel27(13)"
      Tab(3).Control(33)=   "sdb_HGT_YP_MAX(1)"
      Tab(3).Control(34)=   "sdb_HGT_YP_MIN(1)"
      Tab(3).Control(35)=   "ULabel27(12)"
      Tab(3).Control(36)=   "ULabel27(11)"
      Tab(3).Control(37)=   "ULabel27(10)"
      Tab(3).Control(38)=   "ULabel27(9)"
      Tab(3).Control(39)=   "ULabel27(8)"
      Tab(3).Control(40)=   "ULabel27(1)"
      Tab(3).Control(41)=   "txt_HGT_TENCIL_TMP_UNIT(1)"
      Tab(3).Control(42)=   "txt_HGT_TENCIL_TMP(1)"
      Tab(3).Control(43)=   "txt_HGT_TENCIL_SMP_CD(1)"
      Tab(3).Control(44)=   "txt_HGT_SP_EL_SMP_CD(1)"
      Tab(3).Control(45)=   "txt_HGT_EL_CD(3)"
      Tab(3).Control(46)=   "txt_HGT_EL_CD(2)"
      Tab(3).Control(47)=   "txt_HGT_SNPP_EL_CD(3)"
      Tab(3).Control(48)=   "txt_HGT_SNPP_EL_CD(2)"
      Tab(3).Control(49)=   "txt_HGT_SP_EL_CD(3)"
      Tab(3).Control(50)=   "txt_HGT_SP_EL_CD(2)"
      Tab(3).Control(51)=   "txt_HGT_YP_DSC_CD(1)"
      Tab(3).Control(52)=   "txt_HGT_SP_EL_DSC_CD(1)"
      Tab(3).Control(53)=   "txt_HGT_RA_DSC_CD(1)"
      Tab(3).Control(54)=   "txt_HGT_TS_DSC_CD(1)"
      Tab(3).Control(55)=   "txt_HGT_SNPP_EL_DSC_CD(1)"
      Tab(3).Control(56)=   "txt_HGT_EL_DSC_CD(1)"
      Tab(3).Control(57)=   "txt_HTM_CD(3)"
      Tab(3).Control(58)=   "txt_HGT_RA_DIR_NAME(1)"
      Tab(3).Control(59)=   "txt_HGT_RA_DIR_CD(1)"
      Tab(3).Control(60)=   "txt_SMP_WID(3)"
      ...
      Tab(8).Control(94)=   "txt_NON_METAL_DSC_CD"
      Tab(8).Control(95)=   "txt_NON_METAL_SMP_CD"
      ...
      Begin FPSpread.vaSpread ss1 
         ...
         SpreadDesigner  =   "AQB0120C.frx":06A9
      End
      Begin VB.Line Line3 
...
Private Sub txt_ROUNDSTD_text_Change()
