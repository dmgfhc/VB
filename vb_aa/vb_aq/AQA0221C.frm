...
Begin VB.Form AQA0221C 
   Caption         =   "加热规程钢种分类界面_AQA0221C"
   ClientHeight    =   3090
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   4680
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "AQA0221C.frx":0000
   End
...
Private Sub Form_Define()
   ...
   Call Gp_Sp_Collection(ss1, 13, " ", " ", " ", "i", "a", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    Sc1.Add Item:="AQA0221C.P_MODIFY", Key:="P-M"
    Sc1.Add Item:="AQA0221C.P_REFER", Key:="P-R"
    Sc1.Add Item:="AQA0221C.P_ONEROW", Key:="P-O"
