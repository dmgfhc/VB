...
Begin VB.Form AQC0050C 
   ...
   Begin SSSplitter.SSSplitter SSSplitter1 
      ...
      Begin FPSpread.vaSpread ss1 
         ...
         ProcessTab      =   -1  'True
         Protect         =   0   'False
         SpreadDesigner  =   "AQC0050C.frx":052E
      End
   End
...
'     Call Gp_Sp_Collection(ss1, 1, " ", " ", " ", "i", " ", " ", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    Call Gp_Sp_Collection(ss1, 41, " ", " ", " ", "i", "a", " ", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
...
'      设定下达人员
        Call Gp_Sp_InAuthority(Proc_Sc("Sc"), 37)
...
'20090804 sun bin end
   ...
   sMatr(139) = "拉升厚度方向断面收缩率实绩平均"
   sMatr(140) = "高温拉升厚度方向断面收缩率实绩1"
   sMatr(141) = "高温拉升厚度方向断面收缩率实绩2"
   sMatr(142) = "高温拉升厚度方向断面收缩率实绩3"
   sMatr(143) = "高温拉升厚度方向断面收缩率实绩平均"
