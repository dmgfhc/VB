...
Begin VB.Form AQE1060C 
   Caption         =   "南钢中厚板卷厂钢板/钢卷质量情况_AQE1060C"
   ClientHeight    =   7620
   ClientLeft      =   195
   ClientTop       =   2070
   ClientWidth     =   15135
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "AQE1060C.frx":0000
   End
   ...
   Begin FPSpread.vaSpread ss2 
      ...
      MaxRows         =   10
      RetainSelBlock  =   0   'False
      SpreadDesigner  =   "AQE1060C.frx":17E4
   End
...
'---------------------------------------------------------------------------------------------------------------------------------------------------------------
   ...
   Call Gp_Sp_Collection(ss1, 50, " ", " ", " ", " ", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    sc1.Add Item:="AQE1060C.P_SREFER1", Key:="P-R"
...
'---------------------------------------------------------------------------------------------------------------------------------------------------------------
   ...
   Call Gp_Sp_Collection(ss2, 51, " ", " ", " ", " ", " ", "l", pColumn2, nColumn2, mColumn2, iColumn2, aColumn2, lColumn2)
    ...
    'Sc1.Add Item:="AQE1060C.P_MODIFY", Key:="P-M"
    sc2.Add Item:="AQE1060C.P_SREFER2", Key:="P-R"
    'Sc1.Add Item:="AQE1060C.P_ONEROW", Key:="P-O"
