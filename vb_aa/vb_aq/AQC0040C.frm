...
'edit by gengxueyu 20110212 for kangda end
   ...
   sMatr(166) = "抗氢裂能力CSR实绩1                   "
   sMatr(167) = "抗氢裂能力CLR实绩1                   "
   sMatr(168) = "抗氢裂能力CTR实绩1                   "
   sMatr(169) = "抗氢裂能力CSR实绩2                   "
   sMatr(170) = "抗氢裂能力CLR实绩2                   "
   sMatr(171) = "抗氢裂能力CTR实绩2                   "
   sMatr(172) = "抗氢裂能力CSR实绩3                   "
   sMatr(173) = "抗氢裂能力CLR实绩3                   "
   sMatr(174) = "抗氢裂能力CTR实绩3                   "
   sMatr(175) = "抗氢裂能力CSR实绩4                   "
   sMatr(176) = "抗氢裂能力CLR实绩4                   "
   sMatr(177) = "抗氢裂能力CTR实绩4                   "
   sMatr(178) = "抗氢裂能力CSR实绩5                   "
   sMatr(179) = "抗氢裂能力CLR实绩5                   "
   sMatr(180) = "抗氢裂能力CTR实绩5                   "
   sMatr(181) = "抗氢裂能力CSR实绩6                   "
   sMatr(182) = "抗氢裂能力CLR实绩6                   "
   sMatr(183) = "抗氢裂能力CTR实绩6                   "
   sMatr(184) = "抗氢裂能力CSR实绩7                   "
   sMatr(185) = "抗氢裂能力CLR实绩7                   "
   sMatr(186) = "抗氢裂能力CTR实绩7                   "
   sMatr(187) = "抗氢裂能力CSR实绩8                   "
   sMatr(188) = "抗氢裂能力CLR实绩8                   "
   sMatr(189) = "抗氢裂能力CTR实绩8                   "
   sMatr(190) = "抗氢裂能力CSR实绩9                   "
   sMatr(191) = "抗氢裂能力CLR实绩9                   "
   sMatr(192) = "抗氢裂能力CTR实绩9                   "
...
Private Sub subSpreadView3(ByVal strArr As Variant)
    ...
    Dim i                     As Integer
    Dim iRow                  As Integer
    Dim sMatr(3, 193)         As Variant '166
    Dim sMatrCON(6, 193)      As Variant '166
    ...
    If UBound(strArr, 2) = 0 Then        '初始化用与显示数据的数组
        ...
        For i = 0 To 192 '165
            sMatr(1, i) = NullCheck(strArr(i + 193, 0)) '166
        Next i
    
        For i = 0 To 192 '165
            sMatr(2, i) = NullCheck(strArr(i + 386, 0)) '332
        Next i
    ...
    If UBound(strArr, 2) = 1 Then
        ...
        For i = 0 To 192 '165
            sMatrCON(1, i) = NullCheck(strArr(i + 193, 0)) '166
            sMatrCON(4, i) = NullCheck(strArr(i + 193, 1)) '166
        Next i
    
        For i = 0 To 192 '165
            sMatrCON(2, i) = NullCheck(strArr(i + 386, 0)) '332
            sMatrCON(5, i) = NullCheck(strArr(i + 386, 1)) '332
        Next i
