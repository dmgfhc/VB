...
Begin VB.Form AQF0030C 
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "AQF0030C.frx":0000
   End
End
Attribute VB_Name = "AQF0030C"
...
Private Sub Form_Define()
   ...
   Call Gp_Sp_Collection(ss1, 12, " ", " ", " ", " ", " ", " ", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    Sc1.Add Item:="AQF0030C.P_MODIFY", Key:="P-M"
    Sc1.Add Item:="AQF0030C.P_REFER", Key:="P-R"
    'Sc1.Add Item:="AQF0030C.P_ONEROW", Key:="P-O"
