...
Begin VB.Form AFT5000C 
   ...
   Begin VB.ComboBox Combo_ORD_ITEM 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "AFT5000C.frx":0000
      Left            =   5040
      List            =   "AFT5000C.frx":0002
      TabIndex        =   2
      Top             =   255
      Width           =   900
   End
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "AFT5000C.frx":0004
      VisibleCols     =   1
   End
...
Private Sub Form_Define()
    ...
    'Call Master_Collection("Control_Name", "p(primary)", "n(Necessary)", "m(maxlength)", "i(insert)", "r(refer)", "a(append)", "l(lock)")
        Call Gp_Ms_Collection(Text_ORD_NO, "p", " ", " ", " ", "r", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
...
'---------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    sc1.Add Item:="AFT5000C.P_SREFER", Key:="P-R"
...
End Sub
Public Sub Form_Ref()
     If Text_ORD_NO = "" And TXT_PLATE_NO = "" Then
       Call MsgBox("订单号或钢板号不能为空!请输入。")
       Else
...
Private Sub Text_ORD_NO_KeyUp(KeyCode As Integer, Shift As Integer)
   Dim sQuery As String

    If Len(Trim(Text_ORD_NO.Text)) = Text_ORD_NO.MaxLength Then

        If Combo_ORD_ITEM.Text <> "" Then Exit Sub
        
        sQuery = " SELECT ORD_ITEM FROM CP_PRC WHERE ORD_NO = '" & Trim(Text_ORD_NO.Text) & "'"
