...
Begin VB.Form AQE1100C 
   Caption         =   "查询中板厂一次合格率_AQE1100C"
   ClientHeight    =   3195
   ClientLeft      =   -120
   ClientTop       =   2190
   ClientWidth     =   9915
   ...
   Begin SSSplitter.SSSplitter SSSplitter1 
      ...
      Begin FPSpread.vaSpread ss1 
         ...
         SpreadDesigner  =   "AQE1100C.frx":0052
      End
      Begin FPSpread.vaSpread ss2 
         ...
         MaxCols         =   9
         RetainSelBlock  =   0   'False
         SpreadDesigner  =   "AQE1100C.frx":1BE3
      End
   End
...
Private Sub Form_Define()
    ...
    Call Gp_Ms_Collection(txt_PLT_NAME, " ", " ", " ", " ", " ", " ", "l", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
    ...
    Sc1.Add Item:="AQE1100C.P_REFER", Key:="P-R"
    ...
    sc2.Add Item:="AQE1100C.P_REFER_D", Key:="P-R"
