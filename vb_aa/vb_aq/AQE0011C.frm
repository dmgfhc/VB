...
Begin VB.Form AQE0011C 
   Caption         =   "产品性能改判查询_AQE0011C"
   ClientHeight    =   6585
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   10440
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "AQE0011C.frx":0000
   End
...
Private Sub Form_Define()
 ...
 Call Gp_Ms_Collection(udt_DSC_DATE_MIN, "p", "n", " ", " ", "r", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
 Call Gp_Ms_Collection(udt_DSC_DATE_MAX, "p", "n", " ", " ", "r", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
    ...
    Sc1.Add Item:="AQE0011C.P_REFER", Key:="P-R"
...
'    Call Gp_Sp_ColHidden(ss1, 49, True)
'    Call Gp_Sp_ColHidden(ss1, 50, True)
...
'    Call Gp_Sp_ReadOnlySet(Proc_Sc("Sc")("Spread"))
    ...
    udt_DSC_DATE_MIN.RawData = ""
    udt_DSC_DATE_MAX.RawData = ""
