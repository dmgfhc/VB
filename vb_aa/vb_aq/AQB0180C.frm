...
Begin VB.Form AQB0180C 
   Caption         =   "质量再设计处理 - AQB0180C"
   ClientHeight    =   9090
   ClientLeft      =   165
   ClientTop       =   1965
   ClientWidth     =   15240
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "AQB0180C.frx":0000
   End
...
Private Sub Form_Define()
    ...
    Sc1.Add Item:="AQB0180C.P_MODIFY", Key:="P-M"
    Sc1.Add Item:="AQB0180C.P_REFER", Key:="P-R"
...
On Error GoTo Refer_Err
    ...
    If subCheckForm = False Then Exit Sub
...
Public Sub Form_Pro()
    ...
    If Gf_Sp_Process(M_CN1, Proc_Sc("SC"), Mc1) Then
       ...
       Call Gf_Procedure_Exec("AQB2000P")
...
Private Sub txt_DESIGN_STS_KeyUp(KeyCode As Integer, Shift As Integer)
        If KeyCode = vbKeyF4 Then
    
        DD.sWitch = "MS"
        DD.sKey = "Q0024"
        DD.rControl.Add Item:=txt_DESIGN_STS
...
Private Function subCheckForm() As Boolean

    Dim sMesg As String
    
    If Trim(txt_ORD_NO.Text) = "" And Trim(txt_CUST_CD.Text) = "" And Trim(txt_PROD_CD.Text) = "" And Trim(txt_DESIGN_STS) = "" Then
        
          sMesg = sMesg + " 订单号,客户,产品,质量设计状态 1 Must input necessarily"
        Call Gp_MsgBoxDisplay(sMesg)
        Exit Function
    End If
