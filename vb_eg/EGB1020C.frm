...
Begin VB.Form EGB1020C 
   Caption         =   "钢板垛位变更_EGB1020C"
   ClientHeight    =   9660
   ClientLeft      =   195
   ClientTop       =   1500
   ClientWidth     =   14355
   ...
   Begin SSSplitter.SSSplitter SSSplitter1 
      ...
      Begin FPSpread.vaSpread ss1 
         ...
         SpreadDesigner  =   "EGB1020C.frx":0052
      End
      Begin SSSplitter.SSSplitter SSSplitter2 
         ...
         Begin FPSpread.vaSpread ss2 
            ...
            Protect         =   0   'False
            RetainSelBlock  =   0   'False
            SpreadDesigner  =   "EGB1020C.frx":0A4B
         End
      End
   End
