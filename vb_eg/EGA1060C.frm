   ...
   Begin SSSplitter.SSSplitter SSSplitter1 
      ...
      Begin Threed.SSFrame Single 
         ...
         Begin VB.ComboBox CBO_SHIFT 
            Height          =   300
            ItemData        =   "EGA1060C.frx":0072
            Left            =   10815
            List            =   "EGA1060C.frx":007F
            TabIndex        =   5
            Tag             =   "班次"
            Top             =   150
            Width           =   735
         ...
         Begin VB.ComboBox CBO_EMP1 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "EGA1060C.frx":008C
            Left            =   12810
            List            =   "EGA1060C.frx":00BD
            TabIndex        =   3
            Tag             =   "探伤人员"
            Top             =   150
            Width           =   1125
         ...
         Begin VB.ComboBox CBO_EMP2 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "EGA1060C.frx":0141
            Left            =   13920
            List            =   "EGA1060C.frx":0172
            TabIndex        =   2
            Tag             =   "探伤人员"
            Top             =   150
            Width           =   1125
      ...
      Begin FPSpread.vaSpread ss1 
         ...
         SpreadDesigner  =   "EGA1060C.frx":01F6
      End
...
Private Sub Form_Define()
   ...
   Call Gp_Ms_Collection(txt_APLY_ENDUSE_CD, " ", " ", " ", " ", "r", " ", "l", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
     ...
     Call Gp_Ms_Collection(TXT_UST_STAND_NO, " ", "n", " ", "i", "r", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
      ...
      Call Gp_Ms_Collection(SDB_INSP_LEN_MN, " ", " ", " ", " ", "r", " ", "l", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
              Call Gp_Ms_Collection(SDB_WGT, " ", "n", " ", " ", "r", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
          ...
          Call Gp_Ms_Collection(SDB_WID_ORG, " ", " ", " ", " ", "r", " ", "l", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
          Call Gp_Ms_Collection(SDB_LEN_ORG, " ", " ", " ", " ", "r", " ", "l", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
          Call Gp_Ms_Collection(SDB_WGT_ORG, " ", " ", " ", " ", "r", " ", "l", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
   ...
   Call Gp_Ms_Collection(TXT_INSP_OCCR_TIME, " ", "n", " ", "i", "r", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
    ...
    'MASTER Collection
    Mc1.Add Item:="EGA1060C.P_MODIFY", Key:="P-M"
    Mc1.Add Item:="EGA1060C.P_REFER", Key:="P-R"
    ...
    sc1.Add Item:="EGA1060C.P_SREFER", Key:="P-R"
