...
Begin VB.Form EGC1140C 
   ...
   Begin VB.ComboBox cbo_group 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "EGC1140C.frx":0000
      Left            =   14475
      List            =   "EGC1140C.frx":0013
   ...
   Begin VB.ComboBox cbo_shift 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "EGC1140C.frx":0025
      Left            =   12735
      List            =   "EGC1140C.frx":0035
      Style           =   2  'Dropdown List
      TabIndex        =   6
      Top             =   540
      Width           =   765
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      ProcessTab      =   -1  'True
      Protect         =   0   'False
      SpreadDesigner  =   "EGC1140C.frx":0044
   End
...
Private Sub Form_Define()
  ...
  Call Gp_Ms_Collection(SDT_PROD_DATE_FROM, "p", " ", " ", " ", "r", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
    ...
    sc1.Add Item:="EGC1140C.P_REFER", Key:="P-R"
    sc1.Add Item:="EGC1140C.P_ONEROW", Key:="P-O"
    sc1.Add Item:="EGC1140C.P_MODIFY", Key:="P-M"
...
'    Dim xl_J            As String
    ...
    xlApp.Workbooks.Open (App.Path & "\EGC1140C.xls")
