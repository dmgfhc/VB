...
>>>>>>> .r7591
   ...
   Begin VB.Menu Mnu_AKB 
      Caption         =   "轧钢作业"
      Begin VB.Menu Mnu_BKG2010C 
         Caption         =   "轧钢作业指示调整"
      End
      Begin VB.Menu mnu_CKG2040C 
         Caption         =   "批号查询及修改"
      End
      Begin VB.Menu Mnu_BKG2020C 
         Caption         =   "轧钢作业指示查询界面"
      End
      Begin VB.Menu Mnu_BKG2030C 
         Caption         =   "精整作业指示查询界面"
      End
      Begin VB.Menu Mnu_BKH2010C 
         Caption         =   "轧钢生产线进程现状界面"
      End
      Begin VB.Menu mnu_CKG2070C 
         Caption         =   "轧钢计划查询界面"
      End
   End
   Begin VB.Menu Mnu_AKP 
      Caption         =   "生产统计查询"
      Begin VB.Menu Mnu_CKP1010C 
         Caption         =   "中板厂生产简报"
      End
      Begin VB.Menu Mnu_CKG2060C 
         Caption         =   "中板厂生产工作记录表"
      End
      Begin VB.Menu Mnu_CKP1310C 
         Caption         =   "中板厂生产日报"
      End
      Begin VB.Menu Mnu_CKP1312C 
         Caption         =   "中板厂质量日报"
      End
      Begin VB.Menu Mnu_CKP1313C 
         Caption         =   "中板厂生产质量简报"
      End
      Begin VB.Menu Mnu_CKP1020C 
         Caption         =   "中板厂订单完成情况简报"
      End
      Begin VB.Menu Mnu_CKP1311C 
         Caption         =   "目标产量/作业时间录入界面"
      End
   End
...
'        Else
'
'            Call Gp_MsgBoxDisplay("中板生产管制...实行中...", "W")
'            Unload Me
'        End If
'
''        sUserID = "1JS1005"
...
Dim FormLD As Boolean
    ...
    If Cancel = False Then SaveSetting "NISCO", "EXE-FILE", "CK.exe", ""
...
Private Sub Mnu_BKG2020C_Click()
    CKG2020C.Show
    CKG2020C.SetFocus
End Sub

Private Sub Mnu_BKG2030C_Click()
    CKG2030C.Show
    CKG2030C.SetFocus
End Sub

Private Sub mnu_CKG2070C_Click()
    CKG2070C.Show
    CKG2070C.SetFocus
End Sub

Private Sub Mnu_CKP1010C_Click()
    CKP1010C.Show
    CKP1010C.SetFocus
End Sub
...
Private Sub Mnu_BKG2010C_Click()
    CKG2010C.Show
    CKG2010C.SetFocus
End Sub
...
Private Sub Mnu_CKG2060C_Click()
    CKG2060C.Show
    CKG2060C.SetFocus
End Sub

Private Sub Mnu_CKP1020C_Click()
    CKP1020C.Show
    CKP1020C.SetFocus
End Sub

Private Sub Mnu_CKP1310C_Click()
    CKP1310C.Show
    CKP1310C.SetFocus
End Sub

Private Sub Mnu_CKP1311C_Click()
    CKP1311C.Show
    CKP1311C.SetFocus
End Sub

Private Sub Mnu_CKP1312C_Click()
    CKP1312C.Show
    CKP1312C.SetFocus
End Sub

Private Sub Mnu_CKP1313C_Click()
    CKP1313C.Show
    CKP1313C.SetFocus
End Sub
