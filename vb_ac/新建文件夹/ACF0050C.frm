...
Begin VB.Form ACF0050C 
   ...
   Begin SSSplitter.SSSplitter SSSplitter1 
      ...
      Begin FPSpread.vaSpread ss1 
         ...
         ProcessTab      =   -1  'True
         Protect         =   0   'False
         SpreadDesigner  =   "ACF0050C.frx":00D2
      End
      Begin FPSpread.vaSpread ss2 
         ...
         SpreadDesigner  =   "ACF0050C.frx":05DF
      End
      Begin FPSpread.vaSpread ss4 
         ...
         Protect         =   0   'False
         RetainSelBlock  =   0   'False
         SpreadDesigner  =   "ACF0050C.frx":1113
      End
      Begin FPSpread.vaSpread ss5 
         ...
         Protect         =   0   'False
         RetainSelBlock  =   0   'False
         SpreadDesigner  =   "ACF0050C.frx":156A
      End
      Begin FPSpread.vaSpread ss3 
         ...
         Protect         =   0   'False
         RetainSelBlock  =   0   'False
         SpreadDesigner  =   "ACF0050C.frx":1B1B
      End
      Begin FPSpread.vaSpread ss6 
         ...
         RetainSelBlock  =   0   'False
         RowHeaderDisplay=   0
         SpreadDesigner  =   "ACF0050C.frx":2448
      End
   End
