...
Begin VB.Form AEC3000C 
   Caption         =   "中板坯料申请信息查询/选定工序计划炼钢_AEC3000C"
   ClientHeight    =   9585
   ClientLeft      =   840
   ClientTop       =   1440
   ClientWidth     =   15225
   ...
   Begin SSSplitter.SSSplitter SSSplitter1 
      ...
      Begin FPSpread.vaSpread ss1 
         ...
         RetainSelBlock  =   0   'False
         RowHeaderDisplay=   0
         SpreadDesigner  =   "AEC3000C.frx":0A3A
      End
   End
...
Private Sub Form_Define()
    ...
    Call Gp_Ms_Collection(udt_plan_date_to, "p", " ", " ", " ", " ", " ", " ", pControl2, nControl2, mControl2, iControl2, rControl2, aControl2, lControl2)
     ...
     Call Gp_Ms_Collection(sdb_slab_len_to, "p", " ", " ", " ", "r", " ", " ", pControl2, nControl2, mControl2, iControl2, rControl2, aControl2, lControl2)
             Call Gp_Ms_Collection(chk_hcr, "p", " ", " ", " ", "r", " ", " ", pControl2, nControl2, mControl2, iControl2, rControl2, aControl2, lControl2)
             Call Gp_Ms_Collection(chk_ccr, "p", " ", " ", " ", "r", " ", " ", pControl2, nControl2, mControl2, iControl2, rControl2, aControl2, lControl2)
...
Public Sub Form_Ref()
    ...
    sQuery1 = sQuery1 + "  FROM  NISCO.EP_REQ_SLAB "
    
    If txt_ord_no.Text = "" Then
        sQuery1 = sQuery1 + "     WHERE  INS_DATE       BETWEEN '" & udt_req_date_fr.RawData & "' AND '" & udt_req_date_to.RawData & "' "
        sQuery1 = sQuery1 + "       AND  REQ_LIMI_DATE  BETWEEN '" & udt_plan_date_fr.RawData & "000000' AND '" & udt_plan_date_to.RawData & "999999' "
        sQuery1 = sQuery1 + "   AND  REC_STS        IN ('1') "
    Else
        sQuery1 = sQuery1 + "     WHERE  INS_DATE       BETWEEN '00000000'       AND '99999999' "
        sQuery1 = sQuery1 + "       AND  REQ_LIMI_DATE  BETWEEN '00000000000000' AND '99999999999999' "
        sQuery1 = sQuery1 + "   AND  REC_STS        IN ('1','2') "
    End If
    ...
    sQuery2 = " {call AEC3000C.P_DATA ( '" & txt_ord_no.Text & "','" & cbo_ord_item.Text & "','" & _
                                             ...
                                             udt_plan_date_fr.RawData & "','" & udt_plan_date_to.RawData & "','" & sHcr_Fl & "')} "
