...
Begin VB.Form ACB4099C 
   Caption         =   "板坯尺寸信息查询修改_ACB4099C"
   ClientHeight    =   3030
   ClientLeft      =   120
   ClientTop       =   450
   ClientWidth     =   4560
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      ProcessTab      =   -1  'True
      Protect         =   0   'False
      SpreadDesigner  =   "ACB4099C.frx":0000
   End
End
Attribute VB_Name = "ACB4099C"
...
'----> THIS variable USE IS ACB4099C PROGRAM <--------------
...
'---------------------------------------------------------------------------------------------------------------------------------------------------------------
   ...
   Call Gp_Sp_Collection(ss1, 23, " ", " ", " ", " ", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    sc1.Add Item:="ACB4099C.P_MODIFY", Key:="P-M"
    sc1.Add Item:="ACB4099C.P_REFER", Key:="P-R"
    sc1.Add Item:="ACB4099C.P_ONEROW", Key:="P-O"
