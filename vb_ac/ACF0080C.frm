...
.ROW = 1
.Col = SS1_PLT:  .Text = "宽厚板"

ElseIf CBO_PLT.Text = "C1" Then

.ROW = 1
.Col = SS1_PLT:  .Text = "中厚板"
...
Dim OutParam(1, 4) As Variant
    ...
    Dim var1 As String '列名
    Dim var2 As String '列内容
    ...
    'Process Error Check
        ...
        'strRet_Result_ErrMsg = "请输入正确的保存内容" 'adoCmd("arg_e_msg")
'        sErrMessg = "Error Mesg : " & strRet_Result_ErrMsg
'        Call Gp_MsgBoxDisplay(sErrMessg)
    'Else
        Set adoCmd = Nothing
        Screen.MousePointer = vbDefault
        MDIMain.StatusBar1.Panels(1) = "提示信息：成功处理了" & iCount & "条记录"
        Call Form_Ref
        Exit Sub
...
On Error GoTo Ss1_Display_Error
    ...
    Do Until AdoRs.EOF
        ...
        With ss1
            ...
            .Col = 4:   .ROW = 1:    .Text = Val(AdoRs.Fields(0) & ""): PLATE_WGT = .Value '材产量
                        .ROW = 2:    .Text = Val(AdoRs.Fields(1) & ""): BED_WGT = .Value '入库量
                        .ROW = 3:    .Text = Val(AdoRs.Fields(2) & ""): slab_input_wgt = .Value '坯料投入量
                        
                          If slab_input_wgt <> 0 Then
                        
                         .ROW = 4:    .Text = PLATE_WGT * 100 / slab_input_wgt '成材率
                        
                          End If
                        
                        .ROW = 5:    .Text = Val(AdoRs.Fields(3) & "") '切丝回收量
                        .ROW = 6:    .Text = Val(AdoRs.Fields(4) & "") '氧化铁皮回收量
                        .ROW = 7:    .Text = Val(AdoRs.Fields(5) & "") '废次品（外销）
                        
                        .ROW = 8:    .Text = Val(AdoRs.Fields(3) & "") + Val(AdoRs.Fields(4) & "") + Val(AdoRs.Fields(5) & ""): recyle_wgt = .Value '小计
                        
                        
                        If slab_input_wgt <> 0 And PLATE_WGT <> 0 Then
                        
                        .ROW = 9:    .Text = (1 / (1 / (PLATE_WGT / slab_input_wgt) - recyle_wgt / PLATE_WGT)) * 100 '金属平衡
                        
                        End If
                        
                         If PLATE_WGT <> 0 Then
                        
                        .ROW = 11:    .Text = Val(AdoRs.Fields(6) & "") / PLATE_WGT '棍耗
                        
                        End If
                        
                        
                        .ROW = 10:   .Text = Val(AdoRs.Fields(6) & "") '轧辊磨削量
                        
                        
                        
                        .ROW = 12:    .Text = Val(AdoRs.Fields(8) & ""): rolled_unplan_wgt = .Value '卷轧非计划量
                        .ROW = 13:    .Text = Val(AdoRs.Fields(9) & ""): rolled_wgt = .Value '卷轧产量
                        
                        If rolled_wgt <> 0 Then
                        
                        .ROW = 14:    .Text = rolled_unplan_wgt * 100 / rolled_wgt '卷轧非计划率
                        
                         End If
                        
                        .ROW = 15:    .Text = Val(AdoRs.Fields(10) & ""): flat_unplan_wgt = .Value '平轧非计划量
                        .ROW = 16:    .Text = Val(AdoRs.Fields(11) & ""): flat_wgt = .Value '平轧产量
                        
                         If flat_wgt <> 0 Then
                        
                        .ROW = 17:    .Text = flat_unplan_wgt * 100 / flat_wgt '平轧非计划率
                        
                        End If
                        
                        If BED_WGT <> 0 Then
                        
                        .ROW = 18:   .Text = (rolled_unplan_wgt + flat_unplan_wgt) * 100 / BED_WGT ' 综合非计划率
                        
                        End If
                        
                        .ROW = 19:   .Text = Val(AdoRs.Fields(12) & "") '坯料判废量（含待判废量）
                        
                        .ROW = 20:   .Text = Val(AdoRs.Fields(13) & ""): hcr_wgt = .Value '热装热送量
                        
                        If slab_input_wgt <> 0 Then
                        
                        .ROW = 21:    .Text = hcr_wgt * 100 / slab_input_wgt '比例
                        
                        End If
                        
                        .ROW = 22:    .Text = Val(AdoRs.Fields(14) & "") '堵板
                        .ROW = 23:    .Text = Val(AdoRs.Fields(15) & "") '电气
                        .ROW = 24:    .Text = Val(AdoRs.Fields(16) & "") '机械
                        .ROW = 25:    .Text = Val(AdoRs.Fields(17) & "") '计划
                        .ROW = 26:    .Text = Val(AdoRs.Fields(18) & "") '外部
                        .ROW = 27:    .Text = Val(AdoRs.Fields(19) & "") '操作
                        .ROW = 28:    .Text = Val(AdoRs.Fields(20) & "") '其他
    ...
    Do Until AdoRs.EOF
        ...
        With ss1
            ...
            .Col = 4:   .ROW = 29:   .Text = Val(AdoRs.Fields(0) & "") 'DZB/DZE
                        ...
                        .ROW = 33:    .Text = Val(AdoRs.Fields(4) & "") '待热处理量
                        .ROW = 34:    .Text = Val(AdoRs.Fields(5) & "") '堆冷
                        .ROW = 35:    .Text = Val(AdoRs.Fields(6) & "") '待修磨
                        .ROW = 36:    .Text = Val(AdoRs.Fields(7) & "") '待切割
                        .ROW = 37:    .Text = Val(AdoRs.Fields(8) & "") '中板待判量
