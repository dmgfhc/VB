...
Begin VB.Form ACE1260C 
   Caption         =   "HMI材料替代处理_ACE1260C"
   ClientHeight    =   9000
   ClientLeft      =   45
   ClientTop       =   1425
   ClientWidth     =   15240
   ...
   Begin SSSplitter.SSSplitter SSSplitter1 
      ...
      Begin FPSpread.vaSpread ss2 
         ...
         SpreadDesigner  =   "ACE1260C.frx":0052
      End
      Begin FPSpread.vaSpread ss1 
         ...
         MaxRows         =   1
         RetainSelBlock  =   0   'False
         SpreadDesigner  =   "ACE1260C.frx":088F
      End
   End
...
Private Sub Form_Define()
    ...
    Call Gp_Ms_Collection(txt_prod_cd_name, " ", "n", " ", " ", "r", " ", "l", pContro1, nContro1, mContro1, iContro1, rContro1, aContro1, lContro1)
     ...
     Call Gp_Ms_Collection(sdb_slab_wid_to, "p", " ", " ", " ", "r", " ", "l", pContro1, nContro1, mContro1, iContro1, rContro1, aContro1, lContro1)
          Call Gp_Ms_Collection(TXT_ORD_NO, " ", " ", " ", " ", "r", " ", "l", pContro1, nContro1, mContro1, iContro1, rContro1, aContro1, lContro1)
        Call Gp_Ms_Collection(txt_ORD_ITEM, " ", " ", " ", " ", "r", " ", "l", pContro1, nContro1, mContro1, iContro1, rContro1, aContro1, lContro1)
     Call Gp_Ms_Collection(txt_rep_prod_cd, " ", " ", " ", " ", "r", " ", "l", pContro1, nContro1, mContro1, iContro1, rContro1, aContro1, lContro1)
 ...
 Call Gp_Ms_Collection(txt_rep_prod_cd, "p", " ", " ", " ", "r", " ", "l", pContro2, nContro2, mContro2, iContro2, rContro2, aContro2, lContro2)
   ...
   Call Gp_Sp_Collection(ss1, 21, " ", " ", " ", " ", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    sc1.Add Item:="ACE1260C.P_REFER1", Key:="P-R"
    sc1.Add Item:="ACE1260C.P_ONEROW", Key:="P-O"
   ...
   Call Gp_Sp_Collection(ss2, 19, " ", " ", " ", "i", " ", "l", pColumn2, nColumn2, mColumn2, iColumn2, aColumn2, lColumn2)
    ...
    sc2.Add Item:="ACE1260C.P_REFER2", Key:="P-R"
    sc2.Add Item:="ACE1260C.P_MODIFY", Key:="P-M"
...
Private Sub ss1_Click(ByVal Col As Long, ByVal Row As Long)
    ...
    If ss1.Text <> "选择" Then
        ...
        'ORD_NO
        ss1.Col = 1
        TXT_ORD_NO.Text = ss1.Text
        
        'ORD_ITEM
        ss1.Col = 2
        txt_ORD_ITEM.Text = ss1.Text
        
        'REM_WGT
        ss1.Col = 16
        sdb_wgt.Value = ss1.Value
...
Private Sub ss2_Click(ByVal Col As Long, ByVal Row As Long)
    ...
    If ss2.Text <> "Update" Then
        ...
        'REM_WGT
        ss2.Col = 13
        If sdb_wgt.Value - ss2.Value < 0 Then Exit Sub
    
        ss2.Col = 0
        ss2.Text = "Update"
        
        ss2.Col = 17
        ss2.Text = TXT_ORD_NO.Text
        ss2.Col = 18
        ss2.Text = txt_ORD_ITEM.Text
        ss2.Col = 19
        ss2.Text = txt_rep_prod_cd.Text
        
        'REM_WGT
        ss2.Col = 13
        sdb_wgt.Value = sdb_wgt.Value - ss2.Value
