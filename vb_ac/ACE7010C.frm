...
Begin VB.Form ACE7010C 
   Caption         =   "在制品自动替代确认_ACE7010C"
   ClientHeight    =   3030
   ClientLeft      =   120
   ClientTop       =   450
   ClientWidth     =   4560
   ...
   Begin SSSplitter.SSSplitter SSSplitter1 
      ...
      Begin FPSpread.vaSpread ss2 
         ...
         SpreadDesigner  =   "ACE7010C.frx":0072
      End
      Begin FPSpread.vaSpread ss1 
         ...
         Protect         =   0   'False
         RetainSelBlock  =   0   'False
         SpreadDesigner  =   "ACE7010C.frx":894A
      End
      Begin Threed.SSFrame SSFrame1 
         ...
         Begin VB.ComboBox Text_GROUP 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "ACE7010C.frx":99C7
            Left            =   16150
            List            =   "ACE7010C.frx":99C9
            TabIndex        =   31
            Top             =   840
            Width           =   780
         End
         Begin VB.TextBox Text_PROC_CD 
            ...
            Width           =   915
         End
         Begin VB.CheckBox chk_dif_spec 
            Caption         =   "同标准"
            Height          =   255
            Left            =   18600
            TabIndex        =   26
...
Const SS1_FORCE_CD = 23             ' 是否强制替代
Const SS1_REMARK = 24               ' 替代备注
Const SS1_ORDER_NO = 25             ' 替代订单
Const SS1_ORDER_ITEM = 26           ' 替代序列
Const SS1_USER_ID = 27              ' 替代人
Const SS1_CLEAR_SMP = 30              ' 清空试样号
Const SS1_REMARK_REASON = 31              ' 清空试样号
...
Private Sub Form_Define()
    ...
    Call Gp_Ms_Collection(txt_cur_inv_nm, " ", " ", " ", " ", "r", " ", " ", pContro1, nContro1, mContro1, iContro1, rContro1, aContro1, lContro1)
       Call Gp_Ms_Collection(rep_rate_fr, "p", " ", " ", " ", "r", " ", " ", pContro1, nContro1, mContro1, iContro1, rContro1, aContro1, lContro1)
        ...
        Call Gp_Ms_Collection(Udate_BB_CONF_FR, "p", " ", " ", " ", "r", " ", " ", pContro1, nContro1, mContro1, iContro1, rContro1, aContro1, lContro1)
        Call Gp_Ms_Collection(Udate_BB_CONF_TO, "p", " ", " ", " ", "r", " ", " ", pContro1, nContro1, mContro1, iContro1, rContro1, aContro1, lContro1)
        Call Gp_Ms_Collection(Text_PROC_CD, "p", " ", " ", " ", "r", " ", " ", pContro1, nContro1, mContro1, iContro1, rContro1, aContro1, lContro1)
        Call Gp_Ms_Collection(Text_GROUP, "p", " ", " ", " ", "r", " ", " ", pContro1, nContro1, mContro1, iContro1, rContro1, aContro1, lContro1)
    ...
    Call Gp_Ms_Collection(rep_rate_fr, "p", " ", " ", " ", "r", " ", " ", pContro2, nContro2, mContro2, iContro2, rContro2, aContro2, lContro2)
   Call Gp_Ms_Collection(chk_dif_spec, "p", " ", " ", " ", "r", " ", " ", pContro2, nContro2, mContro2, iContro2, rContro2, aContro2, lContro2)
   Call Gp_Ms_Collection(Udate_BB_DEL_FR, "p", " ", " ", " ", "r", " ", " ", pContro2, nContro2, mContro2, iContro2, rContro2, aContro2, lContro2)
   Call Gp_Ms_Collection(UDate_BB_DEL_TO, "p", " ", " ", " ", "r", " ", " ", pContro2, nContro2, mContro2, iContro2, rContro2, aContro2, lContro2)
  ...
  Call Gp_Sp_Collection(ss1, SS1_ORDER_ITEM, " ", " ", " ", "i", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
   ...
   Call Gp_Sp_Collection(ss1, SS1_CLEAR_SMP, " ", " ", " ", "i", " ", " ", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
   Call Gp_Sp_Collection(ss1, SS1_REMARK_REASON, " ", " ", " ", "i", " ", " ", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    
    'Spread_Collection
    sc1.Add Item:=ss1, Key:="Spread"
    sc1.Add Item:="ACE7010C.P_REFER1", Key:="P-R"
    sc1.Add Item:="ACE7010C.P_MODIFY1", Key:="P-M"
    ...
    sc2.Add Item:="ACE7010C.P_REFER2", Key:="P-R"
