...
Begin VB.Form ACB4121C 
   Caption         =   "钢板转坯料处理画面_ACB4121C"
   ClientHeight    =   6945
   ClientLeft      =   120
   ClientTop       =   465
   ClientWidth     =   13230
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      ProcessTab      =   -1  'True
      Protect         =   0   'False
      SpreadDesigner  =   "ACB4121C.frx":0000
   End
...
Private Sub Form_Define()
    ...
    Call Gp_Ms_Collection(udt_date_fr, "p", "n", "m", " ", " ", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
    Call Gp_Ms_Collection(udt_date_to, "p", "n", "m", " ", " ", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
     ...
     Call Gp_Ms_Collection(sdb_thk_fr, "p", " ", " ", " ", " ", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
    ...
    Call Gp_Sp_Collection(ss1, 13, " ", " ", " ", " ", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1, False)
    Call Gp_Sp_Collection(ss1, 14, " ", " ", " ", " ", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    Call Gp_Sp_Collection(ss1, 15, "p", " ", " ", "i", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1, False)

    'Spread_Collection
    sc1.Add Item:=ss1, Key:="Spread"
    sc1.Add Item:="ACB4121C.P_MODIFY", Key:="P-M"
    sc1.Add Item:="ACB4121C.P_REFER", Key:="P-R"
    sc1.Add Item:="ACB4121C.P_ONEROW", Key:="P-O"
