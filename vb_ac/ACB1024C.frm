...
Begin VB.Form ACB1024C 
   Caption         =   "物料信息变更履历查询_ACB1024C"
   ClientHeight    =   9225
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   14460
   ...
   Begin VB.ComboBox CBO_PROD_CD 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "ACB1024C.frx":0000
      Left            =   13170
      List            =   "ACB1024C.frx":0010
      TabIndex        =   7
      Text            =   "PP 钢板"
      Top             =   120
      Width           =   1410
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      ProcessTab      =   -1  'True
      Protect         =   0   'False
      SpreadDesigner  =   "ACB1024C.frx":0038
   End
...
Private Sub Form_Define()
   ...
   Call Gp_Sp_Collection(ss1, 22, " ", " ", " ", " ", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    sc1.Add Item:="ACB1024C.P_REFER", Key:="P-R"
