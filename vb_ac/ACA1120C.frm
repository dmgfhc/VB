...
Private Sub Form_Define()
 ...
 '   FormType = "Msheet"
   ...
   'Call Master_Collection("Control_Name", "p(primary)", "n(Necessary)", "m(maxlength)", "i(insert)", "r(refer)", "a(append)", "l(lock)")
    ...
    Call Gp_Sp_Collection(ss1, 49, " ", " ", " ", " ", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)  '紧急订单绿色标记
...
Public Sub Form_Cls()
    ...
    Udate_BB_INS.Text = Mid(Date, 1, 8) + "06"    '本月6号
