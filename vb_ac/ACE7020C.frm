   ...
   Begin SSSplitter.SSSplitter SSSplitter1 
      ...
      Begin SSSplitter.SSSplitter SSSplitter2 
         ...
         Begin FPSpread.vaSpread ss1 
            ...
            SpreadDesigner  =   "ACE7020C.frx":00A4
         End
      ...
      Begin FPSpread.vaSpread ss2 
         ...
         MaxRows         =   1
         RetainSelBlock  =   0   'False
         SpreadDesigner  =   "ACE7020C.frx":127E
      End
   End
   Begin InDate.ULabel ULabel2 
      Height          =   315
...
Const SS1_FORCE_CD = 30             ' 是否强制替代
Const SS1_REMARK = 31               ' 替代备注
Const SS1_ORDER_NO = 32             ' 替代订单
Const SS1_ORDER_ITEM = 33           ' 替代序列
Const SS1_USER_ID = 34              ' 替代人
...
Private Sub Form_Define()
    ...
    Call Gp_Ms_Collection(txt_enduse_cd, "p", " ", " ", " ", "r", " ", " ", pContro1, nContro1, mContro1, iContro1, rContro1, aContro1, lContro1)
     ...
     Call Gp_Ms_Collection(chk_dif_spec, "p", " ", " ", " ", "r", " ", " ", pContro1, nContro1, mContro1, iContro1, rContro1, aContro1, lContro1)
  ...
  Call Gp_Sp_Collection(ss1, SS1_ORDER_ITEM, " ", " ", " ", "i", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    sc1.Add Item:="ACE7020C.P_REFER1", Key:="P-R"
    sc1.Add Item:="ACE7020C.P_MODIFY1", Key:="P-M"
    ...
    sc2.Add Item:="ACE7020C.P_REFER2", Key:="P-R"
    sc2.Add Item:="ACE7020C.P_ONEROW2", Key:="P-O"
