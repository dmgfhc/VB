...
Begin VB.Form CGD2071C 
   Caption         =   "切割作业计划_CGD2071C"
   ClientHeight    =   3090
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   4680
   ...
   Begin SSSplitter.SSSplitter SSSplitter1 
      ...
      Begin Threed.SSFrame SSFrame2 
         ...
         Begin VB.ComboBox CBO_PRC_STS 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "CGD2071C.frx":0072
            Left            =   1485
            List            =   "CGD2071C.frx":007F
            TabIndex        =   23
            Tag             =   "班次"
            Top             =   900
            Width           =   1875
         ...
         Begin VB.ComboBox cbo_shift 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "CGD2071C.frx":00A3
            Left            =   9495
            List            =   "CGD2071C.frx":00A5
            TabIndex        =   3
            Tag             =   "班次"
            Top             =   3510
            Width           =   735
      ...
      Begin Threed.SSFrame SSFrame1 
         ...
         Begin VB.ComboBox CBO_PLAN_SHIFT 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "CGD2071C.frx":00A7
            Left            =   9525
            List            =   "CGD2071C.frx":00A9
            TabIndex        =   29
            Tag             =   "班次"
            Top             =   75
            Width           =   765
      ...
      Begin FPSpread.vaSpread ss1 
         ...
         SpreadDesigner  =   "CGD2071C.frx":00AB
      End
   End
...
Const SS1_PROC_CD = 4
Const SS1_PRC_STS = 5
Const SS1_PLAN_CUT_DATE = 6
Const SS1_PLAN_CUT_SHIFT = 7
Const SS1_USERID = 31
...
Private Sub Form_Define()
 ...
 Call Gp_Ms_Collection(SDT_PLAN_DATE_FROM, "p", " ", " ", " ", "r", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
   Call Gp_Ms_Collection(SDT_PLAN_DATE_TO, "p", " ", " ", " ", "r", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
     ...
     Call Gp_Sp_Collection(ss1, 6, " ", " ", " ", "i", " ", "l", pColumn, nColumn, mColumn, iColumn, aColumn, lColumn)
