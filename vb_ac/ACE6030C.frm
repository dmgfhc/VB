...
Begin VB.Form ACE6030C 
   Caption         =   "在制品余材降级(订单标准)_ACE6030C"
   ClientHeight    =   9225
   ClientLeft      =   435
   ClientTop       =   1260
   ClientWidth     =   15255
   ...
   Begin SSSplitter.SSSplitter SSSplitter1 
      ...
      Begin SSSplitter.SSSplitter SSSplitter2 
         ...
         Begin FPSpread.vaSpread ss1 
            ...
            SpreadDesigner  =   "ACE6030C.frx":00A4
         End
         Begin Threed.SSPanel SSPanel1 
            ...
            Begin InDate.ULabel ULabel20 
               ...
               ForeColor       =   0
            End
            Begin VB.TextBox txt_woo_rsn_nm 
               BackColor       =   &H00C0FFFF&
               BeginProperty Font 
                  Name            =   "宋体"
                  Size            =   9.75
      ...
      Begin FPSpread.vaSpread ss2 
         ...
         MaxRows         =   1
         RetainSelBlock  =   0   'False
         SpreadDesigner  =   "ACE6030C.frx":0D92
      End
   End
...
Private Sub Form_Define()
    ...
    'Call Master_Collection("Control_Name", "p(primary)", "n(Necessary)", "m(maxlength)", "i(insert)", "r(refer)", "a(append)", "l(lock)")
       ...
       Call Gp_Ms_Collection(TXT_ORD_KND, "p", " ", " ", " ", "r", " ", " ", pContro1, nContro1, mContro1, iContro1, rContro1, aContro1, lContro1)
    Call Gp_Ms_Collection(txt_ord_knd_nm, " ", " ", " ", " ", "r", " ", " ", pContro1, nContro1, mContro1, iContro1, rContro1, aContro1, lContro1)
    ...
    Call Gp_Ms_Collection(txt_cur_inv_nm, " ", " ", " ", " ", "r", " ", " ", pContro2, nContro2, mContro2, iContro2, rContro2, aContro2, lContro2)
        Call Gp_Ms_Collection(txt_mat_no, "p", " ", " ", " ", "r", " ", " ", pContro2, nContro2, mContro2, iContro2, rContro2, aContro2, lContro2)
       Call Gp_Ms_Collection(txt_woo_rsn, " ", " ", " ", " ", "r", " ", " ", pContro2, nContro2, mContro2, iContro2, rContro2, aContro2, lContro2)
    Call Gp_Ms_Collection(txt_woo_rsn_nm, " ", " ", " ", " ", "r", " ", " ", pContro2, nContro2, mContro2, iContro2, rContro2, aContro2, lContro2)
    ...
    For i = 2 To ss1.MaxCols - 4
        Call Gp_Sp_Collection(ss1, i, " ", " ", " ", " ", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    Next i
    
    Call Gp_Sp_Collection(ss1, ss1.MaxCols - 3, " ", " ", " ", "i", " ", " ", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    Call Gp_Sp_Collection(ss1, ss1.MaxCols - 2, " ", " ", " ", " ", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    Call Gp_Sp_Collection(ss1, ss1.MaxCols - 1, " ", " ", " ", "i", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
        Call Gp_Sp_Collection(ss1, ss1.MaxCols, " ", " ", " ", "i", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    
    'Spread_Collection
    sc1.Add Item:=ss1, Key:="Spread"
    sc1.Add Item:="ACE6030C.P_REFER1", Key:="P-R"
    sc1.Add Item:="ACE6030C.P_MODIFY1", Key:="P-M"
    ...
    sc2.Add Item:="ACE6030C.P_REFER2", Key:="P-R"
    sc2.Add Item:="ACE6030C.P_ONEROW2", Key:="P-O"
...
Private Sub cmd_refer_Click()
    ...
    If Len(txt_mat_no.Text) < 8 Then
        Call Gp_MsgBoxDisplay("物料号必须输入", "I")
        Exit Sub
    End If
...
Public Sub Form_Ref()
    ...
    If Gf_Sp_Refer(M_CN1, sc2, Mc1) Then
        ...
        For lRow = 1 To ss2.MaxRows
            ...
            If ss2.Value < 0 Then
                Call Gp_Sp_RowColor(ss2, lRow, &HFF&)
            End If
...
Public Sub Form_Pro()
    ...
    If txt_woo_rsn.Text = "" Or txt_woo_rsn_nm.Text = "" Then
        Call Gp_MsgBoxDisplay("余材原因必须输入", "I")
        Exit Sub
    End If
...
Private Sub ss2_Click(ByVal Col As Long, ByVal Row As Long)
    ...
    If iCurr_Row2 <> 0 Then
        ...
        If ss2.Value < 0 Then
            Call Gp_Sp_RowColor(ss2, iCurr_Row2, &HFF&)
        Else
            Call Gp_Sp_RowColor(ss2, iCurr_Row2)
        End If
    ...
    If ss2.Value < 0 Then
        Call Gp_Sp_RowColor(ss2, iCurr_Row2, &HFF&, &HFFFF80)
    Else
        Call Gp_Sp_RowColor(ss2, iCurr_Row2, , &HFFFF80)
    End If
...
Private Sub txt_ord_knd_KeyUp(KeyCode As Integer, Shift As Integer)
    ...
    Else
        ...
        If Len(Trim(TXT_ORD_KND)) = TXT_ORD_KND.MaxLength Then
            txt_ord_knd_nm.Text = Gf_ComnNameFind(M_CN1, "B0009", Trim(TXT_ORD_KND.Text), 2)
        Else
            txt_ord_knd_nm.Text = ""
        End If
...
Private Sub txt_woo_rsn_KeyUp(KeyCode As Integer, Shift As Integer)
    ...
    If KeyCode = vbKeyF4 Then
        ...
        DD.rControl.Add Item:=txt_woo_rsn_nm
    ...
    Else
        ...
        If Len(Trim(txt_woo_rsn.Text)) = txt_woo_rsn.MaxLength Then
            txt_woo_rsn_nm.Text = Gf_ComnNameFind(M_CN1, "C0008", txt_woo_rsn.Text, 2)
        Else
            txt_woo_rsn_nm.Text = ""
        End If
