   ...
   Begin SSSplitter.SSSplitter SSSplitter2 
      ...
      Begin SSSplitter.SSSplitter SSSplitter1 
         ...
         Begin FPSpread.vaSpread ss3 
            ...
            RetainSelBlock  =   0   'False
            ScrollBarExtMode=   -1  'True
            SpreadDesigner  =   "ACB5035C.frx":25D8
         End
      End
   End
End
...
On Error GoTo Excel_Error
   ...
   Const xlthin = 2
    ...
    With sPname
        ...
        xlSheet.Range("A20").Value = "子板标准号"     '         新增 2015 1 27  周岩
'        xlSheet.Range("A21").Value = "钢印加冲"     '         新增 2015 4 14  韩超
        xlSheet.Range("C21").Value = "交货期"     '         新增 2015 4 14  韩超
...
'        xlSheet.Range("C11").Value = "是否加喷TS"
        ...
        xlSheet.Range("A18", "A19").Merge
        xlSheet.Range("B18", "D19").Merge
        ss3.Col = SS1_MV_DATE:           xlSheet.Range("B1").Value = ss3.Text
        ss3.Col = SS1_PLATE_NO:          xlSheet.Range("B2").Value = ss3.Text
        ss3.Col = SS1_CUST_CD:           xlSheet.Range("B3").Value = ss3.Text
        'ss3.Col = SS1_LEN:               xlSheet.Range("B4").Value = ss3.Text
        ss1.Col = SS1_LEN:               xlSheet.Range("B4").Value = ss1.Text
        ss3.Col = SS1_ORD_THK:           xlSheet.Range("B5").Value = ss3.Text
        ss3.Col = SS1_ORD_WID:           xlSheet.Range("B6").Value = ss3.Text
        ss3.Col = SS1_ORD_LEN:           xlSheet.Range("B7").Value = ss3.Text
        ss3.Col = SS1_TRIM_FL:           xlSheet.Range("B8").Value = ss3.Text
        ss3.Col = SS1_ORD_REMARK:        xlSheet.Range("B9").Value = ss3.Text
        ss3.Col = SS1_UST_STATUS:        xlSheet.Range("B10").Value = ss3.Text
        ss3.Col = SS1_GAS_STATUS:        xlSheet.Range("B11").Value = ss3.Text
        ss3.Col = SS1_CL_STATUS:         xlSheet.Range("B12").Value = ss3.Text
        ss3.Col = SS1_HTM_METH:          xlSheet.Range("B13").Value = ss3.Text
        ss3.Col = SS1_STDSPEC_ORG_KND:   xlSheet.Range("B14").Value = ss3.Text
        ss3.Col = SS1_STDSPEC_STLGRD:    xlSheet.Range("B15").Value = ss3.Text
        ss3.Col = SS1_QT:                xlSheet.Range("B16").Value = ss3.Text
        ss3.Col = SS1_PLATE_CON:         xlSheet.Range("B17").Value = ss3.MaxRows     'ss3.Text
        ss3.Col = SS1_PLATE_SIZE:        xlSheet.Range("B18").Value = ss3.Text
        ss3.Col = SS1_APLY_STDSPEC:      xlSheet.Range("B20").Value = ss3.Text   '新增 2015 1 27 周岩
'        ss3.Col = SS1_PUNCH:             xlSheet.Range("B21").Value = ss3.Text
        
        ss3.Col = SS1_Shift:             xlSheet.Range("D1").Value = ss3.Text
        ss3.Col = SS1_TRNS_CMPY_CD:      xlSheet.Range("D2").Value = ss3.Text
        ss3.Col = SS1_OUT_SHEET_NO:      xlSheet.Range("D3").Value = ss3.Text
        ss3.Col = SS1_THK_AVG:           xlSheet.Range("D5").Value = ss3.Text
        ss3.Col = SS1_WID_AVG:           xlSheet.Range("D6").Value = ss3.Text
        ss3.Col = SS1_LEN_AVG:           xlSheet.Range("D7").Value = ss3.Text
        ss3.Col = SS1_SIZE_KND:          xlSheet.Range("D8").Value = ss3.Text
        ss3.Col = SS1_RM_CR_STAGE3_TIME: xlSheet.Range("D9").Value = ss3.Text
        ss3.Col = SS1_CE_APPR_FL:        xlSheet.Range("D10").Value = ss3.Text
'        ss3.Col = SS1_QS_MARK_FL:        xlSheet.Range("D11").Value = ss3.Text
        ss3.Col = SS1_WGT:               xlSheet.Range("D11").Value = ss3.Text
        ss3.Col = SS1_VESSEL_NO:         xlSheet.Range("D12").Value = ss3.Text
        ss3.Col = SS1_SIDEMARK:          xlSheet.Range("D13").Value = ss3.Text
        ss3.Col = SS1_PAINTNUM:          xlSheet.Range("D14").Value = ss3.Text
        ss3.Col = SS1_GANGYIN:           xlSheet.Range("D15").Value = ss3.Text
        ss3.Col = SS1_PUNCH:             xlSheet.Range("D16").Value = ss3.Text
        ss3.Col = SS1_CUST_CD1:          xlSheet.Range("D17").Value = ss3.Text
        ss3.Col = SS1_CUST:              xlSheet.Range("D21").Value = ss3.Text
