...
Begin VB.Form DGA1130C 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.ComboBox CBO_SHIFT 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "DGA1130C.frx":0000
         Left            =   3990
         List            =   "DGA1130C.frx":000D
         TabIndex        =   4
         Top             =   210
         Width           =   705
      End
      ...
      Begin VB.ComboBox CBO_GROUP 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "DGA1130C.frx":001A
         Left            =   3990
         List            =   "DGA1130C.frx":002A
         TabIndex        =   2
         Top             =   600
         Width           =   705
      End
   ...
   Begin SSSplitter.SSSplitter SSSplitter1 
      ...
      Begin FPSpread.vaSpread ss1 
         ...
         SpreadDesigner  =   "DGA1130C.frx":008C
      End
      Begin FPSpread.vaSpread ss2 
         ...
         Protect         =   0   'False
         RetainSelBlock  =   0   'False
         SpreadDesigner  =   "DGA1130C.frx":08DA
      End
   End
   Begin VB.Line Line2 
...
Const SS2_USER_ID = 25                  'USER ID
Const SS2_BEF_SMP_FLAG = 26             'BEFORE 实绩标记
Const SS2_BEF_SMP_LOC = 27              'BEFORE 位置
Const SS2_BEF_SMP_LEN = 28              'BEFORE 长度
Const SS2_BEF_SMP_NO = 29               'BEFORE 试样号
Const SS2_CHG_SMP_NO = 30               '改判时试样号
Const SS2_CHG_STDSPEC = 31              '改判时适用标准
...
Private Sub Form_Define()
    ...
    sc1.Add Item:="DGA1130C.P_REFER1", Key:="P-R"
    ...
    sc2.Add Item:="DGA1130C.P_MODIFY", Key:="P-M"
    sc2.Add Item:="DGA1130C.P_REFER2", Key:="P-R"
...
Private Sub Cmd_Set_Save_Click()
    ...
    If txt_prod_cd.Text = "SL" Then
       sPlt = "C1"
    ElseIf txt_prod_cd.Text = "LO" Then
       sPlt = "C3"
    Else
       sPlt = "C2"
    End If
    ...
    strQuery = strQuery & "         ,PROD_REMARK                                                " & vbCrLf  '2010.11.19'
    ...
    strQuery = strQuery & "         ,M.PROD_REMARK                             PROD_REMARK      " & vbCrLf   '2010.11.19'
    ...
    strQuery = strQuery & "   FROM  GP_PLATE A  ,GP_REMARK M                                    " & vbCrLf
    strQuery = strQuery & "   WHERE (A.REC_STS          =     '2')              AND             " & vbCrLf
    strQuery = strQuery & "         (A.PROD_CD          =     'PP')             AND             " & vbCrLf
    strQuery = strQuery & "         (A.PLATE_NO         =     M.MAT_NO(+))      AND             " & vbCrLf    '2010.11.19'
    strQuery = strQuery & "         (NVL(A.HTM_METH1,'H')      IN ('N','Q','T','A')) AND        " & vbCrLf
    strQuery = strQuery & "         (A.PLT              =     '" & sPlt & "')  AND  " & vbCrLf
        ...
        For intRow = 1 To .MaxRows
            ...
            If .Text = "Selected" Then
                ...
                If intCount = 0 Then
                    ...
                    If txt_prod_cd = "SL" Or txt_prod_cd = "C2" Then
                      .Col = 1
                    Else
                      .Col = 2
                    End If
