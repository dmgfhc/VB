...
Begin VB.Form DGA1050C 
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      ProcessTab      =   -1  'True
      Protect         =   0   'False
      SpreadDesigner  =   "DGA1050C.frx":0000
   End
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin VB.ComboBox cbo_PrcLine 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "DGA1050C.frx":0D94
         Left            =   4170
         List            =   "DGA1050C.frx":0D96
         Locked          =   -1  'True
         TabIndex        =   6
         Tag             =   "炉座号"
         Top             =   180
...
Private Sub Form_Define()
   ...
   Call Gp_Sp_Collection(ss1, 25, "p", " ", " ", "i", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
   ...
   Call Gp_Sp_Collection(ss1, 28, " ", " ", " ", " ", " ", "l", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    'sc1.Add Item:="DGA1040B.P_REFER1", Key:="P-R"
...
Private Sub txt_RsltHtm_DblClick()
    Call txt_RsltHtm_KeyUp(vbKeyF4, 0)
End Sub

Private Sub txt_RsltHtm_KeyUp(KeyCode As Integer, Shift As Integer)
    If KeyCode = vbKeyF4 Then

        DD.sWitch = "MS"
        DD.sKey = "Q0073"
        DD.rControl.Add Item:=txt_RsltHtm
