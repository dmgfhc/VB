...
Begin VB.Form DGA1080C 
   Caption         =   "抛丸实绩查询_DGA1080C"
   ClientHeight    =   5610
   ClientLeft      =   180
   ClientTop       =   3690
   ClientWidth     =   14940
   ...
   Begin VB.ComboBox cbo_group 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "DGA1080C.frx":0000
      Left            =   8100
      List            =   "DGA1080C.frx":0013
   ...
   Begin VB.ComboBox cbo_shift 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "DGA1080C.frx":0025
      Left            =   5940
      List            =   "DGA1080C.frx":0035
      Style           =   2  'Dropdown List
      TabIndex        =   4
      Top             =   450
      Width           =   795
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      ProcessTab      =   -1  'True
      Protect         =   0   'False
      SpreadDesigner  =   "DGA1080C.frx":0044
   End
...
Private Sub Form_Define()
    ...
    sc1.Add Item:="DGA1080C.P_REFER", Key:="P-R"
    sc1.Add Item:="DGA1080C.P_ONEROW", Key:="P-O"
    sc1.Add Item:="DGA1080C.P_MODIFY", Key:="P-M"
