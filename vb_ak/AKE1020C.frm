...
Begin VB.Form AKE1020C 
   Caption         =   "精炼工艺参数查询界面_AKE1020C"
   ClientHeight    =   3030
   ClientLeft      =   120
   ClientTop       =   450
   ClientWidth     =   4560
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "AKE1020C.frx":0000
   End
   Begin FPSpread.vaSpread ss3 
      ...
      MaxRows         =   4
      RetainSelBlock  =   0   'False
      SpreadDesigner  =   "AKE1020C.frx":04DA
   End
   ...
   Begin FPSpread.vaSpread ss2 
      ...
      MaxRows         =   10
      RetainSelBlock  =   0   'False
      SpreadDesigner  =   "AKE1020C.frx":3490
   End
End
Attribute VB_Name = "AKE1020C"
...
Private Sub Form_Define()
    ...
    sc1.Add Item:="AKE1020C.P_SREFER1", Key:="P-R"
    ...
    sc2.Add Item:="AKE1020C.P_SREFER2", Key:="P-R"
   ...
   'Spread_Collection
    ...
    Sc3.Add Item:="AKE1020C.P_SREFER3", Key:="P-R"
