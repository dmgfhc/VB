...
Begin VB.Form AKN2060C 
   Caption         =   "板坯计划指示恢复界面_AKN2060C"
   ClientHeight    =   3030
   ClientLeft      =   120
   ClientTop       =   450
   ClientWidth     =   4560
   ...
   Begin SSSplitter.SSSplitter SSSplitter1 
      ...
      Begin FPSpread.vaSpread ss1 
         ...
         SpreadDesigner  =   "AKN2060C.frx":00D2
      End
      Begin FPSpread.vaSpread ss2 
         ...
         MaxRows         =   2
         RetainSelBlock  =   0   'False
         SpreadDesigner  =   "AKN2060C.frx":0955
      End
      Begin FPSpread.vaSpread ss3 
         ...
         MaxRows         =   2
         RetainSelBlock  =   0   'False
         SpreadDesigner  =   "AKN2060C.frx":1523
      End
      Begin FPSpread.vaSpread ss5 
         ...
         MaxRows         =   2
         RetainSelBlock  =   0   'False
         SpreadDesigner  =   "AKN2060C.frx":1DA6
      End
      Begin FPSpread.vaSpread ss4 
         ...
         MaxRows         =   2
         RetainSelBlock  =   0   'False
         SpreadDesigner  =   "AKN2060C.frx":2629
      End
      Begin FPSpread.vaSpread ss6 
         ...
         MaxRows         =   2
         RetainSelBlock  =   0   'False
         SpreadDesigner  =   "AKN2060C.frx":31CF
      End
   End
...
Private Sub Form_Define()
    ...
    sc1.Add Item:="AKN2060C.P_REFER1", Key:="P-R"
    ...
    sc2.Add Item:="AKN2060C.P_REFER2", Key:="P-R"
    ...
    Sc3.Add Item:="AKN2060C.P_REFER1", Key:="P-R"
    ...
    Sc4.Add Item:="AKN2060C.P_REFER2", Key:="P-R"
    ...
    Sc5.Add Item:="AKN2060C.P_REFER1", Key:="P-R"
    ...
    Sc6.Add Item:="AKN2060C.P_REFER2", Key:="P-R"
...
On Error GoTo Process_Error
    ...
    sQuery = "{call AKN2060C.P_MODIFY ('" & txt_plt.Text & "',  '" & txt_charge.Text & "', '" & txt_from.Text & "',?)}"
