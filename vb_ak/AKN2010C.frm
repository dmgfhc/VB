...
Begin VB.Form AKN2010C 
   Caption         =   "炼钢作业指示查询界面_AKN2010C"
   ClientHeight    =   9165
   ClientLeft      =   375
   ClientTop       =   2070
   ClientWidth     =   15285
   ...
   Begin VB.ComboBox cbo_cc_id 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "AKN2010C.frx":0000
      Left            =   9000
      List            =   "AKN2010C.frx":0002
      TabIndex        =   3
      Tag             =   "连铸机号"
      Top             =   120
      Width           =   780
   ...
   Begin VB.ComboBox cbo_con_id 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "AKN2010C.frx":0004
      Left            =   5760
      List            =   "AKN2010C.frx":000B
      TabIndex        =   1
      Tag             =   "炉座号"
      Top             =   135
      Width           =   780
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "AKN2010C.frx":0012
   End
...
Private Sub Form_Define()
    ...
    Call Gp_Ms_Collection(cbo_heat_no, "p", " ", " ", " ", "r", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
     Call Gp_Ms_Collection(cbo_con_id, "p", " ", " ", " ", " ", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
      Call Gp_Ms_Collection(cbo_cc_id, "p", " ", " ", " ", " ", " ", " ", pControl, nControl, mControl, iControl, rControl, aControl, lControl)
   ...
   Call Gp_Sp_Collection(ss1, 23, " ", " ", " ", " ", " ", " ", pColumn1, nColumn1, mColumn1, iColumn1, aColumn1, lColumn1)
    ...
    Sc1.Add Item:="AFN2010C.P_REFER", Key:="P-R"
...
Private Sub Form_Load()
    ...
    Call Gf_ComboAdd(M_CN1, cbo_heat_no, "SELECT HEAT_MANA_NO FROM NISCO.EP_CHARGE_INS WHERE PRC_STS='A' AND ROWNUM=1 ORDER BY HEAT_EDT_SEQ ASC ")
