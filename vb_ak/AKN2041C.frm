...
Private Sub Cmd_Ok_Click()
    ...
    If Trim(cbo_plan_name.Text) = "" Then
        Call Gp_MsgBoxDisplay(cbo_plan_name.Tag & "必须输入", "", "错误提示")
        Exit Sub
    End If
    ...
    If sdb_len_2.Value + sdb_cnt_2.Value <> 0 Then
        If sdb_wid_2.Value = 0 Then
            Call Gp_MsgBoxDisplay(sdb_wid_2.Tag & "必须输入", "", "错误提示")
            Exit Sub
    ...
    If sdb_len_3.Value + sdb_cnt_3.Value <> 0 Then
        If sdb_wid_3.Value = 0 Then
            Call Gp_MsgBoxDisplay(sdb_wid_3.Tag & "必须输入", "", "错误提示")
            Exit Sub
    ...
    If sdb_len_4.Value + sdb_cnt_4.Value <> 0 Then
        If sdb_wid_4.Value = 0 Then
            Call Gp_MsgBoxDisplay(sdb_wid_4.Tag & "必须输入", "", "错误提示")
            Exit Sub
    ...
    If sdb_len_5.Value + sdb_cnt_5.Value <> 0 Then
        If sdb_wid_5.Value = 0 Then
            Call Gp_MsgBoxDisplay(sdb_wid_5.Tag & "必须输入", "", "错误提示")
            Exit Sub
...
Public Sub Gp_Process_Exec()
    ...
    If adoCmd("arg_e_msg") <> "" Then
        ...
        Exit Sub
    Else
        Call Gp_MsgBoxDisplay("非计划材编制完了..!!", "I")
        Set adoCmd = Nothing
        Screen.MousePointer = vbDefault
