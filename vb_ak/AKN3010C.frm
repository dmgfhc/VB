...
Begin VB.Form AKN3010C 
   Caption         =   "转炉工艺参数查询界面_AKN3010C"
   ClientHeight    =   3030
   ClientLeft      =   120
   ClientTop       =   450
   ClientWidth     =   4560
   ...
   Begin FPSpread.vaSpread ss1 
      ...
      SpreadDesigner  =   "AKN3010C.frx":0000
   End
   Begin FPSpread.vaSpread ss2 
      ...
      MaxRows         =   3
      RetainSelBlock  =   0   'False
      SpreadDesigner  =   "AKN3010C.frx":04AC
   End
   Begin FPSpread.vaSpread ss3 
      ...
      MaxRows         =   3
      RetainSelBlock  =   0   'False
      SpreadDesigner  =   "AKN3010C.frx":0993
   End
...
Private Sub Form_Define()
    ...
    sc1.Add Item:="AKN3010C.P_SREFER1", Key:="P-R"
    ...
    sc2.Add Item:="AKN3010C.P_SREFER2", Key:="P-R"
   ...
   'Spread_Collection
    ...
    Sc3.Add Item:="AKN3010C.P_SREFER3", Key:="P-R"
